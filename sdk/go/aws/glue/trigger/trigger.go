...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/glue/TriggerAction"
	"https:/github.com/pulumi/pulumi-aws/glue/TriggerPredicate"
...
type Trigger struct {
	...
	Actions glueTriggerAction.TriggerActionArrayOutput `pulumi:"actions"`
	...
	Predicate glueTriggerPredicate.TriggerPredicatePtrOutput `pulumi:"predicate"`
...
type triggerState struct {
	// List of actions initiated by this trigger when it fires. Defined below.
	Actions []glueTriggerAction.TriggerAction `pulumi:"actions"`
	// Amazon Resource Name (ARN) of Glue Trigger
	...
	// A predicate to specify when the new trigger should fire. Required when trigger type is `CONDITIONAL`. Defined below.
	Predicate *glueTriggerPredicate.TriggerPredicate `pulumi:"predicate"`
	// A cron expression used to specify the schedule. [Time-Based Schedules for Jobs and Crawlers](https://docs.aws.amazon.com/glue/latest/dg/monitor-data-warehouse-schedule.html)
...
type TriggerState struct {
	// List of actions initiated by this trigger when it fires. Defined below.
	Actions glueTriggerAction.TriggerActionArrayInput
	// Amazon Resource Name (ARN) of Glue Trigger
	...
	// A predicate to specify when the new trigger should fire. Required when trigger type is `CONDITIONAL`. Defined below.
	Predicate glueTriggerPredicate.TriggerPredicatePtrInput
	// A cron expression used to specify the schedule. [Time-Based Schedules for Jobs and Crawlers](https://docs.aws.amazon.com/glue/latest/dg/monitor-data-warehouse-schedule.html)
