...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/glue/SecurityConfigurationEncryptionConfiguration"
...
type SecurityConfiguration struct {
	...
	EncryptionConfiguration glueSecurityConfigurationEncryptionConfiguration.SecurityConfigurationEncryptionConfigurationOutput `pulumi:"encryptionConfiguration"`
...
type securityConfigurationState struct {
	// Configuration block containing encryption configuration. Detailed below.
	EncryptionConfiguration *glueSecurityConfigurationEncryptionConfiguration.SecurityConfigurationEncryptionConfiguration `pulumi:"encryptionConfiguration"`
	// Name of the security configuration.
...
type SecurityConfigurationState struct {
	// Configuration block containing encryption configuration. Detailed below.
	EncryptionConfiguration glueSecurityConfigurationEncryptionConfiguration.SecurityConfigurationEncryptionConfigurationPtrInput
	// Name of the security configuration.
...
type SecurityConfigurationArgs struct {
	// Configuration block containing encryption configuration. Detailed below.
	EncryptionConfiguration glueSecurityConfigurationEncryptionConfiguration.SecurityConfigurationEncryptionConfigurationInput
	// Name of the security configuration.
	Name pulumi.StringPtrInput
}
