...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/glue/CatalogTablePartitionKey"
	"https:/github.com/pulumi/pulumi-aws/glue/CatalogTableStorageDescriptor"
...
type CatalogTable struct {
	...
	PartitionKeys glueCatalogTablePartitionKey.CatalogTablePartitionKeyArrayOutput `pulumi:"partitionKeys"`
	// Retention time for this table.
	Retention pulumi.IntPtrOutput `pulumi:"retention"`
	// A storage descriptor object containing information about the physical storage of this table. You can refer to the [Glue Developer Guide](https://docs.aws.amazon.com/glue/latest/dg/aws-glue-api-catalog-tables.html#aws-glue-api-catalog-tables-StorageDescriptor) for a full explanation of this object.
	StorageDescriptor glueCatalogTableStorageDescriptor.CatalogTableStorageDescriptorPtrOutput `pulumi:"storageDescriptor"`
...
type catalogTableState struct {
	...
	// A list of columns by which the table is partitioned. Only primitive types are supported as partition keys.
	PartitionKeys []glueCatalogTablePartitionKey.CatalogTablePartitionKey `pulumi:"partitionKeys"`
	// Retention time for this table.
	Retention *int `pulumi:"retention"`
	// A storage descriptor object containing information about the physical storage of this table. You can refer to the [Glue Developer Guide](https://docs.aws.amazon.com/glue/latest/dg/aws-glue-api-catalog-tables.html#aws-glue-api-catalog-tables-StorageDescriptor) for a full explanation of this object.
	StorageDescriptor *glueCatalogTableStorageDescriptor.CatalogTableStorageDescriptor `pulumi:"storageDescriptor"`
	// The type of this table (EXTERNAL_TABLE, VIRTUAL_VIEW, etc.).
...
type CatalogTableState struct {
	...
	// A list of columns by which the table is partitioned. Only primitive types are supported as partition keys.
	PartitionKeys glueCatalogTablePartitionKey.CatalogTablePartitionKeyArrayInput
	// Retention time for this table.
	Retention pulumi.IntPtrInput
	// A storage descriptor object containing information about the physical storage of this table. You can refer to the [Glue Developer Guide](https://docs.aws.amazon.com/glue/latest/dg/aws-glue-api-catalog-tables.html#aws-glue-api-catalog-tables-StorageDescriptor) for a full explanation of this object.
	StorageDescriptor glueCatalogTableStorageDescriptor.CatalogTableStorageDescriptorPtrInput
	// The type of this table (EXTERNAL_TABLE, VIRTUAL_VIEW, etc.).
