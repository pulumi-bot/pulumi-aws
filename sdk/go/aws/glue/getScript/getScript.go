...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/glue/getScriptDagEdge"
	"https:/github.com/pulumi/pulumi-aws/glue/getScriptDagNode"
...
type GetScriptArgs struct {
	...
	DagEdges []gluegetScriptDagEdge.GetScriptDagEdge `pulumi:"dagEdges"`
	// A list of the nodes in the DAG. Defined below.
	DagNodes []gluegetScriptDagNode.GetScriptDagNode `pulumi:"dagNodes"`
