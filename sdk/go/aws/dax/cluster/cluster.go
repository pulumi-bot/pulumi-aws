...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/dax/ClusterNode"
	"https:/github.com/pulumi/pulumi-aws/dax/ClusterServerSideEncryption"
)
...
type Cluster struct {
	...
	Nodes daxClusterNode.ClusterNodeArrayOutput `pulumi:"nodes"`
	...
	ServerSideEncryption daxClusterServerSideEncryption.ClusterServerSideEncryptionPtrOutput `pulumi:"serverSideEncryption"`
...
type clusterState struct {
	...
	// `availabilityZone`. Referenceable e.g. as
	// `${aws_dax_cluster.test.nodes.0.address}`
	Nodes []daxClusterNode.ClusterNode `pulumi:"nodes"`
	// An Amazon Resource Name (ARN) of an
	// SNS topic to send DAX notifications to. Example:
	// `arn:aws:sns:us-east-1:012345678999:my_sns_topic`
	...
	// Encrypt at rest options
	ServerSideEncryption *daxClusterServerSideEncryption.ClusterServerSideEncryption `pulumi:"serverSideEncryption"`
	// Name of the subnet group to be used for the
	// cluster
...
type ClusterState struct {
	...
	// `availabilityZone`. Referenceable e.g. as
	// `${aws_dax_cluster.test.nodes.0.address}`
	Nodes daxClusterNode.ClusterNodeArrayInput
	// An Amazon Resource Name (ARN) of an
	// SNS topic to send DAX notifications to. Example:
	// `arn:aws:sns:us-east-1:012345678999:my_sns_topic`
	...
	// Encrypt at rest options
	ServerSideEncryption daxClusterServerSideEncryption.ClusterServerSideEncryptionPtrInput
	// Name of the subnet group to be used for the
	// cluster
