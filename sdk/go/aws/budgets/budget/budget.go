...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/budgets/BudgetCostTypes"
	"https:/github.com/pulumi/pulumi-aws/budgets/BudgetNotification"
)
...
type Budget struct {
	...
	CostTypes budgetsBudgetCostTypes.BudgetCostTypesOutput `pulumi:"costTypes"`
	...
	Notifications budgetsBudgetNotification.BudgetNotificationArrayOutput `pulumi:"notifications"`
...
type budgetState struct {
	...
	// Object containing CostTypes The types of cost included in a budget, such as tax and subscriptions..
	CostTypes *budgetsBudgetCostTypes.BudgetCostTypes `pulumi:"costTypes"`
	// The amount of cost or usage being measured for a budget.
	...
	// Object containing Budget Notifications. Can be used multiple times to define more than one budget notification
	Notifications []budgetsBudgetNotification.BudgetNotification `pulumi:"notifications"`
	// The end of the time period covered by the budget. There are no restrictions on the end date. Format: `2017-01-01_12:00`.
...
type BudgetState struct {
	...
	// Object containing CostTypes The types of cost included in a budget, such as tax and subscriptions..
	CostTypes budgetsBudgetCostTypes.BudgetCostTypesPtrInput
	// The amount of cost or usage being measured for a budget.
	...
	// Object containing Budget Notifications. Can be used multiple times to define more than one budget notification
	Notifications budgetsBudgetNotification.BudgetNotificationArrayInput
	// The end of the time period covered by the budget. There are no restrictions on the end date. Format: `2017-01-01_12:00`.
