...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/ecs/ServiceCapacityProviderStrategy"
	"https:/github.com/pulumi/pulumi-aws/ecs/ServiceDeploymentController"
	"https:/github.com/pulumi/pulumi-aws/ecs/ServiceLoadBalancer"
	"https:/github.com/pulumi/pulumi-aws/ecs/ServiceNetworkConfiguration"
	"https:/github.com/pulumi/pulumi-aws/ecs/ServiceOrderedPlacementStrategy"
	"https:/github.com/pulumi/pulumi-aws/ecs/ServicePlacementConstraint"
	"https:/github.com/pulumi/pulumi-aws/ecs/ServiceServiceRegistries"
)
...
type Service struct {
	...
	CapacityProviderStrategies ecsServiceCapacityProviderStrategy.ServiceCapacityProviderStrategyArrayOutput `pulumi:"capacityProviderStrategies"`
	// ARN of an ECS cluster
	Cluster pulumi.StringOutput `pulumi:"cluster"`
	// Configuration block containing deployment controller configuration. Defined below.
	DeploymentController ecsServiceDeploymentController.ServiceDeploymentControllerPtrOutput `pulumi:"deploymentController"`
	...
	LoadBalancers ecsServiceLoadBalancer.ServiceLoadBalancerArrayOutput `pulumi:"loadBalancers"`
	// The name of the service (up to 255 letters, numbers, hyphens, and underscores)
	Name pulumi.StringOutput `pulumi:"name"`
	// The network configuration for the service. This parameter is required for task definitions that use the `awsvpc` network mode to receive their own Elastic Network Interface, and it is not supported for other network modes.
	NetworkConfiguration ecsServiceNetworkConfiguration.ServiceNetworkConfigurationPtrOutput `pulumi:"networkConfiguration"`
	...
	OrderedPlacementStrategies ecsServiceOrderedPlacementStrategy.ServiceOrderedPlacementStrategyArrayOutput `pulumi:"orderedPlacementStrategies"`
	// rules that are taken into consideration during task placement. Maximum number of
	// `placementConstraints` is `10`. Defined below.
	PlacementConstraints ecsServicePlacementConstraint.ServicePlacementConstraintArrayOutput `pulumi:"placementConstraints"`
	...
	ServiceRegistries ecsServiceServiceRegistries.ServiceServiceRegistriesPtrOutput `pulumi:"serviceRegistries"`
...
type serviceState struct {
	// The capacity provider strategy to use for the service. Can be one or more.  Defined below.
	CapacityProviderStrategies []ecsServiceCapacityProviderStrategy.ServiceCapacityProviderStrategy `pulumi:"capacityProviderStrategies"`
	// ARN of an ECS cluster
	Cluster *string `pulumi:"cluster"`
	// Configuration block containing deployment controller configuration. Defined below.
	DeploymentController *ecsServiceDeploymentController.ServiceDeploymentController `pulumi:"deploymentController"`
	// The upper limit (as a percentage of the service's desiredCount) of the number of running tasks that can be running in a service during a deployment. Not valid when using the `DAEMON` scheduling strategy.
	...
	// A load balancer block. Load balancers documented below.
	LoadBalancers []ecsServiceLoadBalancer.ServiceLoadBalancer `pulumi:"loadBalancers"`
	// The name of the service (up to 255 letters, numbers, hyphens, and underscores)
	Name *string `pulumi:"name"`
	// The network configuration for the service. This parameter is required for task definitions that use the `awsvpc` network mode to receive their own Elastic Network Interface, and it is not supported for other network modes.
	NetworkConfiguration *ecsServiceNetworkConfiguration.ServiceNetworkConfiguration `pulumi:"networkConfiguration"`
	// Service level strategy rules that are taken into consideration during task placement. List from top to bottom in order of precedence. The maximum number of `orderedPlacementStrategy` blocks is `5`. Defined below.
	OrderedPlacementStrategies []ecsServiceOrderedPlacementStrategy.ServiceOrderedPlacementStrategy `pulumi:"orderedPlacementStrategies"`
	// rules that are taken into consideration during task placement. Maximum number of
	// `placementConstraints` is `10`. Defined below.
	PlacementConstraints []ecsServicePlacementConstraint.ServicePlacementConstraint `pulumi:"placementConstraints"`
	// The platform version on which to run your service. Only applicable for `launchType` set to `FARGATE`. Defaults to `LATEST`. More information about Fargate platform versions can be found in the [AWS ECS User Guide](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/platform_versions.html).
	...
	// The service discovery registries for the service. The maximum number of `serviceRegistries` blocks is `1`.
	ServiceRegistries *ecsServiceServiceRegistries.ServiceServiceRegistries `pulumi:"serviceRegistries"`
	// Key-value mapping of resource tags
...
type ServiceState struct {
	// The capacity provider strategy to use for the service. Can be one or more.  Defined below.
	CapacityProviderStrategies ecsServiceCapacityProviderStrategy.ServiceCapacityProviderStrategyArrayInput
	// ARN of an ECS cluster
	Cluster pulumi.StringPtrInput
	// Configuration block containing deployment controller configuration. Defined below.
	DeploymentController ecsServiceDeploymentController.ServiceDeploymentControllerPtrInput
	// The upper limit (as a percentage of the service's desiredCount) of the number of running tasks that can be running in a service during a deployment. Not valid when using the `DAEMON` scheduling strategy.
	...
	// A load balancer block. Load balancers documented below.
	LoadBalancers ecsServiceLoadBalancer.ServiceLoadBalancerArrayInput
	// The name of the service (up to 255 letters, numbers, hyphens, and underscores)
	Name pulumi.StringPtrInput
	// The network configuration for the service. This parameter is required for task definitions that use the `awsvpc` network mode to receive their own Elastic Network Interface, and it is not supported for other network modes.
	NetworkConfiguration ecsServiceNetworkConfiguration.ServiceNetworkConfigurationPtrInput
	// Service level strategy rules that are taken into consideration during task placement. List from top to bottom in order of precedence. The maximum number of `orderedPlacementStrategy` blocks is `5`. Defined below.
	OrderedPlacementStrategies ecsServiceOrderedPlacementStrategy.ServiceOrderedPlacementStrategyArrayInput
	// rules that are taken into consideration during task placement. Maximum number of
	// `placementConstraints` is `10`. Defined below.
	PlacementConstraints ecsServicePlacementConstraint.ServicePlacementConstraintArrayInput
	// The platform version on which to run your service. Only applicable for `launchType` set to `FARGATE`. Defaults to `LATEST`. More information about Fargate platform versions can be found in the [AWS ECS User Guide](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/platform_versions.html).
	...
	// The service discovery registries for the service. The maximum number of `serviceRegistries` blocks is `1`.
	ServiceRegistries ecsServiceServiceRegistries.ServiceServiceRegistriesPtrInput
	// Key-value mapping of resource tags
