...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/ecs/ClusterDefaultCapacityProviderStrategy"
	"https:/github.com/pulumi/pulumi-aws/ecs/ClusterSetting"
)
...
type Cluster struct {
	...
	DefaultCapacityProviderStrategies ecsClusterDefaultCapacityProviderStrategy.ClusterDefaultCapacityProviderStrategyArrayOutput `pulumi:"defaultCapacityProviderStrategies"`
	...
	Settings ecsClusterSetting.ClusterSettingArrayOutput `pulumi:"settings"`
...
type clusterState struct {
	...
	// The capacity provider strategy to use by default for the cluster. Can be one or more.  Defined below.
	DefaultCapacityProviderStrategies []ecsClusterDefaultCapacityProviderStrategy.ClusterDefaultCapacityProviderStrategy `pulumi:"defaultCapacityProviderStrategies"`
	// The name of the cluster (up to 255 letters, numbers, hyphens, and underscores)
	Name *string `pulumi:"name"`
	// Configuration block(s) with cluster settings. For example, this can be used to enable CloudWatch Container Insights for a cluster. Defined below.
	Settings []ecsClusterSetting.ClusterSetting `pulumi:"settings"`
	// Key-value mapping of resource tags
...
type ClusterState struct {
	...
	// The capacity provider strategy to use by default for the cluster. Can be one or more.  Defined below.
	DefaultCapacityProviderStrategies ecsClusterDefaultCapacityProviderStrategy.ClusterDefaultCapacityProviderStrategyArrayInput
	// The name of the cluster (up to 255 letters, numbers, hyphens, and underscores)
	Name pulumi.StringPtrInput
	// Configuration block(s) with cluster settings. For example, this can be used to enable CloudWatch Container Insights for a cluster. Defined below.
	Settings ecsClusterSetting.ClusterSettingArrayInput
	// Key-value mapping of resource tags
