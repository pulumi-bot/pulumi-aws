...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/ecs/CapacityProviderAutoScalingGroupProvider"
...
type CapacityProvider struct {
	...
	AutoScalingGroupProvider ecsCapacityProviderAutoScalingGroupProvider.CapacityProviderAutoScalingGroupProviderOutput `pulumi:"autoScalingGroupProvider"`
...
type capacityProviderState struct {
	...
	// Nested argument defining the provider for the ECS auto scaling group. Defined below.
	AutoScalingGroupProvider *ecsCapacityProviderAutoScalingGroupProvider.CapacityProviderAutoScalingGroupProvider `pulumi:"autoScalingGroupProvider"`
	// The name of the capacity provider.
...
type CapacityProviderState struct {
	...
	// Nested argument defining the provider for the ECS auto scaling group. Defined below.
	AutoScalingGroupProvider ecsCapacityProviderAutoScalingGroupProvider.CapacityProviderAutoScalingGroupProviderPtrInput
	// The name of the capacity provider.
...
type CapacityProviderArgs struct {
	// Nested argument defining the provider for the ECS auto scaling group. Defined below.
	AutoScalingGroupProvider ecsCapacityProviderAutoScalingGroupProvider.CapacityProviderAutoScalingGroupProviderInput
	// The name of the capacity provider.
	Name pulumi.StringPtrInput
	// Key-value mapping of resource tags.
	Tags pulumi.MapInput
