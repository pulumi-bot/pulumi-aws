...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/ecs/TaskDefinitionPlacementConstraint"
	"https:/github.com/pulumi/pulumi-aws/ecs/TaskDefinitionProxyConfiguration"
	"https:/github.com/pulumi/pulumi-aws/ecs/TaskDefinitionVolume"
...
type TaskDefinition struct {
	...
	PlacementConstraints ecsTaskDefinitionPlacementConstraint.TaskDefinitionPlacementConstraintArrayOutput `pulumi:"placementConstraints"`
	// The proxy configuration details for the App Mesh proxy.
	ProxyConfiguration ecsTaskDefinitionProxyConfiguration.TaskDefinitionProxyConfigurationPtrOutput `pulumi:"proxyConfiguration"`
	...
	Volumes ecsTaskDefinitionVolume.TaskDefinitionVolumeArrayOutput `pulumi:"volumes"`
}
...
type taskDefinitionState struct {
	...
	// A set of placement constraints rules that are taken into consideration during task placement. Maximum number of `placementConstraints` is `10`.
	PlacementConstraints []ecsTaskDefinitionPlacementConstraint.TaskDefinitionPlacementConstraint `pulumi:"placementConstraints"`
	// The proxy configuration details for the App Mesh proxy.
	ProxyConfiguration *ecsTaskDefinitionProxyConfiguration.TaskDefinitionProxyConfiguration `pulumi:"proxyConfiguration"`
	// A set of launch types required by the task. The valid values are `EC2` and `FARGATE`.
	...
	// A set of volume blocks that containers in your task may use.
	Volumes []ecsTaskDefinitionVolume.TaskDefinitionVolume `pulumi:"volumes"`
}
...
type TaskDefinitionState struct {
	...
	// A set of placement constraints rules that are taken into consideration during task placement. Maximum number of `placementConstraints` is `10`.
	PlacementConstraints ecsTaskDefinitionPlacementConstraint.TaskDefinitionPlacementConstraintArrayInput
	// The proxy configuration details for the App Mesh proxy.
	ProxyConfiguration ecsTaskDefinitionProxyConfiguration.TaskDefinitionProxyConfigurationPtrInput
	// A set of launch types required by the task. The valid values are `EC2` and `FARGATE`.
	...
	// A set of volume blocks that containers in your task may use.
	Volumes ecsTaskDefinitionVolume.TaskDefinitionVolumeArrayInput
}
