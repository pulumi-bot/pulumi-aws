...
func GetAmiApply(ctx *pulumi.Context, args GetAmiApplyInput, opts ...pulumi.InvokeOption) GetAmiResultOutput {
	return args.ToGetAmiApplyOutput().ApplyT(func(v GetAmiArgs) (GetAmiResult, error) {
		r, err := GetAmi(ctx, &v, opts...)
		return *r, err

	}).(GetAmiResultOutput)
}

// GetAmiApplyInput is an input type that accepts GetAmiApplyArgs and GetAmiApplyOutput values.
// You can construct a concrete instance of `GetAmiApplyInput` via:
//
//          GetAmiApplyArgs{...}
type GetAmiApplyInput interface {
	pulumi.Input

	ToGetAmiApplyOutput() GetAmiApplyOutput
	ToGetAmiApplyOutputWithContext(context.Context) GetAmiApplyOutput
}

// A collection of arguments for invoking getAmi.
type GetAmiApplyArgs struct {
	// Limit search to users with *explicit* launch permission on
	// the image. Valid items are the numeric account ID or `self`.
...
func (GetAmiApplyArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*GetAmiArgs)(nil)).Elem()
}

func (i GetAmiApplyArgs) ToGetAmiApplyOutput() GetAmiApplyOutput {
	return i.ToGetAmiApplyOutputWithContext(context.Background())
}

func (i GetAmiApplyArgs) ToGetAmiApplyOutputWithContext(ctx context.Context) GetAmiApplyOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GetAmiApplyOutput)
}

// A collection of arguments for invoking getAmi.
type GetAmiApplyOutput struct{ *pulumi.OutputState }

func (GetAmiApplyOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GetAmiArgs)(nil)).Elem()
}

func (o GetAmiApplyOutput) ToGetAmiApplyOutput() GetAmiApplyOutput {
	return o
}

func (o GetAmiApplyOutput) ToGetAmiApplyOutputWithContext(ctx context.Context) GetAmiApplyOutput {
	return o
}

// Limit search to users with *explicit* launch permission on
// the image. Valid items are the numeric account ID or `self`.
func (o GetAmiApplyOutput) ExecutableUsers() pulumi.StringArrayOutput {
	return o.ApplyT(func(v GetAmiArgs) []string { return v.ExecutableUsers }).(pulumi.StringArrayOutput)
}

// One or more name/value pairs to filter off of. There are
// several valid keys, for a full reference, check out
// [describe-images in the AWS CLI reference][1].
func (o GetAmiApplyOutput) Filters() GetAmiFilterArrayOutput {
	return o.ApplyT(func(v GetAmiArgs) []GetAmiFilter { return v.Filters }).(GetAmiFilterArrayOutput)
}

// If more than one result is returned, use the most
// recent AMI.
func (o GetAmiApplyOutput) MostRecent() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v GetAmiArgs) *bool { return v.MostRecent }).(pulumi.BoolPtrOutput)
}
...
// impact if the result is large. It is recommended to combine this with other
// options to narrow down the list AWS returns.
func (o GetAmiApplyOutput) NameRegex() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetAmiArgs) *string { return v.NameRegex }).(pulumi.StringPtrOutput)
}

// List of AMI owners to limit search. At least 1 value must be specified. Valid values: an AWS account ID, `self` (the current account), or an AWS owner alias (e.g. `amazon`, `aws-marketplace`, `microsoft`).
func (o GetAmiApplyOutput) Owners() pulumi.StringArrayOutput {
	return o.ApplyT(func(v GetAmiArgs) []string { return v.Owners }).(pulumi.StringArrayOutput)
}

// Any tags assigned to the image.
// * `tags.#.key` - The key name of the tag.
// * `tags.#.value` - The value of the tag.
func (o GetAmiApplyOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v GetAmiArgs) map[string]string { return v.Tags }).(pulumi.StringMapOutput)
}
...
func init() {
	pulumi.RegisterOutputType(GetAmiApplyOutput{})
