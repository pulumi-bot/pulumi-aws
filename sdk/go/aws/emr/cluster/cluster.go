...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/emr/ClusterBootstrapAction"
	"https:/github.com/pulumi/pulumi-aws/emr/ClusterCoreInstanceGroup"
	"https:/github.com/pulumi/pulumi-aws/emr/ClusterCoreInstanceGroupEbsConfig"
	"https:/github.com/pulumi/pulumi-aws/emr/ClusterEc2Attributes"
	"https:/github.com/pulumi/pulumi-aws/emr/ClusterInstanceGroup"
	"https:/github.com/pulumi/pulumi-aws/emr/ClusterInstanceGroupEbsConfig"
	"https:/github.com/pulumi/pulumi-aws/emr/ClusterKerberosAttributes"
	"https:/github.com/pulumi/pulumi-aws/emr/ClusterMasterInstanceGroup"
	"https:/github.com/pulumi/pulumi-aws/emr/ClusterMasterInstanceGroupEbsConfig"
	"https:/github.com/pulumi/pulumi-aws/emr/ClusterStep"
...
type Cluster struct {
	...
	BootstrapActions emrClusterBootstrapAction.ClusterBootstrapActionArrayOutput `pulumi:"bootstrapActions"`
	...
	CoreInstanceGroup emrClusterCoreInstanceGroup.ClusterCoreInstanceGroupOutput `pulumi:"coreInstanceGroup"`
	...
	Ec2Attributes emrClusterEc2Attributes.ClusterEc2AttributesPtrOutput `pulumi:"ec2Attributes"`
	...
	InstanceGroups emrClusterInstanceGroup.ClusterInstanceGroupArrayOutput `pulumi:"instanceGroups"`
	// Switch on/off run cluster with no steps or when all steps are complete (default is on)
	KeepJobFlowAliveWhenNoSteps pulumi.BoolOutput `pulumi:"keepJobFlowAliveWhenNoSteps"`
	// Kerberos configuration for the cluster. Defined below
	KerberosAttributes emrClusterKerberosAttributes.ClusterKerberosAttributesPtrOutput `pulumi:"kerberosAttributes"`
	...
	MasterInstanceGroup emrClusterMasterInstanceGroup.ClusterMasterInstanceGroupOutput `pulumi:"masterInstanceGroup"`
	...
	Steps emrClusterStep.ClusterStepArrayOutput `pulumi:"steps"`
...
type clusterState struct {
	...
	// List of bootstrap actions that will be run before Hadoop is started on the cluster nodes. Defined below
	BootstrapActions []emrClusterBootstrapAction.ClusterBootstrapAction `pulumi:"bootstrapActions"`
	...
	// Configuration block to use an [Instance Group](https://docs.aws.amazon.com/emr/latest/ManagementGuide/emr-instance-group-configuration.html#emr-plan-instance-groups) for the [core node type](https://docs.aws.amazon.com/emr/latest/ManagementGuide/emr-master-core-task-nodes.html#emr-plan-core). Cannot be specified if `coreInstanceCount` argument, `coreInstanceType` argument, or `instanceGroup` configuration blocks are set. Detailed below.
	CoreInstanceGroup *emrClusterCoreInstanceGroup.ClusterCoreInstanceGroup `pulumi:"coreInstanceGroup"`
	// Use the `coreInstanceGroup` configuration block `instanceType` argument instead. The EC2 instance type of the slave nodes. Cannot be specified if `coreInstanceGroup` or `instanceGroup` configuration blocks are set.
	...
	// Attributes for the EC2 instances running the job flow. Defined below
	Ec2Attributes *emrClusterEc2Attributes.ClusterEc2Attributes `pulumi:"ec2Attributes"`
	// Use the `masterInstanceGroup` configuration block, `coreInstanceGroup` configuration block and [`emr.InstanceGroup` resource(s)](https://www.terraform.io/docs/providers/aws/r/emr_instance_group.html) instead. A list of `instanceGroup` objects for each instance group in the cluster. Exactly one of `masterInstanceType` and `instanceGroup` must be specified. If `instanceGroup` is set, then it must contain a configuration block for at least the `MASTER` instance group type (as well as any additional instance groups). Cannot be specified if `masterInstanceGroup` or `coreInstanceGroup` configuration blocks are set. Defined below
	InstanceGroups []emrClusterInstanceGroup.ClusterInstanceGroup `pulumi:"instanceGroups"`
	// Switch on/off run cluster with no steps or when all steps are complete (default is on)
	KeepJobFlowAliveWhenNoSteps *bool `pulumi:"keepJobFlowAliveWhenNoSteps"`
	// Kerberos configuration for the cluster. Defined below
	KerberosAttributes *emrClusterKerberosAttributes.ClusterKerberosAttributes `pulumi:"kerberosAttributes"`
	// S3 bucket to write the log files of the job flow. If a value is not provided, logs are not created
	LogUri *string `pulumi:"logUri"`
	// Configuration block to use an [Instance Group](https://docs.aws.amazon.com/emr/latest/ManagementGuide/emr-instance-group-configuration.html#emr-plan-instance-groups) for the [master node type](https://docs.aws.amazon.com/emr/latest/ManagementGuide/emr-master-core-task-nodes.html#emr-plan-master). Cannot be specified if `masterInstanceType` argument or `instanceGroup` configuration blocks are set. Detailed below.
	MasterInstanceGroup *emrClusterMasterInstanceGroup.ClusterMasterInstanceGroup `pulumi:"masterInstanceGroup"`
	// Use the `masterInstanceGroup` configuration block `instanceType` argument instead. The EC2 instance type of the master node. Cannot be specified if `masterInstanceGroup` or `instanceGroup` configuration blocks are set.
	...
	// List of steps to run when creating the cluster. Defined below. It is highly recommended to utilize the [lifecycle configuration block](https://www.terraform.io/docs/configuration/resources.html) with `ignoreChanges` if other steps are being managed outside of this provider. This argument is processed in [attribute-as-blocks mode](https://www.terraform.io/docs/configuration/attr-as-blocks.html).
	Steps []emrClusterStep.ClusterStep `pulumi:"steps"`
	// list of tags to apply to the EMR Cluster
...
type ClusterState struct {
	...
	// List of bootstrap actions that will be run before Hadoop is started on the cluster nodes. Defined below
	BootstrapActions emrClusterBootstrapAction.ClusterBootstrapActionArrayInput
	...
	// Configuration block to use an [Instance Group](https://docs.aws.amazon.com/emr/latest/ManagementGuide/emr-instance-group-configuration.html#emr-plan-instance-groups) for the [core node type](https://docs.aws.amazon.com/emr/latest/ManagementGuide/emr-master-core-task-nodes.html#emr-plan-core). Cannot be specified if `coreInstanceCount` argument, `coreInstanceType` argument, or `instanceGroup` configuration blocks are set. Detailed below.
	CoreInstanceGroup emrClusterCoreInstanceGroup.ClusterCoreInstanceGroupPtrInput
	// Use the `coreInstanceGroup` configuration block `instanceType` argument instead. The EC2 instance type of the slave nodes. Cannot be specified if `coreInstanceGroup` or `instanceGroup` configuration blocks are set.
	...
	// Attributes for the EC2 instances running the job flow. Defined below
	Ec2Attributes emrClusterEc2Attributes.ClusterEc2AttributesPtrInput
	// Use the `masterInstanceGroup` configuration block, `coreInstanceGroup` configuration block and [`emr.InstanceGroup` resource(s)](https://www.terraform.io/docs/providers/aws/r/emr_instance_group.html) instead. A list of `instanceGroup` objects for each instance group in the cluster. Exactly one of `masterInstanceType` and `instanceGroup` must be specified. If `instanceGroup` is set, then it must contain a configuration block for at least the `MASTER` instance group type (as well as any additional instance groups). Cannot be specified if `masterInstanceGroup` or `coreInstanceGroup` configuration blocks are set. Defined below
	InstanceGroups emrClusterInstanceGroup.ClusterInstanceGroupArrayInput
	// Switch on/off run cluster with no steps or when all steps are complete (default is on)
	KeepJobFlowAliveWhenNoSteps pulumi.BoolPtrInput
	// Kerberos configuration for the cluster. Defined below
	KerberosAttributes emrClusterKerberosAttributes.ClusterKerberosAttributesPtrInput
	// S3 bucket to write the log files of the job flow. If a value is not provided, logs are not created
	LogUri pulumi.StringPtrInput
	// Configuration block to use an [Instance Group](https://docs.aws.amazon.com/emr/latest/ManagementGuide/emr-instance-group-configuration.html#emr-plan-instance-groups) for the [master node type](https://docs.aws.amazon.com/emr/latest/ManagementGuide/emr-master-core-task-nodes.html#emr-plan-master). Cannot be specified if `masterInstanceType` argument or `instanceGroup` configuration blocks are set. Detailed below.
	MasterInstanceGroup emrClusterMasterInstanceGroup.ClusterMasterInstanceGroupPtrInput
	// Use the `masterInstanceGroup` configuration block `instanceType` argument instead. The EC2 instance type of the master node. Cannot be specified if `masterInstanceGroup` or `instanceGroup` configuration blocks are set.
	...
	// List of steps to run when creating the cluster. Defined below. It is highly recommended to utilize the [lifecycle configuration block](https://www.terraform.io/docs/configuration/resources.html) with `ignoreChanges` if other steps are being managed outside of this provider. This argument is processed in [attribute-as-blocks mode](https://www.terraform.io/docs/configuration/attr-as-blocks.html).
	Steps emrClusterStep.ClusterStepArrayInput
	// list of tags to apply to the EMR Cluster
