...
type Cluster struct {
	...
	//
	// Deprecated: use `[coreInstanceGroup](%23%2FPROPERTY_CONTAINER%2FcoreInstanceGroup)` configuration block `[instanceCount](%23%2FPROPERTY_CONTAINER%2FinstanceCount)` argument instead
	...
	//
	// Deprecated: use `[coreInstanceGroup](%23%2FPROPERTY_CONTAINER%2FcoreInstanceGroup)` configuration block `[instanceType](%23%2FPROPERTY_CONTAINER%2FinstanceType)` argument instead
	...
	//
	// Deprecated: use `[masterInstanceGroup](%23%2FPROPERTY_CONTAINER%2FmasterInstanceGroup)` configuration block, `[coreInstanceGroup](%23%2FPROPERTY_CONTAINER%2FcoreInstanceGroup)` configuration block, and `[aws:emr/instanceGroup:InstanceGroup](%23%2Fresources%2F%2Faws:emr%252FinstanceGroup:InstanceGroup)` resource(s) instead
	...
	//
	// Deprecated: use `[masterInstanceGroup](%23%2FPROPERTY_CONTAINER%2FmasterInstanceGroup)` configuration block `[instanceType](%23%2FPROPERTY_CONTAINER%2FinstanceType)` argument instead
