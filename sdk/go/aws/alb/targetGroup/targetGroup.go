...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/alb/TargetGroupHealthCheck"
	"https:/github.com/pulumi/pulumi-aws/alb/TargetGroupStickiness"
)
...
type TargetGroup struct {
	...
	HealthCheck albTargetGroupHealthCheck.TargetGroupHealthCheckOutput `pulumi:"healthCheck"`
	...
	Stickiness albTargetGroupStickiness.TargetGroupStickinessOutput `pulumi:"stickiness"`
...
type targetGroupState struct {
	...
	// A Health Check block. Health Check blocks are documented below.
	HealthCheck *albTargetGroupHealthCheck.TargetGroupHealthCheck `pulumi:"healthCheck"`
	// Boolean whether the request and response headers exchanged between the load balancer and the Lambda function include arrays of values or strings. Only applies when `targetType` is `lambda`.
	...
	// A Stickiness block. Stickiness blocks are documented below. `stickiness` is only valid if used with Load Balancers of type `Application`
	Stickiness *albTargetGroupStickiness.TargetGroupStickiness `pulumi:"stickiness"`
	// A mapping of tags to assign to the resource.
...
type TargetGroupState struct {
	...
	// A Health Check block. Health Check blocks are documented below.
	HealthCheck albTargetGroupHealthCheck.TargetGroupHealthCheckPtrInput
	// Boolean whether the request and response headers exchanged between the load balancer and the Lambda function include arrays of values or strings. Only applies when `targetType` is `lambda`.
	...
	// A Stickiness block. Stickiness blocks are documented below. `stickiness` is only valid if used with Load Balancers of type `Application`
	Stickiness albTargetGroupStickiness.TargetGroupStickinessPtrInput
	// A mapping of tags to assign to the resource.
