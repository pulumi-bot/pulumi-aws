...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/alb/ListenerRuleAction"
	...
	"https:/github.com/pulumi/pulumi-aws/alb/ListenerRuleCondition"
...
type ListenerRule struct {
	...
	Actions albListenerRuleAction.ListenerRuleActionArrayOutput `pulumi:"actions"`
	// The ARN of the rule (matches `id`)
	Arn pulumi.StringOutput `pulumi:"arn"`
	// A Condition block. Multiple condition blocks of different types can be set and all must be satisfied for the rule to match. Condition blocks are documented below.
	Conditions albListenerRuleCondition.ListenerRuleConditionArrayOutput `pulumi:"conditions"`
...
type listenerRuleState struct {
	// An Action block. Action blocks are documented below.
	Actions []albListenerRuleAction.ListenerRuleAction `pulumi:"actions"`
	// The ARN of the rule (matches `id`)
	Arn *string `pulumi:"arn"`
	// A Condition block. Multiple condition blocks of different types can be set and all must be satisfied for the rule to match. Condition blocks are documented below.
	Conditions []albListenerRuleCondition.ListenerRuleCondition `pulumi:"conditions"`
	// The ARN of the listener to which to attach the rule.
...
type ListenerRuleState struct {
	// An Action block. Action blocks are documented below.
	Actions albListenerRuleAction.ListenerRuleActionArrayInput
	// The ARN of the rule (matches `id`)
	Arn pulumi.StringPtrInput
	// A Condition block. Multiple condition blocks of different types can be set and all must be satisfied for the rule to match. Condition blocks are documented below.
	Conditions albListenerRuleCondition.ListenerRuleConditionArrayInput
	// The ARN of the listener to which to attach the rule.
