...
func LookupTargetGroupApply(ctx *pulumi.Context, args LookupTargetGroupApplyInput, opts ...pulumi.InvokeOption) LookupTargetGroupResultOutput {
	return args.ToLookupTargetGroupApplyOutput().ApplyT(func(v LookupTargetGroupArgs) (LookupTargetGroupResult, error) {
		r, err := LookupTargetGroup(ctx, &v, opts...)
		return *r, err

	}).(LookupTargetGroupResultOutput)
}

// LookupTargetGroupApplyInput is an input type that accepts LookupTargetGroupApplyArgs and LookupTargetGroupApplyOutput values.
// You can construct a concrete instance of `LookupTargetGroupApplyInput` via:
//
//          LookupTargetGroupApplyArgs{...}
type LookupTargetGroupApplyInput interface {
	pulumi.Input

	ToLookupTargetGroupApplyOutput() LookupTargetGroupApplyOutput
	ToLookupTargetGroupApplyOutputWithContext(context.Context) LookupTargetGroupApplyOutput
}

// A collection of arguments for invoking getTargetGroup.
type LookupTargetGroupApplyArgs struct {
	// The full ARN of the target group.
...
func (LookupTargetGroupApplyArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupTargetGroupArgs)(nil)).Elem()
}

func (i LookupTargetGroupApplyArgs) ToLookupTargetGroupApplyOutput() LookupTargetGroupApplyOutput {
	return i.ToLookupTargetGroupApplyOutputWithContext(context.Background())
}

func (i LookupTargetGroupApplyArgs) ToLookupTargetGroupApplyOutputWithContext(ctx context.Context) LookupTargetGroupApplyOutput {
	return pulumi.ToOutputWithContext(ctx, i).(LookupTargetGroupApplyOutput)
}

// A collection of arguments for invoking getTargetGroup.
type LookupTargetGroupApplyOutput struct{ *pulumi.OutputState }

func (LookupTargetGroupApplyOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupTargetGroupArgs)(nil)).Elem()
}

func (o LookupTargetGroupApplyOutput) ToLookupTargetGroupApplyOutput() LookupTargetGroupApplyOutput {
	return o
}

func (o LookupTargetGroupApplyOutput) ToLookupTargetGroupApplyOutputWithContext(ctx context.Context) LookupTargetGroupApplyOutput {
	return o
}

// The full ARN of the target group.
func (o LookupTargetGroupApplyOutput) Arn() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupTargetGroupArgs) *string { return v.Arn }).(pulumi.StringPtrOutput)
}

// The unique name of the target group.
func (o LookupTargetGroupApplyOutput) Name() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupTargetGroupArgs) *string { return v.Name }).(pulumi.StringPtrOutput)
}

func (o LookupTargetGroupApplyOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v LookupTargetGroupArgs) map[string]string { return v.Tags }).(pulumi.StringMapOutput)
}
...
func init() {
	pulumi.RegisterOutputType(LookupTargetGroupApplyOutput{})
