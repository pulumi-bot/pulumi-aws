...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/alb/ListenerRuleConditionHostHeader"
	"https:/github.com/pulumi/pulumi-aws/alb/ListenerRuleConditionHttpHeader"
	"https:/github.com/pulumi/pulumi-aws/alb/ListenerRuleConditionHttpRequestMethod"
	"https:/github.com/pulumi/pulumi-aws/alb/ListenerRuleConditionPathPattern"
	"https:/github.com/pulumi/pulumi-aws/alb/ListenerRuleConditionQueryString"
	"https:/github.com/pulumi/pulumi-aws/alb/ListenerRuleConditionSourceIp"
)
...
type ListenerRuleCondition struct {
	...
	HostHeader *albListenerRuleConditionHostHeader.ListenerRuleConditionHostHeader `pulumi:"hostHeader"`
	// HTTP headers to match. HTTP Header block fields documented below.
	HttpHeader *albListenerRuleConditionHttpHeader.ListenerRuleConditionHttpHeader `pulumi:"httpHeader"`
	// Contains a single `value` item which is a list of HTTP request methods or verbs to match. Maximum size is 40 characters. Only allowed characters are A-Z, hyphen (-) and underscore (\_). Comparison is case sensitive. Wildcards are not supported. Only one needs to match for the condition to be satisfied. AWS recommends that GET and HEAD requests are routed in the same way because the response to a HEAD request may be cached.
	HttpRequestMethod *albListenerRuleConditionHttpRequestMethod.ListenerRuleConditionHttpRequestMethod `pulumi:"httpRequestMethod"`
	...
	PathPattern *albListenerRuleConditionPathPattern.ListenerRuleConditionPathPattern `pulumi:"pathPattern"`
	// Query strings to match. Query String block fields documented below.
	QueryStrings []albListenerRuleConditionQueryString.ListenerRuleConditionQueryString `pulumi:"queryStrings"`
	...
	SourceIp *albListenerRuleConditionSourceIp.ListenerRuleConditionSourceIp `pulumi:"sourceIp"`
...
type ListenerRuleConditionArgs struct {
	...
	// Contains a single `value` item which is a list of host header patterns to match. The maximum size of each pattern is 128 characters. Comparison is case insensitive. Wildcard characters supported: * (matches 0 or more characters) and ? (matches exactly 1 character). Only one pattern needs to match for the condition to be satisfied.
	HostHeader albListenerRuleConditionHostHeader.ListenerRuleConditionHostHeaderPtrInput `pulumi:"hostHeader"`
	// HTTP headers to match. HTTP Header block fields documented below.
	HttpHeader albListenerRuleConditionHttpHeader.ListenerRuleConditionHttpHeaderPtrInput `pulumi:"httpHeader"`
	// Contains a single `value` item which is a list of HTTP request methods or verbs to match. Maximum size is 40 characters. Only allowed characters are A-Z, hyphen (-) and underscore (\_). Comparison is case sensitive. Wildcards are not supported. Only one needs to match for the condition to be satisfied. AWS recommends that GET and HEAD requests are routed in the same way because the response to a HEAD request may be cached.
	HttpRequestMethod albListenerRuleConditionHttpRequestMethod.ListenerRuleConditionHttpRequestMethodPtrInput `pulumi:"httpRequestMethod"`
	// Contains a single `value` item which is a list of path patterns to match against the request URL. Maximum size of each pattern is 128 characters. Comparison is case sensitive. Wildcard charaters supported: * (matches 0 or more characters) and ? (matches exactly 1 character). Only one pattern needs to match for the condition to be satisfied. Path pattern is compared only to the path of the URL, not to its query string. To compare against the query string, use a `query-string` condition.
	PathPattern albListenerRuleConditionPathPattern.ListenerRuleConditionPathPatternPtrInput `pulumi:"pathPattern"`
	// Query strings to match. Query String block fields documented below.
	QueryStrings albListenerRuleConditionQueryString.ListenerRuleConditionQueryStringArrayInput `pulumi:"queryStrings"`
	// Contains a single `value` item which is a list of source IP CIDR notations to match. You can use both IPv4 and IPv6 addresses. Wildcards are not supported. Condition is satisfied if the source IP address of the request matches one of the CIDR blocks. Condition is not satisfied by the addresses in the `X-Forwarded-For` header, use `http-header` condition instead.
	SourceIp albListenerRuleConditionSourceIp.ListenerRuleConditionSourceIpPtrInput `pulumi:"sourceIp"`
	// Query string pairs or values to match. Query String Value blocks documented below. Multiple `values` blocks can be specified, see example above. Maximum size of each string is 128 characters. Comparison is case insensitive. Wildcard characters supported: * (matches 0 or more characters) and ? (matches exactly 1 character). To search for a literal '\*' or '?' character in a query string, escape the character with a backslash (\\). Only one pair needs to match for the condition to be satisfied.
...
// Contains a single `value` item which is a list of host header patterns to match. The maximum size of each pattern is 128 characters. Comparison is case insensitive. Wildcard characters supported: * (matches 0 or more characters) and ? (matches exactly 1 character). Only one pattern needs to match for the condition to be satisfied.
func (o ListenerRuleConditionOutput) HostHeader() albListenerRuleConditionHostHeader.ListenerRuleConditionHostHeaderPtrOutput {
	return o.ApplyT(func (v ListenerRuleCondition) *albListenerRuleConditionHostHeader.ListenerRuleConditionHostHeader { return v.HostHeader }).(albListenerRuleConditionHostHeader.ListenerRuleConditionHostHeaderPtrOutput)
}

// HTTP headers to match. HTTP Header block fields documented below.
func (o ListenerRuleConditionOutput) HttpHeader() albListenerRuleConditionHttpHeader.ListenerRuleConditionHttpHeaderPtrOutput {
	return o.ApplyT(func (v ListenerRuleCondition) *albListenerRuleConditionHttpHeader.ListenerRuleConditionHttpHeader { return v.HttpHeader }).(albListenerRuleConditionHttpHeader.ListenerRuleConditionHttpHeaderPtrOutput)
}

// Contains a single `value` item which is a list of HTTP request methods or verbs to match. Maximum size is 40 characters. Only allowed characters are A-Z, hyphen (-) and underscore (\_). Comparison is case sensitive. Wildcards are not supported. Only one needs to match for the condition to be satisfied. AWS recommends that GET and HEAD requests are routed in the same way because the response to a HEAD request may be cached.
func (o ListenerRuleConditionOutput) HttpRequestMethod() albListenerRuleConditionHttpRequestMethod.ListenerRuleConditionHttpRequestMethodPtrOutput {
	return o.ApplyT(func (v ListenerRuleCondition) *albListenerRuleConditionHttpRequestMethod.ListenerRuleConditionHttpRequestMethod { return v.HttpRequestMethod }).(albListenerRuleConditionHttpRequestMethod.ListenerRuleConditionHttpRequestMethodPtrOutput)
}

// Contains a single `value` item which is a list of path patterns to match against the request URL. Maximum size of each pattern is 128 characters. Comparison is case sensitive. Wildcard charaters supported: * (matches 0 or more characters) and ? (matches exactly 1 character). Only one pattern needs to match for the condition to be satisfied. Path pattern is compared only to the path of the URL, not to its query string. To compare against the query string, use a `query-string` condition.
func (o ListenerRuleConditionOutput) PathPattern() albListenerRuleConditionPathPattern.ListenerRuleConditionPathPatternPtrOutput {
	return o.ApplyT(func (v ListenerRuleCondition) *albListenerRuleConditionPathPattern.ListenerRuleConditionPathPattern { return v.PathPattern }).(albListenerRuleConditionPathPattern.ListenerRuleConditionPathPatternPtrOutput)
}

// Query strings to match. Query String block fields documented below.
func (o ListenerRuleConditionOutput) QueryStrings() albListenerRuleConditionQueryString.ListenerRuleConditionQueryStringArrayOutput {
	return o.ApplyT(func (v ListenerRuleCondition) []albListenerRuleConditionQueryString.ListenerRuleConditionQueryString { return v.QueryStrings }).(albListenerRuleConditionQueryString.ListenerRuleConditionQueryStringArrayOutput)
}

// Contains a single `value` item which is a list of source IP CIDR notations to match. You can use both IPv4 and IPv6 addresses. Wildcards are not supported. Condition is satisfied if the source IP address of the request matches one of the CIDR blocks. Condition is not satisfied by the addresses in the `X-Forwarded-For` header, use `http-header` condition instead.
func (o ListenerRuleConditionOutput) SourceIp() albListenerRuleConditionSourceIp.ListenerRuleConditionSourceIpPtrOutput {
	return o.ApplyT(func (v ListenerRuleCondition) *albListenerRuleConditionSourceIp.ListenerRuleConditionSourceIp { return v.SourceIp }).(albListenerRuleConditionSourceIp.ListenerRuleConditionSourceIpPtrOutput)
}
