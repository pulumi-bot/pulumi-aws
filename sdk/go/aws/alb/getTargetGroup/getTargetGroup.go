...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/alb/getTargetGroupHealthCheck"
	"https:/github.com/pulumi/pulumi-aws/alb/getTargetGroupStickiness"
)
...
type GetTargetGroupResult struct {
	...
	HealthCheck albgetTargetGroupHealthCheck.GetTargetGroupHealthCheck `pulumi:"healthCheck"`
	...
	Stickiness albgetTargetGroupStickiness.GetTargetGroupStickiness `pulumi:"stickiness"`
	Tags map[string]interface{} `pulumi:"tags"`
