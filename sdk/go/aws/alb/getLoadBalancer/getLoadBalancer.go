...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/alb/getLoadBalancerAccessLogs"
	"https:/github.com/pulumi/pulumi-aws/alb/getLoadBalancerSubnetMapping"
)
...
type GetLoadBalancerResult struct {
	AccessLogs albgetLoadBalancerAccessLogs.GetLoadBalancerAccessLogs `pulumi:"accessLogs"`
	Arn string `pulumi:"arn"`
	...
	SubnetMappings []albgetLoadBalancerSubnetMapping.GetLoadBalancerSubnetMapping `pulumi:"subnetMappings"`
