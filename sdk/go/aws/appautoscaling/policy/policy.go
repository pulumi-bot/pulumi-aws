...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/appautoscaling/PolicyStepScalingPolicyConfiguration"
	"https:/github.com/pulumi/pulumi-aws/appautoscaling/PolicyStepScalingPolicyConfigurationStepAdjustment"
	"https:/github.com/pulumi/pulumi-aws/appautoscaling/PolicyTargetTrackingScalingPolicyConfiguration"
...
type Policy struct {
	...
	StepScalingPolicyConfiguration appautoscalingPolicyStepScalingPolicyConfiguration.PolicyStepScalingPolicyConfigurationPtrOutput `pulumi:"stepScalingPolicyConfiguration"`
	// A target tracking policy, requires `policyType = "TargetTrackingScaling"`. See supported fields below.
	TargetTrackingScalingPolicyConfiguration appautoscalingPolicyTargetTrackingScalingPolicyConfiguration.PolicyTargetTrackingScalingPolicyConfigurationPtrOutput `pulumi:"targetTrackingScalingPolicyConfiguration"`
}
...
type policyState struct {
	...
	// Step scaling policy configuration, requires `policyType = "StepScaling"` (default). See supported fields below.
	StepScalingPolicyConfiguration *appautoscalingPolicyStepScalingPolicyConfiguration.PolicyStepScalingPolicyConfiguration `pulumi:"stepScalingPolicyConfiguration"`
	// A target tracking policy, requires `policyType = "TargetTrackingScaling"`. See supported fields below.
	TargetTrackingScalingPolicyConfiguration *appautoscalingPolicyTargetTrackingScalingPolicyConfiguration.PolicyTargetTrackingScalingPolicyConfiguration `pulumi:"targetTrackingScalingPolicyConfiguration"`
}
...
type PolicyState struct {
	...
	// Step scaling policy configuration, requires `policyType = "StepScaling"` (default). See supported fields below.
	StepScalingPolicyConfiguration appautoscalingPolicyStepScalingPolicyConfiguration.PolicyStepScalingPolicyConfigurationPtrInput
	// A target tracking policy, requires `policyType = "TargetTrackingScaling"`. See supported fields below.
	TargetTrackingScalingPolicyConfiguration appautoscalingPolicyTargetTrackingScalingPolicyConfiguration.PolicyTargetTrackingScalingPolicyConfigurationPtrInput
}
