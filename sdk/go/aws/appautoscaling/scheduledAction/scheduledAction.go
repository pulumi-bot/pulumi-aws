...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/appautoscaling/ScheduledActionScalableTargetAction"
)
...
type ScheduledAction struct {
	...
	ScalableTargetAction appautoscalingScheduledActionScalableTargetAction.ScheduledActionScalableTargetActionPtrOutput `pulumi:"scalableTargetAction"`
...
type scheduledActionState struct {
	...
	// The new minimum and maximum capacity. You can set both values or just one. See below
	ScalableTargetAction *appautoscalingScheduledActionScalableTargetAction.ScheduledActionScalableTargetAction `pulumi:"scalableTargetAction"`
	// The schedule for this action. The following formats are supported: At expressions - at(yyyy-mm-ddThh:mm:ss), Rate expressions - rate(valueunit), Cron expressions - cron(fields). In UTC. Documentation can be found in the parameter at: [AWS Application Auto Scaling API Reference](https://docs.aws.amazon.com/ApplicationAutoScaling/latest/APIReference/API_PutScheduledAction.html#ApplicationAutoScaling-PutScheduledAction-request-Schedule)
...
type ScheduledActionState struct {
	...
	// The new minimum and maximum capacity. You can set both values or just one. See below
	ScalableTargetAction appautoscalingScheduledActionScalableTargetAction.ScheduledActionScalableTargetActionPtrInput
	// The schedule for this action. The following formats are supported: At expressions - at(yyyy-mm-ddThh:mm:ss), Rate expressions - rate(valueunit), Cron expressions - cron(fields). In UTC. Documentation can be found in the parameter at: [AWS Application Auto Scaling API Reference](https://docs.aws.amazon.com/ApplicationAutoScaling/latest/APIReference/API_PutScheduledAction.html#ApplicationAutoScaling-PutScheduledAction-request-Schedule)
