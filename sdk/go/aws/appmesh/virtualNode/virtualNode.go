...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/appmesh/VirtualNodeSpec"
...
type VirtualNode struct {
	...
	Spec appmeshVirtualNodeSpec.VirtualNodeSpecOutput `pulumi:"spec"`
...
type virtualNodeState struct {
	...
	// The virtual node specification to apply.
	Spec *appmeshVirtualNodeSpec.VirtualNodeSpec `pulumi:"spec"`
	// A mapping of tags to assign to the resource.
...
type VirtualNodeState struct {
	...
	// The virtual node specification to apply.
	Spec appmeshVirtualNodeSpec.VirtualNodeSpecPtrInput
	// A mapping of tags to assign to the resource.
...
type VirtualNodeArgs struct {
	...
	Name pulumi.StringPtrInput
	// The virtual node specification to apply.
	Spec appmeshVirtualNodeSpec.VirtualNodeSpecInput
	// A mapping of tags to assign to the resource.
	Tags pulumi.MapInput
}
