...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/appmesh/RouteSpec"
...
type Route struct {
	...
	Spec appmeshRouteSpec.RouteSpecOutput `pulumi:"spec"`
...
type routeState struct {
	...
	// The route specification to apply.
	Spec *appmeshRouteSpec.RouteSpec `pulumi:"spec"`
	// A mapping of tags to assign to the resource.
...
type RouteState struct {
	...
	// The route specification to apply.
	Spec appmeshRouteSpec.RouteSpecPtrInput
	// A mapping of tags to assign to the resource.
...
type RouteArgs struct {
	...
	Name pulumi.StringPtrInput
	// The route specification to apply.
	Spec appmeshRouteSpec.RouteSpecInput
	// A mapping of tags to assign to the resource.
	Tags pulumi.MapInput
	// The name of the virtual router in which to create the route.
