...
// nolint: lll
package getTransitGateway

import (
	"github.com/pulumi/pulumi/sdk/go/pulumi"
	"https:/github.com/pulumi/pulumi-aws/ec2transitgateway/getTransitGatewayFilter"
)
...
func GetTransitGateway(ctx *pulumi.Context, args *GetTransitGatewayArgs, opts ...pulumi.InvokeOption) (*GetTransitGatewayResult, error) {
...
type GetTransitGatewayArgs struct {
	...
	Filters []ec2transitgatewaygetTransitGatewayFilter.GetTransitGatewayFilter `pulumi:"filters"`
