...
// nolint: lll
package getVpcAttachment

import (
	"github.com/pulumi/pulumi/sdk/go/pulumi"
	"https:/github.com/pulumi/pulumi-aws/ec2transitgateway/getVpcAttachmentFilter"
)
...
func GetVpcAttachment(ctx *pulumi.Context, args *GetVpcAttachmentArgs, opts ...pulumi.InvokeOption) (*GetVpcAttachmentResult, error) {
...
type GetVpcAttachmentArgs struct {
	...
	Filters []ec2transitgatewaygetVpcAttachmentFilter.GetVpcAttachmentFilter `pulumi:"filters"`
