...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/ec2transitgateway/getRouteTableFilter"
)
...
type GetRouteTableArgs struct {
	...
	Filters []ec2transitgatewaygetRouteTableFilter.GetRouteTableFilter `pulumi:"filters"`
