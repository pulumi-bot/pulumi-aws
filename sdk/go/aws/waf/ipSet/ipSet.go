...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/waf/IpSetIpSetDescriptor"
)
...
type IpSet struct {
	...
	IpSetDescriptors wafIpSetIpSetDescriptor.IpSetIpSetDescriptorArrayOutput `pulumi:"ipSetDescriptors"`
...
type ipSetState struct {
	...
	// One or more pairs specifying the IP address type (IPV4 or IPV6) and the IP address range (in CIDR format) from which web requests originate.
	IpSetDescriptors []wafIpSetIpSetDescriptor.IpSetIpSetDescriptor `pulumi:"ipSetDescriptors"`
	// The name or description of the IPSet.
...
type IpSetState struct {
	...
	// One or more pairs specifying the IP address type (IPV4 or IPV6) and the IP address range (in CIDR format) from which web requests originate.
	IpSetDescriptors wafIpSetIpSetDescriptor.IpSetIpSetDescriptorArrayInput
	// The name or description of the IPSet.
