...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/waf/RateBasedRulePredicate"
)
...
type RateBasedRule struct {
	...
	Predicates wafRateBasedRulePredicate.RateBasedRulePredicateArrayOutput `pulumi:"predicates"`
	// Valid value is IP.
...
type rateBasedRuleState struct {
	...
	// The objects to include in a rule (documented below).
	Predicates []wafRateBasedRulePredicate.RateBasedRulePredicate `pulumi:"predicates"`
	// Valid value is IP.
...
type RateBasedRuleState struct {
	...
	// The objects to include in a rule (documented below).
	Predicates wafRateBasedRulePredicate.RateBasedRulePredicateArrayInput
	// Valid value is IP.
