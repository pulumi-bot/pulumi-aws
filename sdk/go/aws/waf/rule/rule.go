...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/waf/RulePredicate"
)
...
type Rule struct {
	...
	Predicates wafRulePredicate.RulePredicateArrayOutput `pulumi:"predicates"`
...
type ruleState struct {
	...
	// The objects to include in a rule (documented below).
	Predicates []wafRulePredicate.RulePredicate `pulumi:"predicates"`
	// Key-value mapping of resource tags
...
type RuleState struct {
	...
	// The objects to include in a rule (documented below).
	Predicates wafRulePredicate.RulePredicateArrayInput
	// Key-value mapping of resource tags
