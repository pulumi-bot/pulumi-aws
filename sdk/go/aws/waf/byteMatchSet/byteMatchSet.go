...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/waf/ByteMatchSetByteMatchTuple"
...
type ByteMatchSet struct {
	...
	ByteMatchTuples wafByteMatchSetByteMatchTuple.ByteMatchSetByteMatchTupleArrayOutput `pulumi:"byteMatchTuples"`
...
type byteMatchSetState struct {
	...
	// with ASCII characters) that you want to search for in web requests,
	// the location in requests that you want to search, and other settings.
	ByteMatchTuples []wafByteMatchSetByteMatchTuple.ByteMatchSetByteMatchTuple `pulumi:"byteMatchTuples"`
	// The name or description of the Byte Match Set.
...
type ByteMatchSetState struct {
	...
	// with ASCII characters) that you want to search for in web requests,
	// the location in requests that you want to search, and other settings.
	ByteMatchTuples wafByteMatchSetByteMatchTuple.ByteMatchSetByteMatchTupleArrayInput
	// The name or description of the Byte Match Set.
