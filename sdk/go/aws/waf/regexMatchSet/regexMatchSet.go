...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/waf/RegexMatchSetRegexMatchTuple"
...
type RegexMatchSet struct {
	...
	RegexMatchTuples wafRegexMatchSetRegexMatchTuple.RegexMatchSetRegexMatchTupleArrayOutput `pulumi:"regexMatchTuples"`
}
...
type regexMatchSetState struct {
	...
	// The regular expression pattern that you want AWS WAF to search for in web requests,
	// the location in requests that you want AWS WAF to search, and other settings. See below.
	RegexMatchTuples []wafRegexMatchSetRegexMatchTuple.RegexMatchSetRegexMatchTuple `pulumi:"regexMatchTuples"`
}
...
type RegexMatchSetState struct {
	...
	// The regular expression pattern that you want AWS WAF to search for in web requests,
	// the location in requests that you want AWS WAF to search, and other settings. See below.
	RegexMatchTuples wafRegexMatchSetRegexMatchTuple.RegexMatchSetRegexMatchTupleArrayInput
}
