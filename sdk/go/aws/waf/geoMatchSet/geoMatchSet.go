...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/waf/GeoMatchSetGeoMatchConstraint"
)
...
type GeoMatchSet struct {
	...
	GeoMatchConstraints wafGeoMatchSetGeoMatchConstraint.GeoMatchSetGeoMatchConstraintArrayOutput `pulumi:"geoMatchConstraints"`
...
type geoMatchSetState struct {
	...
	// The GeoMatchConstraint objects which contain the country that you want AWS WAF to search for.
	GeoMatchConstraints []wafGeoMatchSetGeoMatchConstraint.GeoMatchSetGeoMatchConstraint `pulumi:"geoMatchConstraints"`
	// The name or description of the GeoMatchSet.
...
type GeoMatchSetState struct {
	...
	// The GeoMatchConstraint objects which contain the country that you want AWS WAF to search for.
	GeoMatchConstraints wafGeoMatchSetGeoMatchConstraint.GeoMatchSetGeoMatchConstraintArrayInput
	// The name or description of the GeoMatchSet.
