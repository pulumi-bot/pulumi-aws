...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/msk/ClusterBrokerNodeGroupInfo"
	"https:/github.com/pulumi/pulumi-aws/msk/ClusterClientAuthentication"
	"https:/github.com/pulumi/pulumi-aws/msk/ClusterClientAuthenticationTls"
	"https:/github.com/pulumi/pulumi-aws/msk/ClusterConfigurationInfo"
	"https:/github.com/pulumi/pulumi-aws/msk/ClusterEncryptionInfo"
...
type Cluster struct {
	...
	BrokerNodeGroupInfo mskClusterBrokerNodeGroupInfo.ClusterBrokerNodeGroupInfoOutput `pulumi:"brokerNodeGroupInfo"`
	// Configuration block for specifying a client authentication. See below.
	ClientAuthentication mskClusterClientAuthentication.ClusterClientAuthenticationPtrOutput `pulumi:"clientAuthentication"`
	// Name of the MSK cluster.
	ClusterName pulumi.StringOutput `pulumi:"clusterName"`
	// Configuration block for specifying a MSK Configuration to attach to Kafka brokers. See below.
	ConfigurationInfo mskClusterConfigurationInfo.ClusterConfigurationInfoPtrOutput `pulumi:"configurationInfo"`
	// Current version of the MSK Cluster used for updates, e.g. `K13V1IB3VIYZZH`
	// * `encryption_info.0.encryption_at_rest_kms_key_arn` - The ARN of the KMS key used for encryption at rest of the broker data volumes.
	CurrentVersion pulumi.StringOutput `pulumi:"currentVersion"`
	// Configuration block for specifying encryption. See below.
	EncryptionInfo mskClusterEncryptionInfo.ClusterEncryptionInfoPtrOutput `pulumi:"encryptionInfo"`
...
type clusterState struct {
	...
	// Configuration block for the broker nodes of the Kafka cluster.
	BrokerNodeGroupInfo *mskClusterBrokerNodeGroupInfo.ClusterBrokerNodeGroupInfo `pulumi:"brokerNodeGroupInfo"`
	// Configuration block for specifying a client authentication. See below.
	ClientAuthentication *mskClusterClientAuthentication.ClusterClientAuthentication `pulumi:"clientAuthentication"`
	// Name of the MSK cluster.
	ClusterName *string `pulumi:"clusterName"`
	// Configuration block for specifying a MSK Configuration to attach to Kafka brokers. See below.
	ConfigurationInfo *mskClusterConfigurationInfo.ClusterConfigurationInfo `pulumi:"configurationInfo"`
	// Current version of the MSK Cluster used for updates, e.g. `K13V1IB3VIYZZH`
	// * `encryption_info.0.encryption_at_rest_kms_key_arn` - The ARN of the KMS key used for encryption at rest of the broker data volumes.
	CurrentVersion *string `pulumi:"currentVersion"`
	// Configuration block for specifying encryption. See below.
	EncryptionInfo *mskClusterEncryptionInfo.ClusterEncryptionInfo `pulumi:"encryptionInfo"`
	// Specify the desired enhanced MSK CloudWatch monitoring level.  See [Monitoring Amazon MSK with Amazon CloudWatch](https://docs.aws.amazon.com/msk/latest/developerguide/monitoring.html)
...
type ClusterState struct {
	...
	// Configuration block for the broker nodes of the Kafka cluster.
	BrokerNodeGroupInfo mskClusterBrokerNodeGroupInfo.ClusterBrokerNodeGroupInfoPtrInput
	// Configuration block for specifying a client authentication. See below.
	ClientAuthentication mskClusterClientAuthentication.ClusterClientAuthenticationPtrInput
	// Name of the MSK cluster.
	ClusterName pulumi.StringPtrInput
	// Configuration block for specifying a MSK Configuration to attach to Kafka brokers. See below.
	ConfigurationInfo mskClusterConfigurationInfo.ClusterConfigurationInfoPtrInput
	// Current version of the MSK Cluster used for updates, e.g. `K13V1IB3VIYZZH`
	// * `encryption_info.0.encryption_at_rest_kms_key_arn` - The ARN of the KMS key used for encryption at rest of the broker data volumes.
	CurrentVersion pulumi.StringPtrInput
	// Configuration block for specifying encryption. See below.
	EncryptionInfo mskClusterEncryptionInfo.ClusterEncryptionInfoPtrInput
	// Specify the desired enhanced MSK CloudWatch monitoring level.  See [Monitoring Amazon MSK with Amazon CloudWatch](https://docs.aws.amazon.com/msk/latest/developerguide/monitoring.html)
...
type ClusterArgs struct {
	// Configuration block for the broker nodes of the Kafka cluster.
	BrokerNodeGroupInfo mskClusterBrokerNodeGroupInfo.ClusterBrokerNodeGroupInfoInput
	// Configuration block for specifying a client authentication. See below.
	ClientAuthentication mskClusterClientAuthentication.ClusterClientAuthenticationPtrInput
	// Name of the MSK cluster.
