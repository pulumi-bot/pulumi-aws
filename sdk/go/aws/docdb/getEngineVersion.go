...
func GetEngineVersionApply(ctx *pulumi.Context, args GetEngineVersionApplyInput, opts ...pulumi.InvokeOption) GetEngineVersionResultOutput {
	return args.ToGetEngineVersionApplyOutput().ApplyT(func(v GetEngineVersionArgs) (GetEngineVersionResult, error) {
		r, err := GetEngineVersion(ctx, &v, opts...)
		return *r, err

	}).(GetEngineVersionResultOutput)
}

// GetEngineVersionApplyInput is an input type that accepts GetEngineVersionApplyArgs and GetEngineVersionApplyOutput values.
// You can construct a concrete instance of `GetEngineVersionApplyInput` via:
//
//          GetEngineVersionApplyArgs{...}
type GetEngineVersionApplyInput interface {
	pulumi.Input

	ToGetEngineVersionApplyOutput() GetEngineVersionApplyOutput
	ToGetEngineVersionApplyOutputWithContext(context.Context) GetEngineVersionApplyOutput
}

// A collection of arguments for invoking getEngineVersion.
type GetEngineVersionApplyArgs struct {
	// DB engine. (Default: `docdb`)
...
func (GetEngineVersionApplyArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*GetEngineVersionArgs)(nil)).Elem()
}

func (i GetEngineVersionApplyArgs) ToGetEngineVersionApplyOutput() GetEngineVersionApplyOutput {
	return i.ToGetEngineVersionApplyOutputWithContext(context.Background())
}

func (i GetEngineVersionApplyArgs) ToGetEngineVersionApplyOutputWithContext(ctx context.Context) GetEngineVersionApplyOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GetEngineVersionApplyOutput)
}

// A collection of arguments for invoking getEngineVersion.
type GetEngineVersionApplyOutput struct{ *pulumi.OutputState }

func (GetEngineVersionApplyOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GetEngineVersionArgs)(nil)).Elem()
}

func (o GetEngineVersionApplyOutput) ToGetEngineVersionApplyOutput() GetEngineVersionApplyOutput {
	return o
}

func (o GetEngineVersionApplyOutput) ToGetEngineVersionApplyOutputWithContext(ctx context.Context) GetEngineVersionApplyOutput {
	return o
}

// DB engine. (Default: `docdb`)
func (o GetEngineVersionApplyOutput) Engine() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetEngineVersionArgs) *string { return v.Engine }).(pulumi.StringPtrOutput)
}

// The name of a specific DB parameter group family. An example parameter group family is `docdb3.6`.
func (o GetEngineVersionApplyOutput) ParameterGroupFamily() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetEngineVersionArgs) *string { return v.ParameterGroupFamily }).(pulumi.StringPtrOutput)
}

// Ordered list of preferred engine versions. The first match in this list will be returned. If no preferred matches are found and the original search returned more than one result, an error is returned. If both the `version` and `preferredVersions` arguments are not configured, the data source will return the default version for the engine.
func (o GetEngineVersionApplyOutput) PreferredVersions() pulumi.StringArrayOutput {
	return o.ApplyT(func(v GetEngineVersionArgs) []string { return v.PreferredVersions }).(pulumi.StringArrayOutput)
}

// Version of the DB engine. For example, `3.6.0`. If `version` and `preferredVersions` are not set, the data source will provide information for the AWS-defined default version. If both the `version` and `preferredVersions` arguments are not configured, the data source will return the default version for the engine.
func (o GetEngineVersionApplyOutput) Version() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetEngineVersionArgs) *string { return v.Version }).(pulumi.StringPtrOutput)
}
...
func init() {
	pulumi.RegisterOutputType(GetEngineVersionApplyOutput{})
