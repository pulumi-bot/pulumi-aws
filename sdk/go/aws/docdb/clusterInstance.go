...
// 		_default, err := docdb.NewCluster(ctx, "_default", &docdb.ClusterArgs{
...
// 			_res, err := docdb.NewClusterInstance(ctx, fmt.Sprintf("clusterInstances-%v", key0), &docdb.ClusterInstanceArgs{
...
// 				return err
// 			}
// 			clusterInstances = append(clusterInstances, _res)
// 		}
// 		return nil
// 	})
// }
