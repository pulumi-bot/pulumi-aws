...
// 			ReplicationInstanceArn:  dynamic(aws_dms_replication_instance.Test - dms - replication - instance - tf.Replication_instance_arn),
// 			ReplicationTaskId:       pulumi.String("test-dms-replication-task-tf"),
// 			ReplicationTaskSettings: pulumi.String("..."),
// 			SourceEndpointArn:       dynamic(aws_dms_endpoint.Test - dms - source - endpoint - tf.Endpoint_arn),
...
// 				"Name": "test",
// 			},
// 			TargetEndpointArn: dynamic(aws_dms_endpoint.Test - dms - target - endpoint - tf.Endpoint_arn),
// 		})
// 		if err != nil {
// 			return err
// 		}
