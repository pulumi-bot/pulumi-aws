...
// 				ClusterJdbcurl: pulumi.All(testCluster.Endpoint, testCluster.DatabaseName).Apply(func(endpoint string, databaseName string) (string, error) {
...
// 				BufferSize:        pulumi.Int(10),
// 				CompressionFormat: pulumi.String("GZIP"),
// 				RoleArn:           dynamic(aws_iam_role.Firehose.Arn),
// 			},
