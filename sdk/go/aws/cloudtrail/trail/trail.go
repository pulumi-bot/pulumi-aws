...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/cloudtrail/TrailEventSelector"
...
type Trail struct {
	...
	EventSelectors cloudtrailTrailEventSelector.TrailEventSelectorArrayOutput `pulumi:"eventSelectors"`
...
type trailState struct {
	...
	// Specifies an event selector for enabling data event logging. Fields documented below. Please note the [CloudTrail limits](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/WhatIsCloudTrail-Limits.html) when configuring these.
	EventSelectors []cloudtrailTrailEventSelector.TrailEventSelector `pulumi:"eventSelectors"`
	// The region in which the trail was created.
...
type TrailState struct {
	...
	// Specifies an event selector for enabling data event logging. Fields documented below. Please note the [CloudTrail limits](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/WhatIsCloudTrail-Limits.html) when configuring these.
	EventSelectors cloudtrailTrailEventSelector.TrailEventSelectorArrayInput
	// The region in which the trail was created.
