...
type ProviderEndpoint struct {
	...
	// Deprecated: use `[endpoints](%23%2FPROPERTY_CONTAINER%2Fendpoints)` configuration block `[kinesisanalytics](%23%2FPROPERTY_CONTAINER%2Fkinesisanalytics)` argument instead
	...
	// Deprecated: use `[endpoints](%23%2FPROPERTY_CONTAINER%2Fendpoints)` configuration block `[route53](%23%2FPROPERTY_CONTAINER%2Froute53)` argument instead
