...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/applicationloadbalancing/TargetGroupHealthCheck"
	"https:/github.com/pulumi/pulumi-aws/applicationloadbalancing/TargetGroupStickiness"
)
...
type TargetGroup struct {
	...
	HealthCheck applicationloadbalancingTargetGroupHealthCheck.TargetGroupHealthCheckOutput `pulumi:"healthCheck"`
	...
	Stickiness applicationloadbalancingTargetGroupStickiness.TargetGroupStickinessOutput `pulumi:"stickiness"`
...
type targetGroupState struct {
	...
	// A Health Check block. Health Check blocks are documented below.
	HealthCheck *applicationloadbalancingTargetGroupHealthCheck.TargetGroupHealthCheck `pulumi:"healthCheck"`
	// Boolean whether the request and response headers exchanged between the load balancer and the Lambda function include arrays of values or strings. Only applies when `targetType` is `lambda`.
	...
	// A Stickiness block. Stickiness blocks are documented below. `stickiness` is only valid if used with Load Balancers of type `Application`
	Stickiness *applicationloadbalancingTargetGroupStickiness.TargetGroupStickiness `pulumi:"stickiness"`
	// A mapping of tags to assign to the resource.
...
type TargetGroupState struct {
	...
	// A Health Check block. Health Check blocks are documented below.
	HealthCheck applicationloadbalancingTargetGroupHealthCheck.TargetGroupHealthCheckPtrInput
	// Boolean whether the request and response headers exchanged between the load balancer and the Lambda function include arrays of values or strings. Only applies when `targetType` is `lambda`.
	...
	// A Stickiness block. Stickiness blocks are documented below. `stickiness` is only valid if used with Load Balancers of type `Application`
	Stickiness applicationloadbalancingTargetGroupStickiness.TargetGroupStickinessPtrInput
	// A mapping of tags to assign to the resource.
