...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/applicationloadbalancing/LoadBalancerAccessLogs"
	"https:/github.com/pulumi/pulumi-aws/applicationloadbalancing/LoadBalancerSubnetMapping"
)
...
type LoadBalancer struct {
	...
	AccessLogs applicationloadbalancingLoadBalancerAccessLogs.LoadBalancerAccessLogsPtrOutput `pulumi:"accessLogs"`
	...
	SubnetMappings applicationloadbalancingLoadBalancerSubnetMapping.LoadBalancerSubnetMappingArrayOutput `pulumi:"subnetMappings"`
...
type loadBalancerState struct {
	// An Access Logs block. Access Logs documented below.
	AccessLogs *applicationloadbalancingLoadBalancerAccessLogs.LoadBalancerAccessLogs `pulumi:"accessLogs"`
	// The ARN of the load balancer (matches `id`).
	...
	// A subnet mapping block as documented below.
	SubnetMappings []applicationloadbalancingLoadBalancerSubnetMapping.LoadBalancerSubnetMapping `pulumi:"subnetMappings"`
	// A list of subnet IDs to attach to the LB. Subnets
	// cannot be updated for Load Balancers of type `network`. Changing this value
	// for load balancers of type `network` will force a recreation of the resource.
...
type LoadBalancerState struct {
	// An Access Logs block. Access Logs documented below.
	AccessLogs applicationloadbalancingLoadBalancerAccessLogs.LoadBalancerAccessLogsPtrInput
	// The ARN of the load balancer (matches `id`).
	...
	// A subnet mapping block as documented below.
	SubnetMappings applicationloadbalancingLoadBalancerSubnetMapping.LoadBalancerSubnetMappingArrayInput
	// A list of subnet IDs to attach to the LB. Subnets
	// cannot be updated for Load Balancers of type `network`. Changing this value
	// for load balancers of type `network` will force a recreation of the resource.
