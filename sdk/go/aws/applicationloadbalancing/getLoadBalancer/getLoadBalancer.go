...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/applicationloadbalancing/getLoadBalancerAccessLogs"
	"https:/github.com/pulumi/pulumi-aws/applicationloadbalancing/getLoadBalancerSubnetMapping"
)
...
type GetLoadBalancerResult struct {
	AccessLogs applicationloadbalancinggetLoadBalancerAccessLogs.GetLoadBalancerAccessLogs `pulumi:"accessLogs"`
	Arn string `pulumi:"arn"`
	...
	SubnetMappings []applicationloadbalancinggetLoadBalancerSubnetMapping.GetLoadBalancerSubnetMapping `pulumi:"subnetMappings"`
