...
// nolint: lll
package getTargetGroup

import (
	"github.com/pulumi/pulumi/sdk/go/pulumi"
	"https:/github.com/pulumi/pulumi-aws/applicationloadbalancing/getTargetGroupHealthCheck"
	"https:/github.com/pulumi/pulumi-aws/applicationloadbalancing/getTargetGroupStickiness"
)
...
func GetTargetGroup(ctx *pulumi.Context, args *GetTargetGroupArgs, opts ...pulumi.InvokeOption) (*GetTargetGroupResult, error) {
...
type GetTargetGroupResult struct {
	...
	HealthCheck applicationloadbalancinggetTargetGroupHealthCheck.GetTargetGroupHealthCheck `pulumi:"healthCheck"`
	...
	Stickiness applicationloadbalancinggetTargetGroupStickiness.GetTargetGroupStickiness `pulumi:"stickiness"`
	Tags map[string]interface{} `pulumi:"tags"`
