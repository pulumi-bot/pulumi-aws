...
// 		opt0 := listenerArn
// 		_, err := lb.LookupListener(ctx, "aws:lb:getListener", &lb.LookupListenerArgs{
// 			Arn: &opt0,
// 		})
// 		if err != nil {
// 			return err
// 		}
// 		opt1 := "default-public"
// 		selected, err := lb.LookupLoadBalancer(ctx, "aws:lb:getLoadBalancer", &lb.LookupLoadBalancerArgs{
// 			Name: &opt1,
// 		})
// 		if err != nil {
// 			return err
