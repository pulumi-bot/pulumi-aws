...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/globalaccelerator/EndpointGroupEndpointConfiguration"
)
...
type EndpointGroup struct {
	...
	EndpointConfigurations globalacceleratorEndpointGroupEndpointConfiguration.EndpointGroupEndpointConfigurationArrayOutput `pulumi:"endpointConfigurations"`
...
type endpointGroupState struct {
	// The list of endpoint objects. Fields documented below.
	EndpointConfigurations []globalacceleratorEndpointGroupEndpointConfiguration.EndpointGroupEndpointConfiguration `pulumi:"endpointConfigurations"`
...
type EndpointGroupState struct {
	// The list of endpoint objects. Fields documented below.
	EndpointConfigurations globalacceleratorEndpointGroupEndpointConfiguration.EndpointGroupEndpointConfigurationArrayInput
