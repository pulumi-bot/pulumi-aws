...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/globalaccelerator/AcceleratorAttributes"
	"https:/github.com/pulumi/pulumi-aws/globalaccelerator/AcceleratorIpSet"
)
...
type Accelerator struct {
	...
	Attributes globalacceleratorAcceleratorAttributes.AcceleratorAttributesPtrOutput `pulumi:"attributes"`
	// Indicates whether the accelerator is enabled. The value is true or false. The default value is true.
	Enabled pulumi.BoolPtrOutput `pulumi:"enabled"`
	// The value for the address type must be `IPV4`.
	IpAddressType pulumi.StringPtrOutput `pulumi:"ipAddressType"`
	// IP address set associated with the accelerator.
	IpSets globalacceleratorAcceleratorIpSet.AcceleratorIpSetArrayOutput `pulumi:"ipSets"`
...
type acceleratorState struct {
	// The attributes of the accelerator. Fields documented below.
	Attributes *globalacceleratorAcceleratorAttributes.AcceleratorAttributes `pulumi:"attributes"`
	// Indicates whether the accelerator is enabled. The value is true or false. The default value is true.
	Enabled *bool `pulumi:"enabled"`
	// The value for the address type must be `IPV4`.
	IpAddressType *string `pulumi:"ipAddressType"`
	// IP address set associated with the accelerator.
	IpSets []globalacceleratorAcceleratorIpSet.AcceleratorIpSet `pulumi:"ipSets"`
	// The name of the accelerator.
...
type AcceleratorState struct {
	// The attributes of the accelerator. Fields documented below.
	Attributes globalacceleratorAcceleratorAttributes.AcceleratorAttributesPtrInput
	// Indicates whether the accelerator is enabled. The value is true or false. The default value is true.
	Enabled pulumi.BoolPtrInput
	// The value for the address type must be `IPV4`.
	IpAddressType pulumi.StringPtrInput
	// IP address set associated with the accelerator.
	IpSets globalacceleratorAcceleratorIpSet.AcceleratorIpSetArrayInput
	// The name of the accelerator.
