...
// The Amazon Resource Name (ARN) of the secret to retrieve.
func (o LookupSecretApplyOutput) Arn() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupSecretArgs) *string { return v.Arn }).(pulumi.StringPtrOutput)
}

// The name of the secret to retrieve.
func (o LookupSecretApplyOutput) Name() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupSecretArgs) *string { return v.Name }).(pulumi.StringPtrOutput)
}
