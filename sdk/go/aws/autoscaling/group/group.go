...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/autoscaling/GroupInitialLifecycleHook"
	"https:/github.com/pulumi/pulumi-aws/autoscaling/GroupLaunchTemplate"
	"https:/github.com/pulumi/pulumi-aws/autoscaling/GroupMixedInstancesPolicy"
	...
	"https:/github.com/pulumi/pulumi-aws/autoscaling/GroupTag"
)
...
type Group struct {
	...
	InitialLifecycleHooks autoscalingGroupInitialLifecycleHook.GroupInitialLifecycleHookArrayOutput `pulumi:"initialLifecycleHooks"`
	// The name of the launch configuration to use.
	LaunchConfiguration pulumi.StringPtrOutput `pulumi:"launchConfiguration"`
	// Nested argument containing launch template settings along with the overrides to specify multiple instance types and weights. Defined below.
	LaunchTemplate autoscalingGroupLaunchTemplate.GroupLaunchTemplatePtrOutput `pulumi:"launchTemplate"`
	...
	MixedInstancesPolicy autoscalingGroupMixedInstancesPolicy.GroupMixedInstancesPolicyPtrOutput `pulumi:"mixedInstancesPolicy"`
	...
	Tags autoscalingGroupTag.GroupTagArrayOutput `pulumi:"tags"`
...
type groupState struct {
	...
	// resource, without the `autoscalingGroupName` attribute. Please note that this will only work when creating
	// a new autoscaling group. For all other use-cases, please use `autoscaling.LifecycleHook` resource.
	InitialLifecycleHooks []autoscalingGroupInitialLifecycleHook.GroupInitialLifecycleHook `pulumi:"initialLifecycleHooks"`
	// The name of the launch configuration to use.
	LaunchConfiguration *string `pulumi:"launchConfiguration"`
	// Nested argument containing launch template settings along with the overrides to specify multiple instance types and weights. Defined below.
	LaunchTemplate *autoscalingGroupLaunchTemplate.GroupLaunchTemplate `pulumi:"launchTemplate"`
	// A list of elastic load balancer names to add to the autoscaling
	// group names. Only valid for classic load balancers. For ALBs, use `targetGroupArns` instead.
	...
	// Configuration block containing settings to define launch targets for Auto Scaling groups. Defined below.
	MixedInstancesPolicy *autoscalingGroupMixedInstancesPolicy.GroupMixedInstancesPolicy `pulumi:"mixedInstancesPolicy"`
	// The name of the auto scaling group. By default generated by this provider.
	...
	// A list of tag blocks. Tags documented below.
	Tags []autoscalingGroupTag.GroupTag `pulumi:"tags"`
	// A list of tag blocks (maps). Tags documented below.
...
type GroupState struct {
	...
	// resource, without the `autoscalingGroupName` attribute. Please note that this will only work when creating
	// a new autoscaling group. For all other use-cases, please use `autoscaling.LifecycleHook` resource.
	InitialLifecycleHooks autoscalingGroupInitialLifecycleHook.GroupInitialLifecycleHookArrayInput
	// The name of the launch configuration to use.
	LaunchConfiguration pulumi.StringPtrInput
	// Nested argument containing launch template settings along with the overrides to specify multiple instance types and weights. Defined below.
	LaunchTemplate autoscalingGroupLaunchTemplate.GroupLaunchTemplatePtrInput
	// A list of elastic load balancer names to add to the autoscaling
	// group names. Only valid for classic load balancers. For ALBs, use `targetGroupArns` instead.
	...
	// Configuration block containing settings to define launch targets for Auto Scaling groups. Defined below.
	MixedInstancesPolicy autoscalingGroupMixedInstancesPolicy.GroupMixedInstancesPolicyPtrInput
	// The name of the auto scaling group. By default generated by this provider.
	...
	// A list of tag blocks. Tags documented below.
	Tags autoscalingGroupTag.GroupTagArrayInput
	// A list of tag blocks (maps). Tags documented below.
