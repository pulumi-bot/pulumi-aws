...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/cloudhsmv2/ClusterClusterCertificates"
)
...
type Cluster struct {
	...
	ClusterCertificates cloudhsmv2ClusterClusterCertificates.ClusterClusterCertificatesOutput `pulumi:"clusterCertificates"`
...
type clusterState struct {
	...
	// * `cluster_certificates.0.hsm_certificate` - The HSM certificate issued (signed) by the HSM hardware.
	// * `cluster_certificates.0.manufacturer_hardware_certificate` - The HSM hardware certificate issued (signed) by the hardware manufacturer.
	ClusterCertificates *cloudhsmv2ClusterClusterCertificates.ClusterClusterCertificates `pulumi:"clusterCertificates"`
	// The id of the CloudHSM cluster.
...
type ClusterState struct {
	...
	// * `cluster_certificates.0.hsm_certificate` - The HSM certificate issued (signed) by the HSM hardware.
	// * `cluster_certificates.0.manufacturer_hardware_certificate` - The HSM hardware certificate issued (signed) by the hardware manufacturer.
	ClusterCertificates cloudhsmv2ClusterClusterCertificates.ClusterClusterCertificatesPtrInput
	// The id of the CloudHSM cluster.
