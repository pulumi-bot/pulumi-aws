...
// The id of Cloud HSM v2 cluster.
func (o LookupClusterApplyOutput) ClusterId() pulumi.StringOutput {
	return o.ApplyT(func(v LookupClusterArgs) string { return v.ClusterId }).(pulumi.StringOutput)
}

// The state of the cluster to be found.
func (o LookupClusterApplyOutput) ClusterState() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupClusterArgs) *string { return v.ClusterState }).(pulumi.StringPtrOutput)
}
