...
type LookupServiceQuotaArgs struct {
	...
	// Service code for the quota. Available values can be found with the `servicequotasgetService` data source or [AWS CLI service-quotas list-services command](https://docs.aws.amazon.com/cli/latest/reference/service-quotas/list-services.html).
