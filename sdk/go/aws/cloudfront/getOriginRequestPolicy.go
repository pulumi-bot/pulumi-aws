...
func LookupOriginRequestPolicyApply(ctx *pulumi.Context, args LookupOriginRequestPolicyApplyInput, opts ...pulumi.InvokeOption) LookupOriginRequestPolicyResultOutput {
	return args.ToLookupOriginRequestPolicyApplyOutput().ApplyT(func(v LookupOriginRequestPolicyArgs) (LookupOriginRequestPolicyResult, error) {
		r, err := LookupOriginRequestPolicy(ctx, &v, opts...)
		return *r, err

	}).(LookupOriginRequestPolicyResultOutput)
}

// LookupOriginRequestPolicyApplyInput is an input type that accepts LookupOriginRequestPolicyApplyArgs and LookupOriginRequestPolicyApplyOutput values.
// You can construct a concrete instance of `LookupOriginRequestPolicyApplyInput` via:
//
//          LookupOriginRequestPolicyApplyArgs{...}
type LookupOriginRequestPolicyApplyInput interface {
	pulumi.Input

	ToLookupOriginRequestPolicyApplyOutput() LookupOriginRequestPolicyApplyOutput
	ToLookupOriginRequestPolicyApplyOutputWithContext(context.Context) LookupOriginRequestPolicyApplyOutput
}

// A collection of arguments for invoking getOriginRequestPolicy.
type LookupOriginRequestPolicyApplyArgs struct {
	// The identifier for the origin request policy.
...
func (LookupOriginRequestPolicyApplyArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupOriginRequestPolicyArgs)(nil)).Elem()
}

func (i LookupOriginRequestPolicyApplyArgs) ToLookupOriginRequestPolicyApplyOutput() LookupOriginRequestPolicyApplyOutput {
	return i.ToLookupOriginRequestPolicyApplyOutputWithContext(context.Background())
}

func (i LookupOriginRequestPolicyApplyArgs) ToLookupOriginRequestPolicyApplyOutputWithContext(ctx context.Context) LookupOriginRequestPolicyApplyOutput {
	return pulumi.ToOutputWithContext(ctx, i).(LookupOriginRequestPolicyApplyOutput)
}

// A collection of arguments for invoking getOriginRequestPolicy.
type LookupOriginRequestPolicyApplyOutput struct{ *pulumi.OutputState }

func (LookupOriginRequestPolicyApplyOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupOriginRequestPolicyArgs)(nil)).Elem()
}

func (o LookupOriginRequestPolicyApplyOutput) ToLookupOriginRequestPolicyApplyOutput() LookupOriginRequestPolicyApplyOutput {
	return o
}

func (o LookupOriginRequestPolicyApplyOutput) ToLookupOriginRequestPolicyApplyOutputWithContext(ctx context.Context) LookupOriginRequestPolicyApplyOutput {
	return o
}

// The identifier for the origin request policy.
func (o LookupOriginRequestPolicyApplyOutput) Id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupOriginRequestPolicyArgs) *string { return v.Id }).(pulumi.StringPtrOutput)
}

// Unique name to identify the origin request policy.
func (o LookupOriginRequestPolicyApplyOutput) Name() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupOriginRequestPolicyArgs) *string { return v.Name }).(pulumi.StringPtrOutput)
}
...
func init() {
	pulumi.RegisterOutputType(LookupOriginRequestPolicyApplyOutput{})
