...
func LookupSigningJobApply(ctx *pulumi.Context, args LookupSigningJobApplyInput, opts ...pulumi.InvokeOption) LookupSigningJobResultOutput {
	return args.ToLookupSigningJobApplyOutput().ApplyT(func(v LookupSigningJobArgs) (LookupSigningJobResult, error) {
		r, err := LookupSigningJob(ctx, &v, opts...)
		return *r, err

	}).(LookupSigningJobResultOutput)
}

// LookupSigningJobApplyInput is an input type that accepts LookupSigningJobApplyArgs and LookupSigningJobApplyOutput values.
// You can construct a concrete instance of `LookupSigningJobApplyInput` via:
//
//          LookupSigningJobApplyArgs{...}
type LookupSigningJobApplyInput interface {
	pulumi.Input

	ToLookupSigningJobApplyOutput() LookupSigningJobApplyOutput
	ToLookupSigningJobApplyOutputWithContext(context.Context) LookupSigningJobApplyOutput
}

// A collection of arguments for invoking getSigningJob.
type LookupSigningJobApplyArgs struct {
	// The ID of the signing job on output.
	JobId pulumi.StringInput `pulumi:"jobId"`
}

func (LookupSigningJobApplyArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupSigningJobArgs)(nil)).Elem()
}

func (i LookupSigningJobApplyArgs) ToLookupSigningJobApplyOutput() LookupSigningJobApplyOutput {
	return i.ToLookupSigningJobApplyOutputWithContext(context.Background())
}

func (i LookupSigningJobApplyArgs) ToLookupSigningJobApplyOutputWithContext(ctx context.Context) LookupSigningJobApplyOutput {
	return pulumi.ToOutputWithContext(ctx, i).(LookupSigningJobApplyOutput)
}

// A collection of arguments for invoking getSigningJob.
type LookupSigningJobApplyOutput struct{ *pulumi.OutputState }

func (LookupSigningJobApplyOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupSigningJobArgs)(nil)).Elem()
}

func (o LookupSigningJobApplyOutput) ToLookupSigningJobApplyOutput() LookupSigningJobApplyOutput {
	return o
}

func (o LookupSigningJobApplyOutput) ToLookupSigningJobApplyOutputWithContext(ctx context.Context) LookupSigningJobApplyOutput {
	return o
}

// The ID of the signing job on output.
func (o LookupSigningJobApplyOutput) JobId() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSigningJobArgs) string { return v.JobId }).(pulumi.StringOutput)
}
...
func init() {
	pulumi.RegisterOutputType(LookupSigningJobApplyOutput{})
