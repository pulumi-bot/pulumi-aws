...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/cognito/IdentityPoolRoleAttachmentRoleMapping"
	"https:/github.com/pulumi/pulumi-aws/cognito/IdentityPoolRoleAttachmentRoleMappingMappingRule"
	"https:/github.com/pulumi/pulumi-aws/cognito/IdentityPoolRoleAttachmentRoles"
)
...
type IdentityPoolRoleAttachment struct {
	...
	RoleMappings cognitoIdentityPoolRoleAttachmentRoleMapping.IdentityPoolRoleAttachmentRoleMappingArrayOutput `pulumi:"roleMappings"`
	// The map of roles associated with this pool. For a given role, the key will be either "authenticated" or "unauthenticated" and the value will be the Role ARN.
	Roles cognitoIdentityPoolRoleAttachmentRoles.IdentityPoolRoleAttachmentRolesOutput `pulumi:"roles"`
}
...
type identityPoolRoleAttachmentState struct {
	...
	// A List of Role Mapping.
	RoleMappings []cognitoIdentityPoolRoleAttachmentRoleMapping.IdentityPoolRoleAttachmentRoleMapping `pulumi:"roleMappings"`
	// The map of roles associated with this pool. For a given role, the key will be either "authenticated" or "unauthenticated" and the value will be the Role ARN.
	Roles *cognitoIdentityPoolRoleAttachmentRoles.IdentityPoolRoleAttachmentRoles `pulumi:"roles"`
}
...
type IdentityPoolRoleAttachmentState struct {
	...
	// A List of Role Mapping.
	RoleMappings cognitoIdentityPoolRoleAttachmentRoleMapping.IdentityPoolRoleAttachmentRoleMappingArrayInput
	// The map of roles associated with this pool. For a given role, the key will be either "authenticated" or "unauthenticated" and the value will be the Role ARN.
	Roles cognitoIdentityPoolRoleAttachmentRoles.IdentityPoolRoleAttachmentRolesPtrInput
}
...
type IdentityPoolRoleAttachmentArgs struct {
	...
	RoleMappings cognitoIdentityPoolRoleAttachmentRoleMapping.IdentityPoolRoleAttachmentRoleMappingArrayInput
	// The map of roles associated with this pool. For a given role, the key will be either "authenticated" or "unauthenticated" and the value will be the Role ARN.
	Roles cognitoIdentityPoolRoleAttachmentRoles.IdentityPoolRoleAttachmentRolesInput
}
