...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/cognito/IdentityPoolCognitoIdentityProvider"
)
...
type IdentityPool struct {
	...
	CognitoIdentityProviders cognitoIdentityPoolCognitoIdentityProvider.IdentityPoolCognitoIdentityProviderArrayOutput `pulumi:"cognitoIdentityProviders"`
...
type identityPoolState struct {
	...
	// An array of Amazon Cognito Identity user pools and their client IDs.
	CognitoIdentityProviders []cognitoIdentityPoolCognitoIdentityProvider.IdentityPoolCognitoIdentityProvider `pulumi:"cognitoIdentityProviders"`
	// The "domain" by which Cognito will refer to your users. This name acts as a placeholder that allows your
	// backend and the Cognito service to communicate about the developer provider.
...
type IdentityPoolState struct {
	...
	// An array of Amazon Cognito Identity user pools and their client IDs.
	CognitoIdentityProviders cognitoIdentityPoolCognitoIdentityProvider.IdentityPoolCognitoIdentityProviderArrayInput
	// The "domain" by which Cognito will refer to your users. This name acts as a placeholder that allows your
	// backend and the Cognito service to communicate about the developer provider.
