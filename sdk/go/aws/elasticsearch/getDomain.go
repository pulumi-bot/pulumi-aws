...
func LookupDomainApply(ctx *pulumi.Context, args LookupDomainApplyInput, opts ...pulumi.InvokeOption) LookupDomainResultOutput {
	return args.ToLookupDomainApplyOutput().ApplyT(func(v LookupDomainArgs) (LookupDomainResult, error) {
		r, err := LookupDomain(ctx, &v, opts...)
		return *r, err

	}).(LookupDomainResultOutput)
}

// LookupDomainApplyInput is an input type that accepts LookupDomainApplyArgs and LookupDomainApplyOutput values.
// You can construct a concrete instance of `LookupDomainApplyInput` via:
//
//          LookupDomainApplyArgs{...}
type LookupDomainApplyInput interface {
	pulumi.Input

	ToLookupDomainApplyOutput() LookupDomainApplyOutput
	ToLookupDomainApplyOutputWithContext(context.Context) LookupDomainApplyOutput
}

// A collection of arguments for invoking getDomain.
type LookupDomainApplyArgs struct {
	// Name of the domain.
...
func (LookupDomainApplyArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupDomainArgs)(nil)).Elem()
}

func (i LookupDomainApplyArgs) ToLookupDomainApplyOutput() LookupDomainApplyOutput {
	return i.ToLookupDomainApplyOutputWithContext(context.Background())
}

func (i LookupDomainApplyArgs) ToLookupDomainApplyOutputWithContext(ctx context.Context) LookupDomainApplyOutput {
	return pulumi.ToOutputWithContext(ctx, i).(LookupDomainApplyOutput)
}

// A collection of arguments for invoking getDomain.
type LookupDomainApplyOutput struct{ *pulumi.OutputState }

func (LookupDomainApplyOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupDomainArgs)(nil)).Elem()
}

func (o LookupDomainApplyOutput) ToLookupDomainApplyOutput() LookupDomainApplyOutput {
	return o
}

func (o LookupDomainApplyOutput) ToLookupDomainApplyOutputWithContext(ctx context.Context) LookupDomainApplyOutput {
	return o
}

// Name of the domain.
func (o LookupDomainApplyOutput) DomainName() pulumi.StringOutput {
	return o.ApplyT(func(v LookupDomainArgs) string { return v.DomainName }).(pulumi.StringOutput)
}

// The tags assigned to the domain.
func (o LookupDomainApplyOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v LookupDomainArgs) map[string]string { return v.Tags }).(pulumi.StringMapOutput)
}
...
func init() {
	pulumi.RegisterOutputType(LookupDomainApplyOutput{})
