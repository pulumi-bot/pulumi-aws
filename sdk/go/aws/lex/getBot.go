...
func LookupBotApply(ctx *pulumi.Context, args LookupBotApplyInput, opts ...pulumi.InvokeOption) LookupBotResultOutput {
	return args.ToLookupBotApplyOutput().ApplyT(func(v LookupBotArgs) (LookupBotResult, error) {
		r, err := LookupBot(ctx, &v, opts...)
		return *r, err

	}).(LookupBotResultOutput)
}

// LookupBotApplyInput is an input type that accepts LookupBotApplyArgs and LookupBotApplyOutput values.
// You can construct a concrete instance of `LookupBotApplyInput` via:
//
//          LookupBotApplyArgs{...}
type LookupBotApplyInput interface {
	pulumi.Input

	ToLookupBotApplyOutput() LookupBotApplyOutput
	ToLookupBotApplyOutputWithContext(context.Context) LookupBotApplyOutput
}

// A collection of arguments for invoking getBot.
type LookupBotApplyArgs struct {
	// The name of the bot. The name is case sensitive.
...
func (LookupBotApplyArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupBotArgs)(nil)).Elem()
}

func (i LookupBotApplyArgs) ToLookupBotApplyOutput() LookupBotApplyOutput {
	return i.ToLookupBotApplyOutputWithContext(context.Background())
}

func (i LookupBotApplyArgs) ToLookupBotApplyOutputWithContext(ctx context.Context) LookupBotApplyOutput {
	return pulumi.ToOutputWithContext(ctx, i).(LookupBotApplyOutput)
}

// A collection of arguments for invoking getBot.
type LookupBotApplyOutput struct{ *pulumi.OutputState }

func (LookupBotApplyOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupBotArgs)(nil)).Elem()
}

func (o LookupBotApplyOutput) ToLookupBotApplyOutput() LookupBotApplyOutput {
	return o
}

func (o LookupBotApplyOutput) ToLookupBotApplyOutputWithContext(ctx context.Context) LookupBotApplyOutput {
	return o
}

// The name of the bot. The name is case sensitive.
func (o LookupBotApplyOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v LookupBotArgs) string { return v.Name }).(pulumi.StringOutput)
}

// The version or alias of the bot.
func (o LookupBotApplyOutput) Version() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupBotArgs) *string { return v.Version }).(pulumi.StringPtrOutput)
}
...
func init() {
	pulumi.RegisterOutputType(LookupBotApplyOutput{})
