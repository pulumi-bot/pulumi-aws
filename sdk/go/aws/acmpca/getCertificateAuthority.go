...
func LookupCertificateAuthorityApply(ctx *pulumi.Context, args LookupCertificateAuthorityApplyInput, opts ...pulumi.InvokeOption) LookupCertificateAuthorityResultOutput {
	return args.ToLookupCertificateAuthorityApplyOutput().ApplyT(func(v LookupCertificateAuthorityArgs) (LookupCertificateAuthorityResult, error) {
		r, err := LookupCertificateAuthority(ctx, &v, opts...)
		return *r, err

	}).(LookupCertificateAuthorityResultOutput)
}

// LookupCertificateAuthorityApplyInput is an input type that accepts LookupCertificateAuthorityApplyArgs and LookupCertificateAuthorityApplyOutput values.
// You can construct a concrete instance of `LookupCertificateAuthorityApplyInput` via:
//
//          LookupCertificateAuthorityApplyArgs{...}
type LookupCertificateAuthorityApplyInput interface {
	pulumi.Input

	ToLookupCertificateAuthorityApplyOutput() LookupCertificateAuthorityApplyOutput
	ToLookupCertificateAuthorityApplyOutputWithContext(context.Context) LookupCertificateAuthorityApplyOutput
}

// A collection of arguments for invoking getCertificateAuthority.
type LookupCertificateAuthorityApplyArgs struct {
	// Amazon Resource Name (ARN) of the certificate authority.
...
func (LookupCertificateAuthorityApplyArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupCertificateAuthorityArgs)(nil)).Elem()
}

func (i LookupCertificateAuthorityApplyArgs) ToLookupCertificateAuthorityApplyOutput() LookupCertificateAuthorityApplyOutput {
	return i.ToLookupCertificateAuthorityApplyOutputWithContext(context.Background())
}

func (i LookupCertificateAuthorityApplyArgs) ToLookupCertificateAuthorityApplyOutputWithContext(ctx context.Context) LookupCertificateAuthorityApplyOutput {
	return pulumi.ToOutputWithContext(ctx, i).(LookupCertificateAuthorityApplyOutput)
}

// A collection of arguments for invoking getCertificateAuthority.
type LookupCertificateAuthorityApplyOutput struct{ *pulumi.OutputState }

func (LookupCertificateAuthorityApplyOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupCertificateAuthorityArgs)(nil)).Elem()
}

func (o LookupCertificateAuthorityApplyOutput) ToLookupCertificateAuthorityApplyOutput() LookupCertificateAuthorityApplyOutput {
	return o
}

func (o LookupCertificateAuthorityApplyOutput) ToLookupCertificateAuthorityApplyOutputWithContext(ctx context.Context) LookupCertificateAuthorityApplyOutput {
	return o
}

// Amazon Resource Name (ARN) of the certificate authority.
func (o LookupCertificateAuthorityApplyOutput) Arn() pulumi.StringOutput {
	return o.ApplyT(func(v LookupCertificateAuthorityArgs) string { return v.Arn }).(pulumi.StringOutput)
}
...
// * `revocation_configuration.0.crl_configuration.0.expiration_in_days` - Number of days until a certificate expires.
// * `revocation_configuration.0.crl_configuration.0.s3_bucket_name` - Name of the S3 bucket that contains the CRL.
func (o LookupCertificateAuthorityApplyOutput) RevocationConfigurations() GetCertificateAuthorityRevocationConfigurationArrayOutput {
	return o.ApplyT(func(v LookupCertificateAuthorityArgs) []GetCertificateAuthorityRevocationConfiguration {
		return v.RevocationConfigurations
	}).(GetCertificateAuthorityRevocationConfigurationArrayOutput)
}

// Specifies a key-value map of user-defined tags that are attached to the certificate authority.
func (o LookupCertificateAuthorityApplyOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v LookupCertificateAuthorityArgs) map[string]string { return v.Tags }).(pulumi.StringMapOutput)
}
...
func init() {
	pulumi.RegisterOutputType(LookupCertificateAuthorityApplyOutput{})
