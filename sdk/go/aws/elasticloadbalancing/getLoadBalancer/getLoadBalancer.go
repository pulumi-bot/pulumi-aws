...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/elasticloadbalancing/getLoadBalancerAccessLogs"
	"https:/github.com/pulumi/pulumi-aws/elasticloadbalancing/getLoadBalancerHealthCheck"
	"https:/github.com/pulumi/pulumi-aws/elasticloadbalancing/getLoadBalancerListener"
)
...
type GetLoadBalancerResult struct {
	AccessLogs elasticloadbalancinggetLoadBalancerAccessLogs.GetLoadBalancerAccessLogs `pulumi:"accessLogs"`
	...
	HealthCheck elasticloadbalancinggetLoadBalancerHealthCheck.GetLoadBalancerHealthCheck `pulumi:"healthCheck"`
	// id is the provider-assigned unique ID for this managed resource.
	Id string `pulumi:"id"`
	IdleTimeout int `pulumi:"idleTimeout"`
	Instances []string `pulumi:"instances"`
	Internal bool `pulumi:"internal"`
	Listeners []elasticloadbalancinggetLoadBalancerListener.GetLoadBalancerListener `pulumi:"listeners"`
	Name string `pulumi:"name"`
