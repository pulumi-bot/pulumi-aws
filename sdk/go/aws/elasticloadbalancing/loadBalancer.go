...
type loadBalancerArgs struct {
	...
	CrossZoneLoadBalancing *bool `pulumi:"crossZoneLoadBalancing"`
	// A healthCheck block. Health Check documented below.
	HealthCheck *LoadBalancerHealthCheckArgs `pulumi:"healthCheck"`
	// The time in seconds that the connection is allowed to be idle. Default: `60`
	IdleTimeout *int `pulumi:"idleTimeout"`
	// A list of instance ids to place in the ELB pool.
	Instances []string `pulumi:"instances"`
	...
	Internal *bool `pulumi:"internal"`
	// A list of listener blocks. Listeners documented below.
	Listeners []LoadBalancerListenerArgs `pulumi:"listeners"`
	// The name of the ELB. By default generated by this provider.
	Name *string `pulumi:"name"`
	// Creates a unique name beginning with the specified
	// prefix. Conflicts with `name`.
...
type LoadBalancerArgs struct {
	...
	CrossZoneLoadBalancing pulumi.BoolPtrInput
	// A healthCheck block. Health Check documented below.
	HealthCheck LoadBalancerHealthCheckArgsPtrInput
	// The time in seconds that the connection is allowed to be idle. Default: `60`
	IdleTimeout pulumi.IntPtrInput
	// A list of instance ids to place in the ELB pool.
	Instances pulumi.StringArrayInput
	...
	Internal pulumi.BoolPtrInput
	// A list of listener blocks. Listeners documented below.
	Listeners LoadBalancerListenerArgsArrayInput
	// The name of the ELB. By default generated by this provider.
	Name pulumi.StringPtrInput
	// Creates a unique name beginning with the specified
	// prefix. Conflicts with `name`.
