...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/transfer/ServerEndpointDetails"
)
...
type Server struct {
	...
	EndpointDetails transferServerEndpointDetails.ServerEndpointDetailsPtrOutput `pulumi:"endpointDetails"`
...
type serverState struct {
	...
	// The virtual private cloud (VPC) endpoint settings that you want to configure for your SFTP server. Fields documented below.
	EndpointDetails *transferServerEndpointDetails.ServerEndpointDetails `pulumi:"endpointDetails"`
	// The type of endpoint that you want your SFTP server connect to. If you connect to a `VPC_ENDPOINT`, your SFTP server isn't accessible over the public internet. If you want to connect your SFTP server via public internet, set `PUBLIC`.  Defaults to `PUBLIC`.
...
type ServerState struct {
	...
	// The virtual private cloud (VPC) endpoint settings that you want to configure for your SFTP server. Fields documented below.
	EndpointDetails transferServerEndpointDetails.ServerEndpointDetailsPtrInput
	// The type of endpoint that you want your SFTP server connect to. If you connect to a `VPC_ENDPOINT`, your SFTP server isn't accessible over the public internet. If you want to connect your SFTP server via public internet, set `PUBLIC`.  Defaults to `PUBLIC`.
