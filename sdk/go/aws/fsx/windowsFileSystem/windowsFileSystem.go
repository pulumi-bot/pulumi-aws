...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/fsx/WindowsFileSystemSelfManagedActiveDirectory"
)
...
type WindowsFileSystem struct {
	...
	SelfManagedActiveDirectory fsxWindowsFileSystemSelfManagedActiveDirectory.WindowsFileSystemSelfManagedActiveDirectoryPtrOutput `pulumi:"selfManagedActiveDirectory"`
...
type windowsFileSystemState struct {
	...
	// Configuration block that Amazon FSx uses to join the Windows File Server instance to your self-managed (including on-premises) Microsoft Active Directory (AD) directory. Cannot be specified with `activeDirectoryId`. Detailed below.
	SelfManagedActiveDirectory *fsxWindowsFileSystemSelfManagedActiveDirectory.WindowsFileSystemSelfManagedActiveDirectory `pulumi:"selfManagedActiveDirectory"`
	// When enabled, will skip the default final backup taken when the file system is deleted. This configuration must be applied separately before attempting to delete the resource to have the desired behavior. Defaults to `false`.
...
type WindowsFileSystemState struct {
	...
	// Configuration block that Amazon FSx uses to join the Windows File Server instance to your self-managed (including on-premises) Microsoft Active Directory (AD) directory. Cannot be specified with `activeDirectoryId`. Detailed below.
	SelfManagedActiveDirectory fsxWindowsFileSystemSelfManagedActiveDirectory.WindowsFileSystemSelfManagedActiveDirectoryPtrInput
	// When enabled, will skip the default final backup taken when the file system is deleted. This configuration must be applied separately before attempting to delete the resource to have the desired behavior. Defaults to `false`.
