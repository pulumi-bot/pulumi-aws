...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/macie/S3BucketAssociationClassificationType"
)
...
type S3BucketAssociation struct {
	...
	ClassificationType macieS3BucketAssociationClassificationType.S3BucketAssociationClassificationTypeOutput `pulumi:"classificationType"`
...
type s3bucketAssociationState struct {
	...
	// The configuration of how Amazon Macie classifies the S3 objects.
	ClassificationType *macieS3BucketAssociationClassificationType.S3BucketAssociationClassificationType `pulumi:"classificationType"`
	// The ID of the Amazon Macie member account whose S3 resources you want to associate with Macie. If `memberAccountId` isn't specified, the action associates specified S3 resources with Macie for the current master account.
...
type S3BucketAssociationState struct {
	...
	// The configuration of how Amazon Macie classifies the S3 objects.
	ClassificationType macieS3BucketAssociationClassificationType.S3BucketAssociationClassificationTypePtrInput
	// The ID of the Amazon Macie member account whose S3 resources you want to associate with Macie. If `memberAccountId` isn't specified, the action associates specified S3 resources with Macie for the current master account.
