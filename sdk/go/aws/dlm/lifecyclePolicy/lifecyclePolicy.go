...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/dlm/LifecyclePolicyPolicyDetails"
...
type LifecyclePolicy struct {
	...
	PolicyDetails dlmLifecyclePolicyPolicyDetails.LifecyclePolicyPolicyDetailsOutput `pulumi:"policyDetails"`
...
type lifecyclePolicyState struct {
	...
	// See the `policyDetails` configuration block. Max of 1.
	PolicyDetails *dlmLifecyclePolicyPolicyDetails.LifecyclePolicyPolicyDetails `pulumi:"policyDetails"`
	// Whether the lifecycle policy should be enabled or disabled. `ENABLED` or `DISABLED` are valid values. Defaults to `ENABLED`.
...
type LifecyclePolicyState struct {
	...
	// See the `policyDetails` configuration block. Max of 1.
	PolicyDetails dlmLifecyclePolicyPolicyDetails.LifecyclePolicyPolicyDetailsPtrInput
	// Whether the lifecycle policy should be enabled or disabled. `ENABLED` or `DISABLED` are valid values. Defaults to `ENABLED`.
...
type LifecyclePolicyArgs struct {
	...
	// See the `policyDetails` configuration block. Max of 1.
	PolicyDetails dlmLifecyclePolicyPolicyDetails.LifecyclePolicyPolicyDetailsInput
	// Whether the lifecycle policy should be enabled or disabled. `ENABLED` or `DISABLED` are valid values. Defaults to `ENABLED`.
	State pulumi.StringPtrInput
	// Key-value mapping of resource tags.
	Tags pulumi.MapInput
