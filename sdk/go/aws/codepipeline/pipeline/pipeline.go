...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/codepipeline/PipelineArtifactStore"
	"https:/github.com/pulumi/pulumi-aws/codepipeline/PipelineArtifactStoreEncryptionKey"
	"https:/github.com/pulumi/pulumi-aws/codepipeline/PipelineStage"
...
type Pipeline struct {
	...
	ArtifactStore codepipelinePipelineArtifactStore.PipelineArtifactStoreOutput `pulumi:"artifactStore"`
	// The name of the pipeline.
	Name pulumi.StringOutput `pulumi:"name"`
	// A service role Amazon Resource Name (ARN) that grants AWS CodePipeline permission to make calls to AWS services on your behalf.
	RoleArn pulumi.StringOutput `pulumi:"roleArn"`
	Stages codepipelinePipelineStage.PipelineStageArrayOutput `pulumi:"stages"`
...
type pipelineState struct {
	...
	// An artifactStore block. Artifact stores are documented below.
	// * `stage` (Minimum of at least two `stage` blocks is required) A stage block. Stages are documented below.
	ArtifactStore *codepipelinePipelineArtifactStore.PipelineArtifactStore `pulumi:"artifactStore"`
	// The name of the pipeline.
	Name *string `pulumi:"name"`
	// A service role Amazon Resource Name (ARN) that grants AWS CodePipeline permission to make calls to AWS services on your behalf.
	RoleArn *string `pulumi:"roleArn"`
	Stages []codepipelinePipelineStage.PipelineStage `pulumi:"stages"`
	// A mapping of tags to assign to the resource.
...
type PipelineState struct {
	...
	// An artifactStore block. Artifact stores are documented below.
	// * `stage` (Minimum of at least two `stage` blocks is required) A stage block. Stages are documented below.
	ArtifactStore codepipelinePipelineArtifactStore.PipelineArtifactStorePtrInput
	// The name of the pipeline.
	Name pulumi.StringPtrInput
	// A service role Amazon Resource Name (ARN) that grants AWS CodePipeline permission to make calls to AWS services on your behalf.
	RoleArn pulumi.StringPtrInput
	Stages codepipelinePipelineStage.PipelineStageArrayInput
	// A mapping of tags to assign to the resource.
...
type PipelineArgs struct {
	// An artifactStore block. Artifact stores are documented below.
	// * `stage` (Minimum of at least two `stage` blocks is required) A stage block. Stages are documented below.
	ArtifactStore codepipelinePipelineArtifactStore.PipelineArtifactStoreInput
	// The name of the pipeline.
	Name pulumi.StringPtrInput
	// A service role Amazon Resource Name (ARN) that grants AWS CodePipeline permission to make calls to AWS services on your behalf.
