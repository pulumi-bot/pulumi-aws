...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/codepipeline/WebhookAuthenticationConfiguration"
	"https:/github.com/pulumi/pulumi-aws/codepipeline/WebhookFilter"
)
...
type Webhook struct {
	...
	AuthenticationConfiguration codepipelineWebhookAuthenticationConfiguration.WebhookAuthenticationConfigurationPtrOutput `pulumi:"authenticationConfiguration"`
	// One or more `filter` blocks. Filter blocks are documented below.
	Filters codepipelineWebhookFilter.WebhookFilterArrayOutput `pulumi:"filters"`
...
type webhookState struct {
	...
	// An `auth` block. Required for `IP` and `GITHUB_HMAC`. Auth blocks are documented below.
	AuthenticationConfiguration *codepipelineWebhookAuthenticationConfiguration.WebhookAuthenticationConfiguration `pulumi:"authenticationConfiguration"`
	// One or more `filter` blocks. Filter blocks are documented below.
	Filters []codepipelineWebhookFilter.WebhookFilter `pulumi:"filters"`
	// The name of the webhook.
...
type WebhookState struct {
	...
	// An `auth` block. Required for `IP` and `GITHUB_HMAC`. Auth blocks are documented below.
	AuthenticationConfiguration codepipelineWebhookAuthenticationConfiguration.WebhookAuthenticationConfigurationPtrInput
	// One or more `filter` blocks. Filter blocks are documented below.
	Filters codepipelineWebhookFilter.WebhookFilterArrayInput
	// The name of the webhook.
