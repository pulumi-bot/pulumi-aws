...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/acm/CertificateDomainValidationOption"
	"https:/github.com/pulumi/pulumi-aws/acm/CertificateOptions"
)
...
type Certificate struct {
	...
	DomainValidationOptions acmCertificateDomainValidationOption.CertificateDomainValidationOptionArrayOutput `pulumi:"domainValidationOptions"`
	Options acmCertificateOptions.CertificateOptionsPtrOutput `pulumi:"options"`
...
type certificateState struct {
	...
	// A list of attributes to feed into other resources to complete certificate validation. Can have more than one element, e.g. if SANs are defined. Only set if `DNS`-validation was used.
	DomainValidationOptions []acmCertificateDomainValidationOption.CertificateDomainValidationOption `pulumi:"domainValidationOptions"`
	Options *acmCertificateOptions.CertificateOptions `pulumi:"options"`
	// The certificate's PEM-formatted private key
...
type CertificateState struct {
	...
	// A list of attributes to feed into other resources to complete certificate validation. Can have more than one element, e.g. if SANs are defined. Only set if `DNS`-validation was used.
	DomainValidationOptions acmCertificateDomainValidationOption.CertificateDomainValidationOptionArrayInput
	Options acmCertificateOptions.CertificateOptionsPtrInput
	// The certificate's PEM-formatted private key
