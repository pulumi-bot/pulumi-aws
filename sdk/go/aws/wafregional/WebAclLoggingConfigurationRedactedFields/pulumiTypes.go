...
type WebAclLoggingConfigurationRedactedFields struct {
	...
	FieldToMatches []wafregionalWebAclLoggingConfigurationRedactedFieldsFieldToMatch.WebAclLoggingConfigurationRedactedFieldsFieldToMatch `pulumi:"fieldToMatches"`
}
...
type WebAclLoggingConfigurationRedactedFieldsArgs struct {
	// Set of configuration blocks for fields to redact. Detailed below.
	FieldToMatches wafregionalWebAclLoggingConfigurationRedactedFieldsFieldToMatch.WebAclLoggingConfigurationRedactedFieldsFieldToMatchArrayInput `pulumi:"fieldToMatches"`
}
...
// Set of configuration blocks for fields to redact. Detailed below.
func (o WebAclLoggingConfigurationRedactedFieldsOutput) FieldToMatches() wafregionalWebAclLoggingConfigurationRedactedFieldsFieldToMatch.WebAclLoggingConfigurationRedactedFieldsFieldToMatchArrayOutput {
	return o.ApplyT(func (v WebAclLoggingConfigurationRedactedFields) []wafregionalWebAclLoggingConfigurationRedactedFieldsFieldToMatch.WebAclLoggingConfigurationRedactedFieldsFieldToMatch { return v.FieldToMatches }).(wafregionalWebAclLoggingConfigurationRedactedFieldsFieldToMatch.WebAclLoggingConfigurationRedactedFieldsFieldToMatchArrayOutput)
}
...
// Set of configuration blocks for fields to redact. Detailed below.
func (o WebAclLoggingConfigurationRedactedFieldsPtrOutput) FieldToMatches() wafregionalWebAclLoggingConfigurationRedactedFieldsFieldToMatch.WebAclLoggingConfigurationRedactedFieldsFieldToMatchArrayOutput {
	return o.ApplyT(func (v WebAclLoggingConfigurationRedactedFields) []wafregionalWebAclLoggingConfigurationRedactedFieldsFieldToMatch.WebAclLoggingConfigurationRedactedFieldsFieldToMatch { return v.FieldToMatches }).(wafregionalWebAclLoggingConfigurationRedactedFieldsFieldToMatch.WebAclLoggingConfigurationRedactedFieldsFieldToMatchArrayOutput)
}
