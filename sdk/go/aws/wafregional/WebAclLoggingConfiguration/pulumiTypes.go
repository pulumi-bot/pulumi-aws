...
type WebAclLoggingConfiguration struct {
	...
	RedactedFields *wafregionalWebAclLoggingConfigurationRedactedFields.WebAclLoggingConfigurationRedactedFields `pulumi:"redactedFields"`
}
...
type WebAclLoggingConfigurationArgs struct {
	...
	// Configuration block containing parts of the request that you want redacted from the logs. Detailed below.
	RedactedFields wafregionalWebAclLoggingConfigurationRedactedFields.WebAclLoggingConfigurationRedactedFieldsPtrInput `pulumi:"redactedFields"`
}
...
// Configuration block containing parts of the request that you want redacted from the logs. Detailed below.
func (o WebAclLoggingConfigurationOutput) RedactedFields() wafregionalWebAclLoggingConfigurationRedactedFields.WebAclLoggingConfigurationRedactedFieldsPtrOutput {
	return o.ApplyT(func (v WebAclLoggingConfiguration) *wafregionalWebAclLoggingConfigurationRedactedFields.WebAclLoggingConfigurationRedactedFields { return v.RedactedFields }).(wafregionalWebAclLoggingConfigurationRedactedFields.WebAclLoggingConfigurationRedactedFieldsPtrOutput)
}
...
// Configuration block containing parts of the request that you want redacted from the logs. Detailed below.
func (o WebAclLoggingConfigurationPtrOutput) RedactedFields() wafregionalWebAclLoggingConfigurationRedactedFields.WebAclLoggingConfigurationRedactedFieldsPtrOutput {
	return o.ApplyT(func (v WebAclLoggingConfiguration) *wafregionalWebAclLoggingConfigurationRedactedFields.WebAclLoggingConfigurationRedactedFields { return v.RedactedFields }).(wafregionalWebAclLoggingConfigurationRedactedFields.WebAclLoggingConfigurationRedactedFieldsPtrOutput)
}
