...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/wafregional/RulePredicate"
)
...
type Rule struct {
	...
	Predicates wafregionalRulePredicate.RulePredicateArrayOutput `pulumi:"predicates"`
...
type ruleState struct {
	...
	// The objects to include in a rule (documented below).
	Predicates []wafregionalRulePredicate.RulePredicate `pulumi:"predicates"`
	// Key-value mapping of resource tags
...
type RuleState struct {
	...
	// The objects to include in a rule (documented below).
	Predicates wafregionalRulePredicate.RulePredicateArrayInput
	// Key-value mapping of resource tags
