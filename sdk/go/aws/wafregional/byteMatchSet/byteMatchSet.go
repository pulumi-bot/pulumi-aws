...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/wafregional/ByteMatchSetByteMatchTuple"
...
type ByteMatchSet struct {
	...
	ByteMatchTuples wafregionalByteMatchSetByteMatchTuple.ByteMatchSetByteMatchTupleArrayOutput `pulumi:"byteMatchTuples"`
...
type byteMatchSetState struct {
	// Settings for the ByteMatchSet, such as the bytes (typically a string that corresponds with ASCII characters) that you want AWS WAF to search for in web requests. ByteMatchTuple documented below.
	ByteMatchTuples []wafregionalByteMatchSetByteMatchTuple.ByteMatchSetByteMatchTuple `pulumi:"byteMatchTuples"`
	// The name or description of the ByteMatchSet.
...
type ByteMatchSetState struct {
	// Settings for the ByteMatchSet, such as the bytes (typically a string that corresponds with ASCII characters) that you want AWS WAF to search for in web requests. ByteMatchTuple documented below.
	ByteMatchTuples wafregionalByteMatchSetByteMatchTuple.ByteMatchSetByteMatchTupleArrayInput
	// The name or description of the ByteMatchSet.
