...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/wafregional/IpSetIpSetDescriptor"
)
...
type IpSet struct {
	...
	IpSetDescriptors wafregionalIpSetIpSetDescriptor.IpSetIpSetDescriptorArrayOutput `pulumi:"ipSetDescriptors"`
...
type ipSetState struct {
	...
	// One or more pairs specifying the IP address type (IPV4 or IPV6) and the IP address range (in CIDR notation) from which web requests originate.
	IpSetDescriptors []wafregionalIpSetIpSetDescriptor.IpSetIpSetDescriptor `pulumi:"ipSetDescriptors"`
	// The name or description of the IPSet.
...
type IpSetState struct {
	...
	// One or more pairs specifying the IP address type (IPV4 or IPV6) and the IP address range (in CIDR notation) from which web requests originate.
	IpSetDescriptors wafregionalIpSetIpSetDescriptor.IpSetIpSetDescriptorArrayInput
	// The name or description of the IPSet.
