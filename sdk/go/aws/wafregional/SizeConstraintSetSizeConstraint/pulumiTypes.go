...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/wafregional/SizeConstraintSetSizeConstraintFieldToMatch"
)
...
type SizeConstraintSetSizeConstraint struct {
	...
	FieldToMatch wafregionalSizeConstraintSetSizeConstraintFieldToMatch.SizeConstraintSetSizeConstraintFieldToMatch `pulumi:"fieldToMatch"`
...
type SizeConstraintSetSizeConstraintArgs struct {
	...
	// Specifies where in a web request to look for the size constraint.
	FieldToMatch wafregionalSizeConstraintSetSizeConstraintFieldToMatch.SizeConstraintSetSizeConstraintFieldToMatchInput `pulumi:"fieldToMatch"`
	// The size in bytes that you want to compare against the size of the specified `fieldToMatch`.
	// Valid values are between 0 - 21474836480 bytes (0 - 20 GB).
...
// Specifies where in a web request to look for the size constraint.
func (o SizeConstraintSetSizeConstraintOutput) FieldToMatch() wafregionalSizeConstraintSetSizeConstraintFieldToMatch.SizeConstraintSetSizeConstraintFieldToMatchOutput {
	return o.ApplyT(func (v SizeConstraintSetSizeConstraint) wafregionalSizeConstraintSetSizeConstraintFieldToMatch.SizeConstraintSetSizeConstraintFieldToMatch { return v.FieldToMatch }).(wafregionalSizeConstraintSetSizeConstraintFieldToMatch.SizeConstraintSetSizeConstraintFieldToMatchOutput)
}
