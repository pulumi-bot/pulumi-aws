...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/wafregional/RateBasedRulePredicate"
)
...
type RateBasedRule struct {
	...
	Predicates wafregionalRateBasedRulePredicate.RateBasedRulePredicateArrayOutput `pulumi:"predicates"`
	// Valid value is IP.
...
type rateBasedRuleState struct {
	...
	// The objects to include in a rule (documented below).
	Predicates []wafregionalRateBasedRulePredicate.RateBasedRulePredicate `pulumi:"predicates"`
	// Valid value is IP.
...
type RateBasedRuleState struct {
	...
	// The objects to include in a rule (documented below).
	Predicates wafregionalRateBasedRulePredicate.RateBasedRulePredicateArrayInput
	// Valid value is IP.
