...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/wafregional/GeoMatchSetGeoMatchConstraint"
)
...
type GeoMatchSet struct {
	...
	GeoMatchConstraints wafregionalGeoMatchSetGeoMatchConstraint.GeoMatchSetGeoMatchConstraintArrayOutput `pulumi:"geoMatchConstraints"`
...
type geoMatchSetState struct {
	// The Geo Match Constraint objects which contain the country that you want AWS WAF to search for.
	GeoMatchConstraints []wafregionalGeoMatchSetGeoMatchConstraint.GeoMatchSetGeoMatchConstraint `pulumi:"geoMatchConstraints"`
	// The name or description of the Geo Match Set.
...
type GeoMatchSetState struct {
	// The Geo Match Constraint objects which contain the country that you want AWS WAF to search for.
	GeoMatchConstraints wafregionalGeoMatchSetGeoMatchConstraint.GeoMatchSetGeoMatchConstraintArrayInput
	// The name or description of the Geo Match Set.
