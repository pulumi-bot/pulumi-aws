...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/wafregional/SqlInjectionMatchSetSqlInjectionMatchTupleFieldToMatch"
)

type SqlInjectionMatchSetSqlInjectionMatchTuple struct {
	// Specifies where in a web request to look for snippets of malicious SQL code.
	FieldToMatch wafregionalSqlInjectionMatchSetSqlInjectionMatchTupleFieldToMatch.SqlInjectionMatchSetSqlInjectionMatchTupleFieldToMatch `pulumi:"fieldToMatch"`
...
type SqlInjectionMatchSetSqlInjectionMatchTupleArgs struct {
	// Specifies where in a web request to look for snippets of malicious SQL code.
	FieldToMatch wafregionalSqlInjectionMatchSetSqlInjectionMatchTupleFieldToMatch.SqlInjectionMatchSetSqlInjectionMatchTupleFieldToMatchInput `pulumi:"fieldToMatch"`
	// Text transformations used to eliminate unusual formatting that attackers use in web requests in an effort to bypass AWS WAF.
	// If you specify a transformation, AWS WAF performs the transformation on `fieldToMatch` before inspecting a request for a match.
	// e.g. `CMD_LINE`, `HTML_ENTITY_DECODE` or `NONE`.
	// See [docs](https://docs.aws.amazon.com/waf/latest/APIReference/API_regional_SqlInjectionMatchTuple.html#WAF-Type-regional_SqlInjectionMatchTuple-TextTransformation)
...
// Specifies where in a web request to look for snippets of malicious SQL code.
func (o SqlInjectionMatchSetSqlInjectionMatchTupleOutput) FieldToMatch() wafregionalSqlInjectionMatchSetSqlInjectionMatchTupleFieldToMatch.SqlInjectionMatchSetSqlInjectionMatchTupleFieldToMatchOutput {
	return o.ApplyT(func (v SqlInjectionMatchSetSqlInjectionMatchTuple) wafregionalSqlInjectionMatchSetSqlInjectionMatchTupleFieldToMatch.SqlInjectionMatchSetSqlInjectionMatchTupleFieldToMatch { return v.FieldToMatch }).(wafregionalSqlInjectionMatchSetSqlInjectionMatchTupleFieldToMatch.SqlInjectionMatchSetSqlInjectionMatchTupleFieldToMatchOutput)
}
