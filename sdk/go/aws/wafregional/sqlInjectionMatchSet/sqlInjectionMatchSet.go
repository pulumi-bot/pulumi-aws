...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/wafregional/SqlInjectionMatchSetSqlInjectionMatchTuple"
...
type SqlInjectionMatchSet struct {
	...
	SqlInjectionMatchTuples wafregionalSqlInjectionMatchSetSqlInjectionMatchTuple.SqlInjectionMatchSetSqlInjectionMatchTupleArrayOutput `pulumi:"sqlInjectionMatchTuples"`
}
...
type sqlInjectionMatchSetState struct {
	...
	// The parts of web requests that you want AWS WAF to inspect for malicious SQL code and, if you want AWS WAF to inspect a header, the name of the header.
	SqlInjectionMatchTuples []wafregionalSqlInjectionMatchSetSqlInjectionMatchTuple.SqlInjectionMatchSetSqlInjectionMatchTuple `pulumi:"sqlInjectionMatchTuples"`
}
...
type SqlInjectionMatchSetState struct {
	...
	// The parts of web requests that you want AWS WAF to inspect for malicious SQL code and, if you want AWS WAF to inspect a header, the name of the header.
	SqlInjectionMatchTuples wafregionalSqlInjectionMatchSetSqlInjectionMatchTuple.SqlInjectionMatchSetSqlInjectionMatchTupleArrayInput
}
