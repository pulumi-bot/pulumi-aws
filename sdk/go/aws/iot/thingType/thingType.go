...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/iot/ThingTypeProperties"
)
...
type ThingType struct {
	...
	Properties iotThingTypeProperties.ThingTypePropertiesPtrOutput `pulumi:"properties"`
}
...
type thingTypeState struct {
	...
	// , Configuration block that can contain the following properties of the thing type:
	Properties *iotThingTypeProperties.ThingTypeProperties `pulumi:"properties"`
}
...
type ThingTypeState struct {
	...
	// , Configuration block that can contain the following properties of the thing type:
	Properties iotThingTypeProperties.ThingTypePropertiesPtrInput
}
