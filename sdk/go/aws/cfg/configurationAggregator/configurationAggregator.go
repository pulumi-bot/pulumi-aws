...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/cfg/ConfigurationAggregatorAccountAggregationSource"
	"https:/github.com/pulumi/pulumi-aws/cfg/ConfigurationAggregatorOrganizationAggregationSource"
)
...
type ConfigurationAggregator struct {
	...
	AccountAggregationSource cfgConfigurationAggregatorAccountAggregationSource.ConfigurationAggregatorAccountAggregationSourcePtrOutput `pulumi:"accountAggregationSource"`
	// The ARN of the aggregator
	Arn pulumi.StringOutput `pulumi:"arn"`
	// The name of the configuration aggregator.
	Name pulumi.StringOutput `pulumi:"name"`
	// The organization to aggregate config data from as documented below.
	OrganizationAggregationSource cfgConfigurationAggregatorOrganizationAggregationSource.ConfigurationAggregatorOrganizationAggregationSourcePtrOutput `pulumi:"organizationAggregationSource"`
...
type configurationAggregatorState struct {
	// The account(s) to aggregate config data from as documented below.
	AccountAggregationSource *cfgConfigurationAggregatorAccountAggregationSource.ConfigurationAggregatorAccountAggregationSource `pulumi:"accountAggregationSource"`
	// The ARN of the aggregator
	Arn *string `pulumi:"arn"`
	// The name of the configuration aggregator.
	Name *string `pulumi:"name"`
	// The organization to aggregate config data from as documented below.
	OrganizationAggregationSource *cfgConfigurationAggregatorOrganizationAggregationSource.ConfigurationAggregatorOrganizationAggregationSource `pulumi:"organizationAggregationSource"`
	// A mapping of tags to assign to the resource.
...
type ConfigurationAggregatorState struct {
	// The account(s) to aggregate config data from as documented below.
	AccountAggregationSource cfgConfigurationAggregatorAccountAggregationSource.ConfigurationAggregatorAccountAggregationSourcePtrInput
	// The ARN of the aggregator
	Arn pulumi.StringPtrInput
	// The name of the configuration aggregator.
	Name pulumi.StringPtrInput
	// The organization to aggregate config data from as documented below.
	OrganizationAggregationSource cfgConfigurationAggregatorOrganizationAggregationSource.ConfigurationAggregatorOrganizationAggregationSourcePtrInput
	// A mapping of tags to assign to the resource.
