...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/cfg/RecorderRecordingGroup"
)
...
type Recorder struct {
	...
	RecordingGroup cfgRecorderRecordingGroup.RecorderRecordingGroupOutput `pulumi:"recordingGroup"`
...
type recorderState struct {
	...
	// Recording group - see below.
	RecordingGroup *cfgRecorderRecordingGroup.RecorderRecordingGroup `pulumi:"recordingGroup"`
	// Amazon Resource Name (ARN) of the IAM role.
	// used to make read or write requests to the delivery channel and to describe the AWS resources associated with the account.
	// See [AWS Docs](http://docs.aws.amazon.com/config/latest/developerguide/iamrole-permissions.html) for more details.
...
type RecorderState struct {
	...
	// Recording group - see below.
	RecordingGroup cfgRecorderRecordingGroup.RecorderRecordingGroupPtrInput
	// Amazon Resource Name (ARN) of the IAM role.
	// used to make read or write requests to the delivery channel and to describe the AWS resources associated with the account.
	// See [AWS Docs](http://docs.aws.amazon.com/config/latest/developerguide/iamrole-permissions.html) for more details.
