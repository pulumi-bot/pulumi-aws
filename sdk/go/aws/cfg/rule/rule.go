...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/cfg/RuleScope"
	"https:/github.com/pulumi/pulumi-aws/cfg/RuleSource"
...
type Rule struct {
	...
	Scope cfgRuleScope.RuleScopePtrOutput `pulumi:"scope"`
	// Source specifies the rule owner, the rule identifier, and the notifications that cause
	// the function to evaluate your AWS resources as documented below.
	Source cfgRuleSource.RuleSourceOutput `pulumi:"source"`
...
type ruleState struct {
	...
	// Scope defines which resources can trigger an evaluation for the rule as documented below.
	Scope *cfgRuleScope.RuleScope `pulumi:"scope"`
	// Source specifies the rule owner, the rule identifier, and the notifications that cause
	// the function to evaluate your AWS resources as documented below.
	Source *cfgRuleSource.RuleSource `pulumi:"source"`
	// A mapping of tags to assign to the resource.
...
type RuleState struct {
	...
	// Scope defines which resources can trigger an evaluation for the rule as documented below.
	Scope cfgRuleScope.RuleScopePtrInput
	// Source specifies the rule owner, the rule identifier, and the notifications that cause
	// the function to evaluate your AWS resources as documented below.
	Source cfgRuleSource.RuleSourcePtrInput
	// A mapping of tags to assign to the resource.
...
type RuleArgs struct {
	...
	// Source specifies the rule owner, the rule identifier, and the notifications that cause
	// the function to evaluate your AWS resources as documented below.
	Source cfgRuleSource.RuleSourceInput
	// A mapping of tags to assign to the resource.
	Tags pulumi.MapInput
}
