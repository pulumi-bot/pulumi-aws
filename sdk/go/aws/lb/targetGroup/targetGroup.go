...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/lb/TargetGroupHealthCheck"
	"https:/github.com/pulumi/pulumi-aws/lb/TargetGroupStickiness"
)
...
type TargetGroup struct {
	...
	HealthCheck lbTargetGroupHealthCheck.TargetGroupHealthCheckOutput `pulumi:"healthCheck"`
	...
	Stickiness lbTargetGroupStickiness.TargetGroupStickinessOutput `pulumi:"stickiness"`
...
type targetGroupState struct {
	...
	// A Health Check block. Health Check blocks are documented below.
	HealthCheck *lbTargetGroupHealthCheck.TargetGroupHealthCheck `pulumi:"healthCheck"`
	// Boolean whether the request and response headers exchanged between the load balancer and the Lambda function include arrays of values or strings. Only applies when `targetType` is `lambda`.
	...
	// A Stickiness block. Stickiness blocks are documented below. `stickiness` is only valid if used with Load Balancers of type `Application`
	Stickiness *lbTargetGroupStickiness.TargetGroupStickiness `pulumi:"stickiness"`
	// A mapping of tags to assign to the resource.
...
type TargetGroupState struct {
	...
	// A Health Check block. Health Check blocks are documented below.
	HealthCheck lbTargetGroupHealthCheck.TargetGroupHealthCheckPtrInput
	// Boolean whether the request and response headers exchanged between the load balancer and the Lambda function include arrays of values or strings. Only applies when `targetType` is `lambda`.
	...
	// A Stickiness block. Stickiness blocks are documented below. `stickiness` is only valid if used with Load Balancers of type `Application`
	Stickiness lbTargetGroupStickiness.TargetGroupStickinessPtrInput
	// A mapping of tags to assign to the resource.
