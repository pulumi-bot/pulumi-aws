...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/lb/ListenerRuleAction"
	...
	"https:/github.com/pulumi/pulumi-aws/lb/ListenerRuleCondition"
...
type ListenerRule struct {
	...
	Actions lbListenerRuleAction.ListenerRuleActionArrayOutput `pulumi:"actions"`
	// The ARN of the rule (matches `id`)
	Arn pulumi.StringOutput `pulumi:"arn"`
	// A Condition block. Multiple condition blocks of different types can be set and all must be satisfied for the rule to match. Condition blocks are documented below.
	Conditions lbListenerRuleCondition.ListenerRuleConditionArrayOutput `pulumi:"conditions"`
...
type listenerRuleState struct {
	// An Action block. Action blocks are documented below.
	Actions []lbListenerRuleAction.ListenerRuleAction `pulumi:"actions"`
	// The ARN of the rule (matches `id`)
	Arn *string `pulumi:"arn"`
	// A Condition block. Multiple condition blocks of different types can be set and all must be satisfied for the rule to match. Condition blocks are documented below.
	Conditions []lbListenerRuleCondition.ListenerRuleCondition `pulumi:"conditions"`
	// The ARN of the listener to which to attach the rule.
...
type ListenerRuleState struct {
	// An Action block. Action blocks are documented below.
	Actions lbListenerRuleAction.ListenerRuleActionArrayInput
	// The ARN of the rule (matches `id`)
	Arn pulumi.StringPtrInput
	// A Condition block. Multiple condition blocks of different types can be set and all must be satisfied for the rule to match. Condition blocks are documented below.
	Conditions lbListenerRuleCondition.ListenerRuleConditionArrayInput
	// The ARN of the listener to which to attach the rule.
