...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/lb/ListenerDefaultActionAuthenticateCognito"
	"https:/github.com/pulumi/pulumi-aws/lb/ListenerDefaultActionAuthenticateOidc"
	"https:/github.com/pulumi/pulumi-aws/lb/ListenerDefaultActionFixedResponse"
	"https:/github.com/pulumi/pulumi-aws/lb/ListenerDefaultActionRedirect"
)

type ListenerDefaultAction struct {
	AuthenticateCognito *lbListenerDefaultActionAuthenticateCognito.ListenerDefaultActionAuthenticateCognito `pulumi:"authenticateCognito"`
	AuthenticateOidc *lbListenerDefaultActionAuthenticateOidc.ListenerDefaultActionAuthenticateOidc `pulumi:"authenticateOidc"`
	// Information for creating an action that returns a custom HTTP response. Required if `type` is `fixed-response`.
	FixedResponse *lbListenerDefaultActionFixedResponse.ListenerDefaultActionFixedResponse `pulumi:"fixedResponse"`
	Order *int `pulumi:"order"`
	// Information for creating a redirect action. Required if `type` is `redirect`.
	Redirect *lbListenerDefaultActionRedirect.ListenerDefaultActionRedirect `pulumi:"redirect"`
...
type ListenerDefaultActionArgs struct {
	AuthenticateCognito lbListenerDefaultActionAuthenticateCognito.ListenerDefaultActionAuthenticateCognitoPtrInput `pulumi:"authenticateCognito"`
	AuthenticateOidc lbListenerDefaultActionAuthenticateOidc.ListenerDefaultActionAuthenticateOidcPtrInput `pulumi:"authenticateOidc"`
	// Information for creating an action that returns a custom HTTP response. Required if `type` is `fixed-response`.
	FixedResponse lbListenerDefaultActionFixedResponse.ListenerDefaultActionFixedResponsePtrInput `pulumi:"fixedResponse"`
	Order pulumi.IntPtrInput `pulumi:"order"`
	// Information for creating a redirect action. Required if `type` is `redirect`.
	Redirect lbListenerDefaultActionRedirect.ListenerDefaultActionRedirectPtrInput `pulumi:"redirect"`
	// The ARN of the Target Group to which to route traffic. Required if `type` is `forward`.
...
func (o ListenerDefaultActionOutput) AuthenticateCognito() lbListenerDefaultActionAuthenticateCognito.ListenerDefaultActionAuthenticateCognitoPtrOutput {
	return o.ApplyT(func (v ListenerDefaultAction) *lbListenerDefaultActionAuthenticateCognito.ListenerDefaultActionAuthenticateCognito { return v.AuthenticateCognito }).(lbListenerDefaultActionAuthenticateCognito.ListenerDefaultActionAuthenticateCognitoPtrOutput)
}

func (o ListenerDefaultActionOutput) AuthenticateOidc() lbListenerDefaultActionAuthenticateOidc.ListenerDefaultActionAuthenticateOidcPtrOutput {
	return o.ApplyT(func (v ListenerDefaultAction) *lbListenerDefaultActionAuthenticateOidc.ListenerDefaultActionAuthenticateOidc { return v.AuthenticateOidc }).(lbListenerDefaultActionAuthenticateOidc.ListenerDefaultActionAuthenticateOidcPtrOutput)
}

// Information for creating an action that returns a custom HTTP response. Required if `type` is `fixed-response`.
func (o ListenerDefaultActionOutput) FixedResponse() lbListenerDefaultActionFixedResponse.ListenerDefaultActionFixedResponsePtrOutput {
	return o.ApplyT(func (v ListenerDefaultAction) *lbListenerDefaultActionFixedResponse.ListenerDefaultActionFixedResponse { return v.FixedResponse }).(lbListenerDefaultActionFixedResponse.ListenerDefaultActionFixedResponsePtrOutput)
}
...
// Information for creating a redirect action. Required if `type` is `redirect`.
func (o ListenerDefaultActionOutput) Redirect() lbListenerDefaultActionRedirect.ListenerDefaultActionRedirectPtrOutput {
	return o.ApplyT(func (v ListenerDefaultAction) *lbListenerDefaultActionRedirect.ListenerDefaultActionRedirect { return v.Redirect }).(lbListenerDefaultActionRedirect.ListenerDefaultActionRedirectPtrOutput)
}
