...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/lb/getTargetGroupHealthCheck"
	"https:/github.com/pulumi/pulumi-aws/lb/getTargetGroupStickiness"
)
...
type GetTargetGroupResult struct {
	...
	HealthCheck lbgetTargetGroupHealthCheck.GetTargetGroupHealthCheck `pulumi:"healthCheck"`
	...
	Stickiness lbgetTargetGroupStickiness.GetTargetGroupStickiness `pulumi:"stickiness"`
	Tags map[string]interface{} `pulumi:"tags"`
