...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/lb/getLoadBalancerAccessLogs"
	"https:/github.com/pulumi/pulumi-aws/lb/getLoadBalancerSubnetMapping"
)
...
type GetLoadBalancerResult struct {
	AccessLogs lbgetLoadBalancerAccessLogs.GetLoadBalancerAccessLogs `pulumi:"accessLogs"`
	Arn string `pulumi:"arn"`
	...
	SubnetMappings []lbgetLoadBalancerSubnetMapping.GetLoadBalancerSubnetMapping `pulumi:"subnetMappings"`
