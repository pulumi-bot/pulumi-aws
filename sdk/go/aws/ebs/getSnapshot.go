...
// several valid keys, for a full reference, check out
// [describe-snapshots in the AWS CLI reference][1].
func (o LookupSnapshotApplyOutput) Filters() GetSnapshotFilterArrayOutput {
	return o.ApplyT(func(v LookupSnapshotArgs) []GetSnapshotFilter { return v.Filters }).(GetSnapshotFilterArrayOutput)
}
...
// Returns the snapshots owned by the specified owner id. Multiple owners can be specified.
func (o LookupSnapshotApplyOutput) Owners() pulumi.StringArrayOutput {
	return o.ApplyT(func(v LookupSnapshotArgs) []string { return v.Owners }).(pulumi.StringArrayOutput)
}

// One or more AWS accounts IDs that can create volumes from the snapshot.
func (o LookupSnapshotApplyOutput) RestorableByUserIds() pulumi.StringArrayOutput {
	return o.ApplyT(func(v LookupSnapshotArgs) []string { return v.RestorableByUserIds }).(pulumi.StringArrayOutput)
}

// Returns information on a specific snapshot_id.
func (o LookupSnapshotApplyOutput) SnapshotIds() pulumi.StringArrayOutput {
	return o.ApplyT(func(v LookupSnapshotArgs) []string { return v.SnapshotIds }).(pulumi.StringArrayOutput)
}

// A map of tags for the resource.
func (o LookupSnapshotApplyOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v LookupSnapshotArgs) map[string]string { return v.Tags }).(pulumi.StringMapOutput)
}
