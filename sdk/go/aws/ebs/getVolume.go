...
// several valid keys, for a full reference, check out
// [describe-volumes in the AWS CLI reference][1].
func (o LookupVolumeApplyOutput) Filters() GetVolumeFilterArrayOutput {
	return o.ApplyT(func(v LookupVolumeArgs) []GetVolumeFilter { return v.Filters }).(GetVolumeFilterArrayOutput)
}

// If more than one result is returned, use the most
// recent Volume.
func (o LookupVolumeApplyOutput) MostRecent() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupVolumeArgs) *bool { return v.MostRecent }).(pulumi.BoolPtrOutput)
}

// A map of tags for the resource.
func (o LookupVolumeApplyOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v LookupVolumeArgs) map[string]string { return v.Tags }).(pulumi.StringMapOutput)
}
