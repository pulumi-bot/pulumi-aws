...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/codebuild/WebhookFilterGroup"
...
type Webhook struct {
	...
	FilterGroups codebuildWebhookFilterGroup.WebhookFilterGroupArrayOutput `pulumi:"filterGroups"`
...
type webhookState struct {
	...
	// Information about the webhook's trigger. Filter group blocks are documented below.
	FilterGroups []codebuildWebhookFilterGroup.WebhookFilterGroup `pulumi:"filterGroups"`
	// The CodeBuild endpoint where webhook events are sent.
...
type WebhookState struct {
	...
	// Information about the webhook's trigger. Filter group blocks are documented below.
	FilterGroups codebuildWebhookFilterGroup.WebhookFilterGroupArrayInput
	// The CodeBuild endpoint where webhook events are sent.
