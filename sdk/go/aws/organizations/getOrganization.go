...
func LookupOrganizationApply(ctx *pulumi.Context, opts ...pulumi.InvokeOption) LookupOrganizationResultOutput {
	return pulumi.Any(opts).ApplyT(func(v interface{}) (LookupOrganizationResult, error) {
