...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/organizations/OrganizationalUnitAccount"
)
...
type OrganizationalUnit struct {
	...
	Accounts organizationsOrganizationalUnitAccount.OrganizationalUnitAccountArrayOutput `pulumi:"accounts"`
...
type organizationalUnitState struct {
	// List of child accounts for this Organizational Unit. Does not return account information for child Organizational Units. All elements have these attributes:
	Accounts []organizationsOrganizationalUnitAccount.OrganizationalUnitAccount `pulumi:"accounts"`
	// ARN of the organizational unit
...
type OrganizationalUnitState struct {
	// List of child accounts for this Organizational Unit. Does not return account information for child Organizational Units. All elements have these attributes:
	Accounts organizationsOrganizationalUnitAccount.OrganizationalUnitAccountArrayInput
	// ARN of the organizational unit
