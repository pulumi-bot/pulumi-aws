...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/organizations/OrganizationAccount"
	"https:/github.com/pulumi/pulumi-aws/organizations/OrganizationNonMasterAccount"
	"https:/github.com/pulumi/pulumi-aws/organizations/OrganizationRoot"
...
type Organization struct {
	...
	Accounts organizationsOrganizationAccount.OrganizationAccountArrayOutput `pulumi:"accounts"`
	// ARN of the root
	...
	NonMasterAccounts organizationsOrganizationNonMasterAccount.OrganizationNonMasterAccountArrayOutput `pulumi:"nonMasterAccounts"`
	// List of organization roots. All elements have these attributes:
	Roots organizationsOrganizationRoot.OrganizationRootArrayOutput `pulumi:"roots"`
}
...
type organizationState struct {
	// List of organization accounts including the master account. For a list excluding the master account, see the `nonMasterAccounts` attribute. All elements have these attributes:
	Accounts []organizationsOrganizationAccount.OrganizationAccount `pulumi:"accounts"`
	// ARN of the root
	...
	// List of organization accounts excluding the master account. For a list including the master account, see the `accounts` attribute. All elements have these attributes:
	NonMasterAccounts []organizationsOrganizationNonMasterAccount.OrganizationNonMasterAccount `pulumi:"nonMasterAccounts"`
	// List of organization roots. All elements have these attributes:
	Roots []organizationsOrganizationRoot.OrganizationRoot `pulumi:"roots"`
}

type OrganizationState struct {
	// List of organization accounts including the master account. For a list excluding the master account, see the `nonMasterAccounts` attribute. All elements have these attributes:
	Accounts organizationsOrganizationAccount.OrganizationAccountArrayInput
	// ARN of the root
	...
	// List of organization accounts excluding the master account. For a list including the master account, see the `accounts` attribute. All elements have these attributes:
	NonMasterAccounts organizationsOrganizationNonMasterAccount.OrganizationNonMasterAccountArrayInput
	// List of organization roots. All elements have these attributes:
	Roots organizationsOrganizationRoot.OrganizationRootArrayInput
}
