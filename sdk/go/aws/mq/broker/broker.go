...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/mq/BrokerConfiguration"
	"https:/github.com/pulumi/pulumi-aws/mq/BrokerEncryptionOptions"
	"https:/github.com/pulumi/pulumi-aws/mq/BrokerInstance"
	"https:/github.com/pulumi/pulumi-aws/mq/BrokerLogs"
	"https:/github.com/pulumi/pulumi-aws/mq/BrokerMaintenanceWindowStartTime"
	"https:/github.com/pulumi/pulumi-aws/mq/BrokerUser"
)
...
type Broker struct {
	...
	Configuration mqBrokerConfiguration.BrokerConfigurationOutput `pulumi:"configuration"`
	...
	EncryptionOptions mqBrokerEncryptionOptions.BrokerEncryptionOptionsPtrOutput `pulumi:"encryptionOptions"`
	...
	Instances mqBrokerInstance.BrokerInstanceArrayOutput `pulumi:"instances"`
	// Logging configuration of the broker. See below.
	Logs mqBrokerLogs.BrokerLogsPtrOutput `pulumi:"logs"`
	// Maintenance window start time. See below.
	MaintenanceWindowStartTime mqBrokerMaintenanceWindowStartTime.BrokerMaintenanceWindowStartTimeOutput `pulumi:"maintenanceWindowStartTime"`
	...
	Users mqBrokerUser.BrokerUserArrayOutput `pulumi:"users"`
}
...
type brokerState struct {
	...
	// Configuration of the broker. See below.
	Configuration *mqBrokerConfiguration.BrokerConfiguration `pulumi:"configuration"`
	// The deployment mode of the broker. Supported: `SINGLE_INSTANCE` and `ACTIVE_STANDBY_MULTI_AZ`. Defaults to `SINGLE_INSTANCE`.
	DeploymentMode *string `pulumi:"deploymentMode"`
	// Configuration block containing encryption options. See below.
	EncryptionOptions *mqBrokerEncryptionOptions.BrokerEncryptionOptions `pulumi:"encryptionOptions"`
	// The type of broker engine. Currently, Amazon MQ supports only `ActiveMQ`.
	...
	// * `mqtt+ssl://broker-id.mq.us-west-2.amazonaws.com:8883`
	// * `wss://broker-id.mq.us-west-2.amazonaws.com:61619`
	Instances []mqBrokerInstance.BrokerInstance `pulumi:"instances"`
	// Logging configuration of the broker. See below.
	Logs *mqBrokerLogs.BrokerLogs `pulumi:"logs"`
	// Maintenance window start time. See below.
	MaintenanceWindowStartTime *mqBrokerMaintenanceWindowStartTime.BrokerMaintenanceWindowStartTime `pulumi:"maintenanceWindowStartTime"`
	// Whether to enable connections from applications outside of the VPC that hosts the broker's subnets.
	...
	// The list of all ActiveMQ usernames for the specified broker. See below.
	Users []mqBrokerUser.BrokerUser `pulumi:"users"`
}
...
type BrokerState struct {
	...
	// Configuration of the broker. See below.
	Configuration mqBrokerConfiguration.BrokerConfigurationPtrInput
	// The deployment mode of the broker. Supported: `SINGLE_INSTANCE` and `ACTIVE_STANDBY_MULTI_AZ`. Defaults to `SINGLE_INSTANCE`.
	DeploymentMode pulumi.StringPtrInput
	// Configuration block containing encryption options. See below.
	EncryptionOptions mqBrokerEncryptionOptions.BrokerEncryptionOptionsPtrInput
	// The type of broker engine. Currently, Amazon MQ supports only `ActiveMQ`.
	...
	// * `mqtt+ssl://broker-id.mq.us-west-2.amazonaws.com:8883`
	// * `wss://broker-id.mq.us-west-2.amazonaws.com:61619`
	Instances mqBrokerInstance.BrokerInstanceArrayInput
	// Logging configuration of the broker. See below.
	Logs mqBrokerLogs.BrokerLogsPtrInput
	// Maintenance window start time. See below.
	MaintenanceWindowStartTime mqBrokerMaintenanceWindowStartTime.BrokerMaintenanceWindowStartTimePtrInput
	// Whether to enable connections from applications outside of the VPC that hosts the broker's subnets.
	...
	// The list of all ActiveMQ usernames for the specified broker. See below.
	Users mqBrokerUser.BrokerUserArrayInput
}
