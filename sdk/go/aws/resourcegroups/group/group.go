...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/resourcegroups/GroupResourceQuery"
)
...
type Group struct {
	...
	ResourceQuery resourcegroupsGroupResourceQuery.GroupResourceQueryOutput `pulumi:"resourceQuery"`
...
type groupState struct {
	...
	// A `resourceQuery` block. Resource queries are documented below.
	ResourceQuery *resourcegroupsGroupResourceQuery.GroupResourceQuery `pulumi:"resourceQuery"`
	// Key-value mapping of resource tags
...
type GroupState struct {
	...
	// A `resourceQuery` block. Resource queries are documented below.
	ResourceQuery resourcegroupsGroupResourceQuery.GroupResourceQueryPtrInput
	// Key-value mapping of resource tags
...
type GroupArgs struct {
	...
	Name pulumi.StringPtrInput
	// A `resourceQuery` block. Resource queries are documented below.
	ResourceQuery resourcegroupsGroupResourceQuery.GroupResourceQueryInput
	// Key-value mapping of resource tags
	Tags pulumi.MapInput
}
