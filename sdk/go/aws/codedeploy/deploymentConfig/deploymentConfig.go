...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/codedeploy/DeploymentConfigMinimumHealthyHosts"
	"https:/github.com/pulumi/pulumi-aws/codedeploy/DeploymentConfigTrafficRoutingConfig"
...
type DeploymentConfig struct {
	...
	MinimumHealthyHosts codedeployDeploymentConfigMinimumHealthyHosts.DeploymentConfigMinimumHealthyHostsPtrOutput `pulumi:"minimumHealthyHosts"`
	// A trafficRoutingConfig block. Traffic Routing Config is documented below.
	TrafficRoutingConfig codedeployDeploymentConfigTrafficRoutingConfig.DeploymentConfigTrafficRoutingConfigPtrOutput `pulumi:"trafficRoutingConfig"`
}
...
type deploymentConfigState struct {
	...
	// A minimumHealthyHosts block. Minimum Healthy Hosts are documented below.
	MinimumHealthyHosts *codedeployDeploymentConfigMinimumHealthyHosts.DeploymentConfigMinimumHealthyHosts `pulumi:"minimumHealthyHosts"`
	// A trafficRoutingConfig block. Traffic Routing Config is documented below.
	TrafficRoutingConfig *codedeployDeploymentConfigTrafficRoutingConfig.DeploymentConfigTrafficRoutingConfig `pulumi:"trafficRoutingConfig"`
}
...
type DeploymentConfigState struct {
	...
	// A minimumHealthyHosts block. Minimum Healthy Hosts are documented below.
	MinimumHealthyHosts codedeployDeploymentConfigMinimumHealthyHosts.DeploymentConfigMinimumHealthyHostsPtrInput
	// A trafficRoutingConfig block. Traffic Routing Config is documented below.
	TrafficRoutingConfig codedeployDeploymentConfigTrafficRoutingConfig.DeploymentConfigTrafficRoutingConfigPtrInput
}
