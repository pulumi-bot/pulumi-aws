...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/redshift/ClusterLogging"
	"https:/github.com/pulumi/pulumi-aws/redshift/ClusterSnapshotCopy"
)
...
type Cluster struct {
	...
	Logging redshiftClusterLogging.ClusterLoggingPtrOutput `pulumi:"logging"`
	...
	SnapshotCopy redshiftClusterSnapshotCopy.ClusterSnapshotCopyPtrOutput `pulumi:"snapshotCopy"`
...
type clusterState struct {
	...
	// Logging, documented below.
	Logging *redshiftClusterLogging.ClusterLogging `pulumi:"logging"`
	// Password for the master DB user.
	// Note that this may show up in logs, and it will be stored in the state file. Password must contain at least 8 chars and
	// contain at least one uppercase letter, one lowercase letter, and one number.
	...
	// Configuration of automatic copy of snapshots from one region to another. Documented below.
	SnapshotCopy *redshiftClusterSnapshotCopy.ClusterSnapshotCopy `pulumi:"snapshotCopy"`
	// The name of the snapshot from which to create the new cluster.
...
type ClusterState struct {
	...
	// Logging, documented below.
	Logging redshiftClusterLogging.ClusterLoggingPtrInput
	// Password for the master DB user.
	// Note that this may show up in logs, and it will be stored in the state file. Password must contain at least 8 chars and
	// contain at least one uppercase letter, one lowercase letter, and one number.
	...
	// Configuration of automatic copy of snapshots from one region to another. Documented below.
	SnapshotCopy redshiftClusterSnapshotCopy.ClusterSnapshotCopyPtrInput
	// The name of the snapshot from which to create the new cluster.
