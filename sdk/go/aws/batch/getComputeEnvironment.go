...
func LookupComputeEnvironmentApply(ctx *pulumi.Context, args LookupComputeEnvironmentApplyInput, opts ...pulumi.InvokeOption) LookupComputeEnvironmentResultOutput {
	return args.ToLookupComputeEnvironmentApplyOutput().ApplyT(func(v LookupComputeEnvironmentArgs) (LookupComputeEnvironmentResult, error) {
		r, err := LookupComputeEnvironment(ctx, &v, opts...)
		return *r, err

	}).(LookupComputeEnvironmentResultOutput)
}

// LookupComputeEnvironmentApplyInput is an input type that accepts LookupComputeEnvironmentApplyArgs and LookupComputeEnvironmentApplyOutput values.
// You can construct a concrete instance of `LookupComputeEnvironmentApplyInput` via:
//
//          LookupComputeEnvironmentApplyArgs{...}
type LookupComputeEnvironmentApplyInput interface {
	pulumi.Input

	ToLookupComputeEnvironmentApplyOutput() LookupComputeEnvironmentApplyOutput
	ToLookupComputeEnvironmentApplyOutputWithContext(context.Context) LookupComputeEnvironmentApplyOutput
}

// A collection of arguments for invoking getComputeEnvironment.
type LookupComputeEnvironmentApplyArgs struct {
	// The name of the Batch Compute Environment
...
func (LookupComputeEnvironmentApplyArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupComputeEnvironmentArgs)(nil)).Elem()
}

func (i LookupComputeEnvironmentApplyArgs) ToLookupComputeEnvironmentApplyOutput() LookupComputeEnvironmentApplyOutput {
	return i.ToLookupComputeEnvironmentApplyOutputWithContext(context.Background())
}

func (i LookupComputeEnvironmentApplyArgs) ToLookupComputeEnvironmentApplyOutputWithContext(ctx context.Context) LookupComputeEnvironmentApplyOutput {
	return pulumi.ToOutputWithContext(ctx, i).(LookupComputeEnvironmentApplyOutput)
}

// A collection of arguments for invoking getComputeEnvironment.
type LookupComputeEnvironmentApplyOutput struct{ *pulumi.OutputState }

func (LookupComputeEnvironmentApplyOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupComputeEnvironmentArgs)(nil)).Elem()
}

func (o LookupComputeEnvironmentApplyOutput) ToLookupComputeEnvironmentApplyOutput() LookupComputeEnvironmentApplyOutput {
	return o
}

func (o LookupComputeEnvironmentApplyOutput) ToLookupComputeEnvironmentApplyOutputWithContext(ctx context.Context) LookupComputeEnvironmentApplyOutput {
	return o
}

// The name of the Batch Compute Environment
func (o LookupComputeEnvironmentApplyOutput) ComputeEnvironmentName() pulumi.StringOutput {
	return o.ApplyT(func(v LookupComputeEnvironmentArgs) string { return v.ComputeEnvironmentName }).(pulumi.StringOutput)
}

// Key-value map of resource tags
func (o LookupComputeEnvironmentApplyOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v LookupComputeEnvironmentArgs) map[string]string { return v.Tags }).(pulumi.StringMapOutput)
}
...
func init() {
	pulumi.RegisterOutputType(LookupComputeEnvironmentApplyOutput{})
