...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/batch/ComputeEnvironmentComputeResources"
...
type ComputeEnvironment struct {
	...
	ComputeResources batchComputeEnvironmentComputeResources.ComputeEnvironmentComputeResourcesPtrOutput `pulumi:"computeResources"`
...
type computeEnvironmentState struct {
	...
	// Details of the compute resources managed by the compute environment. This parameter is required for managed compute environments. See details below.
	ComputeResources *batchComputeEnvironmentComputeResources.ComputeEnvironmentComputeResources `pulumi:"computeResources"`
	// The Amazon Resource Name (ARN) of the underlying Amazon ECS cluster used by the compute environment.
...
type ComputeEnvironmentState struct {
	...
	// Details of the compute resources managed by the compute environment. This parameter is required for managed compute environments. See details below.
	ComputeResources batchComputeEnvironmentComputeResources.ComputeEnvironmentComputeResourcesPtrInput
	// The Amazon Resource Name (ARN) of the underlying Amazon ECS cluster used by the compute environment.
