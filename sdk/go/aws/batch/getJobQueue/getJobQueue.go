...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/batch/getJobQueueComputeEnvironmentOrder"
)
...
func GetJobQueue(ctx *pulumi.Context, args *GetJobQueueArgs, opts ...pulumi.InvokeOption) (*GetJobQueueResult, error) {
...
type GetJobQueueResult struct {
	...
	ComputeEnvironmentOrders []batchgetJobQueueComputeEnvironmentOrder.GetJobQueueComputeEnvironmentOrder `pulumi:"computeEnvironmentOrders"`
