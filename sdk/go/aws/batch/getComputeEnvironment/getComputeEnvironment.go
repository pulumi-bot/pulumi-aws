...
func GetComputeEnvironment(ctx *pulumi.Context, args *GetComputeEnvironmentArgs, opts ...pulumi.InvokeOption) (*GetComputeEnvironmentResult, error) {
