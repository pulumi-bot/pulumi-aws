...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/batch/JobDefinitionRetryStrategy"
	"https:/github.com/pulumi/pulumi-aws/batch/JobDefinitionTimeout"
)
...
type JobDefinition struct {
	...
	RetryStrategy batchJobDefinitionRetryStrategy.JobDefinitionRetryStrategyPtrOutput `pulumi:"retryStrategy"`
	// The revision of the job definition.
	Revision pulumi.IntOutput `pulumi:"revision"`
	// Specifies the timeout for jobs so that if a job runs longer, AWS Batch terminates the job. Maximum number of `timeout` is `1`. Defined below.
	Timeout batchJobDefinitionTimeout.JobDefinitionTimeoutPtrOutput `pulumi:"timeout"`
...
type jobDefinitionState struct {
	...
	// Specifies the retry strategy to use for failed jobs that are submitted with this job definition.
	// Maximum number of `retryStrategy` is `1`.  Defined below.
	RetryStrategy *batchJobDefinitionRetryStrategy.JobDefinitionRetryStrategy `pulumi:"retryStrategy"`
	// The revision of the job definition.
	Revision *int `pulumi:"revision"`
	// Specifies the timeout for jobs so that if a job runs longer, AWS Batch terminates the job. Maximum number of `timeout` is `1`. Defined below.
	Timeout *batchJobDefinitionTimeout.JobDefinitionTimeout `pulumi:"timeout"`
	// The type of job definition.  Must be `container`
...
type JobDefinitionState struct {
	...
	// Specifies the retry strategy to use for failed jobs that are submitted with this job definition.
	// Maximum number of `retryStrategy` is `1`.  Defined below.
	RetryStrategy batchJobDefinitionRetryStrategy.JobDefinitionRetryStrategyPtrInput
	// The revision of the job definition.
	Revision pulumi.IntPtrInput
	// Specifies the timeout for jobs so that if a job runs longer, AWS Batch terminates the job. Maximum number of `timeout` is `1`. Defined below.
	Timeout batchJobDefinitionTimeout.JobDefinitionTimeoutPtrInput
	// The type of job definition.  Must be `container`
