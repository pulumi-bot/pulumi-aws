...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/getAmiBlockDeviceMapping"
	"https:/github.com/pulumi/pulumi-aws/getAmiFilter"
	"https:/github.com/pulumi/pulumi-aws/getAmiProductCode"
)
...
type GetAmiArgs struct {
	...
	Filters []getAmiFilter.GetAmiFilter `pulumi:"filters"`
...
type GetAmiResult struct {
	...
	// instance stores).
	BlockDeviceMappings []getAmiBlockDeviceMapping.GetAmiBlockDeviceMapping `pulumi:"blockDeviceMappings"`
	...
	ProductCodes []getAmiProductCode.GetAmiProductCode `pulumi:"productCodes"`
