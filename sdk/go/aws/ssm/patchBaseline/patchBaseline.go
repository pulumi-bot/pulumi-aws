...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/ssm/PatchBaselineApprovalRule"
	"https:/github.com/pulumi/pulumi-aws/ssm/PatchBaselineApprovalRulePatchFilter"
	"https:/github.com/pulumi/pulumi-aws/ssm/PatchBaselineGlobalFilter"
)
...
type PatchBaseline struct {
	...
	ApprovalRules ssmPatchBaselineApprovalRule.PatchBaselineApprovalRuleArrayOutput `pulumi:"approvalRules"`
	...
	GlobalFilters ssmPatchBaselineGlobalFilter.PatchBaselineGlobalFilterArrayOutput `pulumi:"globalFilters"`
...
type patchBaselineState struct {
	// A set of rules used to include patches in the baseline. up to 10 approval rules can be specified. Each approvalRule block requires the fields documented below.
	ApprovalRules []ssmPatchBaselineApprovalRule.PatchBaselineApprovalRule `pulumi:"approvalRules"`
	// A list of explicitly approved patches for the baseline.
	...
	// A set of global filters used to exclude patches from the baseline. Up to 4 global filters can be specified using Key/Value pairs. Valid Keys are `PRODUCT | CLASSIFICATION | MSRC_SEVERITY | PATCH_ID`.
	GlobalFilters []ssmPatchBaselineGlobalFilter.PatchBaselineGlobalFilter `pulumi:"globalFilters"`
	// The name of the patch baseline.
...
type PatchBaselineState struct {
	// A set of rules used to include patches in the baseline. up to 10 approval rules can be specified. Each approvalRule block requires the fields documented below.
	ApprovalRules ssmPatchBaselineApprovalRule.PatchBaselineApprovalRuleArrayInput
	// A list of explicitly approved patches for the baseline.
	...
	// A set of global filters used to exclude patches from the baseline. Up to 4 global filters can be specified using Key/Value pairs. Valid Keys are `PRODUCT | CLASSIFICATION | MSRC_SEVERITY | PATCH_ID`.
	GlobalFilters ssmPatchBaselineGlobalFilter.PatchBaselineGlobalFilterArrayInput
	// The name of the patch baseline.
