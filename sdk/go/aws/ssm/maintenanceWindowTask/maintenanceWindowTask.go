...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/ssm/MaintenanceWindowTaskLoggingInfo"
	"https:/github.com/pulumi/pulumi-aws/ssm/MaintenanceWindowTaskTarget"
	"https:/github.com/pulumi/pulumi-aws/ssm/MaintenanceWindowTaskTaskInvocationParameters"
	...
	"https:/github.com/pulumi/pulumi-aws/ssm/MaintenanceWindowTaskTaskParameter"
)
...
type MaintenanceWindowTask struct {
	...
	LoggingInfo ssmMaintenanceWindowTaskLoggingInfo.MaintenanceWindowTaskLoggingInfoPtrOutput `pulumi:"loggingInfo"`
	...
	Targets ssmMaintenanceWindowTaskTarget.MaintenanceWindowTaskTargetArrayOutput `pulumi:"targets"`
	...
	TaskInvocationParameters ssmMaintenanceWindowTaskTaskInvocationParameters.MaintenanceWindowTaskTaskInvocationParametersPtrOutput `pulumi:"taskInvocationParameters"`
	...
	TaskParameters ssmMaintenanceWindowTaskTaskParameter.MaintenanceWindowTaskTaskParameterArrayOutput `pulumi:"taskParameters"`
...
type maintenanceWindowTaskState struct {
	...
	// A structure containing information about an Amazon S3 bucket to write instance-level logs to. Use `taskInvocationParameters` configuration block `runCommandParameters` configuration block `output_s3_*` arguments instead. Conflicts with `taskInvocationParameters`. Documented below.
	LoggingInfo *ssmMaintenanceWindowTaskLoggingInfo.MaintenanceWindowTaskLoggingInfo `pulumi:"loggingInfo"`
	// The maximum number of targets this task can be run for in parallel.
	...
	// The targets (either instances or window target ids). Instances are specified using Key=InstanceIds,Values=instanceid1,instanceid2. Window target ids are specified using Key=WindowTargetIds,Values=window target id1, window target id2.
	Targets []ssmMaintenanceWindowTaskTarget.MaintenanceWindowTaskTarget `pulumi:"targets"`
	// The ARN of the task to execute.
	TaskArn *string `pulumi:"taskArn"`
	// The parameters for task execution. This argument is conflict with `taskParameters` and `loggingInfo`.
	TaskInvocationParameters *ssmMaintenanceWindowTaskTaskInvocationParameters.MaintenanceWindowTaskTaskInvocationParameters `pulumi:"taskInvocationParameters"`
	// A structure containing information about parameters required by the particular `taskArn`. Use `parameter` configuration blocks under the `taskInvocationParameters` configuration block instead. Conflicts with `taskInvocationParameters`. Documented below.
	TaskParameters []ssmMaintenanceWindowTaskTaskParameter.MaintenanceWindowTaskTaskParameter `pulumi:"taskParameters"`
	// The type of task being registered. The only allowed value is `RUN_COMMAND`.
...
type MaintenanceWindowTaskState struct {
	...
	// A structure containing information about an Amazon S3 bucket to write instance-level logs to. Use `taskInvocationParameters` configuration block `runCommandParameters` configuration block `output_s3_*` arguments instead. Conflicts with `taskInvocationParameters`. Documented below.
	LoggingInfo ssmMaintenanceWindowTaskLoggingInfo.MaintenanceWindowTaskLoggingInfoPtrInput
	// The maximum number of targets this task can be run for in parallel.
	...
	// The targets (either instances or window target ids). Instances are specified using Key=InstanceIds,Values=instanceid1,instanceid2. Window target ids are specified using Key=WindowTargetIds,Values=window target id1, window target id2.
	Targets ssmMaintenanceWindowTaskTarget.MaintenanceWindowTaskTargetArrayInput
	// The ARN of the task to execute.
	TaskArn pulumi.StringPtrInput
	// The parameters for task execution. This argument is conflict with `taskParameters` and `loggingInfo`.
	TaskInvocationParameters ssmMaintenanceWindowTaskTaskInvocationParameters.MaintenanceWindowTaskTaskInvocationParametersPtrInput
	// A structure containing information about parameters required by the particular `taskArn`. Use `parameter` configuration blocks under the `taskInvocationParameters` configuration block instead. Conflicts with `taskInvocationParameters`. Documented below.
	TaskParameters ssmMaintenanceWindowTaskTaskParameter.MaintenanceWindowTaskTaskParameterArrayInput
	// The type of task being registered. The only allowed value is `RUN_COMMAND`.
