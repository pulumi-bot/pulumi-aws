...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/ssm/ResourceDataSyncS3Destination"
)
...
type ResourceDataSync struct {
	...
	S3Destination ssmResourceDataSyncS3Destination.ResourceDataSyncS3DestinationOutput `pulumi:"s3Destination"`
}
...
type resourceDataSyncState struct {
	...
	// Amazon S3 configuration details for the sync.
	S3Destination *ssmResourceDataSyncS3Destination.ResourceDataSyncS3Destination `pulumi:"s3Destination"`
}
...
type ResourceDataSyncState struct {
	...
	// Amazon S3 configuration details for the sync.
	S3Destination ssmResourceDataSyncS3Destination.ResourceDataSyncS3DestinationPtrInput
}
...
type ResourceDataSyncArgs struct {
	...
	Name pulumi.StringPtrInput
	// Amazon S3 configuration details for the sync.
	S3Destination ssmResourceDataSyncS3Destination.ResourceDataSyncS3DestinationInput
}
