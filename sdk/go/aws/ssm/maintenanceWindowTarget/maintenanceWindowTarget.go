...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/ssm/MaintenanceWindowTargetTarget"
)
...
type MaintenanceWindowTarget struct {
	...
	Targets ssmMaintenanceWindowTargetTarget.MaintenanceWindowTargetTargetArrayOutput `pulumi:"targets"`
...
type maintenanceWindowTargetState struct {
	...
	// The targets (either instances or tags). Instances are specified using Key=InstanceIds,Values=InstanceId1,InstanceId2. Tags are specified using Key=tag name,Values=tag value.
	Targets []ssmMaintenanceWindowTargetTarget.MaintenanceWindowTargetTarget `pulumi:"targets"`
	// The Id of the maintenance window to register the target with.
...
type MaintenanceWindowTargetState struct {
	...
	// The targets (either instances or tags). Instances are specified using Key=InstanceIds,Values=InstanceId1,InstanceId2. Tags are specified using Key=tag name,Values=tag value.
	Targets ssmMaintenanceWindowTargetTarget.MaintenanceWindowTargetTargetArrayInput
	// The Id of the maintenance window to register the target with.
