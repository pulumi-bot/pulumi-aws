...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/ssm/DocumentParameter"
	"https:/github.com/pulumi/pulumi-aws/ssm/DocumentPermissions"
)
...
type Document struct {
	...
	Parameters ssmDocumentParameter.DocumentParameterArrayOutput `pulumi:"parameters"`
	// Additional Permissions to attach to the document. See Permissions below for details.
	Permissions ssmDocumentPermissions.DocumentPermissionsPtrOutput `pulumi:"permissions"`
...
type documentState struct {
	...
	// The parameters that are available to this document.
	Parameters []ssmDocumentParameter.DocumentParameter `pulumi:"parameters"`
	// Additional Permissions to attach to the document. See Permissions below for details.
	Permissions *ssmDocumentPermissions.DocumentPermissions `pulumi:"permissions"`
	// A list of OS platforms compatible with this SSM document, either "Windows" or "Linux".
...
type DocumentState struct {
	...
	// The parameters that are available to this document.
	Parameters ssmDocumentParameter.DocumentParameterArrayInput
	// Additional Permissions to attach to the document. See Permissions below for details.
	Permissions ssmDocumentPermissions.DocumentPermissionsPtrInput
	// A list of OS platforms compatible with this SSM document, either "Windows" or "Linux".
