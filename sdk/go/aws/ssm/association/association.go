...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/ssm/AssociationOutputLocation"
	"https:/github.com/pulumi/pulumi-aws/ssm/AssociationTarget"
)
...
type Association struct {
	...
	OutputLocation ssmAssociationOutputLocation.AssociationOutputLocationPtrOutput `pulumi:"outputLocation"`
	...
	Targets ssmAssociationTarget.AssociationTargetArrayOutput `pulumi:"targets"`
}
...
type associationState struct {
	...
	// An output location block. Output Location is documented below.
	OutputLocation *ssmAssociationOutputLocation.AssociationOutputLocation `pulumi:"outputLocation"`
	// A block of arbitrary string parameters to pass to the SSM document.
	Parameters map[string]interface{} `pulumi:"parameters"`
	// A cron expression when the association will be applied to the target(s).
	ScheduleExpression *string `pulumi:"scheduleExpression"`
	// A block containing the targets of the SSM association. Targets are documented below. AWS currently supports a maximum of 5 targets.
	Targets []ssmAssociationTarget.AssociationTarget `pulumi:"targets"`
}
...
type AssociationState struct {
	...
	// An output location block. Output Location is documented below.
	OutputLocation ssmAssociationOutputLocation.AssociationOutputLocationPtrInput
	// A block of arbitrary string parameters to pass to the SSM document.
	Parameters pulumi.MapInput
	// A cron expression when the association will be applied to the target(s).
	ScheduleExpression pulumi.StringPtrInput
	// A block containing the targets of the SSM association. Targets are documented below. AWS currently supports a maximum of 5 targets.
	Targets ssmAssociationTarget.AssociationTargetArrayInput
}
