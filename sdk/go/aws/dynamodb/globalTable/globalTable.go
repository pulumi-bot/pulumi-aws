...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/dynamodb/GlobalTableReplica"
)
...
type GlobalTable struct {
	...
	Replicas dynamodbGlobalTableReplica.GlobalTableReplicaArrayOutput `pulumi:"replicas"`
}
...
type globalTableState struct {
	...
	// Underlying DynamoDB Table. At least 1 replica must be defined. See below.
	Replicas []dynamodbGlobalTableReplica.GlobalTableReplica `pulumi:"replicas"`
}
...
type GlobalTableState struct {
	...
	// Underlying DynamoDB Table. At least 1 replica must be defined. See below.
	Replicas dynamodbGlobalTableReplica.GlobalTableReplicaArrayInput
}
