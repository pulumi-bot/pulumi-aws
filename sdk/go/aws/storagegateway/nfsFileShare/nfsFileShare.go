...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/storagegateway/NfsFileShareNfsFileShareDefaults"
)
...
type NfsFileShare struct {
	...
	NfsFileShareDefaults storagegatewayNfsFileShareNfsFileShareDefaults.NfsFileShareNfsFileShareDefaultsPtrOutput `pulumi:"nfsFileShareDefaults"`
...
type nfsFileShareState struct {
	...
	// Nested argument with file share default values. More information below.
	NfsFileShareDefaults *storagegatewayNfsFileShareNfsFileShareDefaults.NfsFileShareNfsFileShareDefaults `pulumi:"nfsFileShareDefaults"`
	// Access Control List permission for S3 bucket objects. Defaults to `private`.
...
type NfsFileShareState struct {
	...
	// Nested argument with file share default values. More information below.
	NfsFileShareDefaults storagegatewayNfsFileShareNfsFileShareDefaults.NfsFileShareNfsFileShareDefaultsPtrInput
	// Access Control List permission for S3 bucket objects. Defaults to `private`.
