...
func LookupVpcEndpointApply(ctx *pulumi.Context, args LookupVpcEndpointApplyInput, opts ...pulumi.InvokeOption) LookupVpcEndpointResultOutput {
	return args.ToLookupVpcEndpointApplyOutput().ApplyT(func(v LookupVpcEndpointArgs) (LookupVpcEndpointResult, error) {
		r, err := LookupVpcEndpoint(ctx, &v, opts...)
		return *r, err

	}).(LookupVpcEndpointResultOutput)
}

// LookupVpcEndpointApplyInput is an input type that accepts LookupVpcEndpointApplyArgs and LookupVpcEndpointApplyOutput values.
// You can construct a concrete instance of `LookupVpcEndpointApplyInput` via:
//
//          LookupVpcEndpointApplyArgs{...}
type LookupVpcEndpointApplyInput interface {
	pulumi.Input

	ToLookupVpcEndpointApplyOutput() LookupVpcEndpointApplyOutput
	ToLookupVpcEndpointApplyOutputWithContext(context.Context) LookupVpcEndpointApplyOutput
}

// A collection of arguments for invoking getVpcEndpoint.
type LookupVpcEndpointApplyArgs struct {
	// Custom filter block as described below.
...
func (LookupVpcEndpointApplyArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupVpcEndpointArgs)(nil)).Elem()
}

func (i LookupVpcEndpointApplyArgs) ToLookupVpcEndpointApplyOutput() LookupVpcEndpointApplyOutput {
	return i.ToLookupVpcEndpointApplyOutputWithContext(context.Background())
}

func (i LookupVpcEndpointApplyArgs) ToLookupVpcEndpointApplyOutputWithContext(ctx context.Context) LookupVpcEndpointApplyOutput {
	return pulumi.ToOutputWithContext(ctx, i).(LookupVpcEndpointApplyOutput)
}

// A collection of arguments for invoking getVpcEndpoint.
type LookupVpcEndpointApplyOutput struct{ *pulumi.OutputState }

func (LookupVpcEndpointApplyOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupVpcEndpointArgs)(nil)).Elem()
}

func (o LookupVpcEndpointApplyOutput) ToLookupVpcEndpointApplyOutput() LookupVpcEndpointApplyOutput {
	return o
}

func (o LookupVpcEndpointApplyOutput) ToLookupVpcEndpointApplyOutputWithContext(ctx context.Context) LookupVpcEndpointApplyOutput {
	return o
}

// Custom filter block as described below.
func (o LookupVpcEndpointApplyOutput) Filters() GetVpcEndpointFilterArrayOutput {
	return o.ApplyT(func(v LookupVpcEndpointArgs) []GetVpcEndpointFilter { return v.Filters }).(GetVpcEndpointFilterArrayOutput)
}

// The ID of the specific VPC Endpoint to retrieve.
func (o LookupVpcEndpointApplyOutput) Id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupVpcEndpointArgs) *string { return v.Id }).(pulumi.StringPtrOutput)
}

// The service name of the specific VPC Endpoint to retrieve. For AWS services the service name is usually in the form `com.amazonaws.<region>.<service>` (the SageMaker Notebook service is an exception to this rule, the service name is in the form `aws.sagemaker.<region>.notebook`).
func (o LookupVpcEndpointApplyOutput) ServiceName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupVpcEndpointArgs) *string { return v.ServiceName }).(pulumi.StringPtrOutput)
}

// The state of the specific VPC Endpoint to retrieve.
func (o LookupVpcEndpointApplyOutput) State() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupVpcEndpointArgs) *string { return v.State }).(pulumi.StringPtrOutput)
}

// A map of tags, each pair of which must exactly match
// a pair on the specific VPC Endpoint to retrieve.
func (o LookupVpcEndpointApplyOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v LookupVpcEndpointArgs) map[string]string { return v.Tags }).(pulumi.StringMapOutput)
}

// The ID of the VPC in which the specific VPC Endpoint is used.
func (o LookupVpcEndpointApplyOutput) VpcId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupVpcEndpointArgs) *string { return v.VpcId }).(pulumi.StringPtrOutput)
}
...
func init() {
	pulumi.RegisterOutputType(LookupVpcEndpointApplyOutput{})
