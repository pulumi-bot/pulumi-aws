...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/ec2/DefaultRouteTableRoute"
)
...
type DefaultRouteTable struct {
	...
	Routes ec2DefaultRouteTableRoute.DefaultRouteTableRouteArrayOutput `pulumi:"routes"`
...
type defaultRouteTableState struct {
	...
	// A list of route objects. Their keys are documented below.
	// This argument is processed in [attribute-as-blocks mode](https://www.terraform.io/docs/configuration/attr-as-blocks.html).
	Routes []ec2DefaultRouteTableRoute.DefaultRouteTableRoute `pulumi:"routes"`
	// A mapping of tags to assign to the resource.
...
type DefaultRouteTableState struct {
	...
	// A list of route objects. Their keys are documented below.
	// This argument is processed in [attribute-as-blocks mode](https://www.terraform.io/docs/configuration/attr-as-blocks.html).
	Routes ec2DefaultRouteTableRoute.DefaultRouteTableRouteArrayInput
	// A mapping of tags to assign to the resource.
