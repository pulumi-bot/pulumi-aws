...
// nolint: lll
package getVpcDhcpOptions

import (
	"github.com/pulumi/pulumi/sdk/go/pulumi"
	"https:/github.com/pulumi/pulumi-aws/ec2/getVpcDhcpOptionsFilter"
)
...
func GetVpcDhcpOptions(ctx *pulumi.Context, args *GetVpcDhcpOptionsArgs, opts ...pulumi.InvokeOption) (*GetVpcDhcpOptionsResult, error) {
...
type GetVpcDhcpOptionsArgs struct {
	...
	Filters []ec2getVpcDhcpOptionsFilter.GetVpcDhcpOptionsFilter `pulumi:"filters"`
