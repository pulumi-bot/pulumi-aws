...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/ec2/InstanceCreditSpecification"
	"https:/github.com/pulumi/pulumi-aws/ec2/InstanceEbsBlockDevice"
	"https:/github.com/pulumi/pulumi-aws/ec2/InstanceEphemeralBlockDevice"
	"https:/github.com/pulumi/pulumi-aws/ec2/InstanceNetworkInterface"
	"https:/github.com/pulumi/pulumi-aws/ec2/InstanceRootBlockDevice"
)
...
type Instance struct {
	...
	CreditSpecification ec2InstanceCreditSpecification.InstanceCreditSpecificationPtrOutput `pulumi:"creditSpecification"`
	...
	EbsBlockDevices ec2InstanceEbsBlockDevice.InstanceEbsBlockDeviceArrayOutput `pulumi:"ebsBlockDevices"`
	...
	EphemeralBlockDevices ec2InstanceEphemeralBlockDevice.InstanceEphemeralBlockDeviceArrayOutput `pulumi:"ephemeralBlockDevices"`
	...
	NetworkInterfaces ec2InstanceNetworkInterface.InstanceNetworkInterfaceArrayOutput `pulumi:"networkInterfaces"`
	...
	RootBlockDevice ec2InstanceRootBlockDevice.InstanceRootBlockDeviceOutput `pulumi:"rootBlockDevice"`
...
type instanceState struct {
	...
	// Customize the credit specification of the instance. See Credit Specification below for more details.
	CreditSpecification *ec2InstanceCreditSpecification.InstanceCreditSpecification `pulumi:"creditSpecification"`
	// If true, enables [EC2 Instance
	// Termination Protection](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/terminating-instances.html#Using_ChangingDisableAPITermination)
	DisableApiTermination *bool `pulumi:"disableApiTermination"`
	// Additional EBS block devices to attach to the
	// instance.  Block device configurations only apply on resource creation. See Block Devices below for details on attributes and drift detection.
	EbsBlockDevices []ec2InstanceEbsBlockDevice.InstanceEbsBlockDevice `pulumi:"ebsBlockDevices"`
	// If true, the launched EC2 instance will be EBS-optimized.
	// Note that if this is not set on an instance type that is optimized by default then
	// this will show as disabled but if the instance type is optimized by default then
	// there is no need to set this and there is no effect to disabling it.
	...
	// Customize Ephemeral (also known as
	// "Instance Store") volumes on the instance. See Block Devices below for details.
	EphemeralBlockDevices []ec2InstanceEphemeralBlockDevice.InstanceEphemeralBlockDevice `pulumi:"ephemeralBlockDevices"`
	// If true, wait for password data to become available and retrieve it. Useful for getting the administrator password for instances running Microsoft Windows. The password data is exported to the `passwordData` attribute. See [GetPasswordData](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_GetPasswordData.html) for more information.
	...
	// Customize network interfaces to be attached at instance boot time. See Network Interfaces below for more details.
	NetworkInterfaces []ec2InstanceNetworkInterface.InstanceNetworkInterface `pulumi:"networkInterfaces"`
	// Base-64 encoded encrypted password data for the instance.
	// Useful for getting the administrator password for instances running Microsoft Windows.
	// This attribute is only exported if `getPasswordData` is true.
	// Note that this encrypted value will be stored in the state file, as with all exported attributes.
	...
	// Customize details about the root block
	// device of the instance. See Block Devices below for details.
	RootBlockDevice *ec2InstanceRootBlockDevice.InstanceRootBlockDevice `pulumi:"rootBlockDevice"`
	// A list of security group names (EC2-Classic) or IDs (default VPC) to associate with.
...
type InstanceState struct {
	...
	// Customize the credit specification of the instance. See Credit Specification below for more details.
	CreditSpecification ec2InstanceCreditSpecification.InstanceCreditSpecificationPtrInput
	// If true, enables [EC2 Instance
	// Termination Protection](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/terminating-instances.html#Using_ChangingDisableAPITermination)
	DisableApiTermination pulumi.BoolPtrInput
	// Additional EBS block devices to attach to the
	// instance.  Block device configurations only apply on resource creation. See Block Devices below for details on attributes and drift detection.
	EbsBlockDevices ec2InstanceEbsBlockDevice.InstanceEbsBlockDeviceArrayInput
	// If true, the launched EC2 instance will be EBS-optimized.
	// Note that if this is not set on an instance type that is optimized by default then
	// this will show as disabled but if the instance type is optimized by default then
	// there is no need to set this and there is no effect to disabling it.
	...
	// Customize Ephemeral (also known as
	// "Instance Store") volumes on the instance. See Block Devices below for details.
	EphemeralBlockDevices ec2InstanceEphemeralBlockDevice.InstanceEphemeralBlockDeviceArrayInput
	// If true, wait for password data to become available and retrieve it. Useful for getting the administrator password for instances running Microsoft Windows. The password data is exported to the `passwordData` attribute. See [GetPasswordData](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_GetPasswordData.html) for more information.
	...
	// Customize network interfaces to be attached at instance boot time. See Network Interfaces below for more details.
	NetworkInterfaces ec2InstanceNetworkInterface.InstanceNetworkInterfaceArrayInput
	// Base-64 encoded encrypted password data for the instance.
	// Useful for getting the administrator password for instances running Microsoft Windows.
	// This attribute is only exported if `getPasswordData` is true.
	// Note that this encrypted value will be stored in the state file, as with all exported attributes.
	...
	// Customize details about the root block
	// device of the instance. See Block Devices below for details.
	RootBlockDevice ec2InstanceRootBlockDevice.InstanceRootBlockDevicePtrInput
	// A list of security group names (EC2-Classic) or IDs (default VPC) to associate with.
