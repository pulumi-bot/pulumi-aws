...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/ec2/SpotFleetRequestLaunchSpecification"
...
type SpotFleetRequest struct {
	...
	LaunchSpecifications ec2SpotFleetRequestLaunchSpecification.SpotFleetRequestLaunchSpecificationArrayOutput `pulumi:"launchSpecifications"`
...
type spotFleetRequestState struct {
	...
	// spot-fleet request. Can be specified multiple times to define different bids
	// across different markets and instance types.
	LaunchSpecifications []ec2SpotFleetRequestLaunchSpecification.SpotFleetRequestLaunchSpecification `pulumi:"launchSpecifications"`
	// A list of elastic load balancer names to add to the Spot fleet.
...
type SpotFleetRequestState struct {
	...
	// spot-fleet request. Can be specified multiple times to define different bids
	// across different markets and instance types.
	LaunchSpecifications ec2SpotFleetRequestLaunchSpecification.SpotFleetRequestLaunchSpecificationArrayInput
	// A list of elastic load balancer names to add to the Spot fleet.
