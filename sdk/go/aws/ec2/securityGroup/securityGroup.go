...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/ec2/SecurityGroupEgress"
	"https:/github.com/pulumi/pulumi-aws/ec2/SecurityGroupIngress"
)
...
type SecurityGroup struct {
	...
	Egress ec2SecurityGroupEgress.SecurityGroupEgressArrayOutput `pulumi:"egress"`
	// Can be specified multiple times for each
	// ingress rule. Each ingress block supports fields documented below.
	// This argument is processed in [attribute-as-blocks mode](https://www.terraform.io/docs/configuration/attr-as-blocks.html).
	Ingress ec2SecurityGroupIngress.SecurityGroupIngressArrayOutput `pulumi:"ingress"`
...
type securityGroupState struct {
	...
	// egress rule. Each egress block supports fields documented below.
	// This argument is processed in [attribute-as-blocks mode](https://www.terraform.io/docs/configuration/attr-as-blocks.html).
	Egress []ec2SecurityGroupEgress.SecurityGroupEgress `pulumi:"egress"`
	// Can be specified multiple times for each
	// ingress rule. Each ingress block supports fields documented below.
	// This argument is processed in [attribute-as-blocks mode](https://www.terraform.io/docs/configuration/attr-as-blocks.html).
	Ingress []ec2SecurityGroupIngress.SecurityGroupIngress `pulumi:"ingress"`
	// The name of the security group. If omitted, this provider will
	// assign a random, unique name
...
type SecurityGroupState struct {
	...
	// egress rule. Each egress block supports fields documented below.
	// This argument is processed in [attribute-as-blocks mode](https://www.terraform.io/docs/configuration/attr-as-blocks.html).
	Egress ec2SecurityGroupEgress.SecurityGroupEgressArrayInput
	// Can be specified multiple times for each
	// ingress rule. Each ingress block supports fields documented below.
	// This argument is processed in [attribute-as-blocks mode](https://www.terraform.io/docs/configuration/attr-as-blocks.html).
	Ingress ec2SecurityGroupIngress.SecurityGroupIngressArrayInput
	// The name of the security group. If omitted, this provider will
	// assign a random, unique name
