...
// several valid keys, for a full reference, check out
// [describe-instances in the AWS CLI reference][1].
func (o LookupInstanceApplyOutput) Filters() GetInstanceFilterArrayOutput {
	return o.ApplyT(func(v LookupInstanceArgs) []GetInstanceFilter { return v.Filters }).(GetInstanceFilterArrayOutput)
}

// If true, wait for password data to become available and retrieve it. Useful for getting the administrator password for instances running Microsoft Windows. The password data is exported to the `passwordData` attribute. See [GetPasswordData](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_GetPasswordData.html) for more information.
func (o LookupInstanceApplyOutput) GetPasswordData() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupInstanceArgs) *bool { return v.GetPasswordData }).(pulumi.BoolPtrOutput)
}

// Retrieve Base64 encoded User Data contents into the `userDataBase64` attribute. A SHA-1 hash of the User Data contents will always be present in the `userData` attribute. Defaults to `false`.
func (o LookupInstanceApplyOutput) GetUserData() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupInstanceArgs) *bool { return v.GetUserData }).(pulumi.BoolPtrOutput)
}

// Specify the exact Instance ID with which to populate the data source.
func (o LookupInstanceApplyOutput) InstanceId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupInstanceArgs) *string { return v.InstanceId }).(pulumi.StringPtrOutput)
}

// A map of tags, each pair of which must
// exactly match a pair on the desired Instance.
func (o LookupInstanceApplyOutput) InstanceTags() pulumi.StringMapOutput {
	return o.ApplyT(func(v LookupInstanceArgs) map[string]string { return v.InstanceTags }).(pulumi.StringMapOutput)
}

// A map of tags assigned to the Instance.
func (o LookupInstanceApplyOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v LookupInstanceArgs) map[string]string { return v.Tags }).(pulumi.StringMapOutput)
}
