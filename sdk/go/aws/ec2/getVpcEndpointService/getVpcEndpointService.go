...
func GetVpcEndpointService(ctx *pulumi.Context, args *GetVpcEndpointServiceArgs, opts ...pulumi.InvokeOption) (*GetVpcEndpointServiceResult, error) {
