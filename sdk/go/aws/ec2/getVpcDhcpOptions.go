...
func LookupVpcDhcpOptionsApply(ctx *pulumi.Context, args LookupVpcDhcpOptionsApplyInput, opts ...pulumi.InvokeOption) LookupVpcDhcpOptionsResultOutput {
	return args.ToLookupVpcDhcpOptionsApplyOutput().ApplyT(func(v LookupVpcDhcpOptionsArgs) (LookupVpcDhcpOptionsResult, error) {
		r, err := LookupVpcDhcpOptions(ctx, &v, opts...)
		return *r, err

	}).(LookupVpcDhcpOptionsResultOutput)
}

// LookupVpcDhcpOptionsApplyInput is an input type that accepts LookupVpcDhcpOptionsApplyArgs and LookupVpcDhcpOptionsApplyOutput values.
// You can construct a concrete instance of `LookupVpcDhcpOptionsApplyInput` via:
//
//          LookupVpcDhcpOptionsApplyArgs{...}
type LookupVpcDhcpOptionsApplyInput interface {
	pulumi.Input

	ToLookupVpcDhcpOptionsApplyOutput() LookupVpcDhcpOptionsApplyOutput
	ToLookupVpcDhcpOptionsApplyOutputWithContext(context.Context) LookupVpcDhcpOptionsApplyOutput
}

// A collection of arguments for invoking getVpcDhcpOptions.
type LookupVpcDhcpOptionsApplyArgs struct {
	// The EC2 DHCP Options ID.
...
func (LookupVpcDhcpOptionsApplyArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupVpcDhcpOptionsArgs)(nil)).Elem()
}

func (i LookupVpcDhcpOptionsApplyArgs) ToLookupVpcDhcpOptionsApplyOutput() LookupVpcDhcpOptionsApplyOutput {
	return i.ToLookupVpcDhcpOptionsApplyOutputWithContext(context.Background())
}

func (i LookupVpcDhcpOptionsApplyArgs) ToLookupVpcDhcpOptionsApplyOutputWithContext(ctx context.Context) LookupVpcDhcpOptionsApplyOutput {
	return pulumi.ToOutputWithContext(ctx, i).(LookupVpcDhcpOptionsApplyOutput)
}

// A collection of arguments for invoking getVpcDhcpOptions.
type LookupVpcDhcpOptionsApplyOutput struct{ *pulumi.OutputState }

func (LookupVpcDhcpOptionsApplyOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupVpcDhcpOptionsArgs)(nil)).Elem()
}

func (o LookupVpcDhcpOptionsApplyOutput) ToLookupVpcDhcpOptionsApplyOutput() LookupVpcDhcpOptionsApplyOutput {
	return o
}

func (o LookupVpcDhcpOptionsApplyOutput) ToLookupVpcDhcpOptionsApplyOutputWithContext(ctx context.Context) LookupVpcDhcpOptionsApplyOutput {
	return o
}

// The EC2 DHCP Options ID.
func (o LookupVpcDhcpOptionsApplyOutput) DhcpOptionsId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupVpcDhcpOptionsArgs) *string { return v.DhcpOptionsId }).(pulumi.StringPtrOutput)
}

// List of custom filters as described below.
func (o LookupVpcDhcpOptionsApplyOutput) Filters() GetVpcDhcpOptionsFilterArrayOutput {
	return o.ApplyT(func(v LookupVpcDhcpOptionsArgs) []GetVpcDhcpOptionsFilter { return v.Filters }).(GetVpcDhcpOptionsFilterArrayOutput)
}

// A map of tags assigned to the resource.
func (o LookupVpcDhcpOptionsApplyOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v LookupVpcDhcpOptionsArgs) map[string]string { return v.Tags }).(pulumi.StringMapOutput)
}
...
func init() {
	pulumi.RegisterOutputType(LookupVpcDhcpOptionsApplyOutput{})
