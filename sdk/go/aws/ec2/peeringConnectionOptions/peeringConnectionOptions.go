...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/ec2/PeeringConnectionOptionsAccepter"
	"https:/github.com/pulumi/pulumi-aws/ec2/PeeringConnectionOptionsRequester"
)
...
type PeeringConnectionOptions struct {
	...
	Accepter ec2PeeringConnectionOptionsAccepter.PeeringConnectionOptionsAccepterOutput `pulumi:"accepter"`
	// A optional configuration block that allows for [VPC Peering Connection]
	// (http://docs.aws.amazon.com/AmazonVPC/latest/PeeringGuide) options to be set for the VPC that requests
	// the peering connection (a maximum of one).
	Requester ec2PeeringConnectionOptionsRequester.PeeringConnectionOptionsRequesterOutput `pulumi:"requester"`
...
type peeringConnectionOptionsState struct {
	...
	// (http://docs.aws.amazon.com/AmazonVPC/latest/PeeringGuide) options to be set for the VPC that accepts
	// the peering connection (a maximum of one).
	Accepter *ec2PeeringConnectionOptionsAccepter.PeeringConnectionOptionsAccepter `pulumi:"accepter"`
	// A optional configuration block that allows for [VPC Peering Connection]
	// (http://docs.aws.amazon.com/AmazonVPC/latest/PeeringGuide) options to be set for the VPC that requests
	// the peering connection (a maximum of one).
	Requester *ec2PeeringConnectionOptionsRequester.PeeringConnectionOptionsRequester `pulumi:"requester"`
	// The ID of the requester VPC peering connection.
...
type PeeringConnectionOptionsState struct {
	...
	// (http://docs.aws.amazon.com/AmazonVPC/latest/PeeringGuide) options to be set for the VPC that accepts
	// the peering connection (a maximum of one).
	Accepter ec2PeeringConnectionOptionsAccepter.PeeringConnectionOptionsAccepterPtrInput
	// A optional configuration block that allows for [VPC Peering Connection]
	// (http://docs.aws.amazon.com/AmazonVPC/latest/PeeringGuide) options to be set for the VPC that requests
	// the peering connection (a maximum of one).
	Requester ec2PeeringConnectionOptionsRequester.PeeringConnectionOptionsRequesterPtrInput
	// The ID of the requester VPC peering connection.
