...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/ec2/getVpcCidrBlockAssociation"
	"https:/github.com/pulumi/pulumi-aws/ec2/getVpcFilter"
)
...
type GetVpcArgs struct {
	...
	Filters []ec2getVpcFilter.GetVpcFilter `pulumi:"filters"`
...
type GetVpcResult struct {
	...
	CidrBlock string `pulumi:"cidrBlock"`
	CidrBlockAssociations []ec2getVpcCidrBlockAssociation.GetVpcCidrBlockAssociation `pulumi:"cidrBlockAssociations"`
	Default bool `pulumi:"default"`
	DhcpOptionsId string `pulumi:"dhcpOptionsId"`
