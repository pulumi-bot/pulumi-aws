...
func GetInstanceTypeApply(ctx *pulumi.Context, args GetInstanceTypeApplyInput, opts ...pulumi.InvokeOption) GetInstanceTypeResultOutput {
	return args.ToGetInstanceTypeApplyOutput().ApplyT(func(v GetInstanceTypeArgs) (GetInstanceTypeResult, error) {
		r, err := GetInstanceType(ctx, &v, opts...)
		return *r, err

	}).(GetInstanceTypeResultOutput)
}

// GetInstanceTypeApplyInput is an input type that accepts GetInstanceTypeApplyArgs and GetInstanceTypeApplyOutput values.
// You can construct a concrete instance of `GetInstanceTypeApplyInput` via:
//
//          GetInstanceTypeApplyArgs{...}
type GetInstanceTypeApplyInput interface {
	pulumi.Input

	ToGetInstanceTypeApplyOutput() GetInstanceTypeApplyOutput
	ToGetInstanceTypeApplyOutputWithContext(context.Context) GetInstanceTypeApplyOutput
}

// A collection of arguments for invoking getInstanceType.
type GetInstanceTypeApplyArgs struct {
	// The default number of cores for the instance type.
...
func (GetInstanceTypeApplyArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*GetInstanceTypeArgs)(nil)).Elem()
}

func (i GetInstanceTypeApplyArgs) ToGetInstanceTypeApplyOutput() GetInstanceTypeApplyOutput {
	return i.ToGetInstanceTypeApplyOutputWithContext(context.Background())
}

func (i GetInstanceTypeApplyArgs) ToGetInstanceTypeApplyOutputWithContext(ctx context.Context) GetInstanceTypeApplyOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GetInstanceTypeApplyOutput)
}

// A collection of arguments for invoking getInstanceType.
type GetInstanceTypeApplyOutput struct{ *pulumi.OutputState }

func (GetInstanceTypeApplyOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GetInstanceTypeArgs)(nil)).Elem()
}

func (o GetInstanceTypeApplyOutput) ToGetInstanceTypeApplyOutput() GetInstanceTypeApplyOutput {
	return o
}

func (o GetInstanceTypeApplyOutput) ToGetInstanceTypeApplyOutputWithContext(ctx context.Context) GetInstanceTypeApplyOutput {
	return o
}

// The default number of cores for the instance type.
func (o GetInstanceTypeApplyOutput) DefaultCores() pulumi.IntPtrOutput {
	return o.ApplyT(func(v GetInstanceTypeArgs) *int { return v.DefaultCores }).(pulumi.IntPtrOutput)
}

// The  default  number of threads per core for the instance type.
func (o GetInstanceTypeApplyOutput) DefaultThreadsPerCore() pulumi.IntPtrOutput {
	return o.ApplyT(func(v GetInstanceTypeArgs) *int { return v.DefaultThreadsPerCore }).(pulumi.IntPtrOutput)
}
...
// * `fpgas.#.memory_size` - The size (in MiB) for the memory available to the FPGA accelerator.
// * `fpgas.#.name` - The name of the FPGA accelerator.
func (o GetInstanceTypeApplyOutput) Fpgas() GetInstanceTypeFpgaArrayOutput {
	return o.ApplyT(func(v GetInstanceTypeArgs) []GetInstanceTypeFpga { return v.Fpgas }).(GetInstanceTypeFpgaArrayOutput)
}
...
// * `gpus.#.memory_size` - The size (in MiB) for the memory available to the GPU accelerator.
// * `gpus.#.name` - The name of the GPU accelerator.
func (o GetInstanceTypeApplyOutput) Gpuses() GetInstanceTypeGpusArrayOutput {
	return o.ApplyT(func(v GetInstanceTypeArgs) []GetInstanceTypeGpus { return v.Gpuses }).(GetInstanceTypeGpusArrayOutput)
}
...
// * `inference_accelerators.#.manufacturer` - The manufacturer of the Inference accelerator.
// * `inference_accelerators.#.name` - The name of the Inference accelerator.
func (o GetInstanceTypeApplyOutput) Hypervisor() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetInstanceTypeArgs) *string { return v.Hypervisor }).(pulumi.StringPtrOutput)
}

func (o GetInstanceTypeApplyOutput) InferenceAccelerators() GetInstanceTypeInferenceAcceleratorArrayOutput {
	return o.ApplyT(func(v GetInstanceTypeArgs) []GetInstanceTypeInferenceAccelerator { return v.InferenceAccelerators }).(GetInstanceTypeInferenceAcceleratorArrayOutput)
}
...
// * `instance_disks.#.size` - The size of the disk in GB.
// * `instance_disks.#.type` - The type of disk.
func (o GetInstanceTypeApplyOutput) InstanceDisks() GetInstanceTypeInstanceDiskArrayOutput {
	return o.ApplyT(func(v GetInstanceTypeArgs) []GetInstanceTypeInstanceDisk { return v.InstanceDisks }).(GetInstanceTypeInstanceDiskArrayOutput)
}

// Instance
func (o GetInstanceTypeApplyOutput) InstanceType() pulumi.StringOutput {
	return o.ApplyT(func(v GetInstanceTypeArgs) string { return v.InstanceType }).(pulumi.StringOutput)
}

// The maximum number of IPv6 addresses per network interface.
func (o GetInstanceTypeApplyOutput) MaximumIpv6AddressesPerInterface() pulumi.IntPtrOutput {
	return o.ApplyT(func(v GetInstanceTypeArgs) *int { return v.MaximumIpv6AddressesPerInterface }).(pulumi.IntPtrOutput)
}

// The total memory of all FPGA accelerators for the instance type (in MiB).
func (o GetInstanceTypeApplyOutput) TotalFpgaMemory() pulumi.IntPtrOutput {
	return o.ApplyT(func(v GetInstanceTypeArgs) *int { return v.TotalFpgaMemory }).(pulumi.IntPtrOutput)
}

// The total size of the memory for the GPU accelerators for the instance type (in MiB).
func (o GetInstanceTypeApplyOutput) TotalGpuMemory() pulumi.IntPtrOutput {
	return o.ApplyT(func(v GetInstanceTypeArgs) *int { return v.TotalGpuMemory }).(pulumi.IntPtrOutput)
}

// The total size of the instance disks, in GB.
func (o GetInstanceTypeApplyOutput) TotalInstanceStorage() pulumi.IntPtrOutput {
	return o.ApplyT(func(v GetInstanceTypeArgs) *int { return v.TotalInstanceStorage }).(pulumi.IntPtrOutput)
}
...
func init() {
	pulumi.RegisterOutputType(GetInstanceTypeApplyOutput{})
