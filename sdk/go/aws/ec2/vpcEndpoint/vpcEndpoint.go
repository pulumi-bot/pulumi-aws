...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/ec2/VpcEndpointDnsEntry"
)
...
type VpcEndpoint struct {
	...
	DnsEntries ec2VpcEndpointDnsEntry.VpcEndpointDnsEntryArrayOutput `pulumi:"dnsEntries"`
...
type vpcEndpointState struct {
	...
	// The DNS entries for the VPC Endpoint. Applicable for endpoints of type `Interface`. DNS blocks are documented below.
	DnsEntries []ec2VpcEndpointDnsEntry.VpcEndpointDnsEntry `pulumi:"dnsEntries"`
	// One or more network interfaces for the VPC Endpoint. Applicable for endpoints of type `Interface`.
...
type VpcEndpointState struct {
	...
	// The DNS entries for the VPC Endpoint. Applicable for endpoints of type `Interface`. DNS blocks are documented below.
	DnsEntries ec2VpcEndpointDnsEntry.VpcEndpointDnsEntryArrayInput
	// One or more network interfaces for the VPC Endpoint. Applicable for endpoints of type `Interface`.
