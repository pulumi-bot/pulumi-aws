...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/ec2/NetworkInterfaceAttachment"
)
...
type NetworkInterface struct {
	...
	Attachments ec2NetworkInterfaceAttachment.NetworkInterfaceAttachmentArrayOutput `pulumi:"attachments"`
...
type networkInterfaceState struct {
	// Block to define the attachment of the ENI. Documented below.
	Attachments []ec2NetworkInterfaceAttachment.NetworkInterfaceAttachment `pulumi:"attachments"`
	// A description for the network interface.
...
type NetworkInterfaceState struct {
	// Block to define the attachment of the ENI. Documented below.
	Attachments ec2NetworkInterfaceAttachment.NetworkInterfaceAttachmentArrayInput
	// A description for the network interface.
