...
func GetElasticIpApply(ctx *pulumi.Context, args GetElasticIpApplyInput, opts ...pulumi.InvokeOption) GetElasticIpResultOutput {
	return args.ToGetElasticIpApplyOutput().ApplyT(func(v GetElasticIpArgs) (GetElasticIpResult, error) {
		r, err := GetElasticIp(ctx, &v, opts...)
		return *r, err

	}).(GetElasticIpResultOutput)
}

// GetElasticIpApplyInput is an input type that accepts GetElasticIpApplyArgs and GetElasticIpApplyOutput values.
// You can construct a concrete instance of `GetElasticIpApplyInput` via:
//
//          GetElasticIpApplyArgs{...}
type GetElasticIpApplyInput interface {
	pulumi.Input

	ToGetElasticIpApplyOutput() GetElasticIpApplyOutput
	ToGetElasticIpApplyOutputWithContext(context.Context) GetElasticIpApplyOutput
}

// A collection of arguments for invoking getElasticIp.
type GetElasticIpApplyArgs struct {
	// One or more name/value pairs to use as filters. There are several valid keys, for a full reference, check out the [EC2 API Reference](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeAddresses.html).
...
func (GetElasticIpApplyArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*GetElasticIpArgs)(nil)).Elem()
}

func (i GetElasticIpApplyArgs) ToGetElasticIpApplyOutput() GetElasticIpApplyOutput {
	return i.ToGetElasticIpApplyOutputWithContext(context.Background())
}

func (i GetElasticIpApplyArgs) ToGetElasticIpApplyOutputWithContext(ctx context.Context) GetElasticIpApplyOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GetElasticIpApplyOutput)
}

// A collection of arguments for invoking getElasticIp.
type GetElasticIpApplyOutput struct{ *pulumi.OutputState }

func (GetElasticIpApplyOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GetElasticIpArgs)(nil)).Elem()
}

func (o GetElasticIpApplyOutput) ToGetElasticIpApplyOutput() GetElasticIpApplyOutput {
	return o
}

func (o GetElasticIpApplyOutput) ToGetElasticIpApplyOutputWithContext(ctx context.Context) GetElasticIpApplyOutput {
	return o
}

// One or more name/value pairs to use as filters. There are several valid keys, for a full reference, check out the [EC2 API Reference](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeAddresses.html).
func (o GetElasticIpApplyOutput) Filters() GetElasticIpFilterArrayOutput {
	return o.ApplyT(func(v GetElasticIpArgs) []GetElasticIpFilter { return v.Filters }).(GetElasticIpFilterArrayOutput)
}

// The allocation id of the specific VPC EIP to retrieve. If a classic EIP is required, do NOT set `id`, only set `publicIp`
func (o GetElasticIpApplyOutput) Id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetElasticIpArgs) *string { return v.Id }).(pulumi.StringPtrOutput)
}

// The public IP of the specific EIP to retrieve.
func (o GetElasticIpApplyOutput) PublicIp() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetElasticIpArgs) *string { return v.PublicIp }).(pulumi.StringPtrOutput)
}

// A map of tags, each pair of which must exactly match a pair on the desired Elastic IP
func (o GetElasticIpApplyOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v GetElasticIpArgs) map[string]string { return v.Tags }).(pulumi.StringMapOutput)
}
...
func init() {
	pulumi.RegisterOutputType(GetElasticIpApplyOutput{})
