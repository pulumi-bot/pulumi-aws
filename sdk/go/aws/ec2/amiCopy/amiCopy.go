...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/ec2/AmiCopyEbsBlockDevice"
	"https:/github.com/pulumi/pulumi-aws/ec2/AmiCopyEphemeralBlockDevice"
)
...
type AmiCopy struct {
	...
	EbsBlockDevices ec2AmiCopyEbsBlockDevice.AmiCopyEbsBlockDeviceArrayOutput `pulumi:"ebsBlockDevices"`
	...
	EphemeralBlockDevices ec2AmiCopyEphemeralBlockDevice.AmiCopyEphemeralBlockDeviceArrayOutput `pulumi:"ephemeralBlockDevices"`
...
type amiCopyState struct {
	...
	// Nested block describing an EBS block device that should be
	// attached to created instances. The structure of this block is described below.
	EbsBlockDevices []ec2AmiCopyEbsBlockDevice.AmiCopyEbsBlockDevice `pulumi:"ebsBlockDevices"`
	// Specifies whether enhanced networking with ENA is enabled. Defaults to `false`.
	...
	// Nested block describing an ephemeral block device that
	// should be attached to created instances. The structure of this block is described below.
	EphemeralBlockDevices []ec2AmiCopyEphemeralBlockDevice.AmiCopyEphemeralBlockDevice `pulumi:"ephemeralBlockDevices"`
	// Path to an S3 object containing an image manifest, e.g. created
	// by the `ec2-upload-bundle` command in the EC2 command line tools.
...
type AmiCopyState struct {
	...
	// Nested block describing an EBS block device that should be
	// attached to created instances. The structure of this block is described below.
	EbsBlockDevices ec2AmiCopyEbsBlockDevice.AmiCopyEbsBlockDeviceArrayInput
	// Specifies whether enhanced networking with ENA is enabled. Defaults to `false`.
	...
	// Nested block describing an ephemeral block device that
	// should be attached to created instances. The structure of this block is described below.
	EphemeralBlockDevices ec2AmiCopyEphemeralBlockDevice.AmiCopyEphemeralBlockDeviceArrayInput
	// Path to an S3 object containing an image manifest, e.g. created
	// by the `ec2-upload-bundle` command in the EC2 command line tools.
