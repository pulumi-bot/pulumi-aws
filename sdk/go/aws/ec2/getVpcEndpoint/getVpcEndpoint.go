...
// nolint: lll
package getVpcEndpoint

import (
	"github.com/pulumi/pulumi/sdk/go/pulumi"
	"https:/github.com/pulumi/pulumi-aws/ec2/getVpcEndpointDnsEntry"
	"https:/github.com/pulumi/pulumi-aws/ec2/getVpcEndpointFilter"
)
...
func GetVpcEndpoint(ctx *pulumi.Context, args *GetVpcEndpointArgs, opts ...pulumi.InvokeOption) (*GetVpcEndpointResult, error) {
...
type GetVpcEndpointArgs struct {
	...
	Filters []ec2getVpcEndpointFilter.GetVpcEndpointFilter `pulumi:"filters"`
...
type GetVpcEndpointResult struct {
	...
	DnsEntries []ec2getVpcEndpointDnsEntry.GetVpcEndpointDnsEntry `pulumi:"dnsEntries"`
	Filters []ec2getVpcEndpointFilter.GetVpcEndpointFilter `pulumi:"filters"`
	Id string `pulumi:"id"`
