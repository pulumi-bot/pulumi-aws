...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/ec2/DefaultSecurityGroupEgress"
	"https:/github.com/pulumi/pulumi-aws/ec2/DefaultSecurityGroupIngress"
)
...
type DefaultSecurityGroup struct {
	...
	Egress ec2DefaultSecurityGroupEgress.DefaultSecurityGroupEgressArrayOutput `pulumi:"egress"`
	// Can be specified multiple times for each
	// ingress rule. Each ingress block supports fields documented below.
	Ingress ec2DefaultSecurityGroupIngress.DefaultSecurityGroupIngressArrayOutput `pulumi:"ingress"`
...
type defaultSecurityGroupState struct {
	...
	// Can be specified multiple times for each
	// egress rule. Each egress block supports fields documented below.
	Egress []ec2DefaultSecurityGroupEgress.DefaultSecurityGroupEgress `pulumi:"egress"`
	// Can be specified multiple times for each
	// ingress rule. Each ingress block supports fields documented below.
	Ingress []ec2DefaultSecurityGroupIngress.DefaultSecurityGroupIngress `pulumi:"ingress"`
	// The name of the security group
...
type DefaultSecurityGroupState struct {
	...
	// Can be specified multiple times for each
	// egress rule. Each egress block supports fields documented below.
	Egress ec2DefaultSecurityGroupEgress.DefaultSecurityGroupEgressArrayInput
	// Can be specified multiple times for each
	// ingress rule. Each ingress block supports fields documented below.
	Ingress ec2DefaultSecurityGroupIngress.DefaultSecurityGroupIngressArrayInput
	// The name of the security group
