...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/ec2/VpcPeeringConnectionAccepterAccepter"
	"https:/github.com/pulumi/pulumi-aws/ec2/VpcPeeringConnectionAccepterRequester"
)
...
type VpcPeeringConnectionAccepter struct {
	...
	Accepter ec2VpcPeeringConnectionAccepterAccepter.VpcPeeringConnectionAccepterAccepterOutput `pulumi:"accepter"`
	...
	Requester ec2VpcPeeringConnectionAccepterRequester.VpcPeeringConnectionAccepterRequesterOutput `pulumi:"requester"`
...
type vpcPeeringConnectionAccepterState struct {
	...
	// A configuration block that describes [VPC Peering Connection]
	// (http://docs.aws.amazon.com/AmazonVPC/latest/PeeringGuide) options set for the accepter VPC.
	Accepter *ec2VpcPeeringConnectionAccepterAccepter.VpcPeeringConnectionAccepterAccepter `pulumi:"accepter"`
	// Whether or not to accept the peering request. Defaults to `false`.
	...
	// A configuration block that describes [VPC Peering Connection]
	// (http://docs.aws.amazon.com/AmazonVPC/latest/PeeringGuide) options set for the requester VPC.
	Requester *ec2VpcPeeringConnectionAccepterRequester.VpcPeeringConnectionAccepterRequester `pulumi:"requester"`
	// A mapping of tags to assign to the resource.
...
type VpcPeeringConnectionAccepterState struct {
	...
	// A configuration block that describes [VPC Peering Connection]
	// (http://docs.aws.amazon.com/AmazonVPC/latest/PeeringGuide) options set for the accepter VPC.
	Accepter ec2VpcPeeringConnectionAccepterAccepter.VpcPeeringConnectionAccepterAccepterPtrInput
	// Whether or not to accept the peering request. Defaults to `false`.
	...
	// A configuration block that describes [VPC Peering Connection]
	// (http://docs.aws.amazon.com/AmazonVPC/latest/PeeringGuide) options set for the requester VPC.
	Requester ec2VpcPeeringConnectionAccepterRequester.VpcPeeringConnectionAccepterRequesterPtrInput
	// A mapping of tags to assign to the resource.
