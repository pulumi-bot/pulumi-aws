...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/ec2/getInstanceCreditSpecification"
	"https:/github.com/pulumi/pulumi-aws/ec2/getInstanceEbsBlockDevice"
	"https:/github.com/pulumi/pulumi-aws/ec2/getInstanceEphemeralBlockDevice"
	"https:/github.com/pulumi/pulumi-aws/ec2/getInstanceFilter"
	"https:/github.com/pulumi/pulumi-aws/ec2/getInstanceRootBlockDevice"
)
...
type GetInstanceArgs struct {
	...
	Filters []ec2getInstanceFilter.GetInstanceFilter `pulumi:"filters"`
...
type GetInstanceResult struct {
	...
	CreditSpecifications []ec2getInstanceCreditSpecification.GetInstanceCreditSpecification `pulumi:"creditSpecifications"`
	DisableApiTermination bool `pulumi:"disableApiTermination"`
	// The EBS block device mappings of the Instance.
	EbsBlockDevices []ec2getInstanceEbsBlockDevice.GetInstanceEbsBlockDevice `pulumi:"ebsBlockDevices"`
	// Whether the Instance is EBS optimized or not (Boolean).
	EbsOptimized bool `pulumi:"ebsOptimized"`
	// The ephemeral block device mappings of the Instance.
	EphemeralBlockDevices []ec2getInstanceEphemeralBlockDevice.GetInstanceEphemeralBlockDevice `pulumi:"ephemeralBlockDevices"`
	Filters []ec2getInstanceFilter.GetInstanceFilter `pulumi:"filters"`
	GetPasswordData *bool `pulumi:"getPasswordData"`
	GetUserData *bool `pulumi:"getUserData"`
	...
	RootBlockDevices []ec2getInstanceRootBlockDevice.GetInstanceRootBlockDevice `pulumi:"rootBlockDevices"`
