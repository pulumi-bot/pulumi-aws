...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/ec2/SpotInstanceRequestCreditSpecification"
	"https:/github.com/pulumi/pulumi-aws/ec2/SpotInstanceRequestEbsBlockDevice"
	"https:/github.com/pulumi/pulumi-aws/ec2/SpotInstanceRequestEphemeralBlockDevice"
	"https:/github.com/pulumi/pulumi-aws/ec2/SpotInstanceRequestNetworkInterface"
	"https:/github.com/pulumi/pulumi-aws/ec2/SpotInstanceRequestRootBlockDevice"
)
...
type SpotInstanceRequest struct {
	...
	CreditSpecification ec2SpotInstanceRequestCreditSpecification.SpotInstanceRequestCreditSpecificationPtrOutput `pulumi:"creditSpecification"`
	...
	EbsBlockDevices ec2SpotInstanceRequestEbsBlockDevice.SpotInstanceRequestEbsBlockDeviceArrayOutput `pulumi:"ebsBlockDevices"`
	...
	EphemeralBlockDevices ec2SpotInstanceRequestEphemeralBlockDevice.SpotInstanceRequestEphemeralBlockDeviceArrayOutput `pulumi:"ephemeralBlockDevices"`
	...
	NetworkInterfaces ec2SpotInstanceRequestNetworkInterface.SpotInstanceRequestNetworkInterfaceArrayOutput `pulumi:"networkInterfaces"`
	...
	RootBlockDevice ec2SpotInstanceRequestRootBlockDevice.SpotInstanceRequestRootBlockDeviceOutput `pulumi:"rootBlockDevice"`
...
type spotInstanceRequestState struct {
	...
	// Customize the credit specification of the instance. See Credit Specification below for more details.
	CreditSpecification *ec2SpotInstanceRequestCreditSpecification.SpotInstanceRequestCreditSpecification `pulumi:"creditSpecification"`
	// If true, enables [EC2 Instance
	// Termination Protection](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/terminating-instances.html#Using_ChangingDisableAPITermination)
	DisableApiTermination *bool `pulumi:"disableApiTermination"`
	// Additional EBS block devices to attach to the
	// instance.  Block device configurations only apply on resource creation. See Block Devices below for details on attributes and drift detection.
	EbsBlockDevices []ec2SpotInstanceRequestEbsBlockDevice.SpotInstanceRequestEbsBlockDevice `pulumi:"ebsBlockDevices"`
	// If true, the launched EC2 instance will be EBS-optimized.
	// Note that if this is not set on an instance type that is optimized by default then
	// this will show as disabled but if the instance type is optimized by default then
	// there is no need to set this and there is no effect to disabling it.
	...
	// Customize Ephemeral (also known as
	// "Instance Store") volumes on the instance. See Block Devices below for details.
	EphemeralBlockDevices []ec2SpotInstanceRequestEphemeralBlockDevice.SpotInstanceRequestEphemeralBlockDevice `pulumi:"ephemeralBlockDevices"`
	// If true, wait for password data to become available and retrieve it. Useful for getting the administrator password for instances running Microsoft Windows. The password data is exported to the `passwordData` attribute. See [GetPasswordData](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_GetPasswordData.html) for more information.
	...
	// Customize network interfaces to be attached at instance boot time. See Network Interfaces below for more details.
	NetworkInterfaces []ec2SpotInstanceRequestNetworkInterface.SpotInstanceRequestNetworkInterface `pulumi:"networkInterfaces"`
	...
	// Customize details about the root block
	// device of the instance. See Block Devices below for details.
	RootBlockDevice *ec2SpotInstanceRequestRootBlockDevice.SpotInstanceRequestRootBlockDevice `pulumi:"rootBlockDevice"`
	// A list of security group names (EC2-Classic) or IDs (default VPC) to associate with.
...
type SpotInstanceRequestState struct {
	...
	// Customize the credit specification of the instance. See Credit Specification below for more details.
	CreditSpecification ec2SpotInstanceRequestCreditSpecification.SpotInstanceRequestCreditSpecificationPtrInput
	// If true, enables [EC2 Instance
	// Termination Protection](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/terminating-instances.html#Using_ChangingDisableAPITermination)
	DisableApiTermination pulumi.BoolPtrInput
	// Additional EBS block devices to attach to the
	// instance.  Block device configurations only apply on resource creation. See Block Devices below for details on attributes and drift detection.
	EbsBlockDevices ec2SpotInstanceRequestEbsBlockDevice.SpotInstanceRequestEbsBlockDeviceArrayInput
	// If true, the launched EC2 instance will be EBS-optimized.
	// Note that if this is not set on an instance type that is optimized by default then
	// this will show as disabled but if the instance type is optimized by default then
	// there is no need to set this and there is no effect to disabling it.
	...
	// Customize Ephemeral (also known as
	// "Instance Store") volumes on the instance. See Block Devices below for details.
	EphemeralBlockDevices ec2SpotInstanceRequestEphemeralBlockDevice.SpotInstanceRequestEphemeralBlockDeviceArrayInput
	// If true, wait for password data to become available and retrieve it. Useful for getting the administrator password for instances running Microsoft Windows. The password data is exported to the `passwordData` attribute. See [GetPasswordData](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_GetPasswordData.html) for more information.
	...
	// Customize network interfaces to be attached at instance boot time. See Network Interfaces below for more details.
	NetworkInterfaces ec2SpotInstanceRequestNetworkInterface.SpotInstanceRequestNetworkInterfaceArrayInput
	...
	// Customize details about the root block
	// device of the instance. See Block Devices below for details.
	RootBlockDevice ec2SpotInstanceRequestRootBlockDevice.SpotInstanceRequestRootBlockDevicePtrInput
	// A list of security group names (EC2-Classic) or IDs (default VPC) to associate with.
