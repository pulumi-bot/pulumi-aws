...
// nolint: lll
package getLaunchConfiguration

import (
	"github.com/pulumi/pulumi/sdk/go/pulumi"
	"https:/github.com/pulumi/pulumi-aws/ec2/getLaunchConfigurationEbsBlockDevice"
	"https:/github.com/pulumi/pulumi-aws/ec2/getLaunchConfigurationEphemeralBlockDevice"
	"https:/github.com/pulumi/pulumi-aws/ec2/getLaunchConfigurationRootBlockDevice"
)
...
func GetLaunchConfiguration(ctx *pulumi.Context, args *GetLaunchConfigurationArgs, opts ...pulumi.InvokeOption) (*GetLaunchConfigurationResult, error) {
...
type GetLaunchConfigurationResult struct {
	...
	EbsBlockDevices []ec2getLaunchConfigurationEbsBlockDevice.GetLaunchConfigurationEbsBlockDevice `pulumi:"ebsBlockDevices"`
	// Whether the launched EC2 instance will be EBS-optimized.
	EbsOptimized bool `pulumi:"ebsOptimized"`
	// Whether Detailed Monitoring is Enabled.
	EnableMonitoring bool `pulumi:"enableMonitoring"`
	// The Ephemeral volumes on the instance.
	EphemeralBlockDevices []ec2getLaunchConfigurationEphemeralBlockDevice.GetLaunchConfigurationEphemeralBlockDevice `pulumi:"ephemeralBlockDevices"`
	...
	RootBlockDevices []ec2getLaunchConfigurationRootBlockDevice.GetLaunchConfigurationRootBlockDevice `pulumi:"rootBlockDevices"`
