...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/ec2/VpcPeeringConnectionAccepter"
	"https:/github.com/pulumi/pulumi-aws/ec2/VpcPeeringConnectionRequester"
)
...
type VpcPeeringConnection struct {
	...
	Accepter ec2VpcPeeringConnectionAccepter.VpcPeeringConnectionAccepterOutput `pulumi:"accepter"`
	...
	// the peering connection (a maximum of one).
	Requester ec2VpcPeeringConnectionRequester.VpcPeeringConnectionRequesterOutput `pulumi:"requester"`
...
type vpcPeeringConnectionState struct {
	...
	// (http://docs.aws.amazon.com/AmazonVPC/latest/PeeringGuide) options to be set for the VPC that accepts
	// the peering connection (a maximum of one).
	Accepter *ec2VpcPeeringConnectionAccepter.VpcPeeringConnectionAccepter `pulumi:"accepter"`
	// Accept the peering (both VPCs need to be in the same AWS account).
	...
	// (http://docs.aws.amazon.com/AmazonVPC/latest/PeeringGuide) options to be set for the VPC that requests
	// the peering connection (a maximum of one).
	Requester *ec2VpcPeeringConnectionRequester.VpcPeeringConnectionRequester `pulumi:"requester"`
	// A mapping of tags to assign to the resource.
...
type VpcPeeringConnectionState struct {
	...
	// (http://docs.aws.amazon.com/AmazonVPC/latest/PeeringGuide) options to be set for the VPC that accepts
	// the peering connection (a maximum of one).
	Accepter ec2VpcPeeringConnectionAccepter.VpcPeeringConnectionAccepterPtrInput
	// Accept the peering (both VPCs need to be in the same AWS account).
	...
	// (http://docs.aws.amazon.com/AmazonVPC/latest/PeeringGuide) options to be set for the VPC that requests
	// the peering connection (a maximum of one).
	Requester ec2VpcPeeringConnectionRequester.VpcPeeringConnectionRequesterPtrInput
	// A mapping of tags to assign to the resource.
