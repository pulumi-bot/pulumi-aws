...
func LookupLaunchTemplateApply(ctx *pulumi.Context, args LookupLaunchTemplateApplyInput, opts ...pulumi.InvokeOption) LookupLaunchTemplateResultOutput {
	return args.ToLookupLaunchTemplateApplyOutput().ApplyT(func(v LookupLaunchTemplateArgs) (LookupLaunchTemplateResult, error) {
		r, err := LookupLaunchTemplate(ctx, &v, opts...)
		return *r, err

	}).(LookupLaunchTemplateResultOutput)
}

// LookupLaunchTemplateApplyInput is an input type that accepts LookupLaunchTemplateApplyArgs and LookupLaunchTemplateApplyOutput values.
// You can construct a concrete instance of `LookupLaunchTemplateApplyInput` via:
//
//          LookupLaunchTemplateApplyArgs{...}
type LookupLaunchTemplateApplyInput interface {
	pulumi.Input

	ToLookupLaunchTemplateApplyOutput() LookupLaunchTemplateApplyOutput
	ToLookupLaunchTemplateApplyOutputWithContext(context.Context) LookupLaunchTemplateApplyOutput
}

// A collection of arguments for invoking getLaunchTemplate.
type LookupLaunchTemplateApplyArgs struct {
	// Configuration block(s) for filtering. Detailed below.
...
func (LookupLaunchTemplateApplyArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupLaunchTemplateArgs)(nil)).Elem()
}

func (i LookupLaunchTemplateApplyArgs) ToLookupLaunchTemplateApplyOutput() LookupLaunchTemplateApplyOutput {
	return i.ToLookupLaunchTemplateApplyOutputWithContext(context.Background())
}

func (i LookupLaunchTemplateApplyArgs) ToLookupLaunchTemplateApplyOutputWithContext(ctx context.Context) LookupLaunchTemplateApplyOutput {
	return pulumi.ToOutputWithContext(ctx, i).(LookupLaunchTemplateApplyOutput)
}

// A collection of arguments for invoking getLaunchTemplate.
type LookupLaunchTemplateApplyOutput struct{ *pulumi.OutputState }

func (LookupLaunchTemplateApplyOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupLaunchTemplateArgs)(nil)).Elem()
}

func (o LookupLaunchTemplateApplyOutput) ToLookupLaunchTemplateApplyOutput() LookupLaunchTemplateApplyOutput {
	return o
}

func (o LookupLaunchTemplateApplyOutput) ToLookupLaunchTemplateApplyOutputWithContext(ctx context.Context) LookupLaunchTemplateApplyOutput {
	return o
}

// Configuration block(s) for filtering. Detailed below.
func (o LookupLaunchTemplateApplyOutput) Filters() GetLaunchTemplateFilterArrayOutput {
	return o.ApplyT(func(v LookupLaunchTemplateArgs) []GetLaunchTemplateFilter { return v.Filters }).(GetLaunchTemplateFilterArrayOutput)
}

// The ID of the specific launch template to retrieve.
func (o LookupLaunchTemplateApplyOutput) Id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupLaunchTemplateArgs) *string { return v.Id }).(pulumi.StringPtrOutput)
}

// The name of the filter field. Valid values can be found in the [EC2 DescribeLaunchTemplates API Reference](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeLaunchTemplates.html).
func (o LookupLaunchTemplateApplyOutput) Name() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupLaunchTemplateArgs) *string { return v.Name }).(pulumi.StringPtrOutput)
}

// A map of tags, each pair of which must exactly match a pair on the desired Launch Template.
func (o LookupLaunchTemplateApplyOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v LookupLaunchTemplateArgs) map[string]string { return v.Tags }).(pulumi.StringMapOutput)
}
...
func init() {
	pulumi.RegisterOutputType(LookupLaunchTemplateApplyOutput{})
