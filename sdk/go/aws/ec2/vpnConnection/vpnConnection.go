...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/ec2/VpnConnectionRoute"
	"https:/github.com/pulumi/pulumi-aws/ec2/VpnConnectionVgwTelemetry"
)
...
type VpnConnection struct {
	...
	Routes ec2VpnConnectionRoute.VpnConnectionRouteArrayOutput `pulumi:"routes"`
	...
	VgwTelemetries ec2VpnConnectionVgwTelemetry.VpnConnectionVgwTelemetryArrayOutput `pulumi:"vgwTelemetries"`
...
type vpnConnectionState struct {
	...
	Routes []ec2VpnConnectionRoute.VpnConnectionRoute `pulumi:"routes"`
	// Whether the VPN connection uses static routes exclusively. Static routes must be used for devices that don't support BGP.
	...
	VgwTelemetries []ec2VpnConnectionVgwTelemetry.VpnConnectionVgwTelemetry `pulumi:"vgwTelemetries"`
	// The ID of the Virtual Private Gateway.
...
type VpnConnectionState struct {
	...
	Routes ec2VpnConnectionRoute.VpnConnectionRouteArrayInput
	// Whether the VPN connection uses static routes exclusively. Static routes must be used for devices that don't support BGP.
	...
	VgwTelemetries ec2VpnConnectionVgwTelemetry.VpnConnectionVgwTelemetryArrayInput
	// The ID of the Virtual Private Gateway.
