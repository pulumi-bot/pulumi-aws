...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/ec2/LaunchConfigurationEbsBlockDevice"
	"https:/github.com/pulumi/pulumi-aws/ec2/LaunchConfigurationEphemeralBlockDevice"
	"https:/github.com/pulumi/pulumi-aws/ec2/LaunchConfigurationRootBlockDevice"
)
...
type LaunchConfiguration struct {
	...
	EbsBlockDevices ec2LaunchConfigurationEbsBlockDevice.LaunchConfigurationEbsBlockDeviceArrayOutput `pulumi:"ebsBlockDevices"`
	...
	EphemeralBlockDevices ec2LaunchConfigurationEphemeralBlockDevice.LaunchConfigurationEphemeralBlockDeviceArrayOutput `pulumi:"ephemeralBlockDevices"`
	...
	RootBlockDevice ec2LaunchConfigurationRootBlockDevice.LaunchConfigurationRootBlockDeviceOutput `pulumi:"rootBlockDevice"`
...
type launchConfigurationState struct {
	...
	// Additional EBS block devices to attach to the
	// instance.  See Block Devices below for details.
	EbsBlockDevices []ec2LaunchConfigurationEbsBlockDevice.LaunchConfigurationEbsBlockDevice `pulumi:"ebsBlockDevices"`
	// If true, the launched EC2 instance will be EBS-optimized.
	...
	// Customize Ephemeral (also known as
	// "Instance Store") volumes on the instance. See Block Devices below for details.
	EphemeralBlockDevices []ec2LaunchConfigurationEphemeralBlockDevice.LaunchConfigurationEphemeralBlockDevice `pulumi:"ephemeralBlockDevices"`
	// The name attribute of the IAM instance profile to associate
	// with launched instances.
	...
	// Customize details about the root block
	// device of the instance. See Block Devices below for details.
	RootBlockDevice *ec2LaunchConfigurationRootBlockDevice.LaunchConfigurationRootBlockDevice `pulumi:"rootBlockDevice"`
	// A list of associated security group IDS.
...
type LaunchConfigurationState struct {
	...
	// Additional EBS block devices to attach to the
	// instance.  See Block Devices below for details.
	EbsBlockDevices ec2LaunchConfigurationEbsBlockDevice.LaunchConfigurationEbsBlockDeviceArrayInput
	// If true, the launched EC2 instance will be EBS-optimized.
	...
	// Customize Ephemeral (also known as
	// "Instance Store") volumes on the instance. See Block Devices below for details.
	EphemeralBlockDevices ec2LaunchConfigurationEphemeralBlockDevice.LaunchConfigurationEphemeralBlockDeviceArrayInput
	// The name attribute of the IAM instance profile to associate
	// with launched instances.
	...
	// Customize details about the root block
	// device of the instance. See Block Devices below for details.
	RootBlockDevice ec2LaunchConfigurationRootBlockDevice.LaunchConfigurationRootBlockDevicePtrInput
	// A list of associated security group IDS.
