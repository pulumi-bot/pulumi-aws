...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/ec2/DefaultNetworkAclEgress"
	"https:/github.com/pulumi/pulumi-aws/ec2/DefaultNetworkAclIngress"
)
...
type DefaultNetworkAcl struct {
	...
	Egress ec2DefaultNetworkAclEgress.DefaultNetworkAclEgressArrayOutput `pulumi:"egress"`
	// Specifies an ingress rule. Parameters defined below.
	Ingress ec2DefaultNetworkAclIngress.DefaultNetworkAclIngressArrayOutput `pulumi:"ingress"`
...
type defaultNetworkAclState struct {
	...
	// Specifies an egress rule. Parameters defined below.
	Egress []ec2DefaultNetworkAclEgress.DefaultNetworkAclEgress `pulumi:"egress"`
	// Specifies an ingress rule. Parameters defined below.
	Ingress []ec2DefaultNetworkAclIngress.DefaultNetworkAclIngress `pulumi:"ingress"`
	// The ID of the AWS account that owns the Default Network ACL
...
type DefaultNetworkAclState struct {
	...
	// Specifies an egress rule. Parameters defined below.
	Egress ec2DefaultNetworkAclEgress.DefaultNetworkAclEgressArrayInput
	// Specifies an ingress rule. Parameters defined below.
	Ingress ec2DefaultNetworkAclIngress.DefaultNetworkAclIngressArrayInput
	// The ID of the AWS account that owns the Default Network ACL
