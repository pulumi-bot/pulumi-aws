...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/ses/EventDestinationCloudwatchDestination"
	"https:/github.com/pulumi/pulumi-aws/ses/EventDestinationKinesisDestination"
	"https:/github.com/pulumi/pulumi-aws/ses/EventDestinationSnsDestination"
)
...
type EventDestination struct {
	...
	CloudwatchDestinations sesEventDestinationCloudwatchDestination.EventDestinationCloudwatchDestinationArrayOutput `pulumi:"cloudwatchDestinations"`
	// The name of the configuration set
	ConfigurationSetName pulumi.StringOutput `pulumi:"configurationSetName"`
	// If true, the event destination will be enabled
	Enabled pulumi.BoolPtrOutput `pulumi:"enabled"`
	// Send the events to a kinesis firehose destination
	KinesisDestination sesEventDestinationKinesisDestination.EventDestinationKinesisDestinationPtrOutput `pulumi:"kinesisDestination"`
	// A list of matching types. May be any of `"send"`, `"reject"`, `"bounce"`, `"complaint"`, `"delivery"`, `"open"`, `"click"`, or `"renderingFailure"`.
	MatchingTypes pulumi.StringArrayOutput `pulumi:"matchingTypes"`
	// The name of the event destination
	Name pulumi.StringOutput `pulumi:"name"`
	// Send the events to an SNS Topic destination
	SnsDestination sesEventDestinationSnsDestination.EventDestinationSnsDestinationPtrOutput `pulumi:"snsDestination"`
}
...
type eventDestinationState struct {
	// CloudWatch destination for the events
	CloudwatchDestinations []sesEventDestinationCloudwatchDestination.EventDestinationCloudwatchDestination `pulumi:"cloudwatchDestinations"`
	// The name of the configuration set
	ConfigurationSetName *string `pulumi:"configurationSetName"`
	// If true, the event destination will be enabled
	Enabled *bool `pulumi:"enabled"`
	// Send the events to a kinesis firehose destination
	KinesisDestination *sesEventDestinationKinesisDestination.EventDestinationKinesisDestination `pulumi:"kinesisDestination"`
	// A list of matching types. May be any of `"send"`, `"reject"`, `"bounce"`, `"complaint"`, `"delivery"`, `"open"`, `"click"`, or `"renderingFailure"`.
	MatchingTypes []string `pulumi:"matchingTypes"`
	// The name of the event destination
	Name *string `pulumi:"name"`
	// Send the events to an SNS Topic destination
	SnsDestination *sesEventDestinationSnsDestination.EventDestinationSnsDestination `pulumi:"snsDestination"`
}

type EventDestinationState struct {
	// CloudWatch destination for the events
	CloudwatchDestinations sesEventDestinationCloudwatchDestination.EventDestinationCloudwatchDestinationArrayInput
	// The name of the configuration set
	ConfigurationSetName pulumi.StringPtrInput
	// If true, the event destination will be enabled
	Enabled pulumi.BoolPtrInput
	// Send the events to a kinesis firehose destination
	KinesisDestination sesEventDestinationKinesisDestination.EventDestinationKinesisDestinationPtrInput
	// A list of matching types. May be any of `"send"`, `"reject"`, `"bounce"`, `"complaint"`, `"delivery"`, `"open"`, `"click"`, or `"renderingFailure"`.
	MatchingTypes pulumi.StringArrayInput
	// The name of the event destination
	Name pulumi.StringPtrInput
	// Send the events to an SNS Topic destination
	SnsDestination sesEventDestinationSnsDestination.EventDestinationSnsDestinationPtrInput
}
