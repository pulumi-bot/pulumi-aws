...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/rds/ParameterGroupParameter"
)
...
type ParameterGroup struct {
	...
	Parameters rdsParameterGroupParameter.ParameterGroupParameterArrayOutput `pulumi:"parameters"`
...
type parameterGroupState struct {
	...
	// A list of DB parameters to apply. Note that parameters may differ from a family to an other. Full list of all parameters can be discovered via [`aws rds describe-db-parameters`](https://docs.aws.amazon.com/cli/latest/reference/rds/describe-db-parameters.html) after initial creation of the group.
	Parameters []rdsParameterGroupParameter.ParameterGroupParameter `pulumi:"parameters"`
	// A mapping of tags to assign to the resource.
...
type ParameterGroupState struct {
	...
	// A list of DB parameters to apply. Note that parameters may differ from a family to an other. Full list of all parameters can be discovered via [`aws rds describe-db-parameters`](https://docs.aws.amazon.com/cli/latest/reference/rds/describe-db-parameters.html) after initial creation of the group.
	Parameters rdsParameterGroupParameter.ParameterGroupParameterArrayInput
	// A mapping of tags to assign to the resource.
