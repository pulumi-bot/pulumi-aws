...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/rds/ClusterParameterGroupParameter"
)
...
type ClusterParameterGroup struct {
	...
	Parameters rdsClusterParameterGroupParameter.ClusterParameterGroupParameterArrayOutput `pulumi:"parameters"`
...
type clusterParameterGroupState struct {
	...
	// A list of DB parameters to apply. Note that parameters may differ from a family to an other. Full list of all parameters can be discovered via [`aws rds describe-db-cluster-parameters`](https://docs.aws.amazon.com/cli/latest/reference/rds/describe-db-cluster-parameters.html) after initial creation of the group.
	Parameters []rdsClusterParameterGroupParameter.ClusterParameterGroupParameter `pulumi:"parameters"`
	// A mapping of tags to assign to the resource.
...
type ClusterParameterGroupState struct {
	...
	// A list of DB parameters to apply. Note that parameters may differ from a family to an other. Full list of all parameters can be discovered via [`aws rds describe-db-cluster-parameters`](https://docs.aws.amazon.com/cli/latest/reference/rds/describe-db-cluster-parameters.html) after initial creation of the group.
	Parameters rdsClusterParameterGroupParameter.ClusterParameterGroupParameterArrayInput
	// A mapping of tags to assign to the resource.
