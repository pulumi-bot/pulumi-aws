...
func LookupClusterSnapshotApply(ctx *pulumi.Context, args LookupClusterSnapshotApplyInput, opts ...pulumi.InvokeOption) LookupClusterSnapshotResultOutput {
	return args.ToLookupClusterSnapshotApplyOutput().ApplyT(func(v LookupClusterSnapshotArgs) (LookupClusterSnapshotResult, error) {
		r, err := LookupClusterSnapshot(ctx, &v, opts...)
		return *r, err

	}).(LookupClusterSnapshotResultOutput)
}

// LookupClusterSnapshotApplyInput is an input type that accepts LookupClusterSnapshotApplyArgs and LookupClusterSnapshotApplyOutput values.
// You can construct a concrete instance of `LookupClusterSnapshotApplyInput` via:
//
//          LookupClusterSnapshotApplyArgs{...}
type LookupClusterSnapshotApplyInput interface {
	pulumi.Input

	ToLookupClusterSnapshotApplyOutput() LookupClusterSnapshotApplyOutput
	ToLookupClusterSnapshotApplyOutputWithContext(context.Context) LookupClusterSnapshotApplyOutput
}

// A collection of arguments for invoking getClusterSnapshot.
type LookupClusterSnapshotApplyArgs struct {
	// Returns the list of snapshots created by the specific db_cluster
...
func (LookupClusterSnapshotApplyArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupClusterSnapshotArgs)(nil)).Elem()
}

func (i LookupClusterSnapshotApplyArgs) ToLookupClusterSnapshotApplyOutput() LookupClusterSnapshotApplyOutput {
	return i.ToLookupClusterSnapshotApplyOutputWithContext(context.Background())
}

func (i LookupClusterSnapshotApplyArgs) ToLookupClusterSnapshotApplyOutputWithContext(ctx context.Context) LookupClusterSnapshotApplyOutput {
	return pulumi.ToOutputWithContext(ctx, i).(LookupClusterSnapshotApplyOutput)
}

// A collection of arguments for invoking getClusterSnapshot.
type LookupClusterSnapshotApplyOutput struct{ *pulumi.OutputState }

func (LookupClusterSnapshotApplyOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupClusterSnapshotArgs)(nil)).Elem()
}

func (o LookupClusterSnapshotApplyOutput) ToLookupClusterSnapshotApplyOutput() LookupClusterSnapshotApplyOutput {
	return o
}

func (o LookupClusterSnapshotApplyOutput) ToLookupClusterSnapshotApplyOutputWithContext(ctx context.Context) LookupClusterSnapshotApplyOutput {
	return o
}

// Returns the list of snapshots created by the specific db_cluster
func (o LookupClusterSnapshotApplyOutput) DbClusterIdentifier() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupClusterSnapshotArgs) *string { return v.DbClusterIdentifier }).(pulumi.StringPtrOutput)
}

// Returns information on a specific snapshot_id.
func (o LookupClusterSnapshotApplyOutput) DbClusterSnapshotIdentifier() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupClusterSnapshotArgs) *string { return v.DbClusterSnapshotIdentifier }).(pulumi.StringPtrOutput)
}

// Set this value to true to include manual DB Cluster Snapshots that are public and can be
// copied or restored by any AWS account, otherwise set this value to false. The default is `false`.
func (o LookupClusterSnapshotApplyOutput) IncludePublic() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupClusterSnapshotArgs) *bool { return v.IncludePublic }).(pulumi.BoolPtrOutput)
}

// Set this value to true to include shared manual DB Cluster Snapshots from other
// AWS accounts that this AWS account has been given permission to copy or restore, otherwise set this value to false.
// The default is `false`.
func (o LookupClusterSnapshotApplyOutput) IncludeShared() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupClusterSnapshotArgs) *bool { return v.IncludeShared }).(pulumi.BoolPtrOutput)
}

// If more than one result is returned, use the most recent Snapshot.
func (o LookupClusterSnapshotApplyOutput) MostRecent() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupClusterSnapshotArgs) *bool { return v.MostRecent }).(pulumi.BoolPtrOutput)
}

// The type of snapshots to be returned. If you don't specify a SnapshotType
// value, then both automated and manual DB cluster snapshots are returned. Shared and public DB Cluster Snapshots are not
// included in the returned results by default. Possible values are, `automated`, `manual`, `shared`, `public` and `awsbackup`.
func (o LookupClusterSnapshotApplyOutput) SnapshotType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupClusterSnapshotArgs) *string { return v.SnapshotType }).(pulumi.StringPtrOutput)
}

// A map of tags for the resource.
func (o LookupClusterSnapshotApplyOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v LookupClusterSnapshotArgs) map[string]string { return v.Tags }).(pulumi.StringMapOutput)
}
...
func init() {
	pulumi.RegisterOutputType(LookupClusterSnapshotApplyOutput{})
