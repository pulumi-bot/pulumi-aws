...
// The name of the RDS instance
func (o LookupInstanceApplyOutput) DbInstanceIdentifier() pulumi.StringOutput {
	return o.ApplyT(func(v LookupInstanceArgs) string { return v.DbInstanceIdentifier }).(pulumi.StringOutput)
}
