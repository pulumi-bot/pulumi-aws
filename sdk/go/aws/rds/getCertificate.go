...
// Certificate identifier. For example, `rds-ca-2019`.
func (o GetCertificateApplyOutput) Id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetCertificateArgs) *string { return v.Id }).(pulumi.StringPtrOutput)
}

// When enabled, returns the certificate with the latest `ValidTill`.
func (o GetCertificateApplyOutput) LatestValidTill() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v GetCertificateArgs) *bool { return v.LatestValidTill }).(pulumi.BoolPtrOutput)
}
