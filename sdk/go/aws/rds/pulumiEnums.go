...
func (EngineMode) possibleValues() map[EngineMode]bool {
	return map[EngineMode]bool{
		EngineModeProvisioned:   true,
		EngineModeServerless:    true,
		EngineModeParallelQuery: true,
		EngineModeGlobal:        true,
	}
}
...
func (EngineType) possibleValues() map[EngineType]bool {
	return map[EngineType]bool{
		EngineTypeAurora:           true,
		EngineTypeAuroraMysql:      true,
		EngineTypeAuroraPostgresql: true,
	}
}
...
func (InstanceType) possibleValues() map[InstanceType]bool {
	return map[InstanceType]bool{
		...
		InstanceType_M1_Small:     true,
		InstanceType_M1_Medium:    true,
		InstanceType_M1_Large:     true,
		InstanceType_M1_XLarge:    true,
		InstanceType_M2_XLarge:    true,
		InstanceType_M2_2XLarge:   true,
		InstanceType_M2_4XLarge:   true,
