...
// 		_default, err := rds.NewCluster(ctx, "_default", &rds.ClusterArgs{
...
// 			_res, err := rds.NewClusterInstance(ctx, fmt.Sprintf("clusterInstances-%v", key0), &rds.ClusterInstanceArgs{
