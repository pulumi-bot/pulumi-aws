...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/rds/SecurityGroupIngress"
)
...
type SecurityGroup struct {
	...
	Ingress rdsSecurityGroupIngress.SecurityGroupIngressArrayOutput `pulumi:"ingress"`
...
type securityGroupState struct {
	...
	// A list of ingress rules.
	Ingress []rdsSecurityGroupIngress.SecurityGroupIngress `pulumi:"ingress"`
	// The name of the DB security group.
...
type SecurityGroupState struct {
	...
	// A list of ingress rules.
	Ingress rdsSecurityGroupIngress.SecurityGroupIngressArrayInput
	// The name of the DB security group.
