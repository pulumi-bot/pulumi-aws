...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/rds/OptionGroupOption"
...
type OptionGroup struct {
	...
	Options rdsOptionGroupOption.OptionGroupOptionArrayOutput `pulumi:"options"`
...
type optionGroupState struct {
	...
	// A list of Options to apply.
	Options []rdsOptionGroupOption.OptionGroupOption `pulumi:"options"`
	// A mapping of tags to assign to the resource.
...
type OptionGroupState struct {
	...
	// A list of Options to apply.
	Options rdsOptionGroupOption.OptionGroupOptionArrayInput
	// A mapping of tags to assign to the resource.
