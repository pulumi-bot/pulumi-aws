...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/elb/LoadBalancerAccessLogs"
	"https:/github.com/pulumi/pulumi-aws/elb/LoadBalancerHealthCheck"
	"https:/github.com/pulumi/pulumi-aws/elb/LoadBalancerListener"
)
...
type LoadBalancer struct {
	...
	AccessLogs elbLoadBalancerAccessLogs.LoadBalancerAccessLogsPtrOutput `pulumi:"accessLogs"`
	// The ARN of the ELB
	...
	HealthCheck elbLoadBalancerHealthCheck.LoadBalancerHealthCheckOutput `pulumi:"healthCheck"`
	...
	Listeners elbLoadBalancerListener.LoadBalancerListenerArrayOutput `pulumi:"listeners"`
...
type loadBalancerState struct {
	// An Access Logs block. Access Logs documented below.
	AccessLogs *elbLoadBalancerAccessLogs.LoadBalancerAccessLogs `pulumi:"accessLogs"`
	// The ARN of the ELB
	...
	// A healthCheck block. Health Check documented below.
	HealthCheck *elbLoadBalancerHealthCheck.LoadBalancerHealthCheck `pulumi:"healthCheck"`
	// The time in seconds that the connection is allowed to be idle. Default: `60`
	...
	// A list of listener blocks. Listeners documented below.
	Listeners []elbLoadBalancerListener.LoadBalancerListener `pulumi:"listeners"`
	// The name of the ELB. By default generated by this provider.
...
type LoadBalancerState struct {
	// An Access Logs block. Access Logs documented below.
	AccessLogs elbLoadBalancerAccessLogs.LoadBalancerAccessLogsPtrInput
	// The ARN of the ELB
	...
	// A healthCheck block. Health Check documented below.
	HealthCheck elbLoadBalancerHealthCheck.LoadBalancerHealthCheckPtrInput
	// The time in seconds that the connection is allowed to be idle. Default: `60`
	...
	// A list of listener blocks. Listeners documented below.
	Listeners elbLoadBalancerListener.LoadBalancerListenerArrayInput
	// The name of the ELB. By default generated by this provider.
