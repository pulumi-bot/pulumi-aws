...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/elb/SslNegotiationPolicyAttribute"
)
...
type SslNegotiationPolicy struct {
	...
	Attributes elbSslNegotiationPolicyAttribute.SslNegotiationPolicyAttributeArrayOutput `pulumi:"attributes"`
...
type sslNegotiationPolicyState struct {
	// An SSL Negotiation policy attribute. Each has two properties:
	Attributes []elbSslNegotiationPolicyAttribute.SslNegotiationPolicyAttribute `pulumi:"attributes"`
	// The load balancer port to which the policy
	// should be applied. This must be an active listener on the load
	// balancer.
...
type SslNegotiationPolicyState struct {
	// An SSL Negotiation policy attribute. Each has two properties:
	Attributes elbSslNegotiationPolicyAttribute.SslNegotiationPolicyAttributeArrayInput
	// The load balancer port to which the policy
	// should be applied. This must be an active listener on the load
	// balancer.
