...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/appsync/ResolverPipelineConfig"
)
...
type Resolver struct {
	...
	PipelineConfig appsyncResolverPipelineConfig.ResolverPipelineConfigPtrOutput `pulumi:"pipelineConfig"`
...
type resolverState struct {
	...
	// The PipelineConfig. A `pipelineConfig` block is documented below.
	PipelineConfig *appsyncResolverPipelineConfig.ResolverPipelineConfig `pulumi:"pipelineConfig"`
	// The request mapping template for UNIT resolver or 'before mapping template' for PIPELINE resolver.
...
type ResolverState struct {
	...
	// The PipelineConfig. A `pipelineConfig` block is documented below.
	PipelineConfig appsyncResolverPipelineConfig.ResolverPipelineConfigPtrInput
	// The request mapping template for UNIT resolver or 'before mapping template' for PIPELINE resolver.
