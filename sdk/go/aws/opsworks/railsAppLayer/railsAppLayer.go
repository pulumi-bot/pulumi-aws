...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/opsworks/RailsAppLayerEbsVolume"
)
...
type RailsAppLayer struct {
	...
	EbsVolumes opsworksRailsAppLayerEbsVolume.RailsAppLayerEbsVolumeArrayOutput `pulumi:"ebsVolumes"`
...
type railsAppLayerState struct {
	...
	// `ebsVolume` blocks, as described below, will each create an EBS volume and connect it to the layer's instances.
	EbsVolumes []opsworksRailsAppLayerEbsVolume.RailsAppLayerEbsVolume `pulumi:"ebsVolumes"`
	// Name of an Elastic Load Balancer to attach to this layer
...
type RailsAppLayerState struct {
	...
	// `ebsVolume` blocks, as described below, will each create an EBS volume and connect it to the layer's instances.
	EbsVolumes opsworksRailsAppLayerEbsVolume.RailsAppLayerEbsVolumeArrayInput
	// Name of an Elastic Load Balancer to attach to this layer
