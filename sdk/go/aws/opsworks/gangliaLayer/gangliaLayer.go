...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/opsworks/GangliaLayerEbsVolume"
)
...
type GangliaLayer struct {
	...
	EbsVolumes opsworksGangliaLayerEbsVolume.GangliaLayerEbsVolumeArrayOutput `pulumi:"ebsVolumes"`
...
type gangliaLayerState struct {
	...
	// `ebsVolume` blocks, as described below, will each create an EBS volume and connect it to the layer's instances.
	EbsVolumes []opsworksGangliaLayerEbsVolume.GangliaLayerEbsVolume `pulumi:"ebsVolumes"`
	// Name of an Elastic Load Balancer to attach to this layer
...
type GangliaLayerState struct {
	...
	// `ebsVolume` blocks, as described below, will each create an EBS volume and connect it to the layer's instances.
	EbsVolumes opsworksGangliaLayerEbsVolume.GangliaLayerEbsVolumeArrayInput
	// Name of an Elastic Load Balancer to attach to this layer
