...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/opsworks/MysqlLayerEbsVolume"
)
...
type MysqlLayer struct {
	...
	EbsVolumes opsworksMysqlLayerEbsVolume.MysqlLayerEbsVolumeArrayOutput `pulumi:"ebsVolumes"`
...
type mysqlLayerState struct {
	...
	// `ebsVolume` blocks, as described below, will each create an EBS volume and connect it to the layer's instances.
	EbsVolumes []opsworksMysqlLayerEbsVolume.MysqlLayerEbsVolume `pulumi:"ebsVolumes"`
	// Name of an Elastic Load Balancer to attach to this layer
...
type MysqlLayerState struct {
	...
	// `ebsVolume` blocks, as described below, will each create an EBS volume and connect it to the layer's instances.
	EbsVolumes opsworksMysqlLayerEbsVolume.MysqlLayerEbsVolumeArrayInput
	// Name of an Elastic Load Balancer to attach to this layer
