...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/opsworks/HaproxyLayerEbsVolume"
)
...
type HaproxyLayer struct {
	...
	EbsVolumes opsworksHaproxyLayerEbsVolume.HaproxyLayerEbsVolumeArrayOutput `pulumi:"ebsVolumes"`
...
type haproxyLayerState struct {
	...
	// `ebsVolume` blocks, as described below, will each create an EBS volume and connect it to the layer's instances.
	EbsVolumes []opsworksHaproxyLayerEbsVolume.HaproxyLayerEbsVolume `pulumi:"ebsVolumes"`
	// Name of an Elastic Load Balancer to attach to this layer
...
type HaproxyLayerState struct {
	...
	// `ebsVolume` blocks, as described below, will each create an EBS volume and connect it to the layer's instances.
	EbsVolumes opsworksHaproxyLayerEbsVolume.HaproxyLayerEbsVolumeArrayInput
	// Name of an Elastic Load Balancer to attach to this layer
