...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/opsworks/InstanceEbsBlockDevice"
	"https:/github.com/pulumi/pulumi-aws/opsworks/InstanceEphemeralBlockDevice"
	"https:/github.com/pulumi/pulumi-aws/opsworks/InstanceRootBlockDevice"
)
...
type Instance struct {
	...
	EbsBlockDevices opsworksInstanceEbsBlockDevice.InstanceEbsBlockDeviceArrayOutput `pulumi:"ebsBlockDevices"`
	...
	EphemeralBlockDevices opsworksInstanceEphemeralBlockDevice.InstanceEphemeralBlockDeviceArrayOutput `pulumi:"ephemeralBlockDevices"`
	...
	RootBlockDevices opsworksInstanceRootBlockDevice.InstanceRootBlockDeviceArrayOutput `pulumi:"rootBlockDevices"`
...
type instanceState struct {
	...
	// Additional EBS block devices to attach to the
	// instance.  See Block Devices below for details.
	EbsBlockDevices []opsworksInstanceEbsBlockDevice.InstanceEbsBlockDevice `pulumi:"ebsBlockDevices"`
	// If true, the launched EC2 instance will be EBS-optimized.
	...
	// Customize Ephemeral (also known as
	// "Instance Store") volumes on the instance. See Block Devices below for details.
	EphemeralBlockDevices []opsworksInstanceEphemeralBlockDevice.InstanceEphemeralBlockDevice `pulumi:"ephemeralBlockDevices"`
	// The instance's host name.
	...
	// Customize details about the root block
	// device of the instance. See Block Devices below for details.
	RootBlockDevices []opsworksInstanceRootBlockDevice.InstanceRootBlockDevice `pulumi:"rootBlockDevices"`
	// Name of the type of root device instances will have by default.  Can be either `"ebs"` or `"instance-store"`
...
type InstanceState struct {
	...
	// Additional EBS block devices to attach to the
	// instance.  See Block Devices below for details.
	EbsBlockDevices opsworksInstanceEbsBlockDevice.InstanceEbsBlockDeviceArrayInput
	// If true, the launched EC2 instance will be EBS-optimized.
	...
	// Customize Ephemeral (also known as
	// "Instance Store") volumes on the instance. See Block Devices below for details.
	EphemeralBlockDevices opsworksInstanceEphemeralBlockDevice.InstanceEphemeralBlockDeviceArrayInput
	// The instance's host name.
	...
	// Customize details about the root block
	// device of the instance. See Block Devices below for details.
	RootBlockDevices opsworksInstanceRootBlockDevice.InstanceRootBlockDeviceArrayInput
	// Name of the type of root device instances will have by default.  Can be either `"ebs"` or `"instance-store"`
