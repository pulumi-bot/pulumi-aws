...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/opsworks/StaticWebLayerEbsVolume"
)
...
type StaticWebLayer struct {
	...
	EbsVolumes opsworksStaticWebLayerEbsVolume.StaticWebLayerEbsVolumeArrayOutput `pulumi:"ebsVolumes"`
...
type staticWebLayerState struct {
	...
	// `ebsVolume` blocks, as described below, will each create an EBS volume and connect it to the layer's instances.
	EbsVolumes []opsworksStaticWebLayerEbsVolume.StaticWebLayerEbsVolume `pulumi:"ebsVolumes"`
	// Name of an Elastic Load Balancer to attach to this layer
...
type StaticWebLayerState struct {
	...
	// `ebsVolume` blocks, as described below, will each create an EBS volume and connect it to the layer's instances.
	EbsVolumes opsworksStaticWebLayerEbsVolume.StaticWebLayerEbsVolumeArrayInput
	// Name of an Elastic Load Balancer to attach to this layer
