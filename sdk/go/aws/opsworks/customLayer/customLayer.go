...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/opsworks/CustomLayerEbsVolume"
)
...
type CustomLayer struct {
	...
	EbsVolumes opsworksCustomLayerEbsVolume.CustomLayerEbsVolumeArrayOutput `pulumi:"ebsVolumes"`
...
type customLayerState struct {
	...
	// `ebsVolume` blocks, as described below, will each create an EBS volume and connect it to the layer's instances.
	EbsVolumes []opsworksCustomLayerEbsVolume.CustomLayerEbsVolume `pulumi:"ebsVolumes"`
	// Name of an Elastic Load Balancer to attach to this layer
...
type CustomLayerState struct {
	...
	// `ebsVolume` blocks, as described below, will each create an EBS volume and connect it to the layer's instances.
	EbsVolumes opsworksCustomLayerEbsVolume.CustomLayerEbsVolumeArrayInput
	// Name of an Elastic Load Balancer to attach to this layer
