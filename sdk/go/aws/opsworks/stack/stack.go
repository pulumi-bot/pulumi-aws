...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/opsworks/StackCustomCookbooksSource"
)
...
type Stack struct {
	...
	// described below.
	CustomCookbooksSources opsworksStackCustomCookbooksSource.StackCustomCookbooksSourceArrayOutput `pulumi:"customCookbooksSources"`
...
type stackState struct {
	...
	// When `useCustomCookbooks` is set, provide this sub-object as
	// described below.
	CustomCookbooksSources []opsworksStackCustomCookbooksSource.StackCustomCookbooksSource `pulumi:"customCookbooksSources"`
	// Custom JSON attributes to apply to the entire stack.
...
type StackState struct {
	...
	// When `useCustomCookbooks` is set, provide this sub-object as
	// described below.
	CustomCookbooksSources opsworksStackCustomCookbooksSource.StackCustomCookbooksSourceArrayInput
	// Custom JSON attributes to apply to the entire stack.
