...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/opsworks/JavaAppLayerEbsVolume"
)
...
type JavaAppLayer struct {
	...
	EbsVolumes opsworksJavaAppLayerEbsVolume.JavaAppLayerEbsVolumeArrayOutput `pulumi:"ebsVolumes"`
...
type javaAppLayerState struct {
	...
	// `ebsVolume` blocks, as described below, will each create an EBS volume and connect it to the layer's instances.
	EbsVolumes []opsworksJavaAppLayerEbsVolume.JavaAppLayerEbsVolume `pulumi:"ebsVolumes"`
	// Name of an Elastic Load Balancer to attach to this layer
...
type JavaAppLayerState struct {
	...
	// `ebsVolume` blocks, as described below, will each create an EBS volume and connect it to the layer's instances.
	EbsVolumes opsworksJavaAppLayerEbsVolume.JavaAppLayerEbsVolumeArrayInput
	// Name of an Elastic Load Balancer to attach to this layer
