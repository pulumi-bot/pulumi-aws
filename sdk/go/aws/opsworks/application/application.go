...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/opsworks/ApplicationAppSource"
	"https:/github.com/pulumi/pulumi-aws/opsworks/ApplicationEnvironment"
	"https:/github.com/pulumi/pulumi-aws/opsworks/ApplicationSslConfiguration"
)
...
type Application struct {
	...
	AppSources opsworksApplicationAppSource.ApplicationAppSourceArrayOutput `pulumi:"appSources"`
	...
	Environments opsworksApplicationEnvironment.ApplicationEnvironmentArrayOutput `pulumi:"environments"`
	...
	SslConfigurations opsworksApplicationSslConfiguration.ApplicationSslConfigurationArrayOutput `pulumi:"sslConfigurations"`
...
type applicationState struct {
	// SCM configuration of the app as described below.
	AppSources []opsworksApplicationAppSource.ApplicationAppSource `pulumi:"appSources"`
	// Run bundle install when deploying for application of type `rails`.
	...
	// Object to define environment variables.  Object is described below.
	Environments []opsworksApplicationEnvironment.ApplicationEnvironment `pulumi:"environments"`
	// A human-readable name for the application.
	...
	// The SSL configuration of the app. Object is described below.
	SslConfigurations []opsworksApplicationSslConfiguration.ApplicationSslConfiguration `pulumi:"sslConfigurations"`
	// The id of the stack the application will belong to.
...
type ApplicationState struct {
	// SCM configuration of the app as described below.
	AppSources opsworksApplicationAppSource.ApplicationAppSourceArrayInput
	// Run bundle install when deploying for application of type `rails`.
	...
	// Object to define environment variables.  Object is described below.
	Environments opsworksApplicationEnvironment.ApplicationEnvironmentArrayInput
	// A human-readable name for the application.
	...
	// The SSL configuration of the app. Object is described below.
	SslConfigurations opsworksApplicationSslConfiguration.ApplicationSslConfigurationArrayInput
	// The id of the stack the application will belong to.
