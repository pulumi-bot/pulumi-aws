...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/opsworks/NodejsAppLayerEbsVolume"
)
...
type NodejsAppLayer struct {
	...
	EbsVolumes opsworksNodejsAppLayerEbsVolume.NodejsAppLayerEbsVolumeArrayOutput `pulumi:"ebsVolumes"`
...
type nodejsAppLayerState struct {
	...
	// `ebsVolume` blocks, as described below, will each create an EBS volume and connect it to the layer's instances.
	EbsVolumes []opsworksNodejsAppLayerEbsVolume.NodejsAppLayerEbsVolume `pulumi:"ebsVolumes"`
	// Name of an Elastic Load Balancer to attach to this layer
...
type NodejsAppLayerState struct {
	...
	// `ebsVolume` blocks, as described below, will each create an EBS volume and connect it to the layer's instances.
	EbsVolumes opsworksNodejsAppLayerEbsVolume.NodejsAppLayerEbsVolumeArrayInput
	// Name of an Elastic Load Balancer to attach to this layer
