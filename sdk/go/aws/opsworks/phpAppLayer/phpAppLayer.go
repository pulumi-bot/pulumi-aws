...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/opsworks/PhpAppLayerEbsVolume"
)
...
type PhpAppLayer struct {
	...
	EbsVolumes opsworksPhpAppLayerEbsVolume.PhpAppLayerEbsVolumeArrayOutput `pulumi:"ebsVolumes"`
...
type phpAppLayerState struct {
	...
	// `ebsVolume` blocks, as described below, will each create an EBS volume and connect it to the layer's instances.
	EbsVolumes []opsworksPhpAppLayerEbsVolume.PhpAppLayerEbsVolume `pulumi:"ebsVolumes"`
	// Name of an Elastic Load Balancer to attach to this layer
...
type PhpAppLayerState struct {
	...
	// `ebsVolume` blocks, as described below, will each create an EBS volume and connect it to the layer's instances.
	EbsVolumes opsworksPhpAppLayerEbsVolume.PhpAppLayerEbsVolumeArrayInput
	// Name of an Elastic Load Balancer to attach to this layer
