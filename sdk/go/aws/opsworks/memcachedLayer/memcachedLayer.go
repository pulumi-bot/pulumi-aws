...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/opsworks/MemcachedLayerEbsVolume"
)
...
type MemcachedLayer struct {
	...
	EbsVolumes opsworksMemcachedLayerEbsVolume.MemcachedLayerEbsVolumeArrayOutput `pulumi:"ebsVolumes"`
...
type memcachedLayerState struct {
	...
	// `ebsVolume` blocks, as described below, will each create an EBS volume and connect it to the layer's instances.
	EbsVolumes []opsworksMemcachedLayerEbsVolume.MemcachedLayerEbsVolume `pulumi:"ebsVolumes"`
	// Name of an Elastic Load Balancer to attach to this layer
...
type MemcachedLayerState struct {
	...
	// `ebsVolume` blocks, as described below, will each create an EBS volume and connect it to the layer's instances.
	EbsVolumes opsworksMemcachedLayerEbsVolume.MemcachedLayerEbsVolumeArrayInput
	// Name of an Elastic Load Balancer to attach to this layer
