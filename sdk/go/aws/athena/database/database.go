...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/athena/DatabaseEncryptionConfiguration"
)
...
type Database struct {
	...
	EncryptionConfiguration athenaDatabaseEncryptionConfiguration.DatabaseEncryptionConfigurationPtrOutput `pulumi:"encryptionConfiguration"`
...
type databaseState struct {
	...
	// The encryption key block AWS Athena uses to decrypt the data in S3, such as an AWS Key Management Service (AWS KMS) key. An `encryptionConfiguration` block is documented below.
	EncryptionConfiguration *athenaDatabaseEncryptionConfiguration.DatabaseEncryptionConfiguration `pulumi:"encryptionConfiguration"`
	// A boolean that indicates all tables should be deleted from the database so that the database can be destroyed without error. The tables are *not* recoverable.
...
type DatabaseState struct {
	...
	// The encryption key block AWS Athena uses to decrypt the data in S3, such as an AWS Key Management Service (AWS KMS) key. An `encryptionConfiguration` block is documented below.
	EncryptionConfiguration athenaDatabaseEncryptionConfiguration.DatabaseEncryptionConfigurationPtrInput
	// A boolean that indicates all tables should be deleted from the database so that the database can be destroyed without error. The tables are *not* recoverable.
