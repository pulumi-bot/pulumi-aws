...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/elasticbeanstalk/ConfigurationTemplateSetting"
)
...
type ConfigurationTemplate struct {
	...
	Settings elasticbeanstalkConfigurationTemplateSetting.ConfigurationTemplateSettingArrayOutput `pulumi:"settings"`
...
type configurationTemplateState struct {
	...
	// override specific values that are set as defaults. The format is detailed
	// below in Option Settings
	Settings []elasticbeanstalkConfigurationTemplateSetting.ConfigurationTemplateSetting `pulumi:"settings"`
	// A solution stack to base your Template
	// off of. Example stacks can be found in the [Amazon API documentation][1]
...
type ConfigurationTemplateState struct {
	...
	// override specific values that are set as defaults. The format is detailed
	// below in Option Settings
	Settings elasticbeanstalkConfigurationTemplateSetting.ConfigurationTemplateSettingArrayInput
	// A solution stack to base your Template
	// off of. Example stacks can be found in the [Amazon API documentation][1]
