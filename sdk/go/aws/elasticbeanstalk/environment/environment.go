...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/elasticbeanstalk/EnvironmentAllSetting"
	"https:/github.com/pulumi/pulumi-aws/elasticbeanstalk/EnvironmentSetting"
)
...
type Environment struct {
	...
	// the configuration.
	AllSettings elasticbeanstalkEnvironmentAllSetting.EnvironmentAllSettingArrayOutput `pulumi:"allSettings"`
	...
	Settings elasticbeanstalkEnvironmentSetting.EnvironmentSettingArrayOutput `pulumi:"settings"`
...
type environmentState struct {
	...
	// are a combination of default settings and their overrides from `setting` in
	// the configuration.
	AllSettings []elasticbeanstalkEnvironmentAllSetting.EnvironmentAllSetting `pulumi:"allSettings"`
	// Name of the application that contains the version
	// to be deployed
	...
	// override specific values that are set as defaults. The format is detailed
	// below in Option Settings
	Settings []elasticbeanstalkEnvironmentSetting.EnvironmentSetting `pulumi:"settings"`
	// A solution stack to base your environment
	// off of. Example stacks can be found in the [Amazon API documentation][1]
...
type EnvironmentState struct {
	...
	// are a combination of default settings and their overrides from `setting` in
	// the configuration.
	AllSettings elasticbeanstalkEnvironmentAllSetting.EnvironmentAllSettingArrayInput
	// Name of the application that contains the version
	// to be deployed
	...
	// override specific values that are set as defaults. The format is detailed
	// below in Option Settings
	Settings elasticbeanstalkEnvironmentSetting.EnvironmentSettingArrayInput
	// A solution stack to base your environment
	// off of. Example stacks can be found in the [Amazon API documentation][1]
