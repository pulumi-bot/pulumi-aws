...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/cloudwatch/MetricAlarmMetricQuery"
...
type MetricAlarm struct {
	...
	MetricQueries cloudwatchMetricAlarmMetricQuery.MetricAlarmMetricQueryArrayOutput `pulumi:"metricQueries"`
...
type metricAlarmState struct {
	...
	// Enables you to create an alarm based on a metric math expression. You may specify at most 20.
	MetricQueries []cloudwatchMetricAlarmMetricQuery.MetricAlarmMetricQuery `pulumi:"metricQueries"`
	// The descriptive name for the alarm. This name must be unique within the user's AWS account
...
type MetricAlarmState struct {
	...
	// Enables you to create an alarm based on a metric math expression. You may specify at most 20.
	MetricQueries cloudwatchMetricAlarmMetricQuery.MetricAlarmMetricQueryArrayInput
	// The descriptive name for the alarm. This name must be unique within the user's AWS account
