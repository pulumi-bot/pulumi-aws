...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/cloudwatch/LogMetricFilterMetricTransformation"
)
...
type LogMetricFilter struct {
	...
	MetricTransformation cloudwatchLogMetricFilterMetricTransformation.LogMetricFilterMetricTransformationOutput `pulumi:"metricTransformation"`
...
type logMetricFilterState struct {
	...
	// A block defining collection of information
	// needed to define how metric data gets emitted. See below.
	MetricTransformation *cloudwatchLogMetricFilterMetricTransformation.LogMetricFilterMetricTransformation `pulumi:"metricTransformation"`
	// A name for the metric filter.
...
type LogMetricFilterState struct {
	...
	// A block defining collection of information
	// needed to define how metric data gets emitted. See below.
	MetricTransformation cloudwatchLogMetricFilterMetricTransformation.LogMetricFilterMetricTransformationPtrInput
	// A name for the metric filter.
...
type LogMetricFilterArgs struct {
	...
	// A block defining collection of information
	// needed to define how metric data gets emitted. See below.
	MetricTransformation cloudwatchLogMetricFilterMetricTransformation.LogMetricFilterMetricTransformationInput
	// A name for the metric filter.
	Name pulumi.StringPtrInput
	// A valid [CloudWatch Logs filter pattern](https://docs.aws.amazon.com/AmazonCloudWatch/latest/DeveloperGuide/FilterAndPatternSyntax.html)
	// for extracting metric data out of ingested log events.
