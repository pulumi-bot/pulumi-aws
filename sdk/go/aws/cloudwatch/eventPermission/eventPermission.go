...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/cloudwatch/EventPermissionCondition"
)
...
type EventPermission struct {
	...
	Condition cloudwatchEventPermissionCondition.EventPermissionConditionPtrOutput `pulumi:"condition"`
...
type eventPermissionState struct {
	...
	// Configuration block to limit the event bus permissions you are granting to only accounts that fulfill the condition. Specified below.
	Condition *cloudwatchEventPermissionCondition.EventPermissionCondition `pulumi:"condition"`
	// The 12-digit AWS account ID that you are permitting to put events to your default event bus. Specify `*` to permit any account to put events to your default event bus, optionally limited by `condition`.
...
type EventPermissionState struct {
	...
	// Configuration block to limit the event bus permissions you are granting to only accounts that fulfill the condition. Specified below.
	Condition cloudwatchEventPermissionCondition.EventPermissionConditionPtrInput
	// The 12-digit AWS account ID that you are permitting to put events to your default event bus. Specify `*` to permit any account to put events to your default event bus, optionally limited by `condition`.
