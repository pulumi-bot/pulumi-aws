...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/gamelift/AliasRoutingStrategy"
)
...
type Alias struct {
	...
	RoutingStrategy gameliftAliasRoutingStrategy.AliasRoutingStrategyOutput `pulumi:"routingStrategy"`
}
...
type aliasState struct {
	...
	// Specifies the fleet and/or routing type to use for the alias.
	RoutingStrategy *gameliftAliasRoutingStrategy.AliasRoutingStrategy `pulumi:"routingStrategy"`
}
...
type AliasState struct {
	...
	// Specifies the fleet and/or routing type to use for the alias.
	RoutingStrategy gameliftAliasRoutingStrategy.AliasRoutingStrategyPtrInput
}
...
type AliasArgs struct {
	...
	Name pulumi.StringPtrInput
	// Specifies the fleet and/or routing type to use for the alias.
	RoutingStrategy gameliftAliasRoutingStrategy.AliasRoutingStrategyInput
}
