...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/gamelift/FleetEc2InboundPermission"
	"https:/github.com/pulumi/pulumi-aws/gamelift/FleetResourceCreationLimitPolicy"
	"https:/github.com/pulumi/pulumi-aws/gamelift/FleetRuntimeConfiguration"
...
type Fleet struct {
	...
	Ec2InboundPermissions gameliftFleetEc2InboundPermission.FleetEc2InboundPermissionArrayOutput `pulumi:"ec2InboundPermissions"`
	...
	ResourceCreationLimitPolicy gameliftFleetResourceCreationLimitPolicy.FleetResourceCreationLimitPolicyPtrOutput `pulumi:"resourceCreationLimitPolicy"`
	// Instructions for launching server processes on each instance in the fleet. See below.
	RuntimeConfiguration gameliftFleetRuntimeConfiguration.FleetRuntimeConfigurationPtrOutput `pulumi:"runtimeConfiguration"`
}
...
type fleetState struct {
	...
	// Range of IP addresses and port settings that permit inbound traffic to access server processes running on the fleet. See below.
	Ec2InboundPermissions []gameliftFleetEc2InboundPermission.FleetEc2InboundPermission `pulumi:"ec2InboundPermissions"`
	// Name of an EC2 instance type. e.g. `t2.micro`
	...
	// Policy that limits the number of game sessions an individual player can create over a span of time for this fleet. See below.
	ResourceCreationLimitPolicy *gameliftFleetResourceCreationLimitPolicy.FleetResourceCreationLimitPolicy `pulumi:"resourceCreationLimitPolicy"`
	// Instructions for launching server processes on each instance in the fleet. See below.
	RuntimeConfiguration *gameliftFleetRuntimeConfiguration.FleetRuntimeConfiguration `pulumi:"runtimeConfiguration"`
}
...
type FleetState struct {
	...
	// Range of IP addresses and port settings that permit inbound traffic to access server processes running on the fleet. See below.
	Ec2InboundPermissions gameliftFleetEc2InboundPermission.FleetEc2InboundPermissionArrayInput
	// Name of an EC2 instance type. e.g. `t2.micro`
	...
	// Policy that limits the number of game sessions an individual player can create over a span of time for this fleet. See below.
	ResourceCreationLimitPolicy gameliftFleetResourceCreationLimitPolicy.FleetResourceCreationLimitPolicyPtrInput
	// Instructions for launching server processes on each instance in the fleet. See below.
	RuntimeConfiguration gameliftFleetRuntimeConfiguration.FleetRuntimeConfigurationPtrInput
}
