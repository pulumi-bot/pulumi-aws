...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/gamelift/BuildStorageLocation"
)
...
type Build struct {
	...
	StorageLocation gameliftBuildStorageLocation.BuildStorageLocationOutput `pulumi:"storageLocation"`
...
type buildState struct {
	...
	// Information indicating where your game build files are stored. See below.
	StorageLocation *gameliftBuildStorageLocation.BuildStorageLocation `pulumi:"storageLocation"`
	// Version that is associated with this build.
...
type BuildState struct {
	...
	// Information indicating where your game build files are stored. See below.
	StorageLocation gameliftBuildStorageLocation.BuildStorageLocationPtrInput
	// Version that is associated with this build.
...
type BuildArgs struct {
	...
	// Information indicating where your game build files are stored. See below.
	StorageLocation gameliftBuildStorageLocation.BuildStorageLocationInput
	// Version that is associated with this build.
	Version pulumi.StringPtrInput
}
