...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/worklink/FleetIdentityProvider"
	"https:/github.com/pulumi/pulumi-aws/worklink/FleetNetwork"
)
...
type Fleet struct {
	...
	IdentityProvider worklinkFleetIdentityProvider.FleetIdentityProviderPtrOutput `pulumi:"identityProvider"`
	// The time that the fleet was last updated.
	LastUpdatedTime pulumi.StringOutput `pulumi:"lastUpdatedTime"`
	// A region-unique name for the AMI.
	Name pulumi.StringOutput `pulumi:"name"`
	// Provide this to allow manage the company network configuration for the fleet. Fields documented below.
	Network worklinkFleetNetwork.FleetNetworkPtrOutput `pulumi:"network"`
...
type fleetState struct {
	...
	// Provide this to allow manage the identity provider configuration for the fleet. Fields documented below.
	IdentityProvider *worklinkFleetIdentityProvider.FleetIdentityProvider `pulumi:"identityProvider"`
	// The time that the fleet was last updated.
	LastUpdatedTime *string `pulumi:"lastUpdatedTime"`
	// A region-unique name for the AMI.
	Name *string `pulumi:"name"`
	// Provide this to allow manage the company network configuration for the fleet. Fields documented below.
	Network *worklinkFleetNetwork.FleetNetwork `pulumi:"network"`
	// The option to optimize for better performance by routing traffic through the closest AWS Region to users, which may be outside of your home Region. Defaults to `true`.
...
type FleetState struct {
	...
	// Provide this to allow manage the identity provider configuration for the fleet. Fields documented below.
	IdentityProvider worklinkFleetIdentityProvider.FleetIdentityProviderPtrInput
	// The time that the fleet was last updated.
	LastUpdatedTime pulumi.StringPtrInput
	// A region-unique name for the AMI.
	Name pulumi.StringPtrInput
	// Provide this to allow manage the company network configuration for the fleet. Fields documented below.
	Network worklinkFleetNetwork.FleetNetworkPtrInput
	// The option to optimize for better performance by routing traffic through the closest AWS Region to users, which may be outside of your home Region. Defaults to `true`.
