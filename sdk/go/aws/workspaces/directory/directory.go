...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/workspaces/DirectorySelfServicePermissions"
)
...
type Directory struct {
	...
	SelfServicePermissions workspacesDirectorySelfServicePermissions.DirectorySelfServicePermissionsOutput `pulumi:"selfServicePermissions"`
...
type directoryState struct {
	...
	// The permissions to enable or disable self-service capabilities.
	SelfServicePermissions *workspacesDirectorySelfServicePermissions.DirectorySelfServicePermissions `pulumi:"selfServicePermissions"`
	// The identifiers of the subnets where the directory resides.
...
type DirectoryState struct {
	...
	// The permissions to enable or disable self-service capabilities.
	SelfServicePermissions workspacesDirectorySelfServicePermissions.DirectorySelfServicePermissionsPtrInput
	// The identifiers of the subnets where the directory resides.
