...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/workspaces/IpGroupRule"
)
...
type IpGroup struct {
	...
	Rules workspacesIpGroupRule.IpGroupRuleArrayOutput `pulumi:"rules"`
...
type ipGroupState struct {
	...
	// One or more pairs specifying the IP group rule (in CIDR format) from which web requests originate.
	Rules []workspacesIpGroupRule.IpGroupRule `pulumi:"rules"`
...
type IpGroupState struct {
	...
	// One or more pairs specifying the IP group rule (in CIDR format) from which web requests originate.
	Rules workspacesIpGroupRule.IpGroupRuleArrayInput
