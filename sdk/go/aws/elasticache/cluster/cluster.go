...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/elasticache/ClusterCacheNode"
)
...
type Cluster struct {
	...
	CacheNodes elasticacheClusterCacheNode.ClusterCacheNodeArrayOutput `pulumi:"cacheNodes"`
...
type clusterState struct {
	...
	// List of node objects including `id`, `address`, `port` and `availabilityZone`.
	// Referenceable e.g. as `${aws_elasticache_cluster.bar.cache_nodes.0.address}`
	CacheNodes []elasticacheClusterCacheNode.ClusterCacheNode `pulumi:"cacheNodes"`
	// (Memcached only) The DNS name of the cache cluster without the port appended.
...
type ClusterState struct {
	...
	// List of node objects including `id`, `address`, `port` and `availabilityZone`.
	// Referenceable e.g. as `${aws_elasticache_cluster.bar.cache_nodes.0.address}`
	CacheNodes elasticacheClusterCacheNode.ClusterCacheNodeArrayInput
	// (Memcached only) The DNS name of the cache cluster without the port appended.
