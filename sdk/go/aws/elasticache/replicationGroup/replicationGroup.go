...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/elasticache/ReplicationGroupClusterMode"
)
...
type ReplicationGroup struct {
	...
	ClusterMode elasticacheReplicationGroupClusterMode.ReplicationGroupClusterModeOutput `pulumi:"clusterMode"`
...
type replicationGroupState struct {
	...
	// Create a native redis cluster. `automaticFailoverEnabled` must be set to true. Cluster Mode documented below. Only 1 `clusterMode` block is allowed.
	ClusterMode *elasticacheReplicationGroupClusterMode.ReplicationGroupClusterMode `pulumi:"clusterMode"`
	// The address of the replication group configuration endpoint when cluster mode is enabled.
...
type ReplicationGroupState struct {
	...
	// Create a native redis cluster. `automaticFailoverEnabled` must be set to true. Cluster Mode documented below. Only 1 `clusterMode` block is allowed.
	ClusterMode elasticacheReplicationGroupClusterMode.ReplicationGroupClusterModePtrInput
	// The address of the replication group configuration endpoint when cluster mode is enabled.
