...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/route53/ResolverRuleTargetIp"
)
...
type ResolverRule struct {
	...
	// This argument should only be specified for `FORWARD` type rules.
	TargetIps route53ResolverRuleTargetIp.ResolverRuleTargetIpArrayOutput `pulumi:"targetIps"`
}
...
type resolverRuleState struct {
	...
	// Configuration block(s) indicating the IPs that you want Resolver to forward DNS queries to (documented below).
	// This argument should only be specified for `FORWARD` type rules.
	TargetIps []route53ResolverRuleTargetIp.ResolverRuleTargetIp `pulumi:"targetIps"`
}
...
type ResolverRuleState struct {
	...
	// Configuration block(s) indicating the IPs that you want Resolver to forward DNS queries to (documented below).
	// This argument should only be specified for `FORWARD` type rules.
	TargetIps route53ResolverRuleTargetIp.ResolverRuleTargetIpArrayInput
}
