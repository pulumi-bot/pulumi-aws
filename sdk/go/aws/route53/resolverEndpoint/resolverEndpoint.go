...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/route53/ResolverEndpointIpAddress"
)
...
type ResolverEndpoint struct {
	...
	IpAddresses route53ResolverEndpointIpAddress.ResolverEndpointIpAddressArrayOutput `pulumi:"ipAddresses"`
...
type resolverEndpointState struct {
	...
	// The subnets and IP addresses in your VPC that you want DNS queries to pass through on the way from your VPCs
	// to your network (for outbound endpoints) or on the way from your network to your VPCs (for inbound endpoints). Described below.
	IpAddresses []route53ResolverEndpointIpAddress.ResolverEndpointIpAddress `pulumi:"ipAddresses"`
	// The friendly name of the Route 53 Resolver endpoint.
...
type ResolverEndpointState struct {
	...
	// The subnets and IP addresses in your VPC that you want DNS queries to pass through on the way from your VPCs
	// to your network (for outbound endpoints) or on the way from your network to your VPCs (for inbound endpoints). Described below.
	IpAddresses route53ResolverEndpointIpAddress.ResolverEndpointIpAddressArrayInput
	// The friendly name of the Route 53 Resolver endpoint.
