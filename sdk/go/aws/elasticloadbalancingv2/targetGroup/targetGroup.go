...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/elasticloadbalancingv2/TargetGroupHealthCheck"
	"https:/github.com/pulumi/pulumi-aws/elasticloadbalancingv2/TargetGroupStickiness"
)
...
type TargetGroup struct {
	...
	HealthCheck elasticloadbalancingv2TargetGroupHealthCheck.TargetGroupHealthCheckOutput `pulumi:"healthCheck"`
	...
	Stickiness elasticloadbalancingv2TargetGroupStickiness.TargetGroupStickinessOutput `pulumi:"stickiness"`
...
type targetGroupState struct {
	...
	// A Health Check block. Health Check blocks are documented below.
	HealthCheck *elasticloadbalancingv2TargetGroupHealthCheck.TargetGroupHealthCheck `pulumi:"healthCheck"`
	// Boolean whether the request and response headers exchanged between the load balancer and the Lambda function include arrays of values or strings. Only applies when `targetType` is `lambda`.
	...
	// A Stickiness block. Stickiness blocks are documented below. `stickiness` is only valid if used with Load Balancers of type `Application`
	Stickiness *elasticloadbalancingv2TargetGroupStickiness.TargetGroupStickiness `pulumi:"stickiness"`
	// A mapping of tags to assign to the resource.
...
type TargetGroupState struct {
	...
	// A Health Check block. Health Check blocks are documented below.
	HealthCheck elasticloadbalancingv2TargetGroupHealthCheck.TargetGroupHealthCheckPtrInput
	// Boolean whether the request and response headers exchanged between the load balancer and the Lambda function include arrays of values or strings. Only applies when `targetType` is `lambda`.
	...
	// A Stickiness block. Stickiness blocks are documented below. `stickiness` is only valid if used with Load Balancers of type `Application`
	Stickiness elasticloadbalancingv2TargetGroupStickiness.TargetGroupStickinessPtrInput
	// A mapping of tags to assign to the resource.
