...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/elasticloadbalancingv2/ListenerRuleAction"
	...
	"https:/github.com/pulumi/pulumi-aws/elasticloadbalancingv2/ListenerRuleCondition"
...
type ListenerRule struct {
	...
	Actions elasticloadbalancingv2ListenerRuleAction.ListenerRuleActionArrayOutput `pulumi:"actions"`
	// The ARN of the rule (matches `id`)
	Arn pulumi.StringOutput `pulumi:"arn"`
	// A Condition block. Multiple condition blocks of different types can be set and all must be satisfied for the rule to match. Condition blocks are documented below.
	Conditions elasticloadbalancingv2ListenerRuleCondition.ListenerRuleConditionArrayOutput `pulumi:"conditions"`
...
type listenerRuleState struct {
	// An Action block. Action blocks are documented below.
	Actions []elasticloadbalancingv2ListenerRuleAction.ListenerRuleAction `pulumi:"actions"`
	// The ARN of the rule (matches `id`)
	Arn *string `pulumi:"arn"`
	// A Condition block. Multiple condition blocks of different types can be set and all must be satisfied for the rule to match. Condition blocks are documented below.
	Conditions []elasticloadbalancingv2ListenerRuleCondition.ListenerRuleCondition `pulumi:"conditions"`
	// The ARN of the listener to which to attach the rule.
...
type ListenerRuleState struct {
	// An Action block. Action blocks are documented below.
	Actions elasticloadbalancingv2ListenerRuleAction.ListenerRuleActionArrayInput
	// The ARN of the rule (matches `id`)
	Arn pulumi.StringPtrInput
	// A Condition block. Multiple condition blocks of different types can be set and all must be satisfied for the rule to match. Condition blocks are documented below.
	Conditions elasticloadbalancingv2ListenerRuleCondition.ListenerRuleConditionArrayInput
	// The ARN of the listener to which to attach the rule.
