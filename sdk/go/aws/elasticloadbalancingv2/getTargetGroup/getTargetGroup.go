...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/elasticloadbalancingv2/getTargetGroupHealthCheck"
	"https:/github.com/pulumi/pulumi-aws/elasticloadbalancingv2/getTargetGroupStickiness"
)
...
type GetTargetGroupResult struct {
	...
	HealthCheck elasticloadbalancingv2getTargetGroupHealthCheck.GetTargetGroupHealthCheck `pulumi:"healthCheck"`
	...
	Stickiness elasticloadbalancingv2getTargetGroupStickiness.GetTargetGroupStickiness `pulumi:"stickiness"`
	Tags map[string]interface{} `pulumi:"tags"`
