...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/elasticloadbalancingv2/getLoadBalancerAccessLogs"
	"https:/github.com/pulumi/pulumi-aws/elasticloadbalancingv2/getLoadBalancerSubnetMapping"
)
...
type GetLoadBalancerResult struct {
	AccessLogs elasticloadbalancingv2getLoadBalancerAccessLogs.GetLoadBalancerAccessLogs `pulumi:"accessLogs"`
	Arn string `pulumi:"arn"`
	...
	SubnetMappings []elasticloadbalancingv2getLoadBalancerSubnetMapping.GetLoadBalancerSubnetMapping `pulumi:"subnetMappings"`
