...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/elasticloadbalancingv2/LoadBalancerAccessLogs"
	"https:/github.com/pulumi/pulumi-aws/elasticloadbalancingv2/LoadBalancerSubnetMapping"
)
...
type LoadBalancer struct {
	...
	AccessLogs elasticloadbalancingv2LoadBalancerAccessLogs.LoadBalancerAccessLogsPtrOutput `pulumi:"accessLogs"`
	...
	SubnetMappings elasticloadbalancingv2LoadBalancerSubnetMapping.LoadBalancerSubnetMappingArrayOutput `pulumi:"subnetMappings"`
...
type loadBalancerState struct {
	// An Access Logs block. Access Logs documented below.
	AccessLogs *elasticloadbalancingv2LoadBalancerAccessLogs.LoadBalancerAccessLogs `pulumi:"accessLogs"`
	// The ARN of the load balancer (matches `id`).
	...
	// A subnet mapping block as documented below.
	SubnetMappings []elasticloadbalancingv2LoadBalancerSubnetMapping.LoadBalancerSubnetMapping `pulumi:"subnetMappings"`
	// A list of subnet IDs to attach to the LB. Subnets
	// cannot be updated for Load Balancers of type `network`. Changing this value
	// for load balancers of type `network` will force a recreation of the resource.
...
type LoadBalancerState struct {
	// An Access Logs block. Access Logs documented below.
	AccessLogs elasticloadbalancingv2LoadBalancerAccessLogs.LoadBalancerAccessLogsPtrInput
	// The ARN of the load balancer (matches `id`).
	...
	// A subnet mapping block as documented below.
	SubnetMappings elasticloadbalancingv2LoadBalancerSubnetMapping.LoadBalancerSubnetMappingArrayInput
	// A list of subnet IDs to attach to the LB. Subnets
	// cannot be updated for Load Balancers of type `network`. Changing this value
	// for load balancers of type `network` will force a recreation of the resource.
