...
// 		_default, err := neptune.NewCluster(ctx, "_default", &neptune.ClusterArgs{
...
// 		for key0, _ := range 2 {
// 			_res, err := neptune.NewClusterInstance(ctx, fmt.Sprintf("example-%v", key0), &neptune.ClusterInstanceArgs{
// 				ApplyImmediately:  pulumi.Bool(true),
