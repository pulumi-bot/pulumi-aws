...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/ec2clientvpn/EndpointAuthenticationOptions"
	"https:/github.com/pulumi/pulumi-aws/ec2clientvpn/EndpointConnectionLogOptions"
)
...
type Endpoint struct {
	...
	AuthenticationOptions ec2clientvpnEndpointAuthenticationOptions.EndpointAuthenticationOptionsOutput `pulumi:"authenticationOptions"`
	...
	ConnectionLogOptions ec2clientvpnEndpointConnectionLogOptions.EndpointConnectionLogOptionsOutput `pulumi:"connectionLogOptions"`
...
type endpointState struct {
	// Information about the authentication method to be used to authenticate clients.
	AuthenticationOptions *ec2clientvpnEndpointAuthenticationOptions.EndpointAuthenticationOptions `pulumi:"authenticationOptions"`
	// The IPv4 address range, in CIDR notation, from which to assign client IP addresses. The address range cannot overlap with the local CIDR of the VPC in which the associated subnet is located, or the routes that you add manually. The address range cannot be changed after the Client VPN endpoint has been created. The CIDR block should be /22 or greater.
	ClientCidrBlock *string `pulumi:"clientCidrBlock"`
	// Information about the client connection logging options.
	ConnectionLogOptions *ec2clientvpnEndpointConnectionLogOptions.EndpointConnectionLogOptions `pulumi:"connectionLogOptions"`
	// Name of the repository.
...
type EndpointState struct {
	// Information about the authentication method to be used to authenticate clients.
	AuthenticationOptions ec2clientvpnEndpointAuthenticationOptions.EndpointAuthenticationOptionsPtrInput
	// The IPv4 address range, in CIDR notation, from which to assign client IP addresses. The address range cannot overlap with the local CIDR of the VPC in which the associated subnet is located, or the routes that you add manually. The address range cannot be changed after the Client VPN endpoint has been created. The CIDR block should be /22 or greater.
	ClientCidrBlock pulumi.StringPtrInput
	// Information about the client connection logging options.
	ConnectionLogOptions ec2clientvpnEndpointConnectionLogOptions.EndpointConnectionLogOptionsPtrInput
	// Name of the repository.
...
type EndpointArgs struct {
	// Information about the authentication method to be used to authenticate clients.
	AuthenticationOptions ec2clientvpnEndpointAuthenticationOptions.EndpointAuthenticationOptionsInput
	// The IPv4 address range, in CIDR notation, from which to assign client IP addresses. The address range cannot overlap with the local CIDR of the VPC in which the associated subnet is located, or the routes that you add manually. The address range cannot be changed after the Client VPN endpoint has been created. The CIDR block should be /22 or greater.
	ClientCidrBlock pulumi.StringInput
	// Information about the client connection logging options.
	ConnectionLogOptions ec2clientvpnEndpointConnectionLogOptions.EndpointConnectionLogOptionsInput
	// Name of the repository.
	Description pulumi.StringPtrInput
	// Information about the DNS servers to be used for DNS resolution. A Client VPN endpoint can have up to two DNS servers. If no DNS server is specified, the DNS address of the VPC that is to be associated with Client VPN endpoint is used as the DNS server.
	DnsServers pulumi.StringArrayInput
