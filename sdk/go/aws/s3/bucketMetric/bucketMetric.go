...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/s3/BucketMetricFilter"
)
...
type BucketMetric struct {
	...
	Filter s3BucketMetricFilter.BucketMetricFilterPtrOutput `pulumi:"filter"`
...
type bucketMetricState struct {
	...
	// [Object filtering](http://docs.aws.amazon.com/AmazonS3/latest/dev/metrics-configurations.html#metrics-configurations-filter) that accepts a prefix, tags, or a logical AND of prefix and tags (documented below).
	Filter *s3BucketMetricFilter.BucketMetricFilter `pulumi:"filter"`
	// Unique identifier of the metrics configuration for the bucket.
...
type BucketMetricState struct {
	...
	// [Object filtering](http://docs.aws.amazon.com/AmazonS3/latest/dev/metrics-configurations.html#metrics-configurations-filter) that accepts a prefix, tags, or a logical AND of prefix and tags (documented below).
	Filter s3BucketMetricFilter.BucketMetricFilterPtrInput
	// Unique identifier of the metrics configuration for the bucket.
