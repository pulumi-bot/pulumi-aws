...
// The name of the bucket to read the object from. Alternatively, an [S3 access point](https://docs.aws.amazon.com/AmazonS3/latest/dev/using-access-points.html) ARN can be specified
func (o LookupBucketObjectApplyOutput) Bucket() pulumi.StringOutput {
	return o.ApplyT(func(v LookupBucketObjectArgs) string { return v.Bucket }).(pulumi.StringOutput)
}

// The full path to the object inside the bucket
func (o LookupBucketObjectApplyOutput) Key() pulumi.StringOutput {
	return o.ApplyT(func(v LookupBucketObjectArgs) string { return v.Key }).(pulumi.StringOutput)
}

func (o LookupBucketObjectApplyOutput) Range() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupBucketObjectArgs) *string { return v.Range }).(pulumi.StringPtrOutput)
}

// A map of tags assigned to the object.
func (o LookupBucketObjectApplyOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v LookupBucketObjectArgs) map[string]string { return v.Tags }).(pulumi.StringMapOutput)
}

// Specific version ID of the object returned (defaults to latest version)
func (o LookupBucketObjectApplyOutput) VersionId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupBucketObjectArgs) *string { return v.VersionId }).(pulumi.StringPtrOutput)
}
