...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/s3/InventoryDestination"
	...
	"https:/github.com/pulumi/pulumi-aws/s3/InventoryFilter"
	"https:/github.com/pulumi/pulumi-aws/s3/InventorySchedule"
)
...
type Inventory struct {
	...
	Destination s3InventoryDestination.InventoryDestinationOutput `pulumi:"destination"`
	// Specifies whether the inventory is enabled or disabled.
	Enabled pulumi.BoolPtrOutput `pulumi:"enabled"`
	// Specifies an inventory filter. The inventory only includes objects that meet the filter's criteria (documented below).
	Filter s3InventoryFilter.InventoryFilterPtrOutput `pulumi:"filter"`
	...
	Schedule s3InventorySchedule.InventoryScheduleOutput `pulumi:"schedule"`
}
...
type inventoryState struct {
	...
	// Contains information about where to publish the inventory results (documented below).
	Destination *s3InventoryDestination.InventoryDestination `pulumi:"destination"`
	// Specifies whether the inventory is enabled or disabled.
	Enabled *bool `pulumi:"enabled"`
	// Specifies an inventory filter. The inventory only includes objects that meet the filter's criteria (documented below).
	Filter *s3InventoryFilter.InventoryFilter `pulumi:"filter"`
	// Object versions to include in the inventory list. Valid values: `All`, `Current`.
	...
	// Specifies the schedule for generating inventory results (documented below).
	Schedule *s3InventorySchedule.InventorySchedule `pulumi:"schedule"`
}
...
type InventoryState struct {
	...
	// Contains information about where to publish the inventory results (documented below).
	Destination s3InventoryDestination.InventoryDestinationPtrInput
	// Specifies whether the inventory is enabled or disabled.
	Enabled pulumi.BoolPtrInput
	// Specifies an inventory filter. The inventory only includes objects that meet the filter's criteria (documented below).
	Filter s3InventoryFilter.InventoryFilterPtrInput
	// Object versions to include in the inventory list. Valid values: `All`, `Current`.
	...
	// Specifies the schedule for generating inventory results (documented below).
	Schedule s3InventorySchedule.InventorySchedulePtrInput
}
...
type InventoryArgs struct {
	...
	// Contains information about where to publish the inventory results (documented below).
	Destination s3InventoryDestination.InventoryDestinationInput
	// Specifies whether the inventory is enabled or disabled.
	Enabled pulumi.BoolPtrInput
	// Specifies an inventory filter. The inventory only includes objects that meet the filter's criteria (documented below).
	Filter s3InventoryFilter.InventoryFilterPtrInput
	...
	OptionalFields pulumi.StringArrayInput
	// Specifies the schedule for generating inventory results (documented below).
	Schedule s3InventorySchedule.InventoryScheduleInput
}
