...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/lambda/getFunctionDeadLetterConfig"
	"https:/github.com/pulumi/pulumi-aws/lambda/getFunctionEnvironment"
	"https:/github.com/pulumi/pulumi-aws/lambda/getFunctionTracingConfig"
	"https:/github.com/pulumi/pulumi-aws/lambda/getFunctionVpcConfig"
)
...
type GetFunctionResult struct {
	...
	DeadLetterConfig lambdagetFunctionDeadLetterConfig.GetFunctionDeadLetterConfig `pulumi:"deadLetterConfig"`
	// Description of what your Lambda Function does.
	Description string `pulumi:"description"`
	// The Lambda environment's configuration settings.
	Environment lambdagetFunctionEnvironment.GetFunctionEnvironment `pulumi:"environment"`
	FunctionName string `pulumi:"functionName"`
	...
	TracingConfig lambdagetFunctionTracingConfig.GetFunctionTracingConfig `pulumi:"tracingConfig"`
	// The version of the Lambda function.
	Version string `pulumi:"version"`
	// VPC configuration associated with your Lambda function.
	VpcConfig lambdagetFunctionVpcConfig.GetFunctionVpcConfig `pulumi:"vpcConfig"`
}
