...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/lambda/FunctionDeadLetterConfig"
	"https:/github.com/pulumi/pulumi-aws/lambda/FunctionEnvironment"
	"https:/github.com/pulumi/pulumi-aws/lambda/FunctionTracingConfig"
	"https:/github.com/pulumi/pulumi-aws/lambda/FunctionVpcConfig"
)
...
type Function struct {
	...
	DeadLetterConfig lambdaFunctionDeadLetterConfig.FunctionDeadLetterConfigPtrOutput `pulumi:"deadLetterConfig"`
	// Description of what your Lambda Function does.
	Description pulumi.StringPtrOutput `pulumi:"description"`
	// The Lambda environment's configuration settings. Fields documented below.
	Environment lambdaFunctionEnvironment.FunctionEnvironmentPtrOutput `pulumi:"environment"`
	...
	TracingConfig lambdaFunctionTracingConfig.FunctionTracingConfigOutput `pulumi:"tracingConfig"`
	// Latest published version of your Lambda Function.
	Version pulumi.StringOutput `pulumi:"version"`
	// Provide this to allow your function to access your VPC. Fields documented below. See [Lambda in VPC][7]
	VpcConfig lambdaFunctionVpcConfig.FunctionVpcConfigPtrOutput `pulumi:"vpcConfig"`
}
...
type functionState struct {
	...
	// The path to the function's deployment package within the local filesystem. If defined, The `s3_`-prefixed options cannot be used.
	Code Archive `pulumi:"code"`
	// Nested block to configure the function's *dead letter queue*. See details below.
	DeadLetterConfig *lambdaFunctionDeadLetterConfig.FunctionDeadLetterConfig `pulumi:"deadLetterConfig"`
	// Description of what your Lambda Function does.
	Description *string `pulumi:"description"`
	// The Lambda environment's configuration settings. Fields documented below.
	Environment *lambdaFunctionEnvironment.FunctionEnvironment `pulumi:"environment"`
	// The function [entrypoint][3] in your code.
	...
	TracingConfig *lambdaFunctionTracingConfig.FunctionTracingConfig `pulumi:"tracingConfig"`
	// Latest published version of your Lambda Function.
	Version *string `pulumi:"version"`
	// Provide this to allow your function to access your VPC. Fields documented below. See [Lambda in VPC][7]
	VpcConfig *lambdaFunctionVpcConfig.FunctionVpcConfig `pulumi:"vpcConfig"`
}
...
type FunctionState struct {
	...
	// Nested block to configure the function's *dead letter queue*. See details below.
	DeadLetterConfig lambdaFunctionDeadLetterConfig.FunctionDeadLetterConfigPtrInput
	// Description of what your Lambda Function does.
	Description pulumi.StringPtrInput
	// The Lambda environment's configuration settings. Fields documented below.
	Environment lambdaFunctionEnvironment.FunctionEnvironmentPtrInput
	// The function [entrypoint][3] in your code.
	...
	TracingConfig lambdaFunctionTracingConfig.FunctionTracingConfigPtrInput
	// Latest published version of your Lambda Function.
	Version pulumi.StringPtrInput
	// Provide this to allow your function to access your VPC. Fields documented below. See [Lambda in VPC][7]
	VpcConfig lambdaFunctionVpcConfig.FunctionVpcConfigPtrInput
}
