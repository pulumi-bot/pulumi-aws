...
// Name of the lambda function.
func (o LookupFunctionApplyOutput) FunctionName() pulumi.StringOutput {
	return o.ApplyT(func(v LookupFunctionArgs) string { return v.FunctionName }).(pulumi.StringOutput)
}

// Alias name or version number of the lambda function. e.g. `$LATEST`, `my-alias`, or `1`
func (o LookupFunctionApplyOutput) Qualifier() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupFunctionArgs) *string { return v.Qualifier }).(pulumi.StringPtrOutput)
}

func (o LookupFunctionApplyOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v LookupFunctionArgs) map[string]string { return v.Tags }).(pulumi.StringMapOutput)
}
