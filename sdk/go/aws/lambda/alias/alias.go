...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/lambda/AliasRoutingConfig"
)
...
type Alias struct {
	...
	RoutingConfig lambdaAliasRoutingConfig.AliasRoutingConfigPtrOutput `pulumi:"routingConfig"`
}
...
type aliasState struct {
	...
	// The Lambda alias' route configuration settings. Fields documented below
	RoutingConfig *lambdaAliasRoutingConfig.AliasRoutingConfig `pulumi:"routingConfig"`
}
...
type AliasState struct {
	...
	// The Lambda alias' route configuration settings. Fields documented below
	RoutingConfig lambdaAliasRoutingConfig.AliasRoutingConfigPtrInput
}
