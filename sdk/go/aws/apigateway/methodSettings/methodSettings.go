...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/apigateway/MethodSettingsSettings"
)
...
type MethodSettings struct {
	...
	Settings apigatewayMethodSettingsSettings.MethodSettingsSettingsOutput `pulumi:"settings"`
...
type methodSettingsState struct {
	...
	// The settings block, see below.
	Settings *apigatewayMethodSettingsSettings.MethodSettingsSettings `pulumi:"settings"`
	// The name of the stage
...
type MethodSettingsState struct {
	...
	// The settings block, see below.
	Settings apigatewayMethodSettingsSettings.MethodSettingsSettingsPtrInput
	// The name of the stage
...
type MethodSettingsArgs struct {
	...
	// The settings block, see below.
	Settings apigatewayMethodSettingsSettings.MethodSettingsSettingsInput
	// The name of the stage
