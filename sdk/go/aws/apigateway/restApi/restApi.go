...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/apigateway/RestApiEndpointConfiguration"
)
...
type RestApi struct {
	...
	EndpointConfiguration apigatewayRestApiEndpointConfiguration.RestApiEndpointConfigurationOutput `pulumi:"endpointConfiguration"`
...
type restApiState struct {
	...
	// Nested argument defining API endpoint configuration including endpoint type. Defined below.
	EndpointConfiguration *apigatewayRestApiEndpointConfiguration.RestApiEndpointConfiguration `pulumi:"endpointConfiguration"`
	// The execution ARN part to be used in [`lambdaPermission`](https://www.terraform.io/docs/providers/aws/r/lambda_permission.html)'s `sourceArn`
	// when allowing API Gateway to invoke a Lambda function,
	// e.g. `arn:aws:execute-api:eu-west-2:123456789012:z4675bid1j`, which can be concatenated with allowed stage, method and resource path.
...
type RestApiState struct {
	...
	// Nested argument defining API endpoint configuration including endpoint type. Defined below.
	EndpointConfiguration apigatewayRestApiEndpointConfiguration.RestApiEndpointConfigurationPtrInput
	// The execution ARN part to be used in [`lambdaPermission`](https://www.terraform.io/docs/providers/aws/r/lambda_permission.html)'s `sourceArn`
	// when allowing API Gateway to invoke a Lambda function,
	// e.g. `arn:aws:execute-api:eu-west-2:123456789012:z4675bid1j`, which can be concatenated with allowed stage, method and resource path.
