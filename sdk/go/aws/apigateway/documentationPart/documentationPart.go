...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/apigateway/DocumentationPartLocation"
)
...
type DocumentationPart struct {
	...
	Location apigatewayDocumentationPartLocation.DocumentationPartLocationOutput `pulumi:"location"`
...
type documentationPartState struct {
	// The location of the targeted API entity of the to-be-created documentation part. See below.
	Location *apigatewayDocumentationPartLocation.DocumentationPartLocation `pulumi:"location"`
	// A content map of API-specific key-value pairs describing the targeted API entity. The map must be encoded as a JSON string, e.g., "{ \"description\": \"The API does ...\" }". Only Swagger-compliant key-value pairs can be exported and, hence, published.
...
type DocumentationPartState struct {
	// The location of the targeted API entity of the to-be-created documentation part. See below.
	Location apigatewayDocumentationPartLocation.DocumentationPartLocationPtrInput
	// A content map of API-specific key-value pairs describing the targeted API entity. The map must be encoded as a JSON string, e.g., "{ \"description\": \"The API does ...\" }". Only Swagger-compliant key-value pairs can be exported and, hence, published.
...
type DocumentationPartArgs struct {
	// The location of the targeted API entity of the to-be-created documentation part. See below.
	Location apigatewayDocumentationPartLocation.DocumentationPartLocationInput
	// A content map of API-specific key-value pairs describing the targeted API entity. The map must be encoded as a JSON string, e.g., "{ \"description\": \"The API does ...\" }". Only Swagger-compliant key-value pairs can be exported and, hence, published.
