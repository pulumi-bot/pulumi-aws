...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/apigateway/UsagePlanApiStage"
	"https:/github.com/pulumi/pulumi-aws/apigateway/UsagePlanQuotaSettings"
	"https:/github.com/pulumi/pulumi-aws/apigateway/UsagePlanThrottleSettings"
)
...
type UsagePlan struct {
	...
	ApiStages apigatewayUsagePlanApiStage.UsagePlanApiStageArrayOutput `pulumi:"apiStages"`
	...
	QuotaSettings apigatewayUsagePlanQuotaSettings.UsagePlanQuotaSettingsPtrOutput `pulumi:"quotaSettings"`
	// Key-value mapping of resource tags
	Tags pulumi.MapOutput `pulumi:"tags"`
	// The throttling limits of the usage plan.
	ThrottleSettings apigatewayUsagePlanThrottleSettings.UsagePlanThrottleSettingsPtrOutput `pulumi:"throttleSettings"`
}
...
type usagePlanState struct {
	// The associated API stages of the usage plan.
	ApiStages []apigatewayUsagePlanApiStage.UsagePlanApiStage `pulumi:"apiStages"`
	// Amazon Resource Name (ARN)
	...
	// The quota settings of the usage plan.
	QuotaSettings *apigatewayUsagePlanQuotaSettings.UsagePlanQuotaSettings `pulumi:"quotaSettings"`
	// Key-value mapping of resource tags
	Tags map[string]interface{} `pulumi:"tags"`
	// The throttling limits of the usage plan.
	ThrottleSettings *apigatewayUsagePlanThrottleSettings.UsagePlanThrottleSettings `pulumi:"throttleSettings"`
}

type UsagePlanState struct {
	// The associated API stages of the usage plan.
	ApiStages apigatewayUsagePlanApiStage.UsagePlanApiStageArrayInput
	// Amazon Resource Name (ARN)
	...
	// The quota settings of the usage plan.
	QuotaSettings apigatewayUsagePlanQuotaSettings.UsagePlanQuotaSettingsPtrInput
	// Key-value mapping of resource tags
	Tags pulumi.MapInput
	// The throttling limits of the usage plan.
	ThrottleSettings apigatewayUsagePlanThrottleSettings.UsagePlanThrottleSettingsPtrInput
}
