...
// 			MethodPath: pulumi.All(testResource.PathPart, testMethod.HttpMethod).Apply(func(pathPart string, httpMethod string) (string, error) {
...
// 				"application/xml": fmt.Sprintf("%v%v%v%v%v%v%v%v", "{\n", "   \"body\" : ", "$", "input.json('", "$", "')\n", "}\n", "\n"),
// 			},
// 			ResourceId: testResource.ID(),
// 			RestApi:    testRestApi.ID(),
