...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/apigateway/DomainNameEndpointConfiguration"
)
...
type DomainName struct {
	...
	EndpointConfiguration apigatewayDomainNameEndpointConfiguration.DomainNameEndpointConfigurationOutput `pulumi:"endpointConfiguration"`
...
type domainNameState struct {
	...
	// Configuration block defining API endpoint information including type. Defined below.
	EndpointConfiguration *apigatewayDomainNameEndpointConfiguration.DomainNameEndpointConfiguration `pulumi:"endpointConfiguration"`
	// The ARN for an AWS-managed certificate. AWS Certificate Manager is the only supported source. Used when a regional domain name is desired. Conflicts with `certificateArn`, `certificateName`, `certificateBody`, `certificateChain`, and `certificatePrivateKey`.
...
type DomainNameState struct {
	...
	// Configuration block defining API endpoint information including type. Defined below.
	EndpointConfiguration apigatewayDomainNameEndpointConfiguration.DomainNameEndpointConfigurationPtrInput
	// The ARN for an AWS-managed certificate. AWS Certificate Manager is the only supported source. Used when a regional domain name is desired. Conflicts with `certificateArn`, `certificateName`, `certificateBody`, `certificateChain`, and `certificatePrivateKey`.
