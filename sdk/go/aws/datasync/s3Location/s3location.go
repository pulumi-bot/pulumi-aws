...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/datasync/S3LocationS3Config"
)
...
type S3Location struct {
	...
	S3Config datasyncS3LocationS3Config.S3LocationS3ConfigOutput `pulumi:"s3Config"`
...
type s3locationState struct {
	...
	// Configuration block containing information for connecting to S3.
	S3Config *datasyncS3LocationS3Config.S3LocationS3Config `pulumi:"s3Config"`
	// Prefix to perform actions as source or destination.
...
type S3LocationState struct {
	...
	// Configuration block containing information for connecting to S3.
	S3Config datasyncS3LocationS3Config.S3LocationS3ConfigPtrInput
	// Prefix to perform actions as source or destination.
...
type S3LocationArgs struct {
	...
	// Configuration block containing information for connecting to S3.
	S3Config datasyncS3LocationS3Config.S3LocationS3ConfigInput
	// Prefix to perform actions as source or destination.
