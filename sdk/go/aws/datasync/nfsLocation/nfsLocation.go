...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/datasync/NfsLocationOnPremConfig"
)
...
type NfsLocation struct {
	...
	OnPremConfig datasyncNfsLocationOnPremConfig.NfsLocationOnPremConfigOutput `pulumi:"onPremConfig"`
...
type nfsLocationState struct {
	...
	// Configuration block containing information for connecting to the NFS File System.
	OnPremConfig *datasyncNfsLocationOnPremConfig.NfsLocationOnPremConfig `pulumi:"onPremConfig"`
	// Specifies the IP address or DNS name of the NFS server. The DataSync Agent(s) use this to mount the NFS server.
...
type NfsLocationState struct {
	...
	// Configuration block containing information for connecting to the NFS File System.
	OnPremConfig datasyncNfsLocationOnPremConfig.NfsLocationOnPremConfigPtrInput
	// Specifies the IP address or DNS name of the NFS server. The DataSync Agent(s) use this to mount the NFS server.
...
type NfsLocationArgs struct {
	// Configuration block containing information for connecting to the NFS File System.
	OnPremConfig datasyncNfsLocationOnPremConfig.NfsLocationOnPremConfigInput
	// Specifies the IP address or DNS name of the NFS server. The DataSync Agent(s) use this to mount the NFS server.
