...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/eks/NodeGroupRemoteAccess"
	"https:/github.com/pulumi/pulumi-aws/eks/NodeGroupResource"
	"https:/github.com/pulumi/pulumi-aws/eks/NodeGroupResourceAutoscalingGroup"
	"https:/github.com/pulumi/pulumi-aws/eks/NodeGroupScalingConfig"
)
...
type NodeGroup struct {
	...
	RemoteAccess eksNodeGroupRemoteAccess.NodeGroupRemoteAccessPtrOutput `pulumi:"remoteAccess"`
	// List of objects containing information about underlying resources.
	Resources eksNodeGroupResource.NodeGroupResourceArrayOutput `pulumi:"resources"`
	// Configuration block with scaling settings. Detailed below.
	ScalingConfig eksNodeGroupScalingConfig.NodeGroupScalingConfigOutput `pulumi:"scalingConfig"`
...
type nodeGroupState struct {
	...
	// Configuration block with remote access settings. Detailed below.
	RemoteAccess *eksNodeGroupRemoteAccess.NodeGroupRemoteAccess `pulumi:"remoteAccess"`
	// List of objects containing information about underlying resources.
	Resources []eksNodeGroupResource.NodeGroupResource `pulumi:"resources"`
	// Configuration block with scaling settings. Detailed below.
	ScalingConfig *eksNodeGroupScalingConfig.NodeGroupScalingConfig `pulumi:"scalingConfig"`
	// Status of the EKS Node Group.
...
type NodeGroupState struct {
	...
	// Configuration block with remote access settings. Detailed below.
	RemoteAccess eksNodeGroupRemoteAccess.NodeGroupRemoteAccessPtrInput
	// List of objects containing information about underlying resources.
	Resources eksNodeGroupResource.NodeGroupResourceArrayInput
	// Configuration block with scaling settings. Detailed below.
	ScalingConfig eksNodeGroupScalingConfig.NodeGroupScalingConfigPtrInput
	// Status of the EKS Node Group.
...
type NodeGroupArgs struct {
	...
	RemoteAccess eksNodeGroupRemoteAccess.NodeGroupRemoteAccessPtrInput
	// Configuration block with scaling settings. Detailed below.
	ScalingConfig eksNodeGroupScalingConfig.NodeGroupScalingConfigInput
	// Identifiers of EC2 Subnets to associate with the EKS Node Group. These subnets must have the following resource tag: `kubernetes.io/cluster/CLUSTER_NAME` (where `CLUSTER_NAME` is replaced with the name of the EKS Cluster).
	SubnetIds pulumi.StringArrayInput
	// Key-value mapping of resource tags.
	Tags pulumi.MapInput
