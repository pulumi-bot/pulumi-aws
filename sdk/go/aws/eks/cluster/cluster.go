...
import (
	...
	"https:/github.com/pulumi/pulumi-aws/eks/ClusterCertificateAuthority"
	"https:/github.com/pulumi/pulumi-aws/eks/ClusterIdentity"
	"https:/github.com/pulumi/pulumi-aws/eks/ClusterIdentityOidc"
	"https:/github.com/pulumi/pulumi-aws/eks/ClusterVpcConfig"
)
...
type Cluster struct {
	...
	CertificateAuthority eksClusterCertificateAuthority.ClusterCertificateAuthorityOutput `pulumi:"certificateAuthority"`
	...
	Identities eksClusterIdentity.ClusterIdentityArrayOutput `pulumi:"identities"`
	// Name of the cluster.
	...
	VpcConfig eksClusterVpcConfig.ClusterVpcConfigOutput `pulumi:"vpcConfig"`
}
...
type clusterState struct {
	...
	// Nested attribute containing `certificate-authority-data` for your cluster.
	CertificateAuthority *eksClusterCertificateAuthority.ClusterCertificateAuthority `pulumi:"certificateAuthority"`
	...
	// Nested attribute containing identity provider information for your cluster. Only available on Kubernetes version 1.13 and 1.14 clusters created or upgraded on or after September 3, 2019.
	Identities []eksClusterIdentity.ClusterIdentity `pulumi:"identities"`
	// Name of the cluster.
	...
	// Nested argument for the VPC associated with your cluster. Amazon EKS VPC resources have specific requirements to work properly with Kubernetes. For more information, see [Cluster VPC Considerations](https://docs.aws.amazon.com/eks/latest/userguide/network_reqs.html) and [Cluster Security Group Considerations](https://docs.aws.amazon.com/eks/latest/userguide/sec-group-reqs.html) in the Amazon EKS User Guide. Configuration detailed below.
	VpcConfig *eksClusterVpcConfig.ClusterVpcConfig `pulumi:"vpcConfig"`
}
...
type ClusterState struct {
	...
	// Nested attribute containing `certificate-authority-data` for your cluster.
	CertificateAuthority eksClusterCertificateAuthority.ClusterCertificateAuthorityPtrInput
	...
	// Nested attribute containing identity provider information for your cluster. Only available on Kubernetes version 1.13 and 1.14 clusters created or upgraded on or after September 3, 2019.
	Identities eksClusterIdentity.ClusterIdentityArrayInput
	// Name of the cluster.
	...
	// Nested argument for the VPC associated with your cluster. Amazon EKS VPC resources have specific requirements to work properly with Kubernetes. For more information, see [Cluster VPC Considerations](https://docs.aws.amazon.com/eks/latest/userguide/network_reqs.html) and [Cluster Security Group Considerations](https://docs.aws.amazon.com/eks/latest/userguide/sec-group-reqs.html) in the Amazon EKS User Guide. Configuration detailed below.
	VpcConfig eksClusterVpcConfig.ClusterVpcConfigPtrInput
}
...
type ClusterArgs struct {
	...
	Version pulumi.StringPtrInput
	// Nested argument for the VPC associated with your cluster. Amazon EKS VPC resources have specific requirements to work properly with Kubernetes. For more information, see [Cluster VPC Considerations](https://docs.aws.amazon.com/eks/latest/userguide/network_reqs.html) and [Cluster Security Group Considerations](https://docs.aws.amazon.com/eks/latest/userguide/sec-group-reqs.html) in the Amazon EKS User Guide. Configuration detailed below.
	VpcConfig eksClusterVpcConfig.ClusterVpcConfigInput
}
