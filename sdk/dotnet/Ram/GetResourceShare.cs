...
namespace Pulumi.Aws.Ram
{
    ...
    {
        [Input("filters")]
        private InputList<Inputs.GetResourceShareFiltersArgs>? _filters;
        ...
        /// </summary>
        public InputList<Inputs.GetResourceShareFiltersArgs> Filters
        {
            get => _filters ?? (_filters = new InputList<Inputs.GetResourceShareFiltersArgs>());
            set => _filters = value;
        }
    ...
    public sealed class GetResourceShareFiltersArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The name of the tag key to filter on.
        /// </summary>
