...
namespace Pulumi.Aws.Workspaces
{
    public static class GetBundle
    {
        ...
        public static Output<GetBundleResult> Invoke(GetBundleOutputArgs? args = null, InvokeOptions? options = null)
        {
            args = args ?? new GetBundleOutputArgs();
    ...
    public sealed class GetBundleOutputArgs
    {
        /// <summary>
        /// The ID of the bundle.
        /// </summary>
