...
namespace Pulumi.Aws.Workspaces
{
    public static class GetDirectory
    {
        ...
        public static Output<GetDirectoryResult> Invoke(GetDirectoryOutputArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetDirectoryOutputArgs
    {
        /// <summary>
        /// The directory identifier for registration in WorkSpaces service.
        /// </summary>
