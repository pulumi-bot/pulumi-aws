...
namespace Pulumi.Aws.Emr.Inputs
{
    ...
    public sealed class ClusterCoreInstanceFleetGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.ClusterCoreInstanceFleetInstanceTypeConfigGetArgs>? _instanceTypeConfigs;

        /// <summary>
        /// Configuration block for instance fleet
        /// </summary>
        public InputList<Inputs.ClusterCoreInstanceFleetInstanceTypeConfigGetArgs> InstanceTypeConfigs
        {
            get => _instanceTypeConfigs ?? (_instanceTypeConfigs = new InputList<Inputs.ClusterCoreInstanceFleetInstanceTypeConfigGetArgs>());
