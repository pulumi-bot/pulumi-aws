...
namespace Pulumi.Aws.OpsWorks
{
    ...
    public partial class NodejsAppLayer : Pulumi.CustomResource
    {
        ...
        public NodejsAppLayer(string name, NodejsAppLayerArgs args, CustomResourceOptions? options = null)
            : base("aws:opsworks/nodejsAppLayer:NodejsAppLayer", name, args ?? ResourceArgs.Empty, MakeResourceOptions(options, ""))
        {
        }
    ...
    public sealed class NodejsAppLayerArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Whether to automatically assign an elastic IP address to the layer's instances.
        /// </summary>
    ...
    public sealed class NodejsAppLayerState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Whether to automatically assign an elastic IP address to the layer's instances.
        /// </summary>
