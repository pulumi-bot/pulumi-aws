...
namespace Pulumi.Aws.CodeArtifact
{
    public static class GetRepositoryEndpoint
    {
        ...
        public static Output<GetRepositoryEndpointResult> Apply(GetRepositoryEndpointApplyArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetRepositoryEndpointApplyArgs
    {
        /// <summary>
        /// The name of the domain that contains the repository.
        /// </summary>
        ...
        public GetRepositoryEndpointApplyArgs()
        {
        }
    }
