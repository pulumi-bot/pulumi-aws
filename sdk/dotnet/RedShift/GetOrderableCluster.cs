...
namespace Pulumi.Aws.RedShift
{
    public static class GetOrderableCluster
    {
        ...
        public static Output<GetOrderableClusterResult> Invoke(GetOrderableClusterOutputArgs? args = null, InvokeOptions? options = null)
        {
            args = args ?? new GetOrderableClusterOutputArgs();
    ...
    public sealed class GetOrderableClusterOutputArgs
    {
        /// <summary>
        /// Reshift Cluster type. e.g. `multi-node` or `single-node`
        /// </summary>
        ...
        public GetOrderableClusterOutputArgs()
        {
        }
    }
