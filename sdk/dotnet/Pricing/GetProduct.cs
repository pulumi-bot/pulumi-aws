...
namespace Pulumi.Aws.Pricing
{
    public static class GetProduct
    {
        ...
        public static Output<GetProductResult> Invoke(GetProductOutputArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetProductOutputArgs
    {
        [Input("filters", required: true)]
