...
namespace Pulumi.Aws
{
    public static class GetAvailabilityZone
    {
        ...
        public static Output<GetAvailabilityZoneResult> Invoke(GetAvailabilityZoneOutputArgs? args = null, InvokeOptions? options = null)
        {
            args = args ?? new GetAvailabilityZoneOutputArgs();
    ...
    public sealed class GetAvailabilityZoneOutputArgs
    {
        /// <summary>
        /// Set to `true` to include all Availability Zones and Local Zones regardless of your opt in status.
        /// </summary>
        ...
        public GetAvailabilityZoneOutputArgs()
        {
        }
    }
