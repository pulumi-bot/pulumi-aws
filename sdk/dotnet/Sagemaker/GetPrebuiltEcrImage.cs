...
namespace Pulumi.Aws.Sagemaker
{
    public static class GetPrebuiltEcrImage
    {
        ...
        public static Output<GetPrebuiltEcrImageResult> Invoke(GetPrebuiltEcrImageOutputArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetPrebuiltEcrImageOutputArgs
    {
        /// <summary>
        /// The DNS suffix to use in the registry path. If not specified, the AWS provider sets it to the DNS suffix for the current region.
        /// </summary>
        ...
        public GetPrebuiltEcrImageOutputArgs()
        {
        }
    }
