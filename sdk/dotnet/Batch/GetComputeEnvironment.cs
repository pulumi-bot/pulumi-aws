...
namespace Pulumi.Aws.Batch
{
    public static class GetComputeEnvironment
    {
        ...
        public static Output<GetComputeEnvironmentResult> Apply(GetComputeEnvironmentApplyArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetComputeEnvironmentApplyArgs
    {
        /// <summary>
        /// The name of the Batch Compute Environment
        /// </summary>
        ...
        public GetComputeEnvironmentApplyArgs()
        {
        }
    }
