...
namespace Pulumi.Aws.Batch
{
    public static class GetJobQueue
    {
        ...
        public static Output<GetJobQueueResult> Invoke(GetJobQueueOutputArgs args, InvokeOptions? options = null)
        {
            return Pulumi.Output.All(
                args.Name.Box(),
                args.Tags.ToDict().Box()
            ).Apply(a => {
                    var args = new GetJobQueueArgs();
    ...
    public sealed class GetJobQueueOutputArgs
    {
        /// <summary>
        /// The name of the job queue.
        /// </summary>
