    ...
    public static class GetCertificate
    {
        ...
        public static Output<GetCertificateResult> Apply(GetCertificateApplyArgs args, InvokeOptions? options = null)
        {
            return Pulumi.Output.All(
                args.Domain.Box(),
                args.KeyTypes.ToList().Box(),
                args.MostRecent.Box(),
                args.Statuses.ToList().Box(),
                args.Tags.ToDict().Box(),
                args.Types.ToList().Box()
            ).Apply(a => {
                    var args = new GetCertificateArgs();
                    a[0].Set(args, nameof(args.Domain));
                    a[1].Set(args, nameof(args.KeyTypes));
                    a[2].Set(args, nameof(args.MostRecent));
                    a[3].Set(args, nameof(args.Statuses));
                    a[4].Set(args, nameof(args.Tags));
                    a[5].Set(args, nameof(args.Types));
