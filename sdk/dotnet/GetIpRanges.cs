...
namespace Pulumi.Aws
{
    public static class GetIpRanges
    {
        ...
        public static Output<GetIpRangesResult> Apply(GetIpRangesApplyArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetIpRangesApplyArgs
    {
        [Input("regions")]
