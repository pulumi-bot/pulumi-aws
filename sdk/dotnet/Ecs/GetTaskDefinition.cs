...
namespace Pulumi.Aws.Ecs
{
    public static class GetTaskDefinition
    {
        ...
        public static Output<GetTaskDefinitionResult> Invoke(GetTaskDefinitionOutputArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetTaskDefinitionOutputArgs
    {
        /// <summary>
        /// The family for the latest ACTIVE revision, family and revision (family:revision) for a specific revision in the family, the ARN of the task definition to access to.
        /// </summary>
        ...
        public GetTaskDefinitionOutputArgs()
        {
        }
    }
