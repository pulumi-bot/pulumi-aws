...
namespace Pulumi.Aws.Lambda
{
    public static class GetLayerVersion
    {
        ...
        public static Output<GetLayerVersionResult> Apply(GetLayerVersionApplyArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetLayerVersionApplyArgs
    {
        /// <summary>
        /// Specific runtime the layer version must support. Conflicts with `version`. If specified, the latest available layer version supporting the provided runtime will be used.
        /// </summary>
        ...
        public GetLayerVersionApplyArgs()
        {
        }
    }
