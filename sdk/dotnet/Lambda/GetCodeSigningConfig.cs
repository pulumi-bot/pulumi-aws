...
namespace Pulumi.Aws.Lambda
{
    public static class GetCodeSigningConfig
    {
        ...
        public static Output<GetCodeSigningConfigResult> Apply(GetCodeSigningConfigApplyArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetCodeSigningConfigApplyArgs
    {
        /// <summary>
        /// The Amazon Resource Name (ARN) of the code signing configuration.
        /// </summary>
        ...
        public GetCodeSigningConfigApplyArgs()
        {
        }
    }
