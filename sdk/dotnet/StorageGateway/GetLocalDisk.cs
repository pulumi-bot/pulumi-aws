...
namespace Pulumi.Aws.StorageGateway
{
    public static class GetLocalDisk
    {
        ...
        public static Output<GetLocalDiskResult> Apply(GetLocalDiskApplyArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetLocalDiskApplyArgs
    {
        /// <summary>
        /// The device node of the local disk to retrieve. For example, `/dev/sdb`.
        /// </summary>
