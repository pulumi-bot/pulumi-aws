...
namespace Pulumi.Aws.Dms
{
    ...
    ///             },
    ///         }));
    ///         var dms-access-for-endpoint = new Aws.Iam.Role("dms-access-for-endpoint", new Aws.Iam.RoleArgs
    ///         {
    ///             AssumeRolePolicy = dmsAssumeRole.Apply(dmsAssumeRole =&gt; dmsAssumeRole.Json),
    ///         });
    ///         var dms-access-for-endpoint-AmazonDMSRedshiftS3Role = new Aws.Iam.RolePolicyAttachment("dms-access-for-endpoint-AmazonDMSRedshiftS3Role", new Aws.Iam.RolePolicyAttachmentArgs
    ///         {
    ///             PolicyArn = "arn:aws:iam::aws:policy/service-role/AmazonDMSRedshiftS3Role",
    ///             Role = dms-access-for-endpoint.Name,
    ///         });
    ///         var dms-cloudwatch-logs-role = new Aws.Iam.Role("dms-cloudwatch-logs-role", new Aws.Iam.RoleArgs
    ///         {
    ///             AssumeRolePolicy = dmsAssumeRole.Apply(dmsAssumeRole =&gt; dmsAssumeRole.Json),
    ///         });
    ///         var dms-cloudwatch-logs-role-AmazonDMSCloudWatchLogsRole = new Aws.Iam.RolePolicyAttachment("dms-cloudwatch-logs-role-AmazonDMSCloudWatchLogsRole", new Aws.Iam.RolePolicyAttachmentArgs
    ///         {
    ///             PolicyArn = "arn:aws:iam::aws:policy/service-role/AmazonDMSCloudWatchLogsRole",
    ///             Role = dms-cloudwatch-logs-role.Name,
    ///         });
    ///         var dms-vpc-role = new Aws.Iam.Role("dms-vpc-role", new Aws.Iam.RoleArgs
    ///         {
    ///             AssumeRolePolicy = dmsAssumeRole.Apply(dmsAssumeRole =&gt; dmsAssumeRole.Json),
    ///         });
    ///         var dms-vpc-role-AmazonDMSVPCManagementRole = new Aws.Iam.RolePolicyAttachment("dms-vpc-role-AmazonDMSVPCManagementRole", new Aws.Iam.RolePolicyAttachmentArgs
    ///         {
