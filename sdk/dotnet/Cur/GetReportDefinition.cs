...
namespace Pulumi.Aws.Cur
{
    public static class GetReportDefinition
    {
        ...
        public static Output<GetReportDefinitionResult> Apply(GetReportDefinitionApplyArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetReportDefinitionApplyArgs
    {
        /// <summary>
        /// The name of the report definition to match.
        /// </summary>
        ...
        public GetReportDefinitionApplyArgs()
        {
        }
    }
