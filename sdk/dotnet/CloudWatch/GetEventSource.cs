...
namespace Pulumi.Aws.CloudWatch
{
    public static class GetEventSource
    {
        ...
        public static Output<GetEventSourceResult> Apply(GetEventSourceApplyArgs? args = null, InvokeOptions? options = null)
        {
            args = args ?? new GetEventSourceApplyArgs();
    ...
    public sealed class GetEventSourceApplyArgs
    {
        /// <summary>
        /// Specifying this limits the results to only those partner event sources with names that start with the specified prefix
        /// </summary>
        ...
        public GetEventSourceApplyArgs()
        {
        }
    }
