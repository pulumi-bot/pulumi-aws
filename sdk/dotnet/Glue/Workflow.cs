...
namespace Pulumi.Aws.Glue
{
    ...
    ///         {
    ///         });
    ///         var example-start = new Aws.Glue.Trigger("example-start", new Aws.Glue.TriggerArgs
    ///         {
    ///             Actions = 
    ///             {
    ...
    ///         });
    ///         var example-inner = new Aws.Glue.Trigger("example-inner", new Aws.Glue.TriggerArgs
    ///         {
    ///             Actions = 
    ///             {
    ///                 new Aws.Glue.Inputs.TriggerActionArgs
