...
namespace Pulumi.Aws.Glue
{
    public static class GetScript
    {
        ...
        public static Output<GetScriptResult> Invoke(GetScriptOutputArgs args, InvokeOptions? options = null)
        {
            return Pulumi.Output.All(
                args.DagEdges.ToList().Box(),
                args.DagNodes.ToList().Box(),
                args.Language.Box()
            ).Apply(a => {
    ...
    public sealed class GetScriptOutputArgs
    {
        [Input("dagEdges", required: true)]
