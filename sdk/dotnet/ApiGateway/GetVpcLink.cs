...
namespace Pulumi.Aws.ApiGateway
{
    public static class GetVpcLink
    {
        ...
        public static Output<GetVpcLinkResult> Invoke(GetVpcLinkOutputArgs args, InvokeOptions? options = null)
        {
            return Pulumi.Output.All(
                args.Name.Box(),
                args.Tags.ToDict().Box()
            ).Apply(a => {
                    var args = new GetVpcLinkArgs();
    ...
    public sealed class GetVpcLinkOutputArgs
    {
        /// <summary>
        /// The name of the API Gateway VPC Link to look up. If no API Gateway VPC Link is found with this name, an error will be returned.
        /// If multiple API Gateway VPC Links are found with this name, an error will be returned.
