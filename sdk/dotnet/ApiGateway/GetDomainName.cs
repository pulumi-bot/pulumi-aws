...
namespace Pulumi.Aws.ApiGateway
{
    public static class GetDomainName
    {
        ...
        public static Output<GetDomainNameResult> Invoke(GetDomainNameOutputArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetDomainNameOutputArgs
    {
        /// <summary>
        /// The fully-qualified domain name to look up. If no domain name is found, an error will be returned.
        /// </summary>
        ...
        public GetDomainNameOutputArgs()
        {
        }
    }
