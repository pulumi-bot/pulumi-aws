...
namespace Pulumi.Aws.Ecr
{
    public static class GetCredentials
    {
        ...
        public static Output<GetCredentialsResult> Invoke(GetCredentialsOutputArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetCredentialsOutputArgs
    {
        [Input("registryId", required: true)]
        public Input<string> RegistryId { get; set; } = null!;

        public GetCredentialsOutputArgs()
        {
        }
    }
