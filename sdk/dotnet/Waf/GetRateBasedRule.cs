...
namespace Pulumi.Aws.Waf
{
    public static class GetRateBasedRule
    {
        ...
        public static Output<GetRateBasedRuleResult> Apply(GetRateBasedRuleApplyArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetRateBasedRuleApplyArgs
    {
        /// <summary>
        /// The name of the WAF rate based rule.
        /// </summary>
        ...
        public GetRateBasedRuleApplyArgs()
        {
        }
    }
