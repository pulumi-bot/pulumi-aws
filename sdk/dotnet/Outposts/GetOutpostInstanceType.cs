...
namespace Pulumi.Aws.Outposts
{
    public static class GetOutpostInstanceType
    {
        ...
        public static Output<GetOutpostInstanceTypeResult> Apply(GetOutpostInstanceTypeApplyArgs args, InvokeOptions? options = null)
        {
            return Pulumi.Output.All(
                args.Arn.Box(),
                args.InstanceType.Box(),
                args.PreferredInstanceTypes.Box()
            ).Apply(a => {
    ...
    public sealed class GetOutpostInstanceTypeApplyArgs
    {
        /// <summary>
        /// Outpost Amazon Resource Name (ARN).
        /// </summary>
        ...
        public GetOutpostInstanceTypeApplyArgs()
        {
        }
    }
