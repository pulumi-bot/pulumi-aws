...
namespace Pulumi.Aws.Ses
{
    ...
    ///                 Name = exampleDomainDkim.DkimTokens[range.Value].Apply(dkimTokens =&gt; Output.Format($"{dkimTokens}._domainkey.example.com")),
    ///                 Type = "CNAME",
    ///                 Ttl = 600,
    ///                 Records = 
    ///                 {
    ///                     exampleDomainDkim.DkimTokens[range.Value].Apply(dkimTokens =&gt; Output.Format($"{dkimTokens}.dkim.amazonses.com")),
    ///                 },
    ///             }));
    ///         }
    ///     }
