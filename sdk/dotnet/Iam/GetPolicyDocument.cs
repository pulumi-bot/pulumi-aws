...
namespace Pulumi.Aws.Iam
{
    public static class GetPolicyDocument
    {
        ...
        public static Output<GetPolicyDocumentResult> Invoke(GetPolicyDocumentOutputArgs? args = null, InvokeOptions? options = null)
        {
            args = args ?? new GetPolicyDocumentOutputArgs();
            return Pulumi.Output.All(
                args.OverrideJson.Box(),
                args.OverridePolicyDocuments.ToList().Box(),
                args.PolicyId.Box(),
                args.SourceJson.Box(),
                args.SourcePolicyDocuments.ToList().Box(),
                args.Statements.ToList().Box(),
                args.Version.Box()
            ).Apply(a => {
    ...
    public sealed class GetPolicyDocumentOutputArgs
    {
        /// <summary>
        /// IAM policy document whose statements with non-blank `sid`s will override statements with the same `sid` from documents assigned to the `source_json`, `source_policy_documents`, and `override_policy_documents` arguments. Non-overriding statements will be added to the exported document.
        /// </summary>
        ...
        public GetPolicyDocumentOutputArgs()
        {
        }
    }
