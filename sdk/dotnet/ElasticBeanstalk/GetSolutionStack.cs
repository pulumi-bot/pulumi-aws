...
namespace Pulumi.Aws.ElasticBeanstalk
{
    public static class GetSolutionStack
    {
        ...
        public static Output<GetSolutionStackResult> Invoke(GetSolutionStackOutputArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetSolutionStackOutputArgs
    {
        /// <summary>
        /// If more than one result is returned, use the most
        /// recent solution stack.
        ...
        public GetSolutionStackOutputArgs()
        {
        }
    }
