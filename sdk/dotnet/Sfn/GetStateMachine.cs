...
namespace Pulumi.Aws.Sfn
{
    public static class GetStateMachine
    {
        ...
        public static Output<GetStateMachineResult> Invoke(GetStateMachineOutputArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetStateMachineOutputArgs
    {
        /// <summary>
        /// The friendly name of the state machine to match.
        /// </summary>
        ...
        public GetStateMachineOutputArgs()
        {
        }
    }
