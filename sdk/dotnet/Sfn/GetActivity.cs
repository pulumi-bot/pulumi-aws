...
namespace Pulumi.Aws.Sfn
{
    public static class GetActivity
    {
        ...
        public static Output<GetActivityResult> Apply(GetActivityApplyArgs? args = null, InvokeOptions? options = null)
        {
            args = args ?? new GetActivityApplyArgs();
    ...
    public sealed class GetActivityApplyArgs
    {
        /// <summary>
        /// The Amazon Resource Name (ARN) that identifies the activity.
        /// </summary>
