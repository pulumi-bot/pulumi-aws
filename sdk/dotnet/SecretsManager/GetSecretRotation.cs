...
namespace Pulumi.Aws.SecretsManager
{
    public static class GetSecretRotation
    {
        ...
        public static Output<GetSecretRotationResult> Apply(GetSecretRotationApplyArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetSecretRotationApplyArgs
    {
        /// <summary>
        /// Specifies the secret containing the version that you want to retrieve. You can specify either the Amazon Resource Name (ARN) or the friendly name of the secret.
        /// </summary>
        ...
        public GetSecretRotationApplyArgs()
        {
        }
    }
