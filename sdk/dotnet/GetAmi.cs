...
namespace Pulumi.Aws
{
    ...
    public sealed class GetAmiArgs : Pulumi.ResourceArgs
    {
        ...
        [Input("filters")]
        private InputList<Inputs.GetAmiFiltersArgs>? _filters;
        ...
        /// </summary>
        public InputList<Inputs.GetAmiFiltersArgs> Filters
        {
            get => _filters ?? (_filters = new InputList<Inputs.GetAmiFiltersArgs>());
            set => _filters = value;
        }
    ...
    public sealed class GetAmiFiltersArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The name of the AMI that was provided during image creation.
        /// </summary>
