...
namespace Pulumi.Aws.Ebs
{
    public static partial class Invokes
    {
        ...
        public static Task<GetSnapshotResult> GetSnapshot(GetSnapshotArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSnapshotResult>("aws:ebs/getSnapshot:getSnapshot", args, options.WithVersion());
    }

    public sealed class GetSnapshotArgs : Pulumi.ResourceArgs
    {
        [Input("filters")]
        private InputList<Inputs.GetSnapshotFiltersArgs>? _filters;
        ...
        /// </summary>
        public InputList<Inputs.GetSnapshotFiltersArgs> Filters
        {
            get => _filters ?? (_filters = new InputList<Inputs.GetSnapshotFiltersArgs>());
            set => _filters = value;
        }
    ...
    public sealed class GetSnapshotFiltersArgs : Pulumi.ResourceArgs
    {
