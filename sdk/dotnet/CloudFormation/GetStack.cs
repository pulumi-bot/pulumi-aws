...
namespace Pulumi.Aws.CloudFormation
{
    public static class GetStack
    {
        ...
        public static Output<GetStackResult> Apply(GetStackApplyArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetStackApplyArgs
    {
        /// <summary>
        /// The name of the stack
        /// </summary>
