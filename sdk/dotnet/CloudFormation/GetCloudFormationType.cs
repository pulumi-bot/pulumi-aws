...
namespace Pulumi.Aws.CloudFormation
{
    public static class GetCloudFormationType
    {
        ...
        public static Output<GetCloudFormationTypeResult> Apply(GetCloudFormationTypeApplyArgs? args = null, InvokeOptions? options = null)
        {
            args = args ?? new GetCloudFormationTypeApplyArgs();
    ...
    public sealed class GetCloudFormationTypeApplyArgs
    {
        /// <summary>
        /// Amazon Resource Name (ARN) of the CloudFormation Type. For example, `arn:aws:cloudformation:us-west-2::type/resource/AWS-EC2-VPC`.
        /// </summary>
        ...
        public GetCloudFormationTypeApplyArgs()
        {
        }
    }
