...
namespace Pulumi.Aws.DynamoDB
{
    public static class GetTable
    {
        ...
        public static Output<GetTableResult> Apply(GetTableApplyArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetTableApplyArgs
    {
        /// <summary>
        /// The name of the DynamoDB table.
        /// </summary>
