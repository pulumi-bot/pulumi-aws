...
namespace Pulumi.Aws.DynamoDB
{
    ...
    ///             Region = "us-east-1",
    ///         });
    ///         var us-west-2 = new Aws.Provider("us-west-2", new Aws.ProviderArgs
    ///         {
    ///             Region = "us-west-2",
    ///         });
    ///         var us-east-1Table = new Aws.DynamoDB.Table("us-east-1Table", new Aws.DynamoDB.TableArgs
    ///         {
    ///             Attributes = 
    ///             {
    ...
    ///             WriteCapacity = 1,
    ///         });
    ///         var us-west-2Table = new Aws.DynamoDB.Table("us-west-2Table", new Aws.DynamoDB.TableArgs
    ///         {
    ///             Attributes = 
    ///             {
    ///                 new Aws.DynamoDB.Inputs.TableAttributeArgs
