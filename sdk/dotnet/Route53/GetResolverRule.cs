...
namespace Pulumi.Aws.Route53
{
    public static class GetResolverRule
    {
        ...
        public static Output<GetResolverRuleResult> Apply(GetResolverRuleApplyArgs? args = null, InvokeOptions? options = null)
        {
            args = args ?? new GetResolverRuleApplyArgs();
    ...
    public sealed class GetResolverRuleApplyArgs
    {
        /// <summary>
        /// The domain name the desired resolver rule forwards DNS queries for. Conflicts with `resolver_rule_id`.
        /// </summary>
        ...
        public GetResolverRuleApplyArgs()
        {
        }
    }
