...
namespace Pulumi.Aws.DataSync
{
    ...
    public partial class LocationSmb : Pulumi.CustomResource
    {
        ...
        public LocationSmb(string name, LocationSmbArgs args, CustomResourceOptions? options = null)
            : base("aws:datasync/locationSmb:LocationSmb", name, args ?? ResourceArgs.Empty, MakeResourceOptions(options, ""))
        {
        }
    ...
    public sealed class LocationSmbMountOptionsGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The specific SMB version that you want DataSync to use for mounting your SMB share. Valid values: `AUTOMATIC`, `SMB2`, and `SMB3`. Default: `AUTOMATIC`
        /// </summary>
