...
namespace Pulumi.Aws.Efs
{
    public static class GetMountTarget
    {
        ...
        public static Output<GetMountTargetResult> Invoke(GetMountTargetOutputArgs? args = null, InvokeOptions? options = null)
        {
            args = args ?? new GetMountTargetOutputArgs();
    ...
    public sealed class GetMountTargetOutputArgs
    {
        /// <summary>
        /// ID or ARN of the access point whose mount target that you want to find. It must be included if a `file_system_id` and `mount_target_id` are not included.
        /// </summary>
        ...
        public GetMountTargetOutputArgs()
        {
        }
    }
