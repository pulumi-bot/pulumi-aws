...
namespace Pulumi.Aws.GuardDuty
{
    public static class GetDetector
    {
        ...
        public static Output<GetDetectorResult> Invoke(GetDetectorOutputArgs? args = null, InvokeOptions? options = null)
        {
            args = args ?? new GetDetectorOutputArgs();
            return Pulumi.Output.All(
                args.Id.Box()
            ).Apply(a => {
                    var args = new GetDetectorArgs();
    ...
    public sealed class GetDetectorOutputArgs
    {
        /// <summary>
        /// The ID of the detector.
        /// </summary>
