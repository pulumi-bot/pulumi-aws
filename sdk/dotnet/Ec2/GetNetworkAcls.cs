...
namespace Pulumi.Aws.Ec2
{
    ...
    {
        [Input("filters")]
        private InputList<Inputs.GetNetworkAclsFiltersArgs>? _filters;

        /// <summary>
        /// Custom filter block as described below.
        /// </summary>
        public InputList<Inputs.GetNetworkAclsFiltersArgs> Filters
        {
            get => _filters ?? (_filters = new InputList<Inputs.GetNetworkAclsFiltersArgs>());
            set => _filters = value;
        }
    ...
    public sealed class GetNetworkAclsFiltersArgs : Pulumi.ResourceArgs
    {
        /// <summary>
