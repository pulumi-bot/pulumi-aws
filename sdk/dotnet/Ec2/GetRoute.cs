...
namespace Pulumi.Aws.Ec2
{
    public static class GetRoute
    {
        ...
        public static Output<GetRouteResult> Apply(GetRouteApplyArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetRouteApplyArgs
    {
        /// <summary>
        /// EC2 Carrier Gateway ID of the Route belonging to the Route Table.
        /// </summary>
