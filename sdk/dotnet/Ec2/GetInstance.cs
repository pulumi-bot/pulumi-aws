...
namespace Pulumi.Aws.Ec2
{
    public static partial class Invokes
    {
        ...
        public static Task<GetInstanceResult> GetInstance(GetInstanceArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetInstanceResult>("aws:ec2/getInstance:getInstance", args, options.WithVersion());
    }

    public sealed class GetInstanceArgs : Pulumi.ResourceArgs
    {
        [Input("filters")]
        private InputList<Inputs.GetInstanceFiltersArgs>? _filters;
        ...
        /// </summary>
        public InputList<Inputs.GetInstanceFiltersArgs> Filters
        {
            get => _filters ?? (_filters = new InputList<Inputs.GetInstanceFiltersArgs>());
            set => _filters = value;
        }
    ...
    public sealed class GetInstanceFiltersArgs : Pulumi.ResourceArgs
    {
