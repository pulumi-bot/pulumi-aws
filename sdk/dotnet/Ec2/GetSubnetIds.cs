...
namespace Pulumi.Aws.Ec2
{
    public static class GetSubnetIds
    {
        ...
        public static Output<GetSubnetIdsResult> Invoke(GetSubnetIdsOutputArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetSubnetIdsOutputArgs
    {
        [Input("filters")]
