...
namespace Pulumi.Aws.Ec2
{
    public static class GetAmiIds
    {
        ...
        public static Task<GetAmiIdsResult> InvokeAsync(GetAmiIdsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAmiIdsResult>("aws:ec2/getAmiIds:getAmiIds", args ?? new GetAmiIdsArgs(), options.WithVersion());

        public static Output<GetAmiIdsResult> Invoke(GetAmiIdsOutputArgs args, InvokeOptions? options = null)
        {
            return Pulumi.Output.All(
                ...
                args.SortAscending.Box()
            ).Apply(a => {
                    var args = new GetAmiIdsArgs();
                    a[0].Set(args, nameof(args.ExecutableUsers));
                    a[1].Set(args, nameof(args.Filters));
                    a[2].Set(args, nameof(args.NameRegex));
                    a[3].Set(args, nameof(args.Owners));
                    a[4].Set(args, nameof(args.SortAscending));
    ...
    public sealed class GetAmiIdsOutputArgs
    {
        [Input("executableUsers")]
