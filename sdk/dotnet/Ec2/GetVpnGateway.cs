...
namespace Pulumi.Aws.Ec2
{
    ...
    public sealed class GetVpnGatewayArgs : Pulumi.ResourceArgs
    {
        ...
        [Input("filters")]
        private InputList<Inputs.GetVpnGatewayFiltersArgs>? _filters;

        /// <summary>
        /// Custom filter block as described below.
        /// </summary>
        public InputList<Inputs.GetVpnGatewayFiltersArgs> Filters
        {
            get => _filters ?? (_filters = new InputList<Inputs.GetVpnGatewayFiltersArgs>());
            set => _filters = value;
        }
    ...
    public sealed class GetVpnGatewayFiltersArgs : Pulumi.ResourceArgs
    {
        /// <summary>
