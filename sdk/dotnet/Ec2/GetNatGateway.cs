...
namespace Pulumi.Aws.Ec2
{
    public static class GetNatGateway
    {
        ...
        public static Output<GetNatGatewayResult> Invoke(GetNatGatewayOutputArgs? args = null, InvokeOptions? options = null)
        {
            args = args ?? new GetNatGatewayOutputArgs();
    ...
    public sealed class GetNatGatewayOutputArgs
    {
        [Input("filters")]
        private InputList<Inputs.GetNatGatewayFilterArgs>? _filters;

        /// <summary>
        /// Custom filter block as described below.
        /// </summary>
        public InputList<Inputs.GetNatGatewayFilterArgs> Filters
        {
            get => _filters ?? (_filters = new InputList<Inputs.GetNatGatewayFilterArgs>());
            set => _filters = value;
        }
        ...
        public GetNatGatewayOutputArgs()
        {
        }
    }
