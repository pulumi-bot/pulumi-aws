...
namespace Pulumi.Aws.Sqs
{
    public static class GetQueue
    {
        ...
        public static Output<GetQueueResult> Apply(GetQueueApplyArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetQueueApplyArgs
    {
        /// <summary>
        /// The name of the queue to match.
        /// </summary>
