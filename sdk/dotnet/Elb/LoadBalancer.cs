...
namespace Pulumi.Aws.Elb
{
    ...
    public partial class LoadBalancer : Pulumi.CustomResource
    {
        ...
        public LoadBalancer(string name, LoadBalancerArgs args, CustomResourceOptions? options = null)
            : base("aws:elb/loadBalancer:LoadBalancer", name, args ?? ResourceArgs.Empty, MakeResourceOptions(options, ""))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            ...
            {
                Version = Utilities.Version,                Aliases = { new Alias { Type = "aws:elasticloadbalancing/loadBalancer:LoadBalancer" } },
            };
