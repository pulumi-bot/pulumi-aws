...
namespace Pulumi.Aws.Backup
{
    public static class GetSelection
    {
        ...
        public static Output<GetSelectionResult> Invoke(GetSelectionOutputArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetSelectionOutputArgs
    {
        /// <summary>
        /// The backup plan ID associated with the selection of resources.
        /// </summary>
