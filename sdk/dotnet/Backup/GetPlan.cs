...
namespace Pulumi.Aws.Backup
{
    public static class GetPlan
    {
        ...
        public static Output<GetPlanResult> Invoke(GetPlanOutputArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetPlanOutputArgs
    {
        /// <summary>
        /// The backup plan ID.
        /// </summary>
