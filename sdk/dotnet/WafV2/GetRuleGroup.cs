...
namespace Pulumi.Aws.WafV2
{
    public static class GetRuleGroup
    {
        ...
        public static Output<GetRuleGroupResult> Apply(GetRuleGroupApplyArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetRuleGroupApplyArgs
    {
        /// <summary>
        /// The name of the WAFv2 Rule Group.
        /// </summary>
