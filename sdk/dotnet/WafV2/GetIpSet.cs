...
namespace Pulumi.Aws.WafV2
{
    public static class GetIpSet
    {
        ...
        public static Output<GetIpSetResult> Invoke(GetIpSetOutputArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetIpSetOutputArgs
    {
        /// <summary>
        /// The name of the WAFv2 IP Set.
        /// </summary>
