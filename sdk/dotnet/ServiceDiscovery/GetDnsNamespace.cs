...
namespace Pulumi.Aws.ServiceDiscovery
{
    public static class GetDnsNamespace
    {
        ...
        public static Output<GetDnsNamespaceResult> Apply(GetDnsNamespaceApplyArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetDnsNamespaceApplyArgs
    {
        /// <summary>
        /// The name of the namespace.
        /// </summary>
        ...
        public GetDnsNamespaceApplyArgs()
        {
        }
    }
