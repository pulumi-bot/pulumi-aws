...
namespace Pulumi.Aws.ImageBuilder
{
    public static class GetInfrastructureConfiguration
    {
        ...
        public static Output<GetInfrastructureConfigurationResult> Apply(GetInfrastructureConfigurationApplyArgs args, InvokeOptions? options = null)
        {
            return Pulumi.Output.All(
                args.Arn.Box(),
                args.ResourceTags.Box(),
                args.Tags.Box()
            ).Apply(a => {
    ...
    public sealed class GetInfrastructureConfigurationApplyArgs
    {
        /// <summary>
        /// Amazon Resource Name (ARN) of the infrastructure configuration.
        /// </summary>
        ...
        public GetInfrastructureConfigurationApplyArgs()
        {
        }
    }
