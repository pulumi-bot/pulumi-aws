...
namespace Pulumi.Aws.ImageBuilder
{
    public static class GetDistributionConfiguration
    {
        ...
        public static Output<GetDistributionConfigurationResult> Invoke(GetDistributionConfigurationOutputArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetDistributionConfigurationOutputArgs
    {
        /// <summary>
        /// Amazon Resource Name (ARN) of the distribution configuration.
        /// </summary>
        ...
        public GetDistributionConfigurationOutputArgs()
        {
        }
    }
