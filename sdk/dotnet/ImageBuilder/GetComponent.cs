...
namespace Pulumi.Aws.ImageBuilder
{
    public static class GetComponent
    {
        ...
        public static Output<GetComponentResult> Invoke(GetComponentOutputArgs args, InvokeOptions? options = null)
        {
            return Pulumi.Output.All(
                args.Arn.Box(),
                args.Tags.ToDict().Box()
            ).Apply(a => {
                    var args = new GetComponentArgs();
    ...
    public sealed class GetComponentOutputArgs
    {
        /// <summary>
        /// Amazon Resource Name (ARN) of the component.
        /// </summary>
