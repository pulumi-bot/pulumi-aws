...
namespace Pulumi.Aws.LB
{
    ...
    public partial class TargetGroup : Pulumi.CustomResource
    {
        ...
        public TargetGroup(string name, TargetGroupArgs? args = null, CustomResourceOptions? options = null)
            : base("aws:lb/targetGroup:TargetGroup", name, args ?? ResourceArgs.Empty, MakeResourceOptions(options, ""))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            ...
            {
                Version = Utilities.Version,                Aliases = { new Alias { Type = "aws:elasticloadbalancingv2/targetGroup:TargetGroup" } },
            };
