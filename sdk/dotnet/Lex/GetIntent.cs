...
namespace Pulumi.Aws.Lex
{
    public static class GetIntent
    {
        ...
        public static Output<GetIntentResult> Invoke(GetIntentOutputArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetIntentOutputArgs
    {
        /// <summary>
        /// The name of the intent. The name is case sensitive.
        /// </summary>
