...
namespace Pulumi.Aws.Lex
{
    public static class GetSlotType
    {
        ...
        public static Output<GetSlotTypeResult> Apply(GetSlotTypeApplyArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetSlotTypeApplyArgs
    {
        /// <summary>
        /// The name of the slot type. The name is case sensitive.
        /// </summary>
