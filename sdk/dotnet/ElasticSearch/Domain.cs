...
namespace Pulumi.Aws.ElasticSearch
{
    ...
    ///     public MyStack()
    ///     {
    /// "TODO: // TODO config"        var currentRegion = Output.Create(Aws.GetRegion.InvokeAsync());
    ...
    ///     public MyStack()
    ///     {
    /// "TODO: // TODO config""TODO: // TODO config"        var selectedVpc = Output.Create(Aws.Ec2.GetVpc.InvokeAsync(new Aws.Ec2.GetVpcArgs
    ///         {
    ///             Tags = 
    ///             {
    ///                 { "Name", vpc },
