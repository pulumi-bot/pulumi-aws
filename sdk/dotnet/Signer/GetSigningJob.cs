...
namespace Pulumi.Aws.Signer
{
    public static class GetSigningJob
    {
        ...
        public static Output<GetSigningJobResult> Apply(GetSigningJobApplyArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetSigningJobApplyArgs
    {
        /// <summary>
        /// The ID of the signing job on output.
        /// </summary>
