...
namespace Pulumi.Aws.Kinesis
{
    public static class GetStream
    {
        ...
        public static Output<GetStreamResult> Apply(GetStreamApplyArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetStreamApplyArgs
    {
        /// <summary>
        /// The name of the Kinesis Stream.
        /// </summary>
