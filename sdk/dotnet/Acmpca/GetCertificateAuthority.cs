...
namespace Pulumi.Aws.Acmpca
{
    ...
    public sealed class GetCertificateAuthorityArgs : Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.GetCertificateAuthorityRevocationConfigurationsArgs>? _revocationConfigurations;
        public InputList<Inputs.GetCertificateAuthorityRevocationConfigurationsArgs> RevocationConfigurations
        {
            get => _revocationConfigurations ?? (_revocationConfigurations = new InputList<Inputs.GetCertificateAuthorityRevocationConfigurationsArgs>());
    ...
    public sealed class GetCertificateAuthorityRevocationConfigurationsArgs : Pulumi.ResourceArgs
    {
        [Input("crlConfigurations")]
        private InputList<GetCertificateAuthorityRevocationConfigurationsCrlConfigurationsArgs>? _crlConfigurations;
        public InputList<GetCertificateAuthorityRevocationConfigurationsCrlConfigurationsArgs> CrlConfigurations
        {
            get => _crlConfigurations ?? (_crlConfigurations = new InputList<GetCertificateAuthorityRevocationConfigurationsCrlConfigurationsArgs>());
    ...
    public sealed class GetCertificateAuthorityRevocationConfigurationsCrlConfigurationsArgs : Pulumi.ResourceArgs
    {
        [Input("customCname")]
