...
namespace Pulumi.Aws.Acmpca
{
    public static class GetCertificateAuthority
    {
        ...
        public static Output<GetCertificateAuthorityResult> Invoke(GetCertificateAuthorityOutputArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetCertificateAuthorityOutputArgs
    {
        /// <summary>
        /// Amazon Resource Name (ARN) of the certificate authority.
        /// </summary>
        ...
        public GetCertificateAuthorityOutputArgs()
        {
        }
    }
