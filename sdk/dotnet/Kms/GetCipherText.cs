...
namespace Pulumi.Aws.Kms
{
    public static class GetCipherText
    {
        ...
        public static Output<GetCipherTextResult> Invoke(GetCipherTextOutputArgs args, InvokeOptions? options = null)
        {
            return Pulumi.Output.All(
                args.Context.ToDict().Box(),
                args.KeyId.Box(),
                args.Plaintext.Box()
            ).Apply(a => {
    ...
    public sealed class GetCipherTextOutputArgs
    {
        [Input("context")]
        ...
        public GetCipherTextOutputArgs()
        {
        }
    }
