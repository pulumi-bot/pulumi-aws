...
namespace Pulumi.Aws.Kms
{
    public static class GetSecrets
    {
        ...
        public static Output<GetSecretsResult> Invoke(GetSecretsOutputArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetSecretsOutputArgs
    {
        [Input("secrets", required: true)]
