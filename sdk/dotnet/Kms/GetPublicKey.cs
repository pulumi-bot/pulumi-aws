...
namespace Pulumi.Aws.Kms
{
    public static class GetPublicKey
    {
        ...
        public static Output<GetPublicKeyResult> Invoke(GetPublicKeyOutputArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetPublicKeyOutputArgs
    {
        [Input("grantTokens")]
