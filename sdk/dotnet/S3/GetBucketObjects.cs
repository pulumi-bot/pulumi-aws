...
namespace Pulumi.Aws.S3
{
    public static class GetBucketObjects
    {
        ...
        public static Output<GetBucketObjectsResult> Apply(GetBucketObjectsApplyArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetBucketObjectsApplyArgs
    {
        /// <summary>
        /// Lists object keys in this S3 bucket. Alternatively, an [S3 access point](https://docs.aws.amazon.com/AmazonS3/latest/dev/using-access-points.html) ARN can be specified
        /// </summary>
        ...
        public GetBucketObjectsApplyArgs()
        {
        }
    }
