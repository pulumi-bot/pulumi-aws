...
namespace Pulumi.Aws.S3
{
    public static class GetBucketObjects
    {
        ...
        public static Output<GetBucketObjectsResult> Invoke(GetBucketObjectsOutputArgs args, InvokeOptions? options = null)
        {
            return Pulumi.Output.All(
                args.Bucket.Box(),
                args.Delimiter.Box(),
                args.EncodingType.Box(),
                args.FetchOwner.Box(),
                args.MaxKeys.Box(),
                args.Prefix.Box(),
                args.StartAfter.Box()
            ).Apply(a => {
                    var args = new GetBucketObjectsArgs();
                    a[0].Set(args, nameof(args.Bucket));
                    a[1].Set(args, nameof(args.Delimiter));
                    a[2].Set(args, nameof(args.EncodingType));
                    a[3].Set(args, nameof(args.FetchOwner));
                    a[4].Set(args, nameof(args.MaxKeys));
                    a[5].Set(args, nameof(args.Prefix));
                    a[6].Set(args, nameof(args.StartAfter));
    ...
    public sealed class GetBucketObjectsOutputArgs
    {
        /// <summary>
        /// Lists object keys in this S3 bucket. Alternatively, an [S3 access point](https://docs.aws.amazon.com/AmazonS3/latest/dev/using-access-points.html) ARN can be specified
        /// </summary>
        ...
        public GetBucketObjectsOutputArgs()
        {
        }
    }
