...
namespace Pulumi.Aws.S3
{
    ...
    ///         {
    ///         });
    ///         var example-entire-bucket = new Aws.S3.BucketMetric("example-entire-bucket", new Aws.S3.BucketMetricArgs
    ///         {
    ...
    ///         {
    ///         });
    ///         var example-filtered = new Aws.S3.BucketMetric("example-filtered", new Aws.S3.BucketMetricArgs
    ///         {
    ///             Bucket = example.BucketName,
