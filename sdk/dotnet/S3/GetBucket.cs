...
namespace Pulumi.Aws.S3
{
    public static class GetBucket
    {
        ...
        public static Output<GetBucketResult> Apply(GetBucketApplyArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetBucketApplyArgs
    {
        /// <summary>
        /// The name of the bucket
        /// </summary>
