...
namespace Pulumi.Aws.OpsWorks
{
    ...
    public partial class MemcachedLayer : Pulumi.CustomResource
    {
        ...
        public Output<int?> AllocatedMemory { get; private set; } = null!;
        ...
        public MemcachedLayer(string name, MemcachedLayerArgs args, CustomResourceOptions? options = null)
            : base("aws:opsworks/memcachedLayer:MemcachedLayer", name, args ?? new MemcachedLayerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MemcachedLayer(string name, Input<string> id, MemcachedLayerState? state = null, CustomResourceOptions? options = null)
            : base("aws:opsworks/memcachedLayer:MemcachedLayer", name, state, MakeResourceOptions(options, id))
        {
        }
