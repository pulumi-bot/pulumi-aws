...
class MysqlLayer(pulumi.CustomResource):
    ...
    """
    ebs_volumes: pulumi.Output[Optional[List['outputs.MysqlLayerEbsVolume']]] = pulumi.output_property("ebsVolumes")
    """
    ...
    """
    root_password_on_all_instances: pulumi.Output[Optional[bool]] = pulumi.output_property("rootPasswordOnAllInstances")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, auto_assign_elastic_ips=None, auto_assign_public_ips=None, auto_healing=None, custom_configure_recipes=None, custom_deploy_recipes=None, custom_instance_profile_arn=None, custom_json=None, custom_security_group_ids=None, custom_setup_recipes=None, custom_shutdown_recipes=None, custom_undeploy_recipes=None, drain_elb_on_shutdown=None, ebs_volumes=None, elastic_load_balancer=None, install_updates_on_boot=None, instance_shutdown_timeout=None, name=None, root_password=None, root_password_on_all_instances=None, stack_id=None, system_packages=None, tags=None, use_ebs_optimized_instances=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
        ...
        :param pulumi.Input[List[pulumi.Input['MysqlLayerEbsVolumeArgs']]] ebs_volumes: `ebs_volume` blocks, as described below, will each create an EBS volume and connect it to the layer's instances.
