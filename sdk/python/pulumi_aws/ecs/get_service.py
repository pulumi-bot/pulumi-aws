...
def get_service(cluster_arn: Optional[str] = None,
    ...
    return AwaitableGetServiceResult(
        ...
        cluster_arn=_utilities.get_dict_value(__ret__, 'clusterArn'),
        desired_count=_utilities.get_dict_value(__ret__, 'desiredCount'),
        id=_utilities.get_dict_value(__ret__, 'id'),
        launch_type=_utilities.get_dict_value(__ret__, 'launchType'),
        scheduling_strategy=_utilities.get_dict_value(__ret__, 'schedulingStrategy'),
