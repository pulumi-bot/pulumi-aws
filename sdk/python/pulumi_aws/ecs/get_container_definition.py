...
@pulumi.output_type
class _GetContainerDefinitionResult(dict):
...
def get_container_definition(container_name: Optional[str] = None,
    ...
    return AwaitableGetContainerDefinitionResult(
        container_name=_utilities.get_dict_value(__ret__, 'containerName'),
        cpu=_utilities.get_dict_value(__ret__, 'cpu'),
        disable_networking=_utilities.get_dict_value(__ret__, 'disableNetworking'),
        docker_labels=_utilities.get_dict_value(__ret__, 'dockerLabels'),
        environment=_utilities.get_dict_value(__ret__, 'environment'),
        id=_utilities.get_dict_value(__ret__, 'id'),
        image=_utilities.get_dict_value(__ret__, 'image'),
        image_digest=_utilities.get_dict_value(__ret__, 'imageDigest'),
        memory=_utilities.get_dict_value(__ret__, 'memory'),
        memory_reservation=_utilities.get_dict_value(__ret__, 'memoryReservation'),
        task_definition=_utilities.get_dict_value(__ret__, 'taskDefinition'))
