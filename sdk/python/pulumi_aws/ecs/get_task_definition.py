...
@pulumi.output_type
class _GetTaskDefinitionResult(dict):
...
def get_task_definition(task_definition: Optional[str] = None,
    ...
    return AwaitableGetTaskDefinitionResult(
        ...
        network_mode=_utilities.get_dict_value(__ret__, 'networkMode'),
        ...
        task_role_arn=_utilities.get_dict_value(__ret__, 'taskRoleArn'))
