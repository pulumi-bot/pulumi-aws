...
def get_cluster(cluster_name: Optional[str] = None,
    ...
    return AwaitableGetClusterResult(
        ...
        pending_tasks_count=_utilities.get_dict_value(__ret__, 'pendingTasksCount'),
        registered_container_instances_count=_utilities.get_dict_value(__ret__, 'registeredContainerInstancesCount'),
        running_tasks_count=_utilities.get_dict_value(__ret__, 'runningTasksCount'),
