...
def get_arn(arn: Optional[str] = None,
    ...
    return AwaitableGetArnResult(
        account=_utilities.get_dict_value(__ret__, 'account'),
        arn=_utilities.get_dict_value(__ret__, 'arn'),
        id=_utilities.get_dict_value(__ret__, 'id'),
        partition=_utilities.get_dict_value(__ret__, 'partition'),
        region=_utilities.get_dict_value(__ret__, 'region'),
        resource=_utilities.get_dict_value(__ret__, 'resource'),
