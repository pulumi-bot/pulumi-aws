...
def get_ip_ranges(regions: Optional[List[str]] = None,
    ...
    return AwaitableGetIpRangesResult(
        ...
        create_date=_utilities.get_dict_value(__ret__, 'createDate'),
        id=_utilities.get_dict_value(__ret__, 'id'),
        ipv6_cidr_blocks=_utilities.get_dict_value(__ret__, 'ipv6CidrBlocks'),
        regions=_utilities.get_dict_value(__ret__, 'regions'),
        services=_utilities.get_dict_value(__ret__, 'services'),
        sync_token=_utilities.get_dict_value(__ret__, 'syncToken'),
        url=_utilities.get_dict_value(__ret__, 'url'))
