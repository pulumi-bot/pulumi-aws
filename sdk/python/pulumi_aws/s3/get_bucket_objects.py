...
@pulumi.output_type
class _GetBucketObjectsResult(dict):
...
def get_bucket_objects(bucket: Optional[str] = None,
    ...
    return AwaitableGetBucketObjectsResult(
        ...
        common_prefixes=_utilities.get_dict_value(__ret__, 'commonPrefixes'),
        delimiter=_utilities.get_dict_value(__ret__, 'delimiter'),
        encoding_type=_utilities.get_dict_value(__ret__, 'encodingType'),
        fetch_owner=_utilities.get_dict_value(__ret__, 'fetchOwner'),
        id=_utilities.get_dict_value(__ret__, 'id'),
        keys=_utilities.get_dict_value(__ret__, 'keys'),
        max_keys=_utilities.get_dict_value(__ret__, 'maxKeys'),
        owners=_utilities.get_dict_value(__ret__, 'owners'),
        prefix=_utilities.get_dict_value(__ret__, 'prefix'),
        start_after=_utilities.get_dict_value(__ret__, 'startAfter'))
