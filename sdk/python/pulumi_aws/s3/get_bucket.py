...
def get_bucket(bucket: Optional[str] = None,
    ...
    return AwaitableGetBucketResult(
        ...
        bucket_domain_name=_utilities.get_dict_value(__ret__, 'bucketDomainName'),
        bucket_regional_domain_name=_utilities.get_dict_value(__ret__, 'bucketRegionalDomainName'),
        hosted_zone_id=_utilities.get_dict_value(__ret__, 'hostedZoneId'),
        id=_utilities.get_dict_value(__ret__, 'id'),
        region=_utilities.get_dict_value(__ret__, 'region'),
        website_domain=_utilities.get_dict_value(__ret__, 'websiteDomain'),
        website_endpoint=_utilities.get_dict_value(__ret__, 'websiteEndpoint'))
