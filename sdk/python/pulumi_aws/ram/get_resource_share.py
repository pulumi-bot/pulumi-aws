...
@pulumi.output_type
class _GetResourceShareResult(dict):
...
def get_resource_share(filters: Optional[List[pulumi.InputType['GetResourceShareFilterArgs']]] = None,
    ...
    return AwaitableGetResourceShareResult(
        ...
        owning_account_id=_utilities.get_dict_value(__ret__, 'owningAccountId'),
        resource_owner=_utilities.get_dict_value(__ret__, 'resourceOwner'),
