...
def get_detector(id: Optional[str] = None,
    ...
    return AwaitableGetDetectorResult(
        finding_publishing_frequency=_utilities.get_dict_value(__ret__, 'findingPublishingFrequency'),
        id=_utilities.get_dict_value(__ret__, 'id'),
        service_role_arn=_utilities.get_dict_value(__ret__, 'serviceRoleArn'),
