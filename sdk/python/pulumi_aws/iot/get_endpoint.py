...
def get_endpoint(endpoint_type: Optional[str] = None,
    ...
    return AwaitableGetEndpointResult(
        endpoint_address=_utilities.get_dict_value(__ret__, 'endpointAddress'),
        endpoint_type=_utilities.get_dict_value(__ret__, 'endpointType'),
