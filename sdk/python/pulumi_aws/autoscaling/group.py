...
class Group(pulumi.CustomResource):
    ...
    load_balancers: pulumi.Output[Optional[List[str]]] = pulumi.property("loadBalancers")
    """
    ...
    target_group_arns: pulumi.Output[Optional[List[str]]] = pulumi.property("targetGroupArns")
    """
