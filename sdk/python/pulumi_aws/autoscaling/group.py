...
class Group(pulumi.CustomResource):
    ...
    * `wait_for_capacity_timeout` (Default: "10m") A maximum
    ...
    Configuration block containing settings to define launch targets for Auto Scaling groups. Defined below.
      ...
      * `instances_distribution` (`dict`) - Nested argument containing settings on how to mix on-demand and Spot instances in the Auto Scaling group. Defined below.
    
        * `on_demand_allocation_strategy` (`str`) - Strategy to use when launching on-demand instances. Valid values: `prioritized`. Default: `prioritized`.
        * `on_demand_base_capacity` (`float`) - Absolute minimum amount of desired capacity that must be fulfilled by on-demand instances. Default: `0`.
        * `on_demand_percentage_above_base_capacity` (`float`) - Percentage split between on-demand and Spot instances above the base on-demand capacity. Default: `100`.
        * `spot_allocation_strategy` (`str`) - How to allocate capacity across the Spot pools. Valid values: `lowest-price`. Default: `lowest-price`.
        * `spot_instance_pools` (`float`) - Number of Spot pools per availability zone to allocate capacity. EC2 Auto Scaling selects the cheapest Spot pools and evenly allocates Spot capacity across the number of Spot pools that you specify. Default: `2`.
        * `spot_max_price` (`str`) - Maximum price per unit hour that the user is willing to pay for the Spot instances. Default: an empty string which means the on-demand price.
    
      * `launch_template` (`dict`) - Nested argument containing launch template settings along with the overrides to specify multiple instance types. Defined below.
    
        * `launch_template_specification` (`dict`) - Nested argument defines the Launch Template. Defined below.
    
          * `launch_template_id` (`str`) - The ID of the launch template. Conflicts with `launch_template_name`.
          * `launch_template_name` (`str`) - The name of the launch template. Conflicts with `launch_template_id`.
          * `version` (`str`) - Template version. Can be version number, `$Latest`, or `$Default`. (Default: `$Default`).
    ...
    A list of tag blocks. Tags documented below.
      ...
      * `key` (`str`) - Key
      * `propagate_at_launch` (`bool`) - Enables propagation of the tag to
    ...
    def __init__(__self__, resource_name, opts=None, availability_zones=None, default_cooldown=None, desired_capacity=None, enabled_metrics=None, force_delete=None, health_check_grace_period=None, health_check_type=None, initial_lifecycle_hooks=None, launch_configuration=None, launch_template=None, load_balancers=None, max_size=None, metrics_granularity=None, min_elb_capacity=None, min_size=None, mixed_instances_policy=None, name=None, name_prefix=None, placement_group=None, protect_from_scale_in=None, service_linked_role_arn=None, suspended_processes=None, tags=None, tags_collection=None, target_group_arns=None, termination_policies=None, vpc_zone_identifiers=None, wait_for_capacity_timeout=None, wait_for_elb_capacity=None, __props__=None, __name__=None, __opts__=None):
        ...
        The **mixed_instances_policy** object supports the following:
          ...
          * `instances_distribution` (`pulumi.Input[dict]`) - Nested argument containing settings on how to mix on-demand and Spot instances in the Auto Scaling group. Defined below.
        
            * `on_demand_allocation_strategy` (`pulumi.Input[str]`) - Strategy to use when launching on-demand instances. Valid values: `prioritized`. Default: `prioritized`.
            * `on_demand_base_capacity` (`pulumi.Input[float]`) - Absolute minimum amount of desired capacity that must be fulfilled by on-demand instances. Default: `0`.
            * `on_demand_percentage_above_base_capacity` (`pulumi.Input[float]`) - Percentage split between on-demand and Spot instances above the base on-demand capacity. Default: `100`.
            * `spot_allocation_strategy` (`pulumi.Input[str]`) - How to allocate capacity across the Spot pools. Valid values: `lowest-price`. Default: `lowest-price`.
            * `spot_instance_pools` (`pulumi.Input[float]`) - Number of Spot pools per availability zone to allocate capacity. EC2 Auto Scaling selects the cheapest Spot pools and evenly allocates Spot capacity across the number of Spot pools that you specify. Default: `2`.
            * `spot_max_price` (`pulumi.Input[str]`) - Maximum price per unit hour that the user is willing to pay for the Spot instances. Default: an empty string which means the on-demand price.
        
          * `launch_template` (`pulumi.Input[dict]`) - Nested argument containing launch template settings along with the overrides to specify multiple instance types. Defined below.
        
            * `launch_template_specification` (`pulumi.Input[dict]`) - Nested argument defines the Launch Template. Defined below.
        
              * `launch_template_id` (`pulumi.Input[str]`) - The ID of the launch template. Conflicts with `launch_template_name`.
              * `launch_template_name` (`pulumi.Input[str]`) - The name of the launch template. Conflicts with `launch_template_id`.
              * `version` (`pulumi.Input[str]`) - Template version. Can be version number, `$Latest`, or `$Default`. (Default: `$Default`).
        ...
        The **tags** object supports the following:
          ...
          * `propagate_at_launch` (`pulumi.Input[bool]`) - Enables propagation of the tag to
            Amazon EC2 instances launched via this ASG
