...
def get_network_interfaces(filters=None, tags=None, opts=None):
    ...
    example = aws.ec2.get_network_interfaces(aws.ec2.GetNetworkInterfacesArgsArgs(
        tags={
            "Name": "test",
        },
    ))
    ...
    example_network_interfaces = aws.ec2.get_network_interfaces(aws.ec2.GetNetworkInterfacesArgsArgs(
        filters=[aws.ec2.GetNetworkInterfacesFilterArgs(
            name="subnet-id",
