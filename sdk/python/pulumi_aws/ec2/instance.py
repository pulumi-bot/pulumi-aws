...
class Instance(pulumi.CustomResource):
    ...
    """
    associate_public_ip_address: pulumi.Output[bool] = pulumi.output_property("associatePublicIpAddress")
    """
    ...
    """
    cpu_core_count: pulumi.Output[float] = pulumi.output_property("cpuCoreCount")
    """
    Sets the number of CPU cores for an instance. This option is
    only supported on creation of instance type that support CPU Options
    [CPU Cores and Threads Per CPU Core Per Instance Type](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/instance-optimize-cpu.html#cpu-options-supported-instances-values) - specifying this option for unsupported instance types will return an error from the EC2 API.
    """
    cpu_threads_per_core: pulumi.Output[float] = pulumi.output_property("cpuThreadsPerCore")
    """
    If set to to 1, hyperthreading is disabled on the launched instance. Defaults to 2 if not set. See [Optimizing CPU Options](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/instance-optimize-cpu.html) for more information.
    """
    credit_specification: pulumi.Output[Optional['outputs.InstanceCreditSpecification']] = pulumi.output_property("creditSpecification")
    """
    Customize the credit specification of the instance. See Credit Specification below for more details.
    """
    disable_api_termination: pulumi.Output[Optional[bool]] = pulumi.output_property("disableApiTermination")
    """
    If true, enables [EC2 Instance
    Termination Protection](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/terminating-instances.html#Using_ChangingDisableAPITermination)
    """
    ebs_block_devices: pulumi.Output[List['outputs.InstanceEbsBlockDevice']] = pulumi.output_property("ebsBlockDevices")
    """
    ...
    """
    ephemeral_block_devices: pulumi.Output[List['outputs.InstanceEphemeralBlockDevice']] = pulumi.output_property("ephemeralBlockDevices")
    """
    Customize Ephemeral (also known as
    "Instance Store") volumes on the instance. See Block Devices below for details.
    """
    get_password_data: pulumi.Output[Optional[bool]] = pulumi.output_property("getPasswordData")
    """
    If true, wait for password data to become available and retrieve it. Useful for getting the administrator password for instances running Microsoft Windows. The password data is exported to the `password_data` attribute. See [GetPasswordData](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_GetPasswordData.html) for more information.
    """
    hibernation: pulumi.Output[Optional[bool]] = pulumi.output_property("hibernation")
    """
    If true, the launched EC2 instance will support hibernation.
    """
    host_id: pulumi.Output[str] = pulumi.output_property("hostId")
    """
    The Id of a dedicated host that the instance will be assigned to. Use when an instance is to be launched on a specific dedicated host.
    """
    iam_instance_profile: pulumi.Output[Optional[str]] = pulumi.output_property("iamInstanceProfile")
    """
    The IAM Instance Profile to
    launch the instance with. Specified as the name of the Instance Profile. Ensure your credentials have the correct permission to assign the instance profile according to the [EC2 documentation](http://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles_use_switch-role-ec2.html#roles-usingrole-ec2instance-permissions), notably `iam:PassRole`.
    """
    instance_initiated_shutdown_behavior: pulumi.Output[Optional[str]] = pulumi.output_property("instanceInitiatedShutdownBehavior")
    """
    ...
    """
    instance_state: pulumi.Output[str] = pulumi.output_property("instanceState")
    """
    ...
    """
    ipv6_address_count: pulumi.Output[float] = pulumi.output_property("ipv6AddressCount")
    """
    A number of IPv6 addresses to associate with the primary network interface. Amazon EC2 chooses the IPv6 addresses from the range of your subnet.
    """
    ipv6_addresses: pulumi.Output[List[str]] = pulumi.output_property("ipv6Addresses")
    """
    ...
    """
    metadata_options: pulumi.Output['outputs.InstanceMetadataOptions'] = pulumi.output_property("metadataOptions")
    """
    Customize the metadata options of the instance. See Metadata Options below for more details.
    """
    monitoring: pulumi.Output[Optional[bool]] = pulumi.output_property("monitoring")
    """
    ...
    """
    password_data: pulumi.Output[str] = pulumi.output_property("passwordData")
    """
    ...
    """
    placement_group: pulumi.Output[str] = pulumi.output_property("placementGroup")
    """
    The Placement Group to start the instance in.
    """
    primary_network_interface_id: pulumi.Output[str] = pulumi.output_property("primaryNetworkInterfaceId")
    """
    The ID of the instance's primary network interface.
    """
    private_dns: pulumi.Output[str] = pulumi.output_property("privateDns")
    """
    ...
    instance in a VPC.
    """
    public_dns: pulumi.Output[str] = pulumi.output_property("publicDns")
    """
    ...
    """
    root_block_device: pulumi.Output['outputs.InstanceRootBlockDevice'] = pulumi.output_property("rootBlockDevice")
    """
    ...
    """
    tenancy: pulumi.Output[str] = pulumi.output_property("tenancy")
    """
    ...
    """
    user_data_base64: pulumi.Output[Optional[str]] = pulumi.output_property("userDataBase64")
    """
    Can be used instead of `user_data` to pass base64-encoded binary data directly. Use this instead of `user_data` whenever the value is not a valid UTF-8 string. For example, gzip-encoded user data must be base64-encoded and passed via this argument to avoid corruption.
    """
    volume_tags: pulumi.Output[Dict[str, str]] = pulumi.output_property("volumeTags")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, ami: Optional[pulumi.Input[str]] = None, associate_public_ip_address: Optional[pulumi.Input[bool]] = None, availability_zone: Optional[pulumi.Input[str]] = None, cpu_core_count: Optional[pulumi.Input[float]] = None, cpu_threads_per_core: Optional[pulumi.Input[float]] = None, credit_specification: Optional[pulumi.Input[pulumi.InputType['InstanceCreditSpecificationArgs']]] = None, disable_api_termination: Optional[pulumi.Input[bool]] = None, ebs_block_devices: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['InstanceEbsBlockDeviceArgs']]]]] = None, ebs_optimized: Optional[pulumi.Input[bool]] = None, ephemeral_block_devices: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['InstanceEphemeralBlockDeviceArgs']]]]] = None, get_password_data: Optional[pulumi.Input[bool]] = None, hibernation: Optional[pulumi.Input[bool]] = None, host_id: Optional[pulumi.Input[str]] = None, iam_instance_profile: Optional[pulumi.Input[str]] = None, instance_initiated_shutdown_behavior: Optional[pulumi.Input[str]] = None, instance_type: Optional[pulumi.Input[str]] = None, ipv6_address_count: Optional[pulumi.Input[float]] = None, ipv6_addresses: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, key_name: Optional[pulumi.Input[str]] = None, metadata_options: Optional[pulumi.Input[pulumi.InputType['InstanceMetadataOptionsArgs']]] = None, monitoring: Optional[pulumi.Input[bool]] = None, network_interfaces: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['InstanceNetworkInterfaceArgs']]]]] = None, placement_group: Optional[pulumi.Input[str]] = None, private_ip: Optional[pulumi.Input[str]] = None, root_block_device: Optional[pulumi.Input[pulumi.InputType['InstanceRootBlockDeviceArgs']]] = None, security_groups: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, source_dest_check: Optional[pulumi.Input[bool]] = None, subnet_id: Optional[pulumi.Input[str]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, tenancy: Optional[pulumi.Input[str]] = None, user_data: Optional[pulumi.Input[str]] = None, user_data_base64: Optional[pulumi.Input[str]] = None, volume_tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, vpc_security_group_ids: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
        ...
        :param pulumi.Input[Dict[str, pulumi.Input[str]]] volume_tags: A map of tags to assign to the devices created by the instance at launch time.
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, ami: Optional[pulumi.Input[str]] = None, arn: Optional[pulumi.Input[str]] = None, associate_public_ip_address: Optional[pulumi.Input[bool]] = None, availability_zone: Optional[pulumi.Input[str]] = None, cpu_core_count: Optional[pulumi.Input[float]] = None, cpu_threads_per_core: Optional[pulumi.Input[float]] = None, credit_specification: Optional[pulumi.Input[pulumi.InputType['InstanceCreditSpecificationArgs']]] = None, disable_api_termination: Optional[pulumi.Input[bool]] = None, ebs_block_devices: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['InstanceEbsBlockDeviceArgs']]]]] = None, ebs_optimized: Optional[pulumi.Input[bool]] = None, ephemeral_block_devices: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['InstanceEphemeralBlockDeviceArgs']]]]] = None, get_password_data: Optional[pulumi.Input[bool]] = None, hibernation: Optional[pulumi.Input[bool]] = None, host_id: Optional[pulumi.Input[str]] = None, iam_instance_profile: Optional[pulumi.Input[str]] = None, instance_initiated_shutdown_behavior: Optional[pulumi.Input[str]] = None, instance_state: Optional[pulumi.Input[str]] = None, instance_type: Optional[pulumi.Input[str]] = None, ipv6_address_count: Optional[pulumi.Input[float]] = None, ipv6_addresses: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, key_name: Optional[pulumi.Input[str]] = None, metadata_options: Optional[pulumi.Input[pulumi.InputType['InstanceMetadataOptionsArgs']]] = None, monitoring: Optional[pulumi.Input[bool]] = None, network_interfaces: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['InstanceNetworkInterfaceArgs']]]]] = None, outpost_arn: Optional[pulumi.Input[str]] = None, password_data: Optional[pulumi.Input[str]] = None, placement_group: Optional[pulumi.Input[str]] = None, primary_network_interface_id: Optional[pulumi.Input[str]] = None, private_dns: Optional[pulumi.Input[str]] = None, private_ip: Optional[pulumi.Input[str]] = None, public_dns: Optional[pulumi.Input[str]] = None, public_ip: Optional[pulumi.Input[str]] = None, root_block_device: Optional[pulumi.Input[pulumi.InputType['InstanceRootBlockDeviceArgs']]] = None, security_groups: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, source_dest_check: Optional[pulumi.Input[bool]] = None, subnet_id: Optional[pulumi.Input[str]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, tenancy: Optional[pulumi.Input[str]] = None, user_data: Optional[pulumi.Input[str]] = None, user_data_base64: Optional[pulumi.Input[str]] = None, volume_tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, vpc_security_group_ids: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None) -> 'Instance':
        """
