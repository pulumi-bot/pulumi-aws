...
def get_subnet(availability_zone: Optional[str] = None,
    ...
    return AwaitableGetSubnetResult(
        ...
        assign_ipv6_address_on_creation=_utilities.get_dict_value(__ret__, 'assignIpv6AddressOnCreation'),
        ...
        default_for_az=_utilities.get_dict_value(__ret__, 'defaultForAz'),
        filters=_utilities.get_dict_value(__ret__, 'filters'),
        id=_utilities.get_dict_value(__ret__, 'id'),
        ipv6_cidr_block=_utilities.get_dict_value(__ret__, 'ipv6CidrBlock'),
        ipv6_cidr_block_association_id=_utilities.get_dict_value(__ret__, 'ipv6CidrBlockAssociationId'),
        map_public_ip_on_launch=_utilities.get_dict_value(__ret__, 'mapPublicIpOnLaunch'),
