...
def get_local_gateway_route_tables_apply(filters: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['GetLocalGatewayRouteTablesFilterArgs']]]]] = None,
