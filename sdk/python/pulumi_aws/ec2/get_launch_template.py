...
def get_launch_template(filters=None, name=None, tags=None, opts=None):
    ...
    default = aws.ec2.get_launch_template(aws.ec2.GetLaunchTemplateArgsArgs(
    ...
    test = aws.ec2.get_launch_template(aws.ec2.GetLaunchTemplateArgsArgs(
        filters=[aws.ec2.GetLaunchTemplateFilterArgs(
