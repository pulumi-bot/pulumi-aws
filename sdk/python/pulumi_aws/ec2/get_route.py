...
def get_route(destination_cidr_block: Optional[str] = None,
    ...
    return AwaitableGetRouteResult(
        destination_cidr_block=_utilities.get_dict_value(__ret__, 'destinationCidrBlock'),
        destination_ipv6_cidr_block=_utilities.get_dict_value(__ret__, 'destinationIpv6CidrBlock'),
        egress_only_gateway_id=_utilities.get_dict_value(__ret__, 'egressOnlyGatewayId'),
        gateway_id=_utilities.get_dict_value(__ret__, 'gatewayId'),
        id=_utilities.get_dict_value(__ret__, 'id'),
        instance_id=_utilities.get_dict_value(__ret__, 'instanceId'),
        nat_gateway_id=_utilities.get_dict_value(__ret__, 'natGatewayId'),
        ...
        transit_gateway_id=_utilities.get_dict_value(__ret__, 'transitGatewayId'),
        vpc_peering_connection_id=_utilities.get_dict_value(__ret__, 'vpcPeeringConnectionId'))
