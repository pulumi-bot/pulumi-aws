...
@pulumi.output_type
class _GetLocalGatewayVirtualInterfaceResult(dict):
...
def get_local_gateway_virtual_interface(filters: Optional[List[pulumi.InputType['GetLocalGatewayVirtualInterfaceFilterArgs']]] = None,
    ...
    return AwaitableGetLocalGatewayVirtualInterfaceResult(
        ...
        local_address=_utilities.get_dict_value(__ret__, 'localAddress'),
        local_bgp_asn=_utilities.get_dict_value(__ret__, 'localBgpAsn'),
        local_gateway_id=_utilities.get_dict_value(__ret__, 'localGatewayId'),
        local_gateway_virtual_interface_ids=_utilities.get_dict_value(__ret__, 'localGatewayVirtualInterfaceIds'),
        peer_address=_utilities.get_dict_value(__ret__, 'peerAddress'),
        peer_bgp_asn=_utilities.get_dict_value(__ret__, 'peerBgpAsn'),
        tags=_utilities.get_dict_value(__ret__, 'tags'),
        vlan=_utilities.get_dict_value(__ret__, 'vlan'))
