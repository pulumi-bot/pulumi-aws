...
def get_local_gateway_virtual_interface(filters=None, id=None, tags=None, opts=None):
    ...
    example = [aws.ec2.get_local_gateway_virtual_interface(aws.ec2.GetLocalGatewayVirtualInterfaceArgsArgs(
        id=__value,
    )) for __key, __value in data["aws_ec2_local_gateway_virtual_interface_group"]["example"]["local_gateway_virtual_interface_ids"]]
    ```
