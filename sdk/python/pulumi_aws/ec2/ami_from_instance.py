...
class AmiFromInstance(pulumi.CustomResource):
    ...
    """
    ebs_block_devices: pulumi.Output[List['outputs.AmiFromInstanceEbsBlockDevice']] = pulumi.output_property("ebsBlockDevices")
    """
    ...
    """
    ephemeral_block_devices: pulumi.Output[List['outputs.AmiFromInstanceEphemeralBlockDevice']] = pulumi.output_property("ephemeralBlockDevices")
    """
    ...
    snapshot_without_reboot: pulumi.Output[Optional[bool]] = pulumi.output_property("snapshotWithoutReboot")
    """
    ...
    """
    source_instance_id: pulumi.Output[str] = pulumi.output_property("sourceInstanceId")
    """
