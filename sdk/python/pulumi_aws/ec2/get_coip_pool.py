...
def get_coip_pool(filters: Optional[List[pulumi.InputType['GetCoipPoolFilterArgs']]] = None,
    ...
    return AwaitableGetCoipPoolResult(
        ...
        local_gateway_route_table_id=_utilities.get_dict_value(__ret__, 'localGatewayRouteTableId'),
        pool_cidrs=_utilities.get_dict_value(__ret__, 'poolCidrs'),
        pool_id=_utilities.get_dict_value(__ret__, 'poolId'),
