...
@pulumi.output_type
class _GetVpcDhcpOptionsResult(dict):
...
def get_vpc_dhcp_options(dhcp_options_id: Optional[str] = None,
    ...
    return AwaitableGetVpcDhcpOptionsResult(
        ...
        domain_name_servers=_utilities.get_dict_value(__ret__, 'domainNameServers'),
        filters=_utilities.get_dict_value(__ret__, 'filters'),
        id=_utilities.get_dict_value(__ret__, 'id'),
        netbios_name_servers=_utilities.get_dict_value(__ret__, 'netbiosNameServers'),
        netbios_node_type=_utilities.get_dict_value(__ret__, 'netbiosNodeType'),
        ntp_servers=_utilities.get_dict_value(__ret__, 'ntpServers'),
