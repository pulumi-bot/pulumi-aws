...
class DefaultRouteTableArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['DefaultRouteTableRouteArgs']]] routes: Configuration block of routes. Detailed below.
...
class DefaultRouteTable(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[DefaultRouteTableArgs] = None,
