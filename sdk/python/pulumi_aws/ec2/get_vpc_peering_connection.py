...
@pulumi.output_type
class _GetVpcPeeringConnectionResult(dict):
...
def get_vpc_peering_connection(cidr_block: Optional[str] = None,
    ...
    return AwaitableGetVpcPeeringConnectionResult(
        accepter=_utilities.get_dict_value(__ret__, 'accepter'),
        ...
        peer_cidr_block=_utilities.get_dict_value(__ret__, 'peerCidrBlock'),
        peer_owner_id=_utilities.get_dict_value(__ret__, 'peerOwnerId'),
        peer_region=_utilities.get_dict_value(__ret__, 'peerRegion'),
        peer_vpc_id=_utilities.get_dict_value(__ret__, 'peerVpcId'),
        region=_utilities.get_dict_value(__ret__, 'region'),
        requester=_utilities.get_dict_value(__ret__, 'requester'),
