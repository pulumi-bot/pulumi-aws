...
class TrafficMirrorTarget(pulumi.CustomResource):
    ...
    """
    network_interface_id: pulumi.Output[Optional[str]] = pulumi.output_property("networkInterfaceId")
    """
    The network interface ID that is associated with the target.
    """
    network_load_balancer_arn: pulumi.Output[Optional[str]] = pulumi.output_property("networkLoadBalancerArn")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, description: Optional[pulumi.Input[str]] = None, network_interface_id: Optional[pulumi.Input[str]] = None, network_load_balancer_arn: Optional[pulumi.Input[str]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, arn: Optional[pulumi.Input[str]] = None, description: Optional[pulumi.Input[str]] = None, network_interface_id: Optional[pulumi.Input[str]] = None, network_load_balancer_arn: Optional[pulumi.Input[str]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None) -> 'TrafficMirrorTarget':
        """
