...
@pulumi.output_type
class _GetInstanceTypeOfferingResult(dict):
...
def get_instance_type_offering(filters: Optional[List[pulumi.InputType['GetInstanceTypeOfferingFilterArgs']]] = None,
    ...
    return AwaitableGetInstanceTypeOfferingResult(
        ...
        location_type=_utilities.get_dict_value(__ret__, 'locationType'),
        preferred_instance_types=_utilities.get_dict_value(__ret__, 'preferredInstanceTypes'))
