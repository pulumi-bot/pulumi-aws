...
@pulumi.output_type
class _GetVpcEndpointResult(dict):
...
def get_vpc_endpoint(filters: Optional[List[pulumi.InputType['GetVpcEndpointFilterArgs']]] = None,
    ...
    return AwaitableGetVpcEndpointResult(
        ...
        dns_entries=_utilities.get_dict_value(__ret__, 'dnsEntries'),
        filters=_utilities.get_dict_value(__ret__, 'filters'),
        id=_utilities.get_dict_value(__ret__, 'id'),
        network_interface_ids=_utilities.get_dict_value(__ret__, 'networkInterfaceIds'),
        owner_id=_utilities.get_dict_value(__ret__, 'ownerId'),
        policy=_utilities.get_dict_value(__ret__, 'policy'),
        prefix_list_id=_utilities.get_dict_value(__ret__, 'prefixListId'),
        private_dns_enabled=_utilities.get_dict_value(__ret__, 'privateDnsEnabled'),
        requester_managed=_utilities.get_dict_value(__ret__, 'requesterManaged'),
        route_table_ids=_utilities.get_dict_value(__ret__, 'routeTableIds'),
        ...
        vpc_endpoint_type=_utilities.get_dict_value(__ret__, 'vpcEndpointType'),
