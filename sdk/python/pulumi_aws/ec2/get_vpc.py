...
def get_vpc(cidr_block: Optional[str] = None,
    ...
    return AwaitableGetVpcResult(
        ...
        cidr_block=_utilities.get_dict_value(__ret__, 'cidrBlock'),
        cidr_block_associations=_utilities.get_dict_value(__ret__, 'cidrBlockAssociations'),
        default=_utilities.get_dict_value(__ret__, 'default'),
        dhcp_options_id=_utilities.get_dict_value(__ret__, 'dhcpOptionsId'),
        enable_dns_hostnames=_utilities.get_dict_value(__ret__, 'enableDnsHostnames'),
        enable_dns_support=_utilities.get_dict_value(__ret__, 'enableDnsSupport'),
        filters=_utilities.get_dict_value(__ret__, 'filters'),
        id=_utilities.get_dict_value(__ret__, 'id'),
        instance_tenancy=_utilities.get_dict_value(__ret__, 'instanceTenancy'),
        ipv6_association_id=_utilities.get_dict_value(__ret__, 'ipv6AssociationId'),
        ipv6_cidr_block=_utilities.get_dict_value(__ret__, 'ipv6CidrBlock'),
        main_route_table_id=_utilities.get_dict_value(__ret__, 'mainRouteTableId'),
