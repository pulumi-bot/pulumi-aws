...
@pulumi.output_type
class _GetInstancesResult(dict):
...
def get_instances(filters: Optional[List[pulumi.InputType['GetInstancesFilterArgs']]] = None,
    ...
    return AwaitableGetInstancesResult(
        ...
        instance_state_names=_utilities.get_dict_value(__ret__, 'instanceStateNames'),
        instance_tags=_utilities.get_dict_value(__ret__, 'instanceTags'),
        private_ips=_utilities.get_dict_value(__ret__, 'privateIps'),
        public_ips=_utilities.get_dict_value(__ret__, 'publicIps'))
