...
def get_stream(name: Optional[str] = None,
    ...
    return AwaitableGetStreamResult(
        ...
        closed_shards=_utilities.get_dict_value(__ret__, 'closedShards'),
        creation_timestamp=_utilities.get_dict_value(__ret__, 'creationTimestamp'),
        id=_utilities.get_dict_value(__ret__, 'id'),
        name=_utilities.get_dict_value(__ret__, 'name'),
        open_shards=_utilities.get_dict_value(__ret__, 'openShards'),
        retention_period=_utilities.get_dict_value(__ret__, 'retentionPeriod'),
        shard_level_metrics=_utilities.get_dict_value(__ret__, 'shardLevelMetrics'),
