...
class ApiKey(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, description=None, enabled=None, name=None, tags=None, value=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
