...
def get_resource(path: Optional[str] = None,
    ...
    return AwaitableGetResourceResult(
        ...
        parent_id=_utilities.get_dict_value(__ret__, 'parentId'),
        path=_utilities.get_dict_value(__ret__, 'path'),
        path_part=_utilities.get_dict_value(__ret__, 'pathPart'),
        rest_api_id=_utilities.get_dict_value(__ret__, 'restApiId'))
