...
class Response(pulumi.CustomResource):
    ...
    """
    response_type: pulumi.Output[str] = pulumi.output_property("responseType")
    """
    ...
    """
    status_code: pulumi.Output[Optional[str]] = pulumi.output_property("statusCode")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, response_parameters=None, response_templates=None, response_type=None, rest_api_id=None, status_code=None, __props__=None, __name__=None, __opts__=None) -> None:
        ...
        :param pulumi.Input[Dict[str, pulumi.Input[str]]] response_parameters: A map specifying the parameters (paths, query strings and headers) of the Gateway Response.
        :param pulumi.Input[Dict[str, pulumi.Input[str]]] response_templates: A map specifying the templates used to transform the response body.
