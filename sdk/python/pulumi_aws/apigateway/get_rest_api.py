...
def get_rest_api(name: Optional[str] = None,
    ...
    return AwaitableGetRestApiResult(
        api_key_source=_utilities.get_dict_value(__ret__, 'apiKeySource'),
        arn=_utilities.get_dict_value(__ret__, 'arn'),
        binary_media_types=_utilities.get_dict_value(__ret__, 'binaryMediaTypes'),
        description=_utilities.get_dict_value(__ret__, 'description'),
        endpoint_configurations=_utilities.get_dict_value(__ret__, 'endpointConfigurations'),
        execution_arn=_utilities.get_dict_value(__ret__, 'executionArn'),
        id=_utilities.get_dict_value(__ret__, 'id'),
        minimum_compression_size=_utilities.get_dict_value(__ret__, 'minimumCompressionSize'),
        name=_utilities.get_dict_value(__ret__, 'name'),
        policy=_utilities.get_dict_value(__ret__, 'policy'),
        root_resource_id=_utilities.get_dict_value(__ret__, 'rootResourceId'),
