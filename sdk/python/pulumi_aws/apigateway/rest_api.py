...
class RestApi(pulumi.CustomResource):
    ...
    """
    binary_media_types: pulumi.Output[Optional[List[str]]] = pulumi.output_property("binaryMediaTypes")
    """
    The list of binary media types supported by the RestApi. By default, the RestApi supports only UTF-8-encoded text payloads.
    """
    body: pulumi.Output[Optional[str]] = pulumi.output_property("body")
    """
    ...
    """
    endpoint_configuration: pulumi.Output['outputs.RestApiEndpointConfiguration'] = pulumi.output_property("endpointConfiguration")
    """
    ...
    """
    minimum_compression_size: pulumi.Output[Optional[float]] = pulumi.output_property("minimumCompressionSize")
    """
    ...
    """
    root_resource_id: pulumi.Output[str] = pulumi.output_property("rootResourceId")
    """
