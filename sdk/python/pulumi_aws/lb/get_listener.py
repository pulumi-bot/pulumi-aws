...
def get_listener(arn=None, load_balancer_arn=None, port=None, opts=None):
    ...
    listener = aws.lb.get_listener(aws.lb.GetListenerArgsArgs(
        arn=listener_arn,
    ))
    selected = aws.lb.get_load_balancer(aws.lb.GetLoadBalancerArgsArgs(
        name="default-public",
    ))
    selected443 = aws.lb.get_listener(aws.lb.GetListenerArgsArgs(
        load_balancer_arn=selected.arn,
        port=443,
    ))
    ```
