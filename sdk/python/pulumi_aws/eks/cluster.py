...
class Cluster(pulumi.CustomResource):
    ...
    """
    certificate_authority: pulumi.Output['outputs.ClusterCertificateAuthority'] = pulumi.output_property("certificateAuthority")
    """
    Nested attribute containing `certificate-authority-data` for your cluster.
    """
    created_at: pulumi.Output[str] = pulumi.output_property("createdAt")
    enabled_cluster_log_types: pulumi.Output[Optional[List[str]]] = pulumi.output_property("enabledClusterLogTypes")
    """
    A list of the desired control plane logging to enable. For more information, see [Amazon EKS Control Plane Logging](https://docs.aws.amazon.com/eks/latest/userguide/control-plane-logs.html)
    """
    encryption_config: pulumi.Output[Optional['outputs.ClusterEncryptionConfig']] = pulumi.output_property("encryptionConfig")
    """
    ...
    """
    identities: pulumi.Output[List['outputs.ClusterIdentity']] = pulumi.output_property("identities")
    """
    ...
    """
    vpc_config: pulumi.Output['outputs.ClusterVpcConfig'] = pulumi.output_property("vpcConfig")
    """
    Nested argument for the VPC associated with your cluster. Amazon EKS VPC resources have specific requirements to work properly with Kubernetes. For more information, see [Cluster VPC Considerations](https://docs.aws.amazon.com/eks/latest/userguide/network_reqs.html) and [Cluster Security Group Considerations](https://docs.aws.amazon.com/eks/latest/userguide/sec-group-reqs.html) in the Amazon EKS User Guide. Configuration detailed below.
    """
    # pylint: disable=no-self-argument
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, enabled_cluster_log_types: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, encryption_config: Optional[pulumi.Input[pulumi.InputType['ClusterEncryptionConfigArgs']]] = None, name: Optional[pulumi.Input[str]] = None, role_arn: Optional[pulumi.Input[str]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, version: Optional[pulumi.Input[str]] = None, vpc_config: Optional[pulumi.Input[pulumi.InputType['ClusterVpcConfigArgs']]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, arn: Optional[pulumi.Input[str]] = None, certificate_authority: Optional[pulumi.Input[pulumi.InputType['ClusterCertificateAuthorityArgs']]] = None, created_at: Optional[pulumi.Input[str]] = None, enabled_cluster_log_types: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, encryption_config: Optional[pulumi.Input[pulumi.InputType['ClusterEncryptionConfigArgs']]] = None, endpoint: Optional[pulumi.Input[str]] = None, identities: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['ClusterIdentityArgs']]]]] = None, name: Optional[pulumi.Input[str]] = None, platform_version: Optional[pulumi.Input[str]] = None, role_arn: Optional[pulumi.Input[str]] = None, status: Optional[pulumi.Input[str]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, version: Optional[pulumi.Input[str]] = None, vpc_config: Optional[pulumi.Input[pulumi.InputType['ClusterVpcConfigArgs']]] = None) -> 'Cluster':
        """
