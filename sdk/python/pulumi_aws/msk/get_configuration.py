...
def get_configuration(name: Optional[str] = None,
    ...
    return AwaitableGetConfigurationResult(
        ...
        kafka_versions=_utilities.get_dict_value(__ret__, 'kafkaVersions'),
        latest_revision=_utilities.get_dict_value(__ret__, 'latestRevision'),
        name=_utilities.get_dict_value(__ret__, 'name'),
        server_properties=_utilities.get_dict_value(__ret__, 'serverProperties'))
