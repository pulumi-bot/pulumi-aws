...
def get_cluster(cluster_name: Optional[str] = None,
    ...
    return AwaitableGetClusterResult(
        ...
        bootstrap_brokers=_utilities.get_dict_value(__ret__, 'bootstrapBrokers'),
        bootstrap_brokers_tls=_utilities.get_dict_value(__ret__, 'bootstrapBrokersTls'),
        cluster_name=_utilities.get_dict_value(__ret__, 'clusterName'),
        id=_utilities.get_dict_value(__ret__, 'id'),
        kafka_version=_utilities.get_dict_value(__ret__, 'kafkaVersion'),
        number_of_broker_nodes=_utilities.get_dict_value(__ret__, 'numberOfBrokerNodes'),
        tags=_utilities.get_dict_value(__ret__, 'tags'),
        zookeeper_connect_string=_utilities.get_dict_value(__ret__, 'zookeeperConnectString'))
