...
def get_ami(executable_users: Optional[List[str]] = None,
    ...
    return AwaitableGetAmiResult(
        architecture=_utilities.get_dict_value(__ret__, 'architecture'),
        arn=_utilities.get_dict_value(__ret__, 'arn'),
        block_device_mappings=_utilities.get_dict_value(__ret__, 'blockDeviceMappings'),
        creation_date=_utilities.get_dict_value(__ret__, 'creationDate'),
        description=_utilities.get_dict_value(__ret__, 'description'),
        executable_users=_utilities.get_dict_value(__ret__, 'executableUsers'),
        filters=_utilities.get_dict_value(__ret__, 'filters'),
        hypervisor=_utilities.get_dict_value(__ret__, 'hypervisor'),
        id=_utilities.get_dict_value(__ret__, 'id'),
        image_id=_utilities.get_dict_value(__ret__, 'imageId'),
        image_location=_utilities.get_dict_value(__ret__, 'imageLocation'),
        image_owner_alias=_utilities.get_dict_value(__ret__, 'imageOwnerAlias'),
        image_type=_utilities.get_dict_value(__ret__, 'imageType'),
        ...
        owner_id=_utilities.get_dict_value(__ret__, 'ownerId'),
        owners=_utilities.get_dict_value(__ret__, 'owners'),
        platform=_utilities.get_dict_value(__ret__, 'platform'),
        product_codes=_utilities.get_dict_value(__ret__, 'productCodes'),
        public=_utilities.get_dict_value(__ret__, 'public'),
        ramdisk_id=_utilities.get_dict_value(__ret__, 'ramdiskId'),
        root_device_name=_utilities.get_dict_value(__ret__, 'rootDeviceName'),
        root_device_type=_utilities.get_dict_value(__ret__, 'rootDeviceType'),
        root_snapshot_id=_utilities.get_dict_value(__ret__, 'rootSnapshotId'),
        sriov_net_support=_utilities.get_dict_value(__ret__, 'sriovNetSupport'),
        state=_utilities.get_dict_value(__ret__, 'state'),
        state_reason=_utilities.get_dict_value(__ret__, 'stateReason'),
        tags=_utilities.get_dict_value(__ret__, 'tags'),
        virtualization_type=_utilities.get_dict_value(__ret__, 'virtualizationType'))
