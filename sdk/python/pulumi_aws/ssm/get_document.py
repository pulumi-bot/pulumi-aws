...
def get_document(document_format: Optional[str] = None,
    ...
    return AwaitableGetDocumentResult(
        ...
        document_format=_utilities.get_dict_value(__ret__, 'documentFormat'),
        document_type=_utilities.get_dict_value(__ret__, 'documentType'),
        document_version=_utilities.get_dict_value(__ret__, 'documentVersion'),
