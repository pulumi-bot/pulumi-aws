...
@pulumi.output_type
class _GetPatchBaselineResult(dict):
...
def get_patch_baseline(default_baseline: Optional[bool] = None,
    ...
    return AwaitableGetPatchBaselineResult(
        default_baseline=_utilities.get_dict_value(__ret__, 'defaultBaseline'),
        ...
        operating_system=_utilities.get_dict_value(__ret__, 'operatingSystem'),
