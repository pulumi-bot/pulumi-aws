...
class Service(pulumi.CustomResource):
    ...
    A complex type that contains information about the resource record sets that you want Amazon Route 53 to create when you register an instance.
      ...
      * `dns_records` (`list`) - An array that contains one DnsRecord object for each resource record set.
      ...
      * `routing_policy` (`str`) - The routing policy that you want to apply to all records that Route 53 creates when you register an instance and specify the service. Valid Values: MULTIVALUE, WEIGHTED
    """
    ...
    def __init__(__self__, resource_name, opts=None, description=None, dns_config=None, health_check_config=None, health_check_custom_config=None, name=None, namespace_id=None, __props__=None, __name__=None, __opts__=None):
        ...
        The **dns_config** object supports the following:
          ...
          * `dns_records` (`pulumi.Input[list]`) - An array that contains one DnsRecord object for each resource record set.
          ...
          * `routing_policy` (`pulumi.Input[str]`) - The routing policy that you want to apply to all records that Route 53 creates when you register an instance and specify the service. Valid Values: MULTIVALUE, WEIGHTED
