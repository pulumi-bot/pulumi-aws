...
def get_load_balancer(name: Optional[str] = None,
    ...
    return AwaitableGetLoadBalancerResult(
        ...
        connection_draining=_utilities.get_dict_value(__ret__, 'connectionDraining'),
        connection_draining_timeout=_utilities.get_dict_value(__ret__, 'connectionDrainingTimeout'),
        cross_zone_load_balancing=_utilities.get_dict_value(__ret__, 'crossZoneLoadBalancing'),
        ...
        listeners=_utilities.get_dict_value(__ret__, 'listeners'),
        name=_utilities.get_dict_value(__ret__, 'name'),
        security_groups=_utilities.get_dict_value(__ret__, 'securityGroups'),
        source_security_group=_utilities.get_dict_value(__ret__, 'sourceSecurityGroup'),
        source_security_group_id=_utilities.get_dict_value(__ret__, 'sourceSecurityGroupId'),
