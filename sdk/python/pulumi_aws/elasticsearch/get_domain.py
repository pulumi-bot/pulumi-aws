...
def get_domain(domain_name: Optional[str] = None,
    ...
    return AwaitableGetDomainResult(
        ...
        advanced_options=_utilities.get_dict_value(__ret__, 'advancedOptions'),
        advanced_security_options=_utilities.get_dict_value(__ret__, 'advancedSecurityOptions'),
        arn=_utilities.get_dict_value(__ret__, 'arn'),
        cluster_configs=_utilities.get_dict_value(__ret__, 'clusterConfigs'),
        cognito_options=_utilities.get_dict_value(__ret__, 'cognitoOptions'),
        created=_utilities.get_dict_value(__ret__, 'created'),
        deleted=_utilities.get_dict_value(__ret__, 'deleted'),
        domain_id=_utilities.get_dict_value(__ret__, 'domainId'),
        domain_name=_utilities.get_dict_value(__ret__, 'domainName'),
        ebs_options=_utilities.get_dict_value(__ret__, 'ebsOptions'),
        elasticsearch_version=_utilities.get_dict_value(__ret__, 'elasticsearchVersion'),
        encryption_at_rests=_utilities.get_dict_value(__ret__, 'encryptionAtRests'),
        endpoint=_utilities.get_dict_value(__ret__, 'endpoint'),
        id=_utilities.get_dict_value(__ret__, 'id'),
        kibana_endpoint=_utilities.get_dict_value(__ret__, 'kibanaEndpoint'),
        log_publishing_options=_utilities.get_dict_value(__ret__, 'logPublishingOptions'),
        node_to_node_encryptions=_utilities.get_dict_value(__ret__, 'nodeToNodeEncryptions'),
        processing=_utilities.get_dict_value(__ret__, 'processing'),
        snapshot_options=_utilities.get_dict_value(__ret__, 'snapshotOptions'),
        tags=_utilities.get_dict_value(__ret__, 'tags'),
        vpc_options=_utilities.get_dict_value(__ret__, 'vpcOptions'))
