...
class Authorizer(pulumi.CustomResource):
    ...
    The API identifier.
    """
    authorizer_credentials_arn: pulumi.Output[Optional[str]] = pulumi.output_property("authorizerCredentialsArn")
    """
    The required credentials as an IAM role for API Gateway to invoke the authorizer.
    Supported only for `REQUEST` authorizers.
    """
    authorizer_type: pulumi.Output[str] = pulumi.output_property("authorizerType")
    """
    ...
    Supported only for `REQUEST` authorizers.
    """
    identity_sources: pulumi.Output[List[str]] = pulumi.output_property("identitySources")
    """
    The identity sources for which authorization is requested.
    For `REQUEST` authorizers the value is a list of one or more mapping expressions of the specified request parameters.
    For `JWT` authorizers the single entry specifies where to extract the JSON Web Token (JWT) from inbound requests.
    """
    jwt_configuration: pulumi.Output[Optional['outputs.AuthorizerJwtConfiguration']] = pulumi.output_property("jwtConfiguration")
    """
