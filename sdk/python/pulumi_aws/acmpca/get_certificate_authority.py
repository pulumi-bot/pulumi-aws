...
@pulumi.output_type
class _GetCertificateAuthorityResult(dict):
...
def get_certificate_authority(arn: Optional[str] = None,
    ...
    return AwaitableGetCertificateAuthorityResult(
        ...
        certificate_chain=_utilities.get_dict_value(__ret__, 'certificateChain'),
        certificate_signing_request=_utilities.get_dict_value(__ret__, 'certificateSigningRequest'),
        id=_utilities.get_dict_value(__ret__, 'id'),
        not_after=_utilities.get_dict_value(__ret__, 'notAfter'),
        not_before=_utilities.get_dict_value(__ret__, 'notBefore'),
        revocation_configurations=_utilities.get_dict_value(__ret__, 'revocationConfigurations'),
        serial=_utilities.get_dict_value(__ret__, 'serial'),
