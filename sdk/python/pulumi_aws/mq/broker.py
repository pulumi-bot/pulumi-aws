...
class BrokerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['BrokerUserArgs']]] users: The list of all ActiveMQ usernames for the specified broker. See below.
