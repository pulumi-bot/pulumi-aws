...
def get_broker(broker_id: Optional[str] = None,
    ...
    return AwaitableGetBrokerResult(
        ...
        broker_id=_utilities.get_dict_value(__ret__, 'brokerId'),
        broker_name=_utilities.get_dict_value(__ret__, 'brokerName'),
        configuration=_utilities.get_dict_value(__ret__, 'configuration'),
        deployment_mode=_utilities.get_dict_value(__ret__, 'deploymentMode'),
        encryption_options=_utilities.get_dict_value(__ret__, 'encryptionOptions'),
        engine_type=_utilities.get_dict_value(__ret__, 'engineType'),
        engine_version=_utilities.get_dict_value(__ret__, 'engineVersion'),
        host_instance_type=_utilities.get_dict_value(__ret__, 'hostInstanceType'),
        id=_utilities.get_dict_value(__ret__, 'id'),
        instances=_utilities.get_dict_value(__ret__, 'instances'),
        logs=_utilities.get_dict_value(__ret__, 'logs'),
        maintenance_window_start_time=_utilities.get_dict_value(__ret__, 'maintenanceWindowStartTime'),
        ...
        users=_utilities.get_dict_value(__ret__, 'users'))
