...
class KeyPair(pulumi.CustomResource):
    ...
    """
    encrypted_fingerprint: pulumi.Output[str] = pulumi.output_property("encryptedFingerprint")
    """
    The MD5 public key fingerprint for the encrypted
    private key
    """
    encrypted_private_key: pulumi.Output[str] = pulumi.output_property("encryptedPrivateKey")
    """
