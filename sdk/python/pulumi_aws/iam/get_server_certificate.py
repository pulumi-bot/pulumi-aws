...
@pulumi.output_type
class _GetServerCertificateResult(dict):
...
def get_server_certificate(latest: Optional[bool] = None,
    ...
    return AwaitableGetServerCertificateResult(
        ...
        certificate_body=_utilities.get_dict_value(__ret__, 'certificateBody'),
        ...
        latest=_utilities.get_dict_value(__ret__, 'latest'),
        name=_utilities.get_dict_value(__ret__, 'name'),
        name_prefix=_utilities.get_dict_value(__ret__, 'namePrefix'),
        path=_utilities.get_dict_value(__ret__, 'path'),
        path_prefix=_utilities.get_dict_value(__ret__, 'pathPrefix'),
        upload_date=_utilities.get_dict_value(__ret__, 'uploadDate'))
