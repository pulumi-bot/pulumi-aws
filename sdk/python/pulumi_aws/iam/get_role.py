...
def get_role(name: Optional[str] = None,
    ...
    return AwaitableGetRoleResult(
        ...
        assume_role_policy=_utilities.get_dict_value(__ret__, 'assumeRolePolicy'),
        create_date=_utilities.get_dict_value(__ret__, 'createDate'),
        description=_utilities.get_dict_value(__ret__, 'description'),
        id=_utilities.get_dict_value(__ret__, 'id'),
        max_session_duration=_utilities.get_dict_value(__ret__, 'maxSessionDuration'),
        name=_utilities.get_dict_value(__ret__, 'name'),
        path=_utilities.get_dict_value(__ret__, 'path'),
        permissions_boundary=_utilities.get_dict_value(__ret__, 'permissionsBoundary'),
