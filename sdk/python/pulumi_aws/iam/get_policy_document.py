...
def get_policy_document(override_json=None, policy_id=None, source_json=None, statements=None, version=None, opts=None):
    ...
    example_policy_document = aws.iam.get_policy_document(aws.iam.GetPolicyDocumentArgsArgs(
        statements=[
    ...
    event_stream_bucket_role_assume_role_policy = aws.iam.get_policy_document(aws.iam.GetPolicyDocumentArgsArgs(
    ...
    source = aws.iam.get_policy_document(aws.iam.GetPolicyDocumentArgsArgs(
        statements=[
            aws.iam.GetPolicyDocumentStatementArgs(
                actions=["ec2:*"],
                resources=["*"],
    ...
    source_json_example = aws.iam.get_policy_document(aws.iam.GetPolicyDocumentArgsArgs(
    ...
    override = aws.iam.get_policy_document(aws.iam.GetPolicyDocumentArgsArgs(
        statements=[aws.iam.GetPolicyDocumentStatementArgs(
            actions=["s3:*"],
            resources=["*"],
            sid="SidToOverwrite",
    ...
    override_json_example = aws.iam.get_policy_document(aws.iam.GetPolicyDocumentArgsArgs(
    ...
    politik = aws.iam.get_policy_document(aws.iam.GetPolicyDocumentArgsArgs(
        override_json=override.json,
        source_json=source.json,
    ))
    ```
