...
@pulumi.output_type
class _GetPolicyDocumentResult(dict):
...
def get_policy_document(override_json: Optional[str] = None,
    ...
    return AwaitableGetPolicyDocumentResult(
        ...
        json=_utilities.get_dict_value(__ret__, 'json'),
        override_json=_utilities.get_dict_value(__ret__, 'overrideJson'),
        policy_id=_utilities.get_dict_value(__ret__, 'policyId'),
        source_json=_utilities.get_dict_value(__ret__, 'sourceJson'),
        statements=_utilities.get_dict_value(__ret__, 'statements'),
