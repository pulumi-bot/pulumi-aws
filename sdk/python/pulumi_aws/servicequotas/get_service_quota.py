...
@pulumi.output_type
class _GetServiceQuotaResult(dict):
...
def get_service_quota(quota_code: Optional[str] = None,
    ...
    return AwaitableGetServiceQuotaResult(
        adjustable=_utilities.get_dict_value(__ret__, 'adjustable'),
        arn=_utilities.get_dict_value(__ret__, 'arn'),
        default_value=_utilities.get_dict_value(__ret__, 'defaultValue'),
        global_quota=_utilities.get_dict_value(__ret__, 'globalQuota'),
        id=_utilities.get_dict_value(__ret__, 'id'),
        quota_code=_utilities.get_dict_value(__ret__, 'quotaCode'),
        quota_name=_utilities.get_dict_value(__ret__, 'quotaName'),
        service_code=_utilities.get_dict_value(__ret__, 'serviceCode'),
