...
@pulumi.output_type
class _GetDistributionResult(dict):
...
def get_distribution(id: Optional[str] = None,
    ...
    return AwaitableGetDistributionResult(
        ...
        in_progress_validation_batches=_utilities.get_dict_value(__ret__, 'inProgressValidationBatches'),
        last_modified_time=_utilities.get_dict_value(__ret__, 'lastModifiedTime'),
