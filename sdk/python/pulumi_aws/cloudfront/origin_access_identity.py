...
class OriginAccessIdentity(pulumi.CustomResource):
    ...
    """
    cloudfront_access_identity_path: pulumi.Output[str] = pulumi.output_property("cloudfrontAccessIdentityPath")
    """
    ...
    """
    iam_arn: pulumi.Output[str] = pulumi.output_property("iamArn")
    """
    A pre-generated ARN for use in S3 bucket policies (see below).
    Example: `arn:aws:iam::cloudfront:user/CloudFront Origin Access Identity
    E2QWRUHAPOMQZL`.
    """
    s3_canonical_user_id: pulumi.Output[str] = pulumi.output_property("s3CanonicalUserId")
    """
