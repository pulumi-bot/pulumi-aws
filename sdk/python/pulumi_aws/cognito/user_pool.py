...
class UserPoolArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['UserPoolAccountRecoverySettingArgs'] account_recovery_setting: The account_recovery_setting configuration.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['UserPoolSchemaArgs']]] schemas: A container with the schema attributes of a user pool. Schema attributes from the [standard attribute set](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pool-settings-attributes.html#cognito-user-pools-standard-attributes) only need to be specified if they are different from the default configuration. Maximum of 50 attributes.
