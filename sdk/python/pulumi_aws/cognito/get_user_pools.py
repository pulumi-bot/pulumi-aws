...
def get_user_pools(name=None, opts=None):
    ...
    selected_rest_api = aws.apigateway.get_rest_api(aws.apigateway.GetRestApiArgsArgs(
        name=var["api_gateway_name"],
    ))
    selected_user_pools = aws.cognito.get_user_pools(aws.cognito.GetUserPoolsArgsArgs(
