...
class Permission(pulumi.CustomResource):
    ...
    """
    event_source_token: pulumi.Output[Optional[str]] = pulumi.output_property("eventSourceToken")
    """
    The Event Source Token to validate.  Used with [Alexa Skills](https://developer.amazon.com/docs/custom-skills/host-a-custom-skill-as-an-aws-lambda-function.html#use-aws-cli).
    """
    function: pulumi.Output[str] = pulumi.output_property("function")
    """
    ...
    """
    qualifier: pulumi.Output[Optional[str]] = pulumi.output_property("qualifier")
    """
    Query parameter to specify function version or alias name.
    The permission will then apply to the specific qualified ARN.
    e.g. `arn:aws:lambda:aws-region:acct-id:function:function-name:2`
    """
    source_account: pulumi.Output[Optional[str]] = pulumi.output_property("sourceAccount")
    """
    This parameter is used for S3 and SES. The AWS account ID (without a hyphen) of the source owner.
    """
    source_arn: pulumi.Output[Optional[str]] = pulumi.output_property("sourceArn")
    """
    ...
    """
    statement_id: pulumi.Output[str] = pulumi.output_property("statementId")
    """
    A unique statement identifier. By default generated by this provider.
    """
    statement_id_prefix: pulumi.Output[Optional[str]] = pulumi.output_property("statementIdPrefix")
    """
