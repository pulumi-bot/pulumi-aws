...
@pulumi.output_type
class _GetLayerVersionResult(dict):
...
def get_layer_version(compatible_runtime: Optional[str] = None,
    ...
    return AwaitableGetLayerVersionResult(
        ...
        compatible_runtime=_utilities.get_dict_value(__ret__, 'compatibleRuntime'),
        compatible_runtimes=_utilities.get_dict_value(__ret__, 'compatibleRuntimes'),
        created_date=_utilities.get_dict_value(__ret__, 'createdDate'),
        description=_utilities.get_dict_value(__ret__, 'description'),
        id=_utilities.get_dict_value(__ret__, 'id'),
        layer_arn=_utilities.get_dict_value(__ret__, 'layerArn'),
        layer_name=_utilities.get_dict_value(__ret__, 'layerName'),
        license_info=_utilities.get_dict_value(__ret__, 'licenseInfo'),
