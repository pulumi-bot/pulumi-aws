...
@pulumi.output_type
class _GetRepositoryResult(dict):
...
def get_repository(name: Optional[str] = None,
    ...
    return AwaitableGetRepositoryResult(
        ...
        encryption_configurations=_utilities.get_dict_value(__ret__, 'encryptionConfigurations'),
        id=_utilities.get_dict_value(__ret__, 'id'),
        image_scanning_configurations=_utilities.get_dict_value(__ret__, 'imageScanningConfigurations'),
        image_tag_mutability=_utilities.get_dict_value(__ret__, 'imageTagMutability'),
