...
def get_image(image_digest: Optional[str] = None,
    ...
    return AwaitableGetImageResult(
        ...
        image_pushed_at=_utilities.get_dict_value(__ret__, 'imagePushedAt'),
        image_size_in_bytes=_utilities.get_dict_value(__ret__, 'imageSizeInBytes'),
        image_tag=_utilities.get_dict_value(__ret__, 'imageTag'),
        image_tags=_utilities.get_dict_value(__ret__, 'imageTags'),
        registry_id=_utilities.get_dict_value(__ret__, 'registryId'),
        repository_name=_utilities.get_dict_value(__ret__, 'repositoryName'))
