...
@pulumi.output_type
class _GetAuthorizationTokenResult(dict):
...
def get_authorization_token(registry_id: Optional[str] = None,
    ...
    return AwaitableGetAuthorizationTokenResult(
        authorization_token=_utilities.get_dict_value(__ret__, 'authorizationToken'),
        expires_at=_utilities.get_dict_value(__ret__, 'expiresAt'),
        id=_utilities.get_dict_value(__ret__, 'id'),
        password=_utilities.get_dict_value(__ret__, 'password'),
        proxy_endpoint=_utilities.get_dict_value(__ret__, 'proxyEndpoint'),
        registry_id=_utilities.get_dict_value(__ret__, 'registryId'),
        user_name=_utilities.get_dict_value(__ret__, 'userName'))
