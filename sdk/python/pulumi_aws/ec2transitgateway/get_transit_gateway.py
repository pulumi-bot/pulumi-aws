...
def get_transit_gateway(filters=None, id=None, tags=None, opts=None):
    ...
    example = aws.ec2transitgateway.get_transit_gateway(aws.ec2transitgateway.GetTransitGatewayArgsArgs(
        filters=[aws.ec2transitgateway.GetTransitGatewayFilterArgs(
