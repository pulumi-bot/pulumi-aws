...
@pulumi.output_type
class _GetTransitGatewayResult(dict):
...
def get_transit_gateway(filters: Optional[List[pulumi.InputType['GetTransitGatewayFilterArgs']]] = None,
    ...
    return AwaitableGetTransitGatewayResult(
        amazon_side_asn=_utilities.get_dict_value(__ret__, 'amazonSideAsn'),
        arn=_utilities.get_dict_value(__ret__, 'arn'),
        association_default_route_table_id=_utilities.get_dict_value(__ret__, 'associationDefaultRouteTableId'),
        auto_accept_shared_attachments=_utilities.get_dict_value(__ret__, 'autoAcceptSharedAttachments'),
        default_route_table_association=_utilities.get_dict_value(__ret__, 'defaultRouteTableAssociation'),
        default_route_table_propagation=_utilities.get_dict_value(__ret__, 'defaultRouteTablePropagation'),
        description=_utilities.get_dict_value(__ret__, 'description'),
        dns_support=_utilities.get_dict_value(__ret__, 'dnsSupport'),
        filters=_utilities.get_dict_value(__ret__, 'filters'),
        id=_utilities.get_dict_value(__ret__, 'id'),
        owner_id=_utilities.get_dict_value(__ret__, 'ownerId'),
        propagation_default_route_table_id=_utilities.get_dict_value(__ret__, 'propagationDefaultRouteTableId'),
        tags=_utilities.get_dict_value(__ret__, 'tags'),
        vpn_ecmp_support=_utilities.get_dict_value(__ret__, 'vpnEcmpSupport'))
