...
@pulumi.output_type
class _GetRouteTableResult(dict):
...
def get_route_table(filters: Optional[List[pulumi.InputType['GetRouteTableFilterArgs']]] = None,
    ...
    return AwaitableGetRouteTableResult(
        default_association_route_table=_utilities.get_dict_value(__ret__, 'defaultAssociationRouteTable'),
        default_propagation_route_table=_utilities.get_dict_value(__ret__, 'defaultPropagationRouteTable'),
