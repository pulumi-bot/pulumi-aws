...
def get_vpn_attachment(filters=None, tags=None, transit_gateway_id=None, vpn_connection_id=None, opts=None):
    ...
    example = aws.ec2transitgateway.get_vpn_attachment(aws.ec2transitgateway.GetVpnAttachmentArgsArgs(
    ...
    test = aws.ec2transitgateway.get_vpn_attachment(aws.ec2transitgateway.GetVpnAttachmentArgsArgs(
        filters=[aws.ec2transitgateway.GetVpnAttachmentFilterArgs(
            name="resource-id",
