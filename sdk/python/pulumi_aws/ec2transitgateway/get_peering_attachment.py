...
def get_peering_attachment(filters=None, id=None, tags=None, opts=None):
    ...
    example = aws.ec2transitgateway.get_peering_attachment(aws.ec2transitgateway.GetPeeringAttachmentArgsArgs(
        filters=[aws.ec2transitgateway.GetPeeringAttachmentFilterArgs(
    ...
    attachment = aws.ec2transitgateway.get_peering_attachment(aws.ec2transitgateway.GetPeeringAttachmentArgsArgs(
