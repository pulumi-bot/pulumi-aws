...
@pulumi.output_type
class _GetPeeringAttachmentResult(dict):
...
def get_peering_attachment(filters: Optional[List[pulumi.InputType['GetPeeringAttachmentFilterArgs']]] = None,
    ...
    return AwaitableGetPeeringAttachmentResult(
        ...
        peer_account_id=_utilities.get_dict_value(__ret__, 'peerAccountId'),
        peer_region=_utilities.get_dict_value(__ret__, 'peerRegion'),
        peer_transit_gateway_id=_utilities.get_dict_value(__ret__, 'peerTransitGatewayId'),
