...
class ClusterParameterGroup(pulumi.CustomResource):
    ...
    A list of documentDB parameters to apply.
      ...
      * `name` (`str`) - The name of the documentDB cluster parameter group. If omitted, this provider will assign a random, unique name.
    ...
    def __init__(__self__, resource_name, opts=None, description=None, family=None, name=None, name_prefix=None, parameters=None, tags=None, __props__=None, __name__=None, __opts__=None):
        ...
        :param pulumi.Input[str] name: The name of the documentDB cluster parameter group. If omitted, this provider will assign a random, unique name.
        ...
        The **parameters** object supports the following:
          ...
          * `name` (`pulumi.Input[str]`) - The name of the documentDB cluster parameter group. If omitted, this provider will assign a random, unique name.
