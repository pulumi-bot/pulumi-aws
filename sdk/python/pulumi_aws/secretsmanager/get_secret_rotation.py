...
@pulumi.output_type
class _GetSecretRotationResult(dict):
...
def get_secret_rotation(secret_id: Optional[str] = None,
    ...
    return AwaitableGetSecretRotationResult(
        ...
        rotation_enabled=_utilities.get_dict_value(__ret__, 'rotationEnabled'),
        rotation_lambda_arn=_utilities.get_dict_value(__ret__, 'rotationLambdaArn'),
        rotation_rules=_utilities.get_dict_value(__ret__, 'rotationRules'),
