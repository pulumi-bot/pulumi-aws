...
def get_secret_version(secret_id: Optional[str] = None,
    ...
    return AwaitableGetSecretVersionResult(
        ...
        secret_binary=_utilities.get_dict_value(__ret__, 'secretBinary'),
        secret_id=_utilities.get_dict_value(__ret__, 'secretId'),
        secret_string=_utilities.get_dict_value(__ret__, 'secretString'),
        version_id=_utilities.get_dict_value(__ret__, 'versionId'),
        version_stage=_utilities.get_dict_value(__ret__, 'versionStage'),
        version_stages=_utilities.get_dict_value(__ret__, 'versionStages'))
