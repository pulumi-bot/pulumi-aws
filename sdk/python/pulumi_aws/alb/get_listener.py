...
def get_listener(arn: Optional[str] = None,
    ...
    return AwaitableGetListenerResult(
        ...
        certificate_arn=_utilities.get_dict_value(__ret__, 'certificateArn'),
        default_actions=_utilities.get_dict_value(__ret__, 'defaultActions'),
        id=_utilities.get_dict_value(__ret__, 'id'),
        load_balancer_arn=_utilities.get_dict_value(__ret__, 'loadBalancerArn'),
        port=_utilities.get_dict_value(__ret__, 'port'),
        protocol=_utilities.get_dict_value(__ret__, 'protocol'),
        ssl_policy=_utilities.get_dict_value(__ret__, 'sslPolicy'))
