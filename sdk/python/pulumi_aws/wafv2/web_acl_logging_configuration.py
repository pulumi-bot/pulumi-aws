...
class WebAclLoggingConfiguration(pulumi.CustomResource):
    log_destination_configs: pulumi.Output[List[str]] = pulumi.property("logDestinationConfigs")
    """
    ...
    redacted_fields: pulumi.Output[Optional[List['outputs.WebAclLoggingConfigurationRedactedField']]] = pulumi.property("redactedFields")
    """
