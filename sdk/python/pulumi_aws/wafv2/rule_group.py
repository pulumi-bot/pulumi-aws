...
class RuleGroup(pulumi.CustomResource):
    ...
    rules: pulumi.Output[Optional[List['outputs.RuleGroupRule']]] = pulumi.property("rules")
    """
    ...
    visibility_config: pulumi.Output['outputs.RuleGroupVisibilityConfig'] = pulumi.property("visibilityConfig")
    """
