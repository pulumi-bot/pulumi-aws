...
def get_organization(                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetOrganizationResult:
    ...
    return AwaitableGetOrganizationResult(
        accounts=_utilities.get_dict_value(__ret__, 'accounts'),
        arn=_utilities.get_dict_value(__ret__, 'arn'),
        aws_service_access_principals=_utilities.get_dict_value(__ret__, 'awsServiceAccessPrincipals'),
        enabled_policy_types=_utilities.get_dict_value(__ret__, 'enabledPolicyTypes'),
        feature_set=_utilities.get_dict_value(__ret__, 'featureSet'),
        id=_utilities.get_dict_value(__ret__, 'id'),
        master_account_arn=_utilities.get_dict_value(__ret__, 'masterAccountArn'),
        master_account_email=_utilities.get_dict_value(__ret__, 'masterAccountEmail'),
        master_account_id=_utilities.get_dict_value(__ret__, 'masterAccountId'),
        non_master_accounts=_utilities.get_dict_value(__ret__, 'nonMasterAccounts'),
        roots=_utilities.get_dict_value(__ret__, 'roots'))
