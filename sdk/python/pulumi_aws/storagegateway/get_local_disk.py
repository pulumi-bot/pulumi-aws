...
@pulumi.output_type
class _GetLocalDiskResult(dict):
...
def get_local_disk(disk_node: Optional[str] = None,
    ...
    return AwaitableGetLocalDiskResult(
        disk_id=_utilities.get_dict_value(__ret__, 'diskId'),
        disk_node=_utilities.get_dict_value(__ret__, 'diskNode'),
        disk_path=_utilities.get_dict_value(__ret__, 'diskPath'),
        gateway_arn=_utilities.get_dict_value(__ret__, 'gatewayArn'),
