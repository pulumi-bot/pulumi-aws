...
class WindowsFileSystem(pulumi.CustomResource):
    ...
    deployment_type: pulumi.Output[Optional[str]] = pulumi.property("deploymentType")
    """
    ...
    preferred_file_server_ip: pulumi.Output[str] = pulumi.property("preferredFileServerIp")
    """
    The IP address of the primary, or preferred, file server.
    """

    preferred_subnet_id: pulumi.Output[str] = pulumi.property("preferredSubnetId")
    """
    Specifies the subnet in which you want the preferred file server to be located. Required for when deployment type is `MULTI_AZ_1`.
    """

    remote_administration_endpoint: pulumi.Output[str] = pulumi.property("remoteAdministrationEndpoint")
    """
