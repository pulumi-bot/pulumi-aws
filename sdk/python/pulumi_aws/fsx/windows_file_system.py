...
class WindowsFileSystem(pulumi.CustomResource):
    ...
    """
    automatic_backup_retention_days: pulumi.Output[Optional[float]] = pulumi.output_property("automaticBackupRetentionDays")
    """
    The number of days to retain automatic backups. Minimum of `0` and maximum of `35`. Defaults to `7`. Set to `0` to disable.
    """
    copy_tags_to_backups: pulumi.Output[Optional[bool]] = pulumi.output_property("copyTagsToBackups")
    """
    A boolean flag indicating whether tags on the file system should be copied to backups. Defaults to `false`.
    """
    daily_automatic_backup_start_time: pulumi.Output[str] = pulumi.output_property("dailyAutomaticBackupStartTime")
    """
    ...
    """
    security_group_ids: pulumi.Output[Optional[List[str]]] = pulumi.output_property("securityGroupIds")
    """
    A list of IDs for the security groups that apply to the specified network interfaces created for file system access. These security groups will apply to all network interfaces.
    """
    self_managed_active_directory: pulumi.Output[Optional['outputs.WindowsFileSystemSelfManagedActiveDirectory']] = pulumi.output_property("selfManagedActiveDirectory")
    """
    ...
    """
    skip_final_backup: pulumi.Output[Optional[bool]] = pulumi.output_property("skipFinalBackup")
    """
    When enabled, will skip the default final backup taken when the file system is deleted. This configuration must be applied separately before attempting to delete the resource to have the desired behavior. Defaults to `false`.
    """
    storage_capacity: pulumi.Output[float] = pulumi.output_property("storageCapacity")
    """
    Storage capacity (GiB) of the file system. Minimum of 32 and maximum of 65536.
    """
    subnet_ids: pulumi.Output[str] = pulumi.output_property("subnetIds")
    """
    ...
    """
    throughput_capacity: pulumi.Output[float] = pulumi.output_property("throughputCapacity")
    """
    ...
    """
    weekly_maintenance_start_time: pulumi.Output[str] = pulumi.output_property("weeklyMaintenanceStartTime")
    """
