...
class LustreFileSystem(pulumi.CustomResource):
    ...
    """
    export_path: pulumi.Output[str] = pulumi.output_property("exportPath")
    """
    ...
    """
    import_path: pulumi.Output[Optional[str]] = pulumi.output_property("importPath")
    """
    ...
    """
    imported_file_chunk_size: pulumi.Output[float] = pulumi.output_property("importedFileChunkSize")
    """
