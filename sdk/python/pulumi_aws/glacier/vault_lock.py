...
class VaultLock(pulumi.CustomResource):
    ...
    """
    ignore_deletion_error: pulumi.Output[Optional[bool]] = pulumi.output_property("ignoreDeletionError")
    """
    ...
    """
    vault_name: pulumi.Output[str] = pulumi.output_property("vaultName")
    """
