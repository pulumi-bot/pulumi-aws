...
class _ExportableConfig(types.ModuleType):
    ...
    @property
    def allowed_account_ids(self) -> Optional[Sequence[str]]:
        return __config__.get('allowedAccountIds')

    @property
    def assume_role(self) -> Optional[pulumi.InputType['outputs.AssumeRole']]:
        return __config__.get('assumeRole')

    @property
    def default_tags(self) -> Optional[pulumi.InputType['outputs.DefaultTags']]:
        """
    ...
    @property
    def endpoints(self) -> Optional[Sequence[pulumi.InputType['outputs.Endpoints']]]:
        return __config__.get('endpoints')

    @property
    def forbidden_account_ids(self) -> Optional[Sequence[str]]:
        return __config__.get('forbiddenAccountIds')

    @property
    def ignore_tags(self) -> Optional[pulumi.InputType['outputs.IgnoreTags']]:
        """
