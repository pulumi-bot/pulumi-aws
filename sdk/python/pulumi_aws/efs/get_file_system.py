...
@pulumi.output_type
class _GetFileSystemResult(dict):
...
def get_file_system(creation_token: Optional[str] = None,
    ...
    return AwaitableGetFileSystemResult(
        ...
        creation_token=_utilities.get_dict_value(__ret__, 'creationToken'),
        ...
        lifecycle_policy=_utilities.get_dict_value(__ret__, 'lifecyclePolicy'),
        performance_mode=_utilities.get_dict_value(__ret__, 'performanceMode'),
        provisioned_throughput_in_mibps=_utilities.get_dict_value(__ret__, 'provisionedThroughputInMibps'),
        size_in_bytes=_utilities.get_dict_value(__ret__, 'sizeInBytes'),
        tags=_utilities.get_dict_value(__ret__, 'tags'),
        throughput_mode=_utilities.get_dict_value(__ret__, 'throughputMode'))
