...
class AccessPointPosixUserArgs:
    def __init__(__self__, *,
                 ...
                 secondary_gids: Optional[pulumi.Input[List[pulumi.Input[int]]]] = None):
        """
        ...
        :param pulumi.Input[List[pulumi.Input[int]]] secondary_gids: Secondary POSIX group IDs used for all file system operations using this access point.
        """
    ...
    def secondary_gids(self) -> Optional[pulumi.Input[List[pulumi.Input[int]]]]:
        """
    ...
    def secondary_gids(self, value: Optional[pulumi.Input[List[pulumi.Input[int]]]]):
