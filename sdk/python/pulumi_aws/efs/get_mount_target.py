...
@pulumi.output_type
class _GetMountTargetResult(dict):
...
def get_mount_target(mount_target_id: Optional[str] = None,
    ...
    return AwaitableGetMountTargetResult(
        availability_zone_id=_utilities.get_dict_value(__ret__, 'availabilityZoneId'),
        availability_zone_name=_utilities.get_dict_value(__ret__, 'availabilityZoneName'),
        dns_name=_utilities.get_dict_value(__ret__, 'dnsName'),
        file_system_arn=_utilities.get_dict_value(__ret__, 'fileSystemArn'),
        file_system_id=_utilities.get_dict_value(__ret__, 'fileSystemId'),
        id=_utilities.get_dict_value(__ret__, 'id'),
        ip_address=_utilities.get_dict_value(__ret__, 'ipAddress'),
        mount_target_dns_name=_utilities.get_dict_value(__ret__, 'mountTargetDnsName'),
        mount_target_id=_utilities.get_dict_value(__ret__, 'mountTargetId'),
