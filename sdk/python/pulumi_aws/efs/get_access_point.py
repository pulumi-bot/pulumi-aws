...
@pulumi.output_type
class _GetAccessPointResult(dict):
...
def get_access_point(access_point_id: Optional[str] = None,
    ...
    return AwaitableGetAccessPointResult(
        access_point_id=_utilities.get_dict_value(__ret__, 'accessPointId'),
        ...
        posix_users=_utilities.get_dict_value(__ret__, 'posixUsers'),
        root_directories=_utilities.get_dict_value(__ret__, 'rootDirectories'),
