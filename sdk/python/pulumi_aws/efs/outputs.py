...
class AccessPointPosixUser(dict):
    def __init__(__self__, *,
                 gid: int,
                 uid: int,
                 secondary_gids: Optional[List[int]] = None):
        """
        ...
        :param List[int] secondary_gids: Secondary POSIX group IDs used for all file system operations using this access point.
        """
    ...
    def secondary_gids(self) -> Optional[List[int]]:
        """
...
class GetAccessPointPosixUserResult(dict):
    def __init__(__self__, *,
                 gid: int,
                 secondary_gids: List[int],
                 uid: int):
        """
        :param int gid: Group ID
        :param List[int] secondary_gids: Secondary group IDs
    ...
    @property
    @pulumi.getter(name="secondaryGids")
    def secondary_gids(self) -> List[int]:
        """
        Secondary group IDs
        """
        return pulumi.get(self, "secondary_gids")
