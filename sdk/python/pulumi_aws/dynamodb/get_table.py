...
def get_table(name: Optional[str] = None,
    ...
    return AwaitableGetTableResult(
        ...
        attributes=_utilities.get_dict_value(__ret__, 'attributes'),
        billing_mode=_utilities.get_dict_value(__ret__, 'billingMode'),
        global_secondary_indexes=_utilities.get_dict_value(__ret__, 'globalSecondaryIndexes'),
        hash_key=_utilities.get_dict_value(__ret__, 'hashKey'),
        id=_utilities.get_dict_value(__ret__, 'id'),
        local_secondary_indexes=_utilities.get_dict_value(__ret__, 'localSecondaryIndexes'),
        name=_utilities.get_dict_value(__ret__, 'name'),
        point_in_time_recovery=_utilities.get_dict_value(__ret__, 'pointInTimeRecovery'),
        range_key=_utilities.get_dict_value(__ret__, 'rangeKey'),
        read_capacity=_utilities.get_dict_value(__ret__, 'readCapacity'),
        replicas=_utilities.get_dict_value(__ret__, 'replicas'),
        server_side_encryption=_utilities.get_dict_value(__ret__, 'serverSideEncryption'),
        stream_arn=_utilities.get_dict_value(__ret__, 'streamArn'),
        stream_enabled=_utilities.get_dict_value(__ret__, 'streamEnabled'),
        stream_label=_utilities.get_dict_value(__ret__, 'streamLabel'),
        stream_view_type=_utilities.get_dict_value(__ret__, 'streamViewType'),
        tags=_utilities.get_dict_value(__ret__, 'tags'),
        ttl=_utilities.get_dict_value(__ret__, 'ttl'),
        write_capacity=_utilities.get_dict_value(__ret__, 'writeCapacity'))
