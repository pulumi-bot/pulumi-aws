...
class LogResourcePolicy(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, policy_document=None, policy_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        elasticsearch_log_publishing_policy_policy_document = aws.iam.get_policy_document(aws.iam.GetPolicyDocumentArgsArgs(
        ...
        route53_query_logging_policy_policy_document = aws.iam.get_policy_document(aws.iam.GetPolicyDocumentArgsArgs(
            statements=[aws.iam.GetPolicyDocumentStatementArgs(
                actions=[
                    "logs:CreateLogStream",
                    "logs:PutLogEvents",
