...
@pulumi.output_type
class _GetReportDefinitionResult(dict):
...
def get_report_definition(report_name: Optional[str] = None,
    ...
    return AwaitableGetReportDefinitionResult(
        additional_artifacts=_utilities.get_dict_value(__ret__, 'additionalArtifacts'),
        additional_schema_elements=_utilities.get_dict_value(__ret__, 'additionalSchemaElements'),
        compression=_utilities.get_dict_value(__ret__, 'compression'),
        format=_utilities.get_dict_value(__ret__, 'format'),
        id=_utilities.get_dict_value(__ret__, 'id'),
        report_name=_utilities.get_dict_value(__ret__, 'reportName'),
        s3_bucket=_utilities.get_dict_value(__ret__, 's3Bucket'),
        s3_prefix=_utilities.get_dict_value(__ret__, 's3Prefix'),
        s3_region=_utilities.get_dict_value(__ret__, 's3Region'),
        time_unit=_utilities.get_dict_value(__ret__, 'timeUnit'))
