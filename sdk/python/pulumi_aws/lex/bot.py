...
class Bot(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[int] idle_session_ttl_in_seconds: The maximum time in seconds that Amazon Lex retains the data gathered in a conversation. Default is `300`.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['BotIntentArgs']]]] intents: A set of Intent objects. Each intent represents a command that a user can express. Attributes are documented under intent.
        ...
        :param pulumi.Input[str] name: The name of the bot that you want to create, case sensitive.
