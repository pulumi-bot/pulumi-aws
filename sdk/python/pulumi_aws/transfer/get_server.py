...
def get_server(server_id: Optional[str] = None,
    ...
    return AwaitableGetServerResult(
        ...
        identity_provider_type=_utilities.get_dict_value(__ret__, 'identityProviderType'),
        invocation_role=_utilities.get_dict_value(__ret__, 'invocationRole'),
        logging_role=_utilities.get_dict_value(__ret__, 'loggingRole'),
        server_id=_utilities.get_dict_value(__ret__, 'serverId'),
