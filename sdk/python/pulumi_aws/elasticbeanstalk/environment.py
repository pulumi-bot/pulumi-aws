...
class Environment(pulumi.CustomResource):
    ...
    autoscaling_groups: pulumi.Output[List[str]] = pulumi.output_property("autoscalingGroups")
    """
    ...
    """
    cname_prefix: pulumi.Output[str] = pulumi.output_property("cnamePrefix")
    """
    ...
    """
    endpoint_url: pulumi.Output[str] = pulumi.output_property("endpointUrl")
    """
    ...
    """
    launch_configurations: pulumi.Output[List[str]] = pulumi.output_property("launchConfigurations")
    """
    ...
    """
    platform_arn: pulumi.Output[str] = pulumi.output_property("platformArn")
    """
    The [ARN](https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html) of the Elastic Beanstalk [Platform](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-beanstalk-environment.html#cfn-beanstalk-environment-platformarn)
    to use in deployment
    """
    poll_interval: pulumi.Output[Optional[str]] = pulumi.output_property("pollInterval")
    """
    ...
    """
    queues: pulumi.Output[List[str]] = pulumi.output_property("queues")
    """
    SQS queues in use by this Environment.
    """
    settings: pulumi.Output[Optional[List['outputs.EnvironmentSetting']]] = pulumi.output_property("settings")
    """
    Option settings to configure the new Environment. These
    override specific values that are set as defaults. The format is detailed
    below in Option Settings
    """
    solution_stack_name: pulumi.Output[str] = pulumi.output_property("solutionStackName")
    """
    ...
    """
    template_name: pulumi.Output[Optional[str]] = pulumi.output_property("templateName")
    """
    ...
    """
    triggers: pulumi.Output[List[str]] = pulumi.output_property("triggers")
    """
    ...
    to use in deployment.
    """
    wait_for_ready_timeout: pulumi.Output[Optional[str]] = pulumi.output_property("waitForReadyTimeout")
    """
    The maximum
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, application: Optional[pulumi.Input[str]] = None, cname_prefix: Optional[pulumi.Input[str]] = None, description: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, platform_arn: Optional[pulumi.Input[str]] = None, poll_interval: Optional[pulumi.Input[str]] = None, settings: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['EnvironmentSettingArgs']]]]] = None, solution_stack_name: Optional[pulumi.Input[str]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, template_name: Optional[pulumi.Input[str]] = None, tier: Optional[pulumi.Input[str]] = None, version: Optional[pulumi.Input[str]] = None, wait_for_ready_timeout: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        ...
        * `resource` - (Optional) resource name for [scheduled action](https://docs.aws.amazon.com/elasticbeanstalk/latest/dg/command-options-general.html#command-options-general-autoscalingscheduledaction)
        ...
        :param pulumi.Input[str] solution_stack_name: A solution stack to base your environment
               off of. Example stacks can be found in the [Amazon API documentation](https://docs.aws.amazon.com/elasticbeanstalk/latest/dg/concepts.platforms.html)
        :param pulumi.Input[Dict[str, pulumi.Input[str]]] tags: A set of tags to apply to the Environment.
