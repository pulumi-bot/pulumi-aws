...
class ClusterSnapshot(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, db_cluster_identifier=None, db_cluster_snapshot_identifier=None, tags=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
