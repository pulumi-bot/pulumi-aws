...
def get_instance(db_instance_identifier: Optional[str] = None,
    ...
    return AwaitableGetInstanceResult(
        ...
        auto_minor_version_upgrade=_utilities.get_dict_value(__ret__, 'autoMinorVersionUpgrade'),
        availability_zone=_utilities.get_dict_value(__ret__, 'availabilityZone'),
        backup_retention_period=_utilities.get_dict_value(__ret__, 'backupRetentionPeriod'),
        ca_cert_identifier=_utilities.get_dict_value(__ret__, 'caCertIdentifier'),
        db_cluster_identifier=_utilities.get_dict_value(__ret__, 'dbClusterIdentifier'),
        db_instance_arn=_utilities.get_dict_value(__ret__, 'dbInstanceArn'),
        db_instance_class=_utilities.get_dict_value(__ret__, 'dbInstanceClass'),
        db_instance_identifier=_utilities.get_dict_value(__ret__, 'dbInstanceIdentifier'),
        db_instance_port=_utilities.get_dict_value(__ret__, 'dbInstancePort'),
        db_name=_utilities.get_dict_value(__ret__, 'dbName'),
        db_parameter_groups=_utilities.get_dict_value(__ret__, 'dbParameterGroups'),
        db_security_groups=_utilities.get_dict_value(__ret__, 'dbSecurityGroups'),
        db_subnet_group=_utilities.get_dict_value(__ret__, 'dbSubnetGroup'),
        enabled_cloudwatch_logs_exports=_utilities.get_dict_value(__ret__, 'enabledCloudwatchLogsExports'),
        ...
        hosted_zone_id=_utilities.get_dict_value(__ret__, 'hostedZoneId'),
        ...
        master_username=_utilities.get_dict_value(__ret__, 'masterUsername'),
        monitoring_interval=_utilities.get_dict_value(__ret__, 'monitoringInterval'),
        monitoring_role_arn=_utilities.get_dict_value(__ret__, 'monitoringRoleArn'),
        multi_az=_utilities.get_dict_value(__ret__, 'multiAz'),
        option_group_memberships=_utilities.get_dict_value(__ret__, 'optionGroupMemberships'),
        port=_utilities.get_dict_value(__ret__, 'port'),
        preferred_backup_window=_utilities.get_dict_value(__ret__, 'preferredBackupWindow'),
        preferred_maintenance_window=_utilities.get_dict_value(__ret__, 'preferredMaintenanceWindow'),
        publicly_accessible=_utilities.get_dict_value(__ret__, 'publiclyAccessible'),
        replicate_source_db=_utilities.get_dict_value(__ret__, 'replicateSourceDb'),
        ...
        timezone=_utilities.get_dict_value(__ret__, 'timezone'),
        vpc_security_groups=_utilities.get_dict_value(__ret__, 'vpcSecurityGroups'))
