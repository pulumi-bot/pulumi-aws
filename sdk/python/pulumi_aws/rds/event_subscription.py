...
class _EventSubscriptionState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] arn: The Amazon Resource Name of the RDS event notification subscription
        :param pulumi.Input[str] customer_aws_id: The AWS customer account associated with the RDS event notification subscription
        :param pulumi.Input[bool] enabled: A boolean flag to enable/disable the subscription. Defaults to true.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] event_categories: A list of event categories for a SourceType that you want to subscribe to. See http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_Events.html or run `aws rds describe-event-categories`.
        :param pulumi.Input[str] name: The name of the DB event subscription. By default generated by this provider.
        :param pulumi.Input[str] name_prefix: The name of the DB event subscription. Conflicts with `name`.
    ...
    @property
    @pulumi.getter(name="snsTopic")
    def sns_topic(self) -> Optional[pulumi.Input[str]]:
        """
        The SNS topic to send events to.
        """
        return pulumi.get(self, "sns_topic")
    ...
    @sns_topic.setter
    def sns_topic(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "sns_topic", value)
...
class EventSubscription(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["sns_topic"] = sns_topic
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["tags"] = tags
        __props__.__dict__["tags_all"] = tags_all
        return EventSubscription(resource_name_, opts=opts, __props__=__props__)
