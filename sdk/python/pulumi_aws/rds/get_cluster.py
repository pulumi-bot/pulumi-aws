...
def get_cluster(cluster_identifier: Optional[str] = None,
    ...
    return AwaitableGetClusterResult(
        ...
        backtrack_window=_utilities.get_dict_value(__ret__, 'backtrackWindow'),
        backup_retention_period=_utilities.get_dict_value(__ret__, 'backupRetentionPeriod'),
        cluster_identifier=_utilities.get_dict_value(__ret__, 'clusterIdentifier'),
        cluster_members=_utilities.get_dict_value(__ret__, 'clusterMembers'),
        cluster_resource_id=_utilities.get_dict_value(__ret__, 'clusterResourceId'),
        database_name=_utilities.get_dict_value(__ret__, 'databaseName'),
        db_cluster_parameter_group_name=_utilities.get_dict_value(__ret__, 'dbClusterParameterGroupName'),
        db_subnet_group_name=_utilities.get_dict_value(__ret__, 'dbSubnetGroupName'),
        ...
        final_snapshot_identifier=_utilities.get_dict_value(__ret__, 'finalSnapshotIdentifier'),
        hosted_zone_id=_utilities.get_dict_value(__ret__, 'hostedZoneId'),
        iam_database_authentication_enabled=_utilities.get_dict_value(__ret__, 'iamDatabaseAuthenticationEnabled'),
        iam_roles=_utilities.get_dict_value(__ret__, 'iamRoles'),
        ...
        reader_endpoint=_utilities.get_dict_value(__ret__, 'readerEndpoint'),
        replication_source_identifier=_utilities.get_dict_value(__ret__, 'replicationSourceIdentifier'),
        storage_encrypted=_utilities.get_dict_value(__ret__, 'storageEncrypted'),
        tags=_utilities.get_dict_value(__ret__, 'tags'),
        vpc_security_group_ids=_utilities.get_dict_value(__ret__, 'vpcSecurityGroupIds'))
