...
class Instance(pulumi.CustomResource):
    ...
    """
    allow_major_version_upgrade: pulumi.Output[Optional[bool]] = pulumi.output_property("allowMajorVersionUpgrade")
    """
    ...
    """
    backup_retention_period: pulumi.Output[float] = pulumi.output_property("backupRetentionPeriod")
    """
    ...
    """
    backup_window: pulumi.Output[str] = pulumi.output_property("backupWindow")
    """
    ...
    """
    character_set_name: pulumi.Output[str] = pulumi.output_property("characterSetName")
    """
    ...
    """
    delete_automated_backups: pulumi.Output[Optional[bool]] = pulumi.output_property("deleteAutomatedBackups")
    """
    ...
    """
    domain_iam_role_name: pulumi.Output[Optional[str]] = pulumi.output_property("domainIamRoleName")
    """
    ...
    """
    iops: pulumi.Output[Optional[float]] = pulumi.output_property("iops")
    """
    ...
    """
    max_allocated_storage: pulumi.Output[Optional[float]] = pulumi.output_property("maxAllocatedStorage")
    """
    When configured, the upper limit to which Amazon RDS can automatically scale the storage of the DB instance. Configuring this will automatically ignore differences to `allocated_storage`. Must be greater than or equal to `allocated_storage` or `0` to disable Storage Autoscaling.
    """
    monitoring_interval: pulumi.Output[Optional[float]] = pulumi.output_property("monitoringInterval")
    """
    ...
    """
    monitoring_role_arn: pulumi.Output[str] = pulumi.output_property("monitoringRoleArn")
    """
    ...
    """
    multi_az: pulumi.Output[bool] = pulumi.output_property("multiAz")
    """
    ...
    """
    option_group_name: pulumi.Output[str] = pulumi.output_property("optionGroupName")
    """
    ...
    """
    performance_insights_enabled: pulumi.Output[Optional[bool]] = pulumi.output_property("performanceInsightsEnabled")
    """
    Specifies whether Performance Insights are enabled. Defaults to false.
    """
    performance_insights_kms_key_id: pulumi.Output[str] = pulumi.output_property("performanceInsightsKmsKeyId")
    """
    The ARN for the KMS key to encrypt Performance Insights data. When specifying `performance_insights_kms_key_id`, `performance_insights_enabled` needs to be set to true. Once KMS key is set, it can never be changed.
    """
    performance_insights_retention_period: pulumi.Output[float] = pulumi.output_property("performanceInsightsRetentionPeriod")
    """
    ...
    """
    publicly_accessible: pulumi.Output[Optional[bool]] = pulumi.output_property("publiclyAccessible")
    """
    Bool to control if instance is publicly
    accessible. Default is `false`.
    """
    replicas: pulumi.Output[List[str]] = pulumi.output_property("replicas")
    replicate_source_db: pulumi.Output[Optional[str]] = pulumi.output_property("replicateSourceDb")
    """
    ...
    """
    s3_import: pulumi.Output[Optional['outputs.InstanceS3Import']] = pulumi.output_property("s3Import")
    """
    Restore from a Percona Xtrabackup in S3.  See [Importing Data into an Amazon RDS MySQL DB Instance](http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/MySQL.Procedural.Importing.html)
    """
    security_group_names: pulumi.Output[Optional[List[str]]] = pulumi.output_property("securityGroupNames")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, allocated_storage: Optional[pulumi.Input[float]] = None, allow_major_version_upgrade: Optional[pulumi.Input[bool]] = None, apply_immediately: Optional[pulumi.Input[bool]] = None, auto_minor_version_upgrade: Optional[pulumi.Input[bool]] = None, availability_zone: Optional[pulumi.Input[str]] = None, backup_retention_period: Optional[pulumi.Input[float]] = None, backup_window: Optional[pulumi.Input[str]] = None, ca_cert_identifier: Optional[pulumi.Input[str]] = None, character_set_name: Optional[pulumi.Input[str]] = None, copy_tags_to_snapshot: Optional[pulumi.Input[bool]] = None, db_subnet_group_name: Optional[pulumi.Input[str]] = None, delete_automated_backups: Optional[pulumi.Input[bool]] = None, deletion_protection: Optional[pulumi.Input[bool]] = None, domain: Optional[pulumi.Input[str]] = None, domain_iam_role_name: Optional[pulumi.Input[str]] = None, enabled_cloudwatch_logs_exports: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, engine: Optional[pulumi.Input[str]] = None, engine_version: Optional[pulumi.Input[str]] = None, final_snapshot_identifier: Optional[pulumi.Input[str]] = None, iam_database_authentication_enabled: Optional[pulumi.Input[bool]] = None, identifier: Optional[pulumi.Input[str]] = None, identifier_prefix: Optional[pulumi.Input[str]] = None, instance_class: Optional[pulumi.Input[str]] = None, iops: Optional[pulumi.Input[float]] = None, kms_key_id: Optional[pulumi.Input[str]] = None, license_model: Optional[pulumi.Input[str]] = None, maintenance_window: Optional[pulumi.Input[str]] = None, max_allocated_storage: Optional[pulumi.Input[float]] = None, monitoring_interval: Optional[pulumi.Input[float]] = None, monitoring_role_arn: Optional[pulumi.Input[str]] = None, multi_az: Optional[pulumi.Input[bool]] = None, name: Optional[pulumi.Input[str]] = None, option_group_name: Optional[pulumi.Input[str]] = None, parameter_group_name: Optional[pulumi.Input[str]] = None, password: Optional[pulumi.Input[str]] = None, performance_insights_enabled: Optional[pulumi.Input[bool]] = None, performance_insights_kms_key_id: Optional[pulumi.Input[str]] = None, performance_insights_retention_period: Optional[pulumi.Input[float]] = None, port: Optional[pulumi.Input[float]] = None, publicly_accessible: Optional[pulumi.Input[bool]] = None, replicate_source_db: Optional[pulumi.Input[str]] = None, s3_import: Optional[pulumi.Input[pulumi.InputType['InstanceS3ImportArgs']]] = None, security_group_names: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, skip_final_snapshot: Optional[pulumi.Input[bool]] = None, snapshot_identifier: Optional[pulumi.Input[str]] = None, storage_encrypted: Optional[pulumi.Input[bool]] = None, storage_type: Optional[pulumi.Input[str]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, timezone: Optional[pulumi.Input[str]] = None, username: Optional[pulumi.Input[str]] = None, vpc_security_group_ids: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, address: Optional[pulumi.Input[str]] = None, allocated_storage: Optional[pulumi.Input[float]] = None, allow_major_version_upgrade: Optional[pulumi.Input[bool]] = None, apply_immediately: Optional[pulumi.Input[bool]] = None, arn: Optional[pulumi.Input[str]] = None, auto_minor_version_upgrade: Optional[pulumi.Input[bool]] = None, availability_zone: Optional[pulumi.Input[str]] = None, backup_retention_period: Optional[pulumi.Input[float]] = None, backup_window: Optional[pulumi.Input[str]] = None, ca_cert_identifier: Optional[pulumi.Input[str]] = None, character_set_name: Optional[pulumi.Input[str]] = None, copy_tags_to_snapshot: Optional[pulumi.Input[bool]] = None, db_subnet_group_name: Optional[pulumi.Input[str]] = None, delete_automated_backups: Optional[pulumi.Input[bool]] = None, deletion_protection: Optional[pulumi.Input[bool]] = None, domain: Optional[pulumi.Input[str]] = None, domain_iam_role_name: Optional[pulumi.Input[str]] = None, enabled_cloudwatch_logs_exports: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, endpoint: Optional[pulumi.Input[str]] = None, engine: Optional[pulumi.Input[str]] = None, engine_version: Optional[pulumi.Input[str]] = None, final_snapshot_identifier: Optional[pulumi.Input[str]] = None, hosted_zone_id: Optional[pulumi.Input[str]] = None, iam_database_authentication_enabled: Optional[pulumi.Input[bool]] = None, identifier: Optional[pulumi.Input[str]] = None, identifier_prefix: Optional[pulumi.Input[str]] = None, instance_class: Optional[pulumi.Input[str]] = None, iops: Optional[pulumi.Input[float]] = None, kms_key_id: Optional[pulumi.Input[str]] = None, license_model: Optional[pulumi.Input[str]] = None, maintenance_window: Optional[pulumi.Input[str]] = None, max_allocated_storage: Optional[pulumi.Input[float]] = None, monitoring_interval: Optional[pulumi.Input[float]] = None, monitoring_role_arn: Optional[pulumi.Input[str]] = None, multi_az: Optional[pulumi.Input[bool]] = None, name: Optional[pulumi.Input[str]] = None, option_group_name: Optional[pulumi.Input[str]] = None, parameter_group_name: Optional[pulumi.Input[str]] = None, password: Optional[pulumi.Input[str]] = None, performance_insights_enabled: Optional[pulumi.Input[bool]] = None, performance_insights_kms_key_id: Optional[pulumi.Input[str]] = None, performance_insights_retention_period: Optional[pulumi.Input[float]] = None, port: Optional[pulumi.Input[float]] = None, publicly_accessible: Optional[pulumi.Input[bool]] = None, replicas: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, replicate_source_db: Optional[pulumi.Input[str]] = None, resource_id: Optional[pulumi.Input[str]] = None, s3_import: Optional[pulumi.Input[pulumi.InputType['InstanceS3ImportArgs']]] = None, security_group_names: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, skip_final_snapshot: Optional[pulumi.Input[bool]] = None, snapshot_identifier: Optional[pulumi.Input[str]] = None, status: Optional[pulumi.Input[str]] = None, storage_encrypted: Optional[pulumi.Input[bool]] = None, storage_type: Optional[pulumi.Input[str]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, timezone: Optional[pulumi.Input[str]] = None, username: Optional[pulumi.Input[str]] = None, vpc_security_group_ids: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None) -> 'Instance':
        """
