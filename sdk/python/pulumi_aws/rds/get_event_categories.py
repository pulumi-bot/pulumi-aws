...
@pulumi.output_type
class _GetEventCategoriesResult(dict):
...
def get_event_categories(source_type: Optional[str] = None,
    ...
    return AwaitableGetEventCategoriesResult(
        event_categories=_utilities.get_dict_value(__ret__, 'eventCategories'),
        id=_utilities.get_dict_value(__ret__, 'id'),
        source_type=_utilities.get_dict_value(__ret__, 'sourceType'))
