...
@pulumi.output_type
class _GetResolverRuleResult(dict):
...
def get_resolver_rule(domain_name: Optional[str] = None,
    ...
    return AwaitableGetResolverRuleResult(
        ...
        resolver_endpoint_id=_utilities.get_dict_value(__ret__, 'resolverEndpointId'),
        resolver_rule_id=_utilities.get_dict_value(__ret__, 'resolverRuleId'),
        rule_type=_utilities.get_dict_value(__ret__, 'ruleType'),
        share_status=_utilities.get_dict_value(__ret__, 'shareStatus'),
