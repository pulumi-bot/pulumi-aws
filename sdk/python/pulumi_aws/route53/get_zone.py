...
def get_zone(name: Optional[str] = None,
    ...
    return AwaitableGetZoneResult(
        caller_reference=_utilities.get_dict_value(__ret__, 'callerReference'),
        comment=_utilities.get_dict_value(__ret__, 'comment'),
        id=_utilities.get_dict_value(__ret__, 'id'),
        linked_service_description=_utilities.get_dict_value(__ret__, 'linkedServiceDescription'),
        linked_service_principal=_utilities.get_dict_value(__ret__, 'linkedServicePrincipal'),
        name=_utilities.get_dict_value(__ret__, 'name'),
        name_servers=_utilities.get_dict_value(__ret__, 'nameServers'),
        private_zone=_utilities.get_dict_value(__ret__, 'privateZone'),
        resource_record_set_count=_utilities.get_dict_value(__ret__, 'resourceRecordSetCount'),
