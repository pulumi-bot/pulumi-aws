...
class Record(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, aliases: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['RecordAliasArgs']]]]] = None, allow_overwrite: Optional[pulumi.Input[bool]] = None, failover_routing_policies: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['RecordFailoverRoutingPolicyArgs']]]]] = None, geolocation_routing_policies: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['RecordGeolocationRoutingPolicyArgs']]]]] = None, health_check_id: Optional[pulumi.Input[str]] = None, latency_routing_policies: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['RecordLatencyRoutingPolicyArgs']]]]] = None, multivalue_answer_routing_policy: Optional[pulumi.Input[bool]] = None, name: Optional[pulumi.Input[str]] = None, records: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, set_identifier: Optional[pulumi.Input[str]] = None, ttl: Optional[pulumi.Input[float]] = None, type: Optional[pulumi.Input[str]] = None, weighted_routing_policies: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['RecordWeightedRoutingPolicyArgs']]]]] = None, zone_id: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, aliases: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['RecordAliasArgs']]]]] = None, allow_overwrite: Optional[pulumi.Input[bool]] = None, failover_routing_policies: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['RecordFailoverRoutingPolicyArgs']]]]] = None, fqdn: Optional[pulumi.Input[str]] = None, geolocation_routing_policies: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['RecordGeolocationRoutingPolicyArgs']]]]] = None, health_check_id: Optional[pulumi.Input[str]] = None, latency_routing_policies: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['RecordLatencyRoutingPolicyArgs']]]]] = None, multivalue_answer_routing_policy: Optional[pulumi.Input[bool]] = None, name: Optional[pulumi.Input[str]] = None, records: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, set_identifier: Optional[pulumi.Input[str]] = None, ttl: Optional[pulumi.Input[float]] = None, type: Optional[pulumi.Input[str]] = None, weighted_routing_policies: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['RecordWeightedRoutingPolicyArgs']]]]] = None, zone_id: Optional[pulumi.Input[str]] = None) -> 'Record':
        """
