...
def get_snapshot(filters: Optional[List[pulumi.InputType['GetSnapshotFilterArgs']]] = None,
    ...
    return AwaitableGetSnapshotResult(
        ...
        data_encryption_key_id=_utilities.get_dict_value(__ret__, 'dataEncryptionKeyId'),
        ...
        owner_alias=_utilities.get_dict_value(__ret__, 'ownerAlias'),
        owner_id=_utilities.get_dict_value(__ret__, 'ownerId'),
        owners=_utilities.get_dict_value(__ret__, 'owners'),
        restorable_by_user_ids=_utilities.get_dict_value(__ret__, 'restorableByUserIds'),
        snapshot_id=_utilities.get_dict_value(__ret__, 'snapshotId'),
        snapshot_ids=_utilities.get_dict_value(__ret__, 'snapshotIds'),
        ...
        volume_size=_utilities.get_dict_value(__ret__, 'volumeSize'))
