...
class StackSetInstance(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, account_id=None, parameter_overrides=None, region=None, retain_stack=None, stack_set_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        a_ws_cloud_formation_stack_set_execution_role_assume_role_policy = aws.iam.get_policy_document(aws.iam.GetPolicyDocumentArgsArgs(
        ...
        a_ws_cloud_formation_stack_set_execution_role_minimum_execution_policy_policy_document = aws.iam.get_policy_document(aws.iam.GetPolicyDocumentArgsArgs(
            statements=[aws.iam.GetPolicyDocumentStatementArgs(
                actions=[
                    "cloudformation:*",
                    "s3:*",
