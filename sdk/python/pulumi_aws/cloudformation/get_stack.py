...
def get_stack(name: Optional[str] = None,
    ...
    return AwaitableGetStackResult(
        capabilities=_utilities.get_dict_value(__ret__, 'capabilities'),
        description=_utilities.get_dict_value(__ret__, 'description'),
        disable_rollback=_utilities.get_dict_value(__ret__, 'disableRollback'),
        iam_role_arn=_utilities.get_dict_value(__ret__, 'iamRoleArn'),
        id=_utilities.get_dict_value(__ret__, 'id'),
        name=_utilities.get_dict_value(__ret__, 'name'),
        notification_arns=_utilities.get_dict_value(__ret__, 'notificationArns'),
        outputs=_utilities.get_dict_value(__ret__, 'outputs'),
        parameters=_utilities.get_dict_value(__ret__, 'parameters'),
        tags=_utilities.get_dict_value(__ret__, 'tags'),
        template_body=_utilities.get_dict_value(__ret__, 'templateBody'),
        timeout_in_minutes=_utilities.get_dict_value(__ret__, 'timeoutInMinutes'))
