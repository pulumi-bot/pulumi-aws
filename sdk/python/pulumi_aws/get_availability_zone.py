...
@pulumi.output_type
class _GetAvailabilityZoneResult(dict):
...
def get_availability_zone(all_availability_zones: Optional[bool] = None,
    ...
    return AwaitableGetAvailabilityZoneResult(
        ...
        group_name=_utilities.get_dict_value(__ret__, 'groupName'),
        id=_utilities.get_dict_value(__ret__, 'id'),
        name=_utilities.get_dict_value(__ret__, 'name'),
        name_suffix=_utilities.get_dict_value(__ret__, 'nameSuffix'),
        network_border_group=_utilities.get_dict_value(__ret__, 'networkBorderGroup'),
        opt_in_status=_utilities.get_dict_value(__ret__, 'optInStatus'),
