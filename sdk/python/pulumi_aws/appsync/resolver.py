...
class Resolver(pulumi.CustomResource):
    ...
    The ARN
    """
    caching_config: pulumi.Output[Optional['outputs.ResolverCachingConfig']] = pulumi.output_property("cachingConfig")
    """
    The CachingConfig.
    """
    data_source: pulumi.Output[Optional[str]] = pulumi.output_property("dataSource")
    """
    The DataSource name.
    """
    field: pulumi.Output[str] = pulumi.output_property("field")
    """
    ...
    """
    pipeline_config: pulumi.Output[Optional['outputs.ResolverPipelineConfig']] = pulumi.output_property("pipelineConfig")
    """
    The PipelineConfig.
    """
    request_template: pulumi.Output[str] = pulumi.output_property("requestTemplate")
    """
    The request mapping template for UNIT resolver or 'before mapping template' for PIPELINE resolver.
    """
    response_template: pulumi.Output[str] = pulumi.output_property("responseTemplate")
    """
