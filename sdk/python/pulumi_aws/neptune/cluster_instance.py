...
class ClusterInstance(pulumi.CustomResource):
    ...
    """
    neptune_parameter_group_name: pulumi.Output[Optional[str]] = pulumi.output_property("neptuneParameterGroupName")
    """
