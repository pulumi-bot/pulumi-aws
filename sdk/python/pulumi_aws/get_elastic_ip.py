...
@pulumi.output_type
class _GetElasticIpResult(dict):
...
def get_elastic_ip(filters: Optional[List[pulumi.InputType['GetElasticIpFilterArgs']]] = None,
    ...
    return AwaitableGetElasticIpResult(
        association_id=_utilities.get_dict_value(__ret__, 'associationId'),
        customer_owned_ip=_utilities.get_dict_value(__ret__, 'customerOwnedIp'),
        customer_owned_ipv4_pool=_utilities.get_dict_value(__ret__, 'customerOwnedIpv4Pool'),
        ...
        network_interface_owner_id=_utilities.get_dict_value(__ret__, 'networkInterfaceOwnerId'),
        ...
        public_ipv4_pool=_utilities.get_dict_value(__ret__, 'publicIpv4Pool'),
