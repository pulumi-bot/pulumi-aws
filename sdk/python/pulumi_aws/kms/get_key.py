...
def get_key(grant_tokens: Optional[List[str]] = None,
    ...
    return AwaitableGetKeyResult(
        ...
        aws_account_id=_utilities.get_dict_value(__ret__, 'awsAccountId'),
        creation_date=_utilities.get_dict_value(__ret__, 'creationDate'),
        customer_master_key_spec=_utilities.get_dict_value(__ret__, 'customerMasterKeySpec'),
        deletion_date=_utilities.get_dict_value(__ret__, 'deletionDate'),
        description=_utilities.get_dict_value(__ret__, 'description'),
        enabled=_utilities.get_dict_value(__ret__, 'enabled'),
        expiration_model=_utilities.get_dict_value(__ret__, 'expirationModel'),
        grant_tokens=_utilities.get_dict_value(__ret__, 'grantTokens'),
        id=_utilities.get_dict_value(__ret__, 'id'),
        key_id=_utilities.get_dict_value(__ret__, 'keyId'),
        key_manager=_utilities.get_dict_value(__ret__, 'keyManager'),
        key_state=_utilities.get_dict_value(__ret__, 'keyState'),
        key_usage=_utilities.get_dict_value(__ret__, 'keyUsage'),
        origin=_utilities.get_dict_value(__ret__, 'origin'),
        valid_to=_utilities.get_dict_value(__ret__, 'validTo'))
