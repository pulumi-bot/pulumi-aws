...
class ProviderAssumeRoleArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "durationSeconds", duration_seconds)
        pulumi.set(__self__, "externalId", external_id)
        pulumi.set(__self__, "policy", policy)
        pulumi.set(__self__, "policyArns", policy_arns)
        pulumi.set(__self__, "roleArn", role_arn)
        pulumi.set(__self__, "sessionName", session_name)
        pulumi.set(__self__, "tags", tags)
        pulumi.set(__self__, "transitiveTagKeys", transitive_tag_keys)
