...
@pulumi.output_type
class _GetSelectionResult(dict):
...
def get_selection(plan_id: Optional[str] = None,
    ...
    return AwaitableGetSelectionResult(
        ...
        plan_id=_utilities.get_dict_value(__ret__, 'planId'),
        resources=_utilities.get_dict_value(__ret__, 'resources'),
        selection_id=_utilities.get_dict_value(__ret__, 'selectionId'))
