...
class ReplicationGroup(pulumi.CustomResource):
    ...
    """
    at_rest_encryption_enabled: pulumi.Output[Optional[bool]] = pulumi.output_property("atRestEncryptionEnabled")
    """
    Whether to enable encryption at rest.
    """
    auth_token: pulumi.Output[Optional[str]] = pulumi.output_property("authToken")
    """
    ...
    """
    automatic_failover_enabled: pulumi.Output[Optional[bool]] = pulumi.output_property("automaticFailoverEnabled")
    """
    ...
    """
    cluster_mode: pulumi.Output['outputs.ReplicationGroupClusterMode'] = pulumi.output_property("clusterMode")
    """
    Create a native redis cluster. `automatic_failover_enabled` must be set to true. Cluster Mode documented below. Only 1 `cluster_mode` block is allowed.
    """
    configuration_endpoint_address: pulumi.Output[str] = pulumi.output_property("configurationEndpointAddress")
    """
    ...
    """
    member_clusters: pulumi.Output[List[str]] = pulumi.output_property("memberClusters")
    """
    ...
    """
    number_cache_clusters: pulumi.Output[float] = pulumi.output_property("numberCacheClusters")
    """
    ...
    """
    primary_endpoint_address: pulumi.Output[str] = pulumi.output_property("primaryEndpointAddress")
    """
    (Redis only) The address of the endpoint for the primary node in the replication group, if the cluster mode is disabled.
    """
    replication_group_description: pulumi.Output[str] = pulumi.output_property("replicationGroupDescription")
    """
    A user-created description for the replication group.
    """
    replication_group_id: pulumi.Output[str] = pulumi.output_property("replicationGroupId")
    """
    ...
    """
    snapshot_arns: pulumi.Output[Optional[List[str]]] = pulumi.output_property("snapshotArns")
    """
    A single-element string list containing an
    Amazon Resource Name (ARN) of a Redis RDB snapshot file stored in Amazon S3.
    Example: `arn:aws:s3:::my_bucket/snapshot1.rdb`
    """
    snapshot_name: pulumi.Output[Optional[str]] = pulumi.output_property("snapshotName")
    """
    The name of a snapshot from which to restore data into the new node group. Changing the `snapshot_name` forces a new resource.
    """
    snapshot_retention_limit: pulumi.Output[Optional[float]] = pulumi.output_property("snapshotRetentionLimit")
    """
    ...
    """
    snapshot_window: pulumi.Output[str] = pulumi.output_property("snapshotWindow")
    """
    ...
    """
    transit_encryption_enabled: pulumi.Output[Optional[bool]] = pulumi.output_property("transitEncryptionEnabled")
    """
    Whether to enable encryption in transit.
    """
    # pylint: disable=no-self-argument
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, apply_immediately: Optional[pulumi.Input[bool]] = None, at_rest_encryption_enabled: Optional[pulumi.Input[bool]] = None, auth_token: Optional[pulumi.Input[str]] = None, auto_minor_version_upgrade: Optional[pulumi.Input[bool]] = None, automatic_failover_enabled: Optional[pulumi.Input[bool]] = None, availability_zones: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, cluster_mode: Optional[pulumi.Input[pulumi.InputType['ReplicationGroupClusterModeArgs']]] = None, engine: Optional[pulumi.Input[str]] = None, engine_version: Optional[pulumi.Input[str]] = None, kms_key_id: Optional[pulumi.Input[str]] = None, maintenance_window: Optional[pulumi.Input[str]] = None, node_type: Optional[pulumi.Input[str]] = None, notification_topic_arn: Optional[pulumi.Input[str]] = None, number_cache_clusters: Optional[pulumi.Input[float]] = None, parameter_group_name: Optional[pulumi.Input[str]] = None, port: Optional[pulumi.Input[float]] = None, replication_group_description: Optional[pulumi.Input[str]] = None, replication_group_id: Optional[pulumi.Input[str]] = None, security_group_ids: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, security_group_names: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, snapshot_arns: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, snapshot_name: Optional[pulumi.Input[str]] = None, snapshot_retention_limit: Optional[pulumi.Input[float]] = None, snapshot_window: Optional[pulumi.Input[str]] = None, subnet_group_name: Optional[pulumi.Input[str]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, transit_encryption_enabled: Optional[pulumi.Input[bool]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, apply_immediately: Optional[pulumi.Input[bool]] = None, at_rest_encryption_enabled: Optional[pulumi.Input[bool]] = None, auth_token: Optional[pulumi.Input[str]] = None, auto_minor_version_upgrade: Optional[pulumi.Input[bool]] = None, automatic_failover_enabled: Optional[pulumi.Input[bool]] = None, availability_zones: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, cluster_mode: Optional[pulumi.Input[pulumi.InputType['ReplicationGroupClusterModeArgs']]] = None, configuration_endpoint_address: Optional[pulumi.Input[str]] = None, engine: Optional[pulumi.Input[str]] = None, engine_version: Optional[pulumi.Input[str]] = None, kms_key_id: Optional[pulumi.Input[str]] = None, maintenance_window: Optional[pulumi.Input[str]] = None, member_clusters: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, node_type: Optional[pulumi.Input[str]] = None, notification_topic_arn: Optional[pulumi.Input[str]] = None, number_cache_clusters: Optional[pulumi.Input[float]] = None, parameter_group_name: Optional[pulumi.Input[str]] = None, port: Optional[pulumi.Input[float]] = None, primary_endpoint_address: Optional[pulumi.Input[str]] = None, replication_group_description: Optional[pulumi.Input[str]] = None, replication_group_id: Optional[pulumi.Input[str]] = None, security_group_ids: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, security_group_names: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, snapshot_arns: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, snapshot_name: Optional[pulumi.Input[str]] = None, snapshot_retention_limit: Optional[pulumi.Input[float]] = None, snapshot_window: Optional[pulumi.Input[str]] = None, subnet_group_name: Optional[pulumi.Input[str]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, transit_encryption_enabled: Optional[pulumi.Input[bool]] = None) -> 'ReplicationGroup':
        """
