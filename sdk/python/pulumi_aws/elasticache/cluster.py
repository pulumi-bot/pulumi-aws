...
class Cluster(pulumi.CustomResource):
    ...
    """
    az_mode: pulumi.Output[str] = pulumi.output_property("azMode")
    """
    Specifies whether the nodes in this Memcached node group are created in a single Availability Zone or created across multiple Availability Zones in the cluster's region. Valid values for this parameter are `single-az` or `cross-az`, default is `single-az`. If you want to choose `cross-az`, `num_cache_nodes` must be greater than `1`
    """
    cache_nodes: pulumi.Output[List['outputs.ClusterCacheNode']] = pulumi.output_property("cacheNodes")
    """
    ...
    """
    num_cache_nodes: pulumi.Output[float] = pulumi.output_property("numCacheNodes")
    """
    ...
    """
    preferred_availability_zones: pulumi.Output[Optional[List[str]]] = pulumi.output_property("preferredAvailabilityZones")
    """
