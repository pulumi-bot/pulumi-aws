...
export function getImageRecipeApply(args: GetImageRecipeApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetImageRecipeResult> {
 ...
 * A collection of arguments for invoking getImageRecipe.
 */
export interface GetImageRecipeApplyArgs {
    /**
     * Amazon Resource Name (ARN) of the image recipe.
     */
