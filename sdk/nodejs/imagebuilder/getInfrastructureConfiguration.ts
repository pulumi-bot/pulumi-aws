...
export function getInfrastructureConfigurationApply(args: GetInfrastructureConfigurationApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetInfrastructureConfigurationResult> {
 ...
 * A collection of arguments for invoking getInfrastructureConfiguration.
 */
export interface GetInfrastructureConfigurationApplyArgs {
    /**
     * Amazon Resource Name (ARN) of the infrastructure configuration.
     */
