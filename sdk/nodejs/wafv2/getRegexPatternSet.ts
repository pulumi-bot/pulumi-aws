...
export function getRegexPatternSetApply(args: GetRegexPatternSetApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetRegexPatternSetResult> {
 ...
 * A collection of arguments for invoking getRegexPatternSet.
 */
export interface GetRegexPatternSetApplyArgs {
    /**
     * The name of the WAFv2 Regex Pattern Set.
     */
