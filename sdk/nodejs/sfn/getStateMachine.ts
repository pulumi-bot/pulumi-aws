...
export function getStateMachineApply(args: GetStateMachineApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetStateMachineResult> {
 ...
 * A collection of arguments for invoking getStateMachine.
 */
export interface GetStateMachineApplyArgs {
    /**
     * The friendly name of the state machine to match.
     */
