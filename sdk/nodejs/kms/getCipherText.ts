...
export function getCipherTextApply(args: GetCipherTextApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetCipherTextResult> {
 ...
 * A collection of arguments for invoking getCipherText.
 */
export interface GetCipherTextApplyArgs {
    /**
     * An optional mapping that makes up the encryption context.
     */
