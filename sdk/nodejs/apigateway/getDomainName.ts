...
export function getDomainNameApply(args: GetDomainNameApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetDomainNameResult> {
 ...
 * A collection of arguments for invoking getDomainName.
 */
export interface GetDomainNameApplyArgs {
    /**
     * The fully-qualified domain name to look up. If no domain name is found, an error will be returned.
     */
