 ...
 * const aws_lb_target_group_front_end = new aws.elasticloadbalancingv2.TargetGroup("front_end", {});
 * const aws_lb_listener_front_end = new aws.elasticloadbalancingv2.Listener("front_end", {
 *     defaultAction: pulumi.all([aws_cognito_user_pool_domain_domain.domain, aws_cognito_user_pool_pool.arn, aws_cognito_user_pool_client_client.id, aws_lb_target_group_front_end.arn]).apply(([__arg0, __arg1, __arg2, __arg3]) => (() => {
 *         throw "tf2pulumi error: aws_lb_listener.front_end.default_action: expected at most one item in list, got 2";
 *         return [
 *             {
 *                 authenticateCognito: {
 *                     userPoolArn: __arg1,
 *                     userPoolClientId: __arg2,
 *                     userPoolDomain: __arg0,
 *                 },
