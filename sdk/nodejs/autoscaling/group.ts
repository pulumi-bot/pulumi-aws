...
export class Group extends pulumi.CustomResource {
     ...
     * * `loadBalancers` (Optional) A list of elastic load balancer names to add to the autoscaling
     * group names. Only valid for classic load balancers. For ALBs, use `targetGroupArns` instead.
     * * `vpcZoneIdentifier` (Optional) A list of subnet IDs to launch resources in.
     * * `targetGroupArns` (Optional) A list of `aws.alb.TargetGroup` ARNs, for use with Application or Network Load Balancing.
     * * `terminationPolicies` (Optional) A list of policies to decide how the instances in the auto scale group should be terminated. The allowed values are `OldestInstance`, `NewestInstance`, `OldestLaunchConfiguration`, `ClosestToNextInstanceHour`, `OldestLaunchTemplate`, `AllocationStrategy`, `Default`.
     */
     ...
     * * `placementGroup` (Optional) The name of the placement group into which you'll launch your instances, if any.
     */
     ...
     * (See also Waiting for Capacity below.)
     * * `protectFromScaleIn` (Optional) Allows setting instance protection. The
     * autoscaling group will not select instances with this setting for terminination
     * during scale in events.
     * * `serviceLinkedRoleArn` (Optional) The ARN of the service-linked role that the ASG will use to call other AWS services
     * * `maxInstanceLifetime` (Optional) The maximum amount of time, in seconds, that an instance can be in service, values must be either equal to 0 or between 604800 and 31536000 seconds.
     */
