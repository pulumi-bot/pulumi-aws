...
export function getPermissionSetApply(args: GetPermissionSetApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetPermissionSetResult> {
 ...
 * A collection of arguments for invoking getPermissionSet.
 */
export interface GetPermissionSetApplyArgs {
    /**
     * The Amazon Resource Name (ARN) of the permission set.
     */
