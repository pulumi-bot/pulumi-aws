...
export function getOutpostInstanceTypeApply(args: GetOutpostInstanceTypeApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetOutpostInstanceTypeResult> {
 ...
 * A collection of arguments for invoking getOutpostInstanceType.
 */
export interface GetOutpostInstanceTypeApplyArgs {
    /**
     * Outpost Amazon Resource Name (ARN).
     */
