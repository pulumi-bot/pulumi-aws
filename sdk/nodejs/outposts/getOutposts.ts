...
export function getOutpostsApply(args?: GetOutpostsApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetOutpostsResult> {
 ...
 * A collection of arguments for invoking getOutposts.
 */
export interface GetOutpostsApplyArgs {
    /**
     * Availability Zone name.
     */
