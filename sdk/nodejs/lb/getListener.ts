...
export function getListenerApply(args?: GetListenerApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetListenerResult> {
 ...
 * A collection of arguments for invoking getListener.
 */
export interface GetListenerApplyArgs {
    /**
     * ARN of the listener. Required if `loadBalancerArn` and `port` is not set.
     */
