...
export function getResourceShareApply(args: GetResourceShareApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetResourceShareResult> {
 ...
 * A collection of arguments for invoking getResourceShare.
 */
export interface GetResourceShareApplyArgs {
    /**
     * A filter used to scope the list e.g. by tags. See [related docs] (https://docs.aws.amazon.com/ram/latest/APIReference/API_TagFilter.html).
     */
    filters?: pulumi.Input<pulumi.Input<inputs.ram.GetResourceShareFilter>[]>;
    /**
     * The name of the tag key to filter on.
     */
