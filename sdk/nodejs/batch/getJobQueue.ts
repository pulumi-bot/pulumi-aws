...
export function getJobQueueApply(args: GetJobQueueApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetJobQueueResult> {
 ...
 * A collection of arguments for invoking getJobQueue.
 */
export interface GetJobQueueApplyArgs {
    /**
     * The name of the job queue.
     */
