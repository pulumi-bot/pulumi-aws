...
export function getSnapshotIdsApply(args?: GetSnapshotIdsApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetSnapshotIdsResult> {
 ...
 * A collection of arguments for invoking getSnapshotIds.
 */
export interface GetSnapshotIdsApplyArgs {
    /**
     * One or more name/value pairs to filter off of. There are
     * several valid keys, for a full reference, check out
     * [describe-volumes in the AWS CLI reference][1].
