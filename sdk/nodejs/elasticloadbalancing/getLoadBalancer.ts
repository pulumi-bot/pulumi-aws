...
export interface GetLoadBalancerResult {
    readonly accessLogs: outputApi.elasticloadbalancing.GetLoadBalancerAccessLogs;
    ...
    readonly healthCheck: outputApi.elasticloadbalancing.GetLoadBalancerHealthCheck;
    readonly idleTimeout: number;
    readonly instances: string[];
    readonly internal: boolean;
    readonly listeners: outputApi.elasticloadbalancing.GetLoadBalancerListener[];
    readonly name: string;
