...
export function getHostedZoneIdApply(args?: GetHostedZoneIdApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetHostedZoneIdResult> {
 ...
 * A collection of arguments for invoking getHostedZoneId.
 */
export interface GetHostedZoneIdApplyArgs {
    /**
     * Name of the region whose AWS ELB HostedZoneId is desired.
     * Defaults to the region from the AWS provider configuration.
     */
