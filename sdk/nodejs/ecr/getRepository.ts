...
export function getRepositoryApply(args: GetRepositoryApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetRepositoryResult> {
 ...
 * A collection of arguments for invoking getRepository.
 */
export interface GetRepositoryApplyArgs {
    /**
     * The name of the ECR Repository.
     */
