...
export function getDirectConnectGatewayAttachmentApply(args?: GetDirectConnectGatewayAttachmentApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetDirectConnectGatewayAttachmentResult> {
 ...
 * A collection of arguments for invoking getDirectConnectGatewayAttachment.
 */
export interface GetDirectConnectGatewayAttachmentApplyArgs {
    /**
     * Identifier of the Direct Connect Gateway.
     */
     ...
     * Configuration block(s) for filtering. Detailed below.
     */
    filters?: pulumi.Input<pulumi.Input<inputs.ec2transitgateway.GetDirectConnectGatewayAttachmentFilter>[]>;
    /**
     * A map of tags, each pair of which must exactly match a pair on the desired Transit Gateway Direct Connect Gateway Attachment.
     */
