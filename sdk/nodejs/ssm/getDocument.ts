...
export function getDocumentApply(args: GetDocumentApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetDocumentResult> {
 ...
 * A collection of arguments for invoking getDocument.
 */
export interface GetDocumentApplyArgs {
    /**
     * Returns the document in the specified format. The document format can be either JSON or YAML. JSON is the default format.
     */
