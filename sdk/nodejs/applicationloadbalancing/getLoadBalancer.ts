...
export interface GetLoadBalancerResult {
    readonly accessLogs: outputApi.applicationloadbalancing.GetLoadBalancerAccessLogs;
    readonly arn: string;
    ...
    readonly subnetMappings: outputApi.applicationloadbalancing.GetLoadBalancerSubnetMapping[];
