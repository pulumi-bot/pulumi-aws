...
export interface GetTargetGroupResult {
    ...
    readonly healthCheck: outputApi.applicationloadbalancing.GetTargetGroupHealthCheck;
    ...
    readonly stickiness: outputApi.applicationloadbalancing.GetTargetGroupStickiness;
    readonly tags: {[key: string]: any};
