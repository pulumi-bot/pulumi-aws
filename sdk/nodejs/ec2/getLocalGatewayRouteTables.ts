...
export function getLocalGatewayRouteTablesApply(args?: GetLocalGatewayRouteTablesApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetLocalGatewayRouteTablesResult> {
 ...
 * A collection of arguments for invoking getLocalGatewayRouteTables.
 */
export interface GetLocalGatewayRouteTablesApplyArgs {
    /**
     * Custom filter block as described below.
     */
