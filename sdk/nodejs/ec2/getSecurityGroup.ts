...
export function getSecurityGroupApply(args?: GetSecurityGroupApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetSecurityGroupResult> {
 ...
 * A collection of arguments for invoking getSecurityGroup.
 */
export interface GetSecurityGroupApplyArgs {
    /**
     * Custom filter block as described below.
     */
    filters?: pulumi.Input<pulumi.Input<inputs.ec2.GetSecurityGroupFilter>[]>;
    /**
     * The id of the specific security group to retrieve.
     */
