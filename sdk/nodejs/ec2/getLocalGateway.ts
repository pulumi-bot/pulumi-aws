...
export function getLocalGatewayApply(args?: GetLocalGatewayApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetLocalGatewayResult> {
 ...
 * A collection of arguments for invoking getLocalGateway.
 */
export interface GetLocalGatewayApplyArgs {
    /**
     * Custom filter block as described below.
     */
    filters?: pulumi.Input<pulumi.Input<inputs.ec2.GetLocalGatewayFilter>[]>;
    /**
     * The id of the specific Local Gateway to retrieve.
     */
