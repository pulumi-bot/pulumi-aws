...
export function getManagedPrefixListApply(args?: GetManagedPrefixListApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetManagedPrefixListResult> {
 ...
 * A collection of arguments for invoking getManagedPrefixList.
 */
export interface GetManagedPrefixListApplyArgs {
    /**
     * Configuration block(s) for filtering. Detailed below.
     */
    filters?: pulumi.Input<pulumi.Input<inputs.ec2.GetManagedPrefixListFilter>[]>;
    /**
     * The ID of the prefix list to select.
     */
