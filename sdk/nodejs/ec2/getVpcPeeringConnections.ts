...
export function getVpcPeeringConnectionsApply(args?: GetVpcPeeringConnectionsApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetVpcPeeringConnectionsResult> {
 ...
 * A collection of arguments for invoking getVpcPeeringConnections.
 */
export interface GetVpcPeeringConnectionsApplyArgs {
    /**
     * Custom filter block as described below.
     */
    filters?: pulumi.Input<pulumi.Input<inputs.ec2.GetVpcPeeringConnectionsFilter>[]>;
    /**
     * A mapping of tags, each pair of which must exactly match
     * a pair on the desired VPC Peering Connection.
     */
