...
export function getNatGatewayApply(args?: GetNatGatewayApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetNatGatewayResult> {
 ...
 * A collection of arguments for invoking getNatGateway.
 */
export interface GetNatGatewayApplyArgs {
    /**
     * Custom filter block as described below.
     */
    filters?: pulumi.Input<pulumi.Input<inputs.ec2.GetNatGatewayFilter>[]>;
    /**
     * The id of the specific Nat Gateway to retrieve.
     */
