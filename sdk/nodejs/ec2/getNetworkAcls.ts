...
export function getNetworkAclsApply(args?: GetNetworkAclsApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetNetworkAclsResult> {
 ...
 * A collection of arguments for invoking getNetworkAcls.
 */
export interface GetNetworkAclsApplyArgs {
    /**
     * Custom filter block as described below.
     */
    filters?: pulumi.Input<pulumi.Input<inputs.ec2.GetNetworkAclsFilter>[]>;
    /**
     * A map of tags, each pair of which must exactly match
     * a pair on the desired network ACLs.
     */
