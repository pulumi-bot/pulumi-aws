...
export function getPrefixListApply(args?: GetPrefixListApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetPrefixListResult> {
 ...
 * A collection of arguments for invoking getPrefixList.
 */
export interface GetPrefixListApplyArgs {
    /**
     * Configuration block(s) for filtering. Detailed below.
     */
    filters?: pulumi.Input<pulumi.Input<inputs.ec2.GetPrefixListFilter>[]>;
    /**
     * The name of the filter field. Valid values can be found in the [EC2 DescribePrefixLists API Reference](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribePrefixLists.html).
     */
