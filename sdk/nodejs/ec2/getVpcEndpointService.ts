...
export function getVpcEndpointServiceApply(args?: GetVpcEndpointServiceApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetVpcEndpointServiceResult> {
 ...
 * A collection of arguments for invoking getVpcEndpointService.
 */
export interface GetVpcEndpointServiceApplyArgs {
    /**
     * Configuration block(s) for filtering. Detailed below.
     */
