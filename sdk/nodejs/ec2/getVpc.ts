...
export function getVpcApply(args?: GetVpcApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetVpcResult> {
 ...
 * A collection of arguments for invoking getVpc.
 */
export interface GetVpcApplyArgs {
    /**
     * The cidr block of the desired VPC.
     */
     ...
     * Custom filter block as described below.
     */
    filters?: pulumi.Input<pulumi.Input<inputs.ec2.GetVpcFilter>[]>;
    /**
     * The id of the specific VPC to retrieve.
     */
