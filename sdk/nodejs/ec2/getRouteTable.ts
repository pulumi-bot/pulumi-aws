...
export function getRouteTableApply(args?: GetRouteTableApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetRouteTableResult> {
 ...
 * A collection of arguments for invoking getRouteTable.
 */
export interface GetRouteTableApplyArgs {
    /**
     * Configuration block. Detailed below.
     */
    filters?: pulumi.Input<pulumi.Input<inputs.ec2.GetRouteTableFilter>[]>;
    /**
     * ID of an Internet Gateway or Virtual Private Gateway which is connected to the Route Table (not exported if not passed as a parameter).
     */
