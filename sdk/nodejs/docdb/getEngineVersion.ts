...
export function getEngineVersionApply(args?: GetEngineVersionApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetEngineVersionResult> {
 ...
 * A collection of arguments for invoking getEngineVersion.
 */
export interface GetEngineVersionApplyArgs {
    /**
     * DB engine. (Default: `docdb`)
     */
